...
internal class ProGuardCompatibilityTest {
    ...
    fun proguardRules() {
        val rulesFile =
            javaClass.classLoader.getResourceAsStream("META-INF/proguard/modern-treasury-kotlin-core.pro")
    ...
    fun counterpartyRoundtrip() {
      ...
      val counterparty = Counterparty.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .addAccount(Counterparty.Account.builder()
              .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
              ...
              .liveMode(true)
              .metadata(Counterparty.Account.Metadata.builder()
              ...
              .verificationStatus(Counterparty.Account.VerificationStatus.PENDING_VERIFICATION)
              .build())
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .discardedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          ...
          .liveMode(true)
          .metadata(Counterparty.Metadata.builder()
              .putAdditionalProperty("key", JsonValue.from("value"))
              .putAdditionalProperty("foo", JsonValue.from("bar"))
              .putAdditionalProperty("modern", JsonValue.from("treasury"))
              .build())
      ...
      val roundtrippedCounterparty = jsonMapper.readValue(jsonMapper.writeValueAsString(counterparty), jacksonTypeRef<Counterparty>())
    ...
    fun externalAccountTypeRoundtrip() {
      ...
      val roundtrippedExternalAccountType = jsonMapper.readValue(jsonMapper.writeValueAsString(externalAccountType), jacksonTypeRef<ExternalAccountType>())
