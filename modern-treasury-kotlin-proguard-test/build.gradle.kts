...
dependencies {
    testImplementation(project(":modern-treasury-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../modern-treasury-kotlin-core/src/main/resources/META-INF/proguard/modern-treasury-kotlin-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.moderntreasury.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../modern-treasury-kotlin-core/src/main/resources/META-INF/proguard/modern-treasury-kotlin-core.pro",
