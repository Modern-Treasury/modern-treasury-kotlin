...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.moderntreasury.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.moderntreasury.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.moderntreasury.api.** {
    <init>(...);
