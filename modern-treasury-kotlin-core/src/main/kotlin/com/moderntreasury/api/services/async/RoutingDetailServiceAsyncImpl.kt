...
class RoutingDetailServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : RoutingDetailServiceAsync {

    private val withRawResponse: RoutingDetailServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): RoutingDetailServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): RoutingDetailServiceAsync = RoutingDetailServiceAsyncImpl(clientOptions.toBuilder().apply(modifier).build())

    override suspend fun create(params: RoutingDetailCreateParams, requestOptions: RequestOptions): RoutingDetail =
        // post /api/{accounts_type}/{account_id}/routing_details
        withRawResponse().create(params, requestOptions).parse()

    override suspend fun retrieve(params: RoutingDetailRetrieveParams, requestOptions: RequestOptions): RoutingDetail =
        // get /api/{accounts_type}/{account_id}/routing_details/{id}
        withRawResponse().retrieve(params, requestOptions).parse()

    override suspend fun list(params: RoutingDetailListParams, requestOptions: RequestOptions): RoutingDetailListPageAsync =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): RoutingDetailServiceAsync.WithRawResponse = RoutingDetailServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())

        private val createHandler: Handler<RoutingDetail> = jsonHandler<RoutingDetail>(clientOptions.jsonMapper)

        override suspend fun create(params: RoutingDetailCreateParams, requestOptions: RequestOptions): HttpResponseFor<RoutingDetail> {
        ...
        override suspend fun retrieve(params: RoutingDetailRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<RoutingDetail> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
        ...
        override suspend fun list(params: RoutingDetailListParams, requestOptions: RequestOptions): HttpResponseFor<RoutingDetailListPageAsync> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("accountId", params.accountId())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        override suspend fun delete(params: RoutingDetailDeleteParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id())
          val request = HttpRequest.builder()
