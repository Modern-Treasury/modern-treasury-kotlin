...
class TransactionServiceAsyncImpl internal constructor(
    ...
    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): TransactionServiceAsync = TransactionServiceAsyncImpl(clientOptions.toBuilder().apply(modifier).build())

    override fun lineItems(): LineItemServiceAsync = lineItems

    override suspend fun create(params: TransactionCreateParams, requestOptions: RequestOptions): Transaction =
    ...
    override suspend fun update(params: TransactionUpdateParams, requestOptions: RequestOptions): Transaction =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): TransactionServiceAsync.WithRawResponse = TransactionServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())
        ...
        override suspend fun create(params: TransactionCreateParams, requestOptions: RequestOptions): HttpResponseFor<Transaction> {
        ...
        override suspend fun update(params: TransactionUpdateParams, requestOptions: RequestOptions): HttpResponseFor<Transaction> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id())
          val request = HttpRequest.builder()
        ...
        override suspend fun delete(params: TransactionDeleteParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id())
          val request = HttpRequest.builder()
