...
class CounterpartyServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : CounterpartyService {

    private val withRawResponse: CounterpartyService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): CounterpartyService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): CounterpartyService = CounterpartyServiceImpl(clientOptions.toBuilder().apply(modifier).build())

    override fun create(params: CounterpartyCreateParams, requestOptions: RequestOptions): Counterparty =
        // post /api/counterparties
        withRawResponse().create(params, requestOptions).parse()

    override fun retrieve(params: CounterpartyRetrieveParams, requestOptions: RequestOptions): Counterparty =
        // get /api/counterparties/{id}
        withRawResponse().retrieve(params, requestOptions).parse()

    override fun update(params: CounterpartyUpdateParams, requestOptions: RequestOptions): Counterparty =
        // patch /api/counterparties/{id}
        withRawResponse().update(params, requestOptions).parse()

    override fun list(params: CounterpartyListParams, requestOptions: RequestOptions): CounterpartyListPage =
    ...
    override fun collectAccount(params: CounterpartyCollectAccountParams, requestOptions: RequestOptions): CounterpartyCollectAccountResponse =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): CounterpartyService.WithRawResponse = CounterpartyServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())

        private val createHandler: Handler<Counterparty> = jsonHandler<Counterparty>(clientOptions.jsonMapper)

        override fun create(params: CounterpartyCreateParams, requestOptions: RequestOptions): HttpResponseFor<Counterparty> {
        ...
        override fun retrieve(params: CounterpartyRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<Counterparty> {
        ...
        override fun update(params: CounterpartyUpdateParams, requestOptions: RequestOptions): HttpResponseFor<Counterparty> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id())
          val request = HttpRequest.builder()
        ...
        override fun list(params: CounterpartyListParams, requestOptions: RequestOptions): HttpResponseFor<CounterpartyListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("api", "counterparties")
        ...
        override fun delete(params: CounterpartyDeleteParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id())
          val request = HttpRequest.builder()
        ...
        override fun collectAccount(params: CounterpartyCollectAccountParams, requestOptions: RequestOptions): HttpResponseFor<CounterpartyCollectAccountResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id())
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
