...
class LedgerServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : LedgerService {

    private val withRawResponse: LedgerService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): LedgerService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): LedgerService = LedgerServiceImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): LedgerService.WithRawResponse = LedgerServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())

        private val createHandler: Handler<Ledger> = jsonHandler<Ledger>(clientOptions.jsonMapper)

        override fun create(params: LedgerCreateParams, requestOptions: RequestOptions): HttpResponseFor<Ledger> {
        ...
        override fun retrieve(params: LedgerRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<Ledger> {
        ...
        override fun update(params: LedgerUpdateParams, requestOptions: RequestOptions): HttpResponseFor<Ledger> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id())
          val request = HttpRequest.builder()
        ...
        override fun list(params: LedgerListParams, requestOptions: RequestOptions): HttpResponseFor<LedgerListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("api", "ledgers")
        ...
        override fun delete(params: LedgerDeleteParams, requestOptions: RequestOptions): HttpResponseFor<Ledger> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id())
          val request = HttpRequest.builder()
