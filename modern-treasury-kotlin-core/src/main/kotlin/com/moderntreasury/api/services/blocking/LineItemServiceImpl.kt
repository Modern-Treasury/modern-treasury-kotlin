...
class LineItemServiceImpl internal constructor(
    ...
    override fun retrieve(params: LineItemRetrieveParams, requestOptions: RequestOptions): LineItem =
    ...
    override fun list(params: LineItemListParams, requestOptions: RequestOptions): LineItemListPage =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun retrieve(params: LineItemRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<LineItem> {
        ...
        override fun update(params: LineItemUpdateParams, requestOptions: RequestOptions): HttpResponseFor<LineItem> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id())
          val request = HttpRequest.builder()
        ...
        override fun list(params: LineItemListParams, requestOptions: RequestOptions): HttpResponseFor<LineItemListPage> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
