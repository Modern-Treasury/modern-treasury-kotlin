...
class InternalAccountServiceAsyncImpl internal constructor(
    ...
    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): InternalAccountServiceAsync = InternalAccountServiceAsyncImpl(clientOptions.toBuilder().apply(modifier).build())

    override fun balanceReports(): BalanceReportServiceAsync = balanceReports

    override suspend fun create(params: InternalAccountCreateParams, requestOptions: RequestOptions): InternalAccount =
        // post /api/internal_accounts
        withRawResponse().create(params, requestOptions).parse()

    override suspend fun retrieve(params: InternalAccountRetrieveParams, requestOptions: RequestOptions): InternalAccount =
        // get /api/internal_accounts/{id}
        withRawResponse().retrieve(params, requestOptions).parse()

    override suspend fun update(params: InternalAccountUpdateParams, requestOptions: RequestOptions): InternalAccount =
        // patch /api/internal_accounts/{id}
        withRawResponse().update(params, requestOptions).parse()

    override suspend fun list(params: InternalAccountListParams, requestOptions: RequestOptions): InternalAccountListPageAsync =
        // get /api/internal_accounts
        withRawResponse().list(params, requestOptions).parse()

    override suspend fun requestClosure(params: InternalAccountRequestClosureParams, requestOptions: RequestOptions): InternalAccount =
        // post /api/internal_accounts/{id}/request_closure
        withRawResponse().requestClosure(params, requestOptions).parse()

    override suspend fun updateAccountCapability(params: InternalAccountUpdateAccountCapabilityParams, requestOptions: RequestOptions): InternalAccountUpdateAccountCapabilityResponse =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): InternalAccountServiceAsync.WithRawResponse = InternalAccountServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())
        ...
        override suspend fun create(params: InternalAccountCreateParams, requestOptions: RequestOptions): HttpResponseFor<InternalAccount> {
        ...
        override suspend fun retrieve(params: InternalAccountRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<InternalAccount> {
        ...
        override suspend fun update(params: InternalAccountUpdateParams, requestOptions: RequestOptions): HttpResponseFor<InternalAccount> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id())
          val request = HttpRequest.builder()
        ...
        override suspend fun list(params: InternalAccountListParams, requestOptions: RequestOptions): HttpResponseFor<InternalAccountListPageAsync> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("api", "internal_accounts")
        ...
        override suspend fun requestClosure(params: InternalAccountRequestClosureParams, requestOptions: RequestOptions): HttpResponseFor<InternalAccount> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id())
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override suspend fun updateAccountCapability(params: InternalAccountUpdateAccountCapabilityParams, requestOptions: RequestOptions): HttpResponseFor<InternalAccountUpdateAccountCapabilityResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id())
          val request = HttpRequest.builder()
            .method(HttpMethod.PATCH)
