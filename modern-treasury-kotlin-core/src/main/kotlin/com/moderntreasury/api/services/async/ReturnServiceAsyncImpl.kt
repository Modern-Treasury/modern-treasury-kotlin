...
class ReturnServiceAsyncImpl internal constructor(
    ...
    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): ReturnServiceAsync = ReturnServiceAsyncImpl(clientOptions.toBuilder().apply(modifier).build())

    override suspend fun create(params: ReturnCreateParams, requestOptions: RequestOptions): ReturnObject =
        // post /api/returns
        withRawResponse().create(params, requestOptions).parse()

    override suspend fun retrieve(params: ReturnRetrieveParams, requestOptions: RequestOptions): ReturnObject =
        // get /api/returns/{id}
        withRawResponse().retrieve(params, requestOptions).parse()

    override suspend fun list(params: ReturnListParams, requestOptions: RequestOptions): ReturnListPageAsync =
        // get /api/returns
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): ReturnServiceAsync.WithRawResponse = ReturnServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())

        private val createHandler: Handler<ReturnObject> = jsonHandler<ReturnObject>(clientOptions.jsonMapper)

        override suspend fun create(params: ReturnCreateParams, requestOptions: RequestOptions): HttpResponseFor<ReturnObject> {
        ...
        override suspend fun retrieve(params: ReturnRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<ReturnObject> {
        ...
        override suspend fun list(params: ReturnListParams, requestOptions: RequestOptions): HttpResponseFor<ReturnListPageAsync> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("api", "returns")
