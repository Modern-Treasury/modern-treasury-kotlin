...
class ReversalServiceAsyncImpl internal constructor(
    ...
    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): ReversalServiceAsync = ReversalServiceAsyncImpl(clientOptions.toBuilder().apply(modifier).build())

    override suspend fun create(params: PaymentOrderReversalCreateParams, requestOptions: RequestOptions): Reversal =
        // post /api/payment_orders/{payment_order_id}/reversals
        withRawResponse().create(params, requestOptions).parse()

    override suspend fun retrieve(params: PaymentOrderReversalRetrieveParams, requestOptions: RequestOptions): Reversal =
        // get /api/payment_orders/{payment_order_id}/reversals/{reversal_id}
        withRawResponse().retrieve(params, requestOptions).parse()

    override suspend fun list(params: PaymentOrderReversalListParams, requestOptions: RequestOptions): PaymentOrderReversalListPageAsync =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): ReversalServiceAsync.WithRawResponse = ReversalServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())

        private val createHandler: Handler<Reversal> = jsonHandler<Reversal>(clientOptions.jsonMapper)

        override suspend fun create(params: PaymentOrderReversalCreateParams, requestOptions: RequestOptions): HttpResponseFor<Reversal> {
        ...
        override suspend fun retrieve(params: PaymentOrderReversalRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<Reversal> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
        ...
        override suspend fun list(params: PaymentOrderReversalListParams, requestOptions: RequestOptions): HttpResponseFor<PaymentOrderReversalListPageAsync> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("paymentOrderId", params.paymentOrderId())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
