...
class PaymentActionServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : PaymentActionServiceAsync {

    private val withRawResponse: PaymentActionServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): PaymentActionServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): PaymentActionServiceAsync = PaymentActionServiceAsyncImpl(clientOptions.toBuilder().apply(modifier).build())

    override suspend fun create(params: PaymentActionCreateParams, requestOptions: RequestOptions): PaymentActionCreateResponse =
        // post /api/payment_actions
        withRawResponse().create(params, requestOptions).parse()

    override suspend fun retrieve(params: PaymentActionRetrieveParams, requestOptions: RequestOptions): PaymentActionRetrieveResponse =
        // get /api/payment_actions/{id}
        withRawResponse().retrieve(params, requestOptions).parse()

    override suspend fun update(params: PaymentActionUpdateParams, requestOptions: RequestOptions): PaymentActionUpdateResponse =
        // patch /api/payment_actions/{id}
        withRawResponse().update(params, requestOptions).parse()

    override suspend fun list(params: PaymentActionListParams, requestOptions: RequestOptions): PaymentActionListPageAsync =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): PaymentActionServiceAsync.WithRawResponse = PaymentActionServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())
        ...
        override suspend fun create(params: PaymentActionCreateParams, requestOptions: RequestOptions): HttpResponseFor<PaymentActionCreateResponse> {
        ...
        override suspend fun retrieve(params: PaymentActionRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<PaymentActionRetrieveResponse> {
        ...
        override suspend fun update(params: PaymentActionUpdateParams, requestOptions: RequestOptions): HttpResponseFor<PaymentActionUpdateResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id())
          val request = HttpRequest.builder()
        ...
        override suspend fun list(params: PaymentActionListParams, requestOptions: RequestOptions): HttpResponseFor<PaymentActionListPageAsync> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("api", "payment_actions")
