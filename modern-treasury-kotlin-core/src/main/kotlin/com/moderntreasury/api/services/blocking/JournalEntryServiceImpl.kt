...
class JournalEntryServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : JournalEntryService {

    private val withRawResponse: JournalEntryService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): JournalEntryService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): JournalEntryService = JournalEntryServiceImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): JournalEntryService.WithRawResponse = JournalEntryServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())

        private val retrieveHandler: Handler<Void?> = emptyHandler()

        override fun retrieve(params: JournalEntryRetrieveParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun list(params: JournalEntryListParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
