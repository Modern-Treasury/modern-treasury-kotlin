...
class LedgerEntryServiceAsyncImpl internal constructor(
    ...
    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): LedgerEntryServiceAsync = LedgerEntryServiceAsyncImpl(clientOptions.toBuilder().apply(modifier).build())

    override suspend fun retrieve(params: LedgerEntryRetrieveParams, requestOptions: RequestOptions): LedgerEntry =
        // get /api/ledger_entries/{id}
        withRawResponse().retrieve(params, requestOptions).parse()

    override suspend fun update(params: LedgerEntryUpdateParams, requestOptions: RequestOptions): LedgerEntry =
        // patch /api/ledger_entries/{id}
        withRawResponse().update(params, requestOptions).parse()

    override suspend fun list(params: LedgerEntryListParams, requestOptions: RequestOptions): LedgerEntryListPageAsync =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): LedgerEntryServiceAsync.WithRawResponse = LedgerEntryServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())

        private val retrieveHandler: Handler<LedgerEntry> = jsonHandler<LedgerEntry>(clientOptions.jsonMapper)

        override suspend fun retrieve(params: LedgerEntryRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<LedgerEntry> {
        ...
        override suspend fun update(params: LedgerEntryUpdateParams, requestOptions: RequestOptions): HttpResponseFor<LedgerEntry> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id())
          val request = HttpRequest.builder()
        ...
        override suspend fun list(params: LedgerEntryListParams, requestOptions: RequestOptions): HttpResponseFor<LedgerEntryListPageAsync> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
