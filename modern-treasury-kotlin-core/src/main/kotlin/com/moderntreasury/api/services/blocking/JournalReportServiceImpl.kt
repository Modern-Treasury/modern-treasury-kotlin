...
class JournalReportServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : JournalReportService {

    private val withRawResponse: JournalReportService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): JournalReportService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): JournalReportService = JournalReportServiceImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): JournalReportService.WithRawResponse = JournalReportServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())

        private val retrieveHandler: Handler<Void?> = emptyHandler()

        override fun retrieve(params: JournalReportRetrieveParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun update(params: JournalReportUpdateParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id())
          val request = HttpRequest.builder()
        ...
        override fun list(params: JournalReportListParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
