...
class ReturnServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : ReturnService {

    private val withRawResponse: ReturnService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): ReturnService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): ReturnService = ReturnServiceImpl(clientOptions.toBuilder().apply(modifier).build())

    override fun create(params: ReturnCreateParams, requestOptions: RequestOptions): ReturnObject =
        // post /api/returns
        withRawResponse().create(params, requestOptions).parse()

    override fun retrieve(params: ReturnRetrieveParams, requestOptions: RequestOptions): ReturnObject =
        // get /api/returns/{id}
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): ReturnService.WithRawResponse = ReturnServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())

        private val createHandler: Handler<ReturnObject> = jsonHandler<ReturnObject>(clientOptions.jsonMapper)

        override fun create(params: ReturnCreateParams, requestOptions: RequestOptions): HttpResponseFor<ReturnObject> {
        ...
        override fun retrieve(params: ReturnRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<ReturnObject> {
        ...
        override fun list(params: ReturnListParams, requestOptions: RequestOptions): HttpResponseFor<ReturnListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("api", "returns")
