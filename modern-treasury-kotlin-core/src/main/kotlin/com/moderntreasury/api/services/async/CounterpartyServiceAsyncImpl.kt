...
class CounterpartyServiceAsyncImpl internal constructor(
    ...
    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): CounterpartyServiceAsync = CounterpartyServiceAsyncImpl(clientOptions.toBuilder().apply(modifier).build())

    override suspend fun create(params: CounterpartyCreateParams, requestOptions: RequestOptions): Counterparty =
        // post /api/counterparties
        withRawResponse().create(params, requestOptions).parse()

    override suspend fun retrieve(params: CounterpartyRetrieveParams, requestOptions: RequestOptions): Counterparty =
        // get /api/counterparties/{id}
        withRawResponse().retrieve(params, requestOptions).parse()

    override suspend fun update(params: CounterpartyUpdateParams, requestOptions: RequestOptions): Counterparty =
        // patch /api/counterparties/{id}
        withRawResponse().update(params, requestOptions).parse()

    override suspend fun list(params: CounterpartyListParams, requestOptions: RequestOptions): CounterpartyListPageAsync =
    ...
    override suspend fun collectAccount(params: CounterpartyCollectAccountParams, requestOptions: RequestOptions): CounterpartyCollectAccountResponse =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): CounterpartyServiceAsync.WithRawResponse = CounterpartyServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())

        private val createHandler: Handler<Counterparty> = jsonHandler<Counterparty>(clientOptions.jsonMapper)

        override suspend fun create(params: CounterpartyCreateParams, requestOptions: RequestOptions): HttpResponseFor<Counterparty> {
        ...
        override suspend fun retrieve(params: CounterpartyRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<Counterparty> {
        ...
        override suspend fun update(params: CounterpartyUpdateParams, requestOptions: RequestOptions): HttpResponseFor<Counterparty> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id())
          val request = HttpRequest.builder()
        ...
        override suspend fun list(params: CounterpartyListParams, requestOptions: RequestOptions): HttpResponseFor<CounterpartyListPageAsync> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("api", "counterparties")
        ...
        override suspend fun delete(params: CounterpartyDeleteParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id())
          val request = HttpRequest.builder()
        ...
        override suspend fun collectAccount(params: CounterpartyCollectAccountParams, requestOptions: RequestOptions): HttpResponseFor<CounterpartyCollectAccountResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id())
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
