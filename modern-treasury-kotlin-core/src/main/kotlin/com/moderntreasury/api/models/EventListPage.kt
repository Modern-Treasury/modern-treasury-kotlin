...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is EventListPage && this.eventsService == other.eventsService && this.params == other.params && this.response == other.response /* spotless:on */
    }
    ...
    fun getNextPageParams(): EventListParams? {
        ...
        return EventListParams.builder().from(params).afterCursor(afterCursor()).build()
    }
    ...
    constructor(
        ...
        fun items(): List<Event> = items.getNullable("items") ?: listOf()

        fun perPage(): String = perPage

        fun afterCursor(): String = afterCursor

        @JsonProperty("items") fun _items(): JsonField<List<Event>>? = items
        ...
        override fun toString() =
            "EventListPage.Response{items=$items, additionalProperties=$additionalProperties}"
