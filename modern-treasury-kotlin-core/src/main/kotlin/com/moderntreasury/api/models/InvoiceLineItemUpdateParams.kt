...
class InvoiceLineItemUpdateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        private var body: InvoiceLineItemUpdateRequest.Builder = InvoiceLineItemUpdateRequest.builder()
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        internal fun from(invoiceLineItemUpdateParams: InvoiceLineItemUpdateParams) =
            apply {
         ...
         * - etc.
         */
        fun body(body: InvoiceLineItemUpdateRequest) =
            apply {
        ...
        /** The cost per unit of the product or service that this line item is for,           specified in the invoice currency's smallest unit. */
        fun unitAmount(unitAmount: Long) =
            apply {
                body.unitAmount(unitAmount)
            }
    ...
    fun _body(): InvoiceLineItemUpdateRequest = body
    ...
    class InvoiceLineItemUpdateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        companion object {
            ...
            /** Returns a mutable builder for constructing an instance of [InvoiceLineItemUpdateRequest]. */
            fun builder() = Builder()
        }
        ...
        class Builder internal constructor() {
            ...
            internal fun from(invoiceLineItemUpdateRequest: InvoiceLineItemUpdateRequest) =
                apply {
                    ...
                    additionalProperties = invoiceLineItemUpdateRequest.additionalProperties.toMutableMap()
                }
         ...
         *   expected type.
         */
        fun validate(): InvoiceLineItemUpdateRequest =
            apply {
                if (validated) {
                  return@apply
                }
         ...
         */
        internal fun validity(): Int = (if (description.asKnown() == null) 0 else 1) + (if (direction.asKnown() == null) 0 else 1) + (metadata.asKnown()?.validity() ?: 0) + (if (name.asKnown() == null) 0 else 1) + (if (quantity.asKnown() == null) 0 else 1) + (if (unitAmount.asKnown() == null) 0 else 1) + (if (unitAmountDecimal.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is InvoiceLineItemUpdateRequest && description == other.description && direction == other.direction && metadata == other.metadata && name == other.name && quantity == other.quantity && unitAmount == other.unitAmount && unitAmountDecimal == other.unitAmountDecimal && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "InvoiceLineItemUpdateRequest{description=$description, direction=$direction, metadata=$metadata, name=$name, quantity=$quantity, unitAmount=$unitAmount, unitAmountDecimal=$unitAmountDecimal, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is InvoiceLineItemUpdateParams && invoiceId == other.invoiceId && id == other.id && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(invoiceId, id, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "InvoiceLineItemUpdateParams{invoiceId=$invoiceId, id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
