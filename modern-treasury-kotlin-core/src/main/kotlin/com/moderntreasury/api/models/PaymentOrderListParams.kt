...
class PaymentOrderListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(paymentOrderListParams: PaymentOrderListParams) =
            apply {
        ...
        /** An inclusive upper bound for searching created_at */
        fun createdAtEnd(createdAtEnd: LocalDate?) =
            apply {
                this.createdAtEnd = createdAtEnd
            }

        /** An inclusive lower bound for searching created_at */
        fun createdAtStart(createdAtStart: LocalDate?) =
            apply {
        ...
        /** An inclusive upper bound for searching effective_date */
        fun effectiveDateEnd(effectiveDateEnd: LocalDate?) =
            apply {
                this.effectiveDateEnd = effectiveDateEnd
            }

        /** An inclusive lower bound for searching effective_date */
        fun effectiveDateStart(effectiveDateStart: LocalDate?) =
            apply {
        ...
        /** An inclusive upper bound for searching process_after */
        fun processAfterEnd(processAfterEnd: OffsetDateTime?) =
            apply {
                this.processAfterEnd = processAfterEnd
            }

        /** An inclusive lower bound for searching process_after */
        fun processAfterStart(processAfterStart: OffsetDateTime?) =
            apply {
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                ...
                processAfterEnd?.let { put("process_after_end", DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(it)) }
                processAfterStart?.let { put("process_after_start", DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(it)) }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PaymentOrderListParams && afterCursor == other.afterCursor && counterpartyId == other.counterpartyId && createdAtEnd == other.createdAtEnd && createdAtStart == other.createdAtStart && direction == other.direction && effectiveDateEnd == other.effectiveDateEnd && effectiveDateStart == other.effectiveDateStart && externalId == other.externalId && metadata == other.metadata && originatingAccountId == other.originatingAccountId && perPage == other.perPage && priority == other.priority && processAfterEnd == other.processAfterEnd && processAfterStart == other.processAfterStart && referenceNumber == other.referenceNumber && status == other.status && transactionId == other.transactionId && type == other.type && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(afterCursor, counterpartyId, createdAtEnd, createdAtStart, direction, effectiveDateEnd, effectiveDateStart, externalId, metadata, originatingAccountId, perPage, priority, processAfterEnd, processAfterStart, referenceNumber, status, transactionId, type, additionalHeaders, additionalQueryParams)

    override fun toString() = "PaymentOrderListParams{afterCursor=$afterCursor, counterpartyId=$counterpartyId, createdAtEnd=$createdAtEnd, createdAtStart=$createdAtStart, direction=$direction, effectiveDateEnd=$effectiveDateEnd, effectiveDateStart=$effectiveDateStart, externalId=$externalId, metadata=$metadata, originatingAccountId=$originatingAccountId, perPage=$perPage, priority=$priority, processAfterEnd=$processAfterEnd, processAfterStart=$processAfterStart, referenceNumber=$referenceNumber, status=$status, transactionId=$transactionId, type=$type, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
