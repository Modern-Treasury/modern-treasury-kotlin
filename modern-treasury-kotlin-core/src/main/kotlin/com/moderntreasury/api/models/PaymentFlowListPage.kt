...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PaymentFlowListPage && this.paymentFlowsService == other.paymentFlowsService && this.params == other.params && this.response == other.response /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(paymentFlowsService, params, response) /* spotless:on */
    }
    ...
    constructor(
        ...
        override fun toString() =
            "PaymentFlowListPage.Response{items=$items, additionalProperties=$additionalProperties}"
