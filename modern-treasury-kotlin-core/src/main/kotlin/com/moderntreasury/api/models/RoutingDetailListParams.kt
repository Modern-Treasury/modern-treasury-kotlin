...
constructor(
    ...
    override fun toString() =
        "RoutingDetailListParams{accountsType=$accountsType, accountId=$accountId, afterCursor=$afterCursor, perPage=$perPage, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(routingDetailListParams: RoutingDetailListParams) = apply {
            ...
            additionalBodyProperties(routingDetailListParams.additionalBodyProperties)
        }
