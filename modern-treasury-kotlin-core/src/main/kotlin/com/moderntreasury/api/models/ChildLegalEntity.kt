...
class ChildLegalEntity @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(childLegalEntity: ChildLegalEntity) =
            apply {
                ...
                industryClassifications = childLegalEntity.industryClassifications.map { it.toMutableList() }
                intendedUse = childLegalEntity.intendedUse
                lastName = childLegalEntity.lastName
                legalEntityAssociations = childLegalEntity.legalEntityAssociations.map { it.toMutableList() }
                ...
                operatingJurisdictions = childLegalEntity.operatingJurisdictions.map { it.toMutableList() }
                ...
                primarySocialMediaSites = childLegalEntity.primarySocialMediaSites.map { it.toMutableList() }
                ...
                thirdPartyVerifications = childLegalEntity.thirdPartyVerifications.map { it.toMutableList() }
        ...
        fun build(): ChildLegalEntity =
            ChildLegalEntity(
              ...
              checkRequired(
                "legalEntityAssociations", legalEntityAssociations
              ).map { it.toImmutable() },
              checkRequired(
