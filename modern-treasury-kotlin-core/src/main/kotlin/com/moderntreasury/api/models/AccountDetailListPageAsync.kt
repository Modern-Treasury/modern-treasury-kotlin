...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AccountDetailListPageAsync && this.accountDetailsService == other.accountDetailsService && this.params == other.params && this.response == other.response /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(accountDetailsService, params, response) /* spotless:on */
    }
    ...
    constructor(
        ...
        override fun toString() =
            "AccountDetailListPageAsync.Response{items=$items, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: AccountDetailListPageAsync,
    ) : Flow<AccountDetail> {
