...
/** update invoice */
class InvoiceUpdateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(invoiceUpdateParams: InvoiceUpdateParams) =
            apply {
         ...
         * - etc.
         */
        fun body(body: InvoiceUpdateRequest) =
            apply {
    ...
    class InvoiceUpdateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(invoiceUpdateRequest: InvoiceUpdateRequest) =
                apply {
                    ...
                    notificationEmailAddresses = invoiceUpdateRequest.notificationEmailAddresses.map { it.toMutableList() }
                    ...
                    remindAfterOverdueDays = invoiceUpdateRequest.remindAfterOverdueDays.map { it.toMutableList() }
            ...
            /**
             * Returns an immutable instance of [InvoiceUpdateRequest].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             */
         ...
         *   expected type.
         */
        fun validate(): InvoiceUpdateRequest =
            apply {
                if (validated) {
                  return@apply
                }
         ...
         */
        internal fun validity(): Int = (contactDetails.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (counterpartyBillingAddress.asKnown()?.validity() ?: 0) + (if (counterpartyId.asKnown() == null) 0 else 1) + (counterpartyShippingAddress.asKnown()?.validity() ?: 0) + (currency.asKnown()?.validity() ?: 0) + (if (description.asKnown() == null) 0 else 1) + (if (dueDate.asKnown() == null) 0 else 1) + (if (fallbackPaymentMethod.asKnown() == null) 0 else 1) + (invoiceLineItems.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (invoicerAddress.asKnown()?.validity() ?: 0) + (if (invoicerName.asKnown() == null) 0 else 1) + (metadata.asKnown()?.validity() ?: 0) + (notificationEmailAddresses.asKnown()?.size ?: 0) + (if (notificationsEnabled.asKnown() == null) 0 else 1) + (if (originatingAccountId.asKnown() == null) 0 else 1) + (if (paymentEffectiveDate.asKnown() == null) 0 else 1) + (paymentMethod.asKnown()?.validity() ?: 0) + (paymentType.asKnown()?.validity() ?: 0) + (if (receivingAccountId.asKnown() == null) 0 else 1) + (if (recipientEmail.asKnown() == null) 0 else 1) + (if (recipientName.asKnown() == null) 0 else 1) + (remindAfterOverdueDays.asKnown()?.size ?: 0) + (if (status.asKnown() == null) 0 else 1) + (if (virtualAccountId.asKnown() == null) 0 else 1)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is InvoiceUpdateParams && id == other.id && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(id, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "InvoiceUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
