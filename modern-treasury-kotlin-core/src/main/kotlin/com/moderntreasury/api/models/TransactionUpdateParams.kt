...
class TransactionUpdateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(transactionUpdateParams: TransactionUpdateParams) =
            apply {
         ...
         * - [metadata]
         */
        fun body(body: TransactionUpdateRequest) =
            apply {
    ...
    class TransactionUpdateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        companion object {
            ...
            /** Returns a mutable builder for constructing an instance of [TransactionUpdateRequest]. */
            fun builder() = Builder()
        }
        ...
        class Builder internal constructor() {
            ...
            internal fun from(transactionUpdateRequest: TransactionUpdateRequest) =
                apply {
            ...
            /**
             * Returns an immutable instance of [TransactionUpdateRequest].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             */
         ...
         *   expected type.
         */
        fun validate(): TransactionUpdateRequest =
            apply {
                if (validated) {
                  return@apply
                }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is TransactionUpdateRequest && metadata == other.metadata && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "TransactionUpdateRequest{metadata=$metadata, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is TransactionUpdateParams && id == other.id && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(id, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "TransactionUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
