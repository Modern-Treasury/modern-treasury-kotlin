...
class LineItemRetrieveResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LineItemRetrieveResponse].
         *
    ...
    /** A builder for [LineItemRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(lineItemRetrieveResponse: LineItemRetrieveResponse) = apply {
            id = lineItemRetrieveResponse.id
            accounting = lineItemRetrieveResponse.accounting
            accountingCategoryId = lineItemRetrieveResponse.accountingCategoryId
            accountingLedgerClassId = lineItemRetrieveResponse.accountingLedgerClassId
            amount = lineItemRetrieveResponse.amount
            createdAt = lineItemRetrieveResponse.createdAt
            description = lineItemRetrieveResponse.description
            itemizableId = lineItemRetrieveResponse.itemizableId
            itemizableType = lineItemRetrieveResponse.itemizableType
            liveMode = lineItemRetrieveResponse.liveMode
            metadata = lineItemRetrieveResponse.metadata
            object_ = lineItemRetrieveResponse.object_
            updatedAt = lineItemRetrieveResponse.updatedAt
            additionalProperties = lineItemRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LineItemRetrieveResponse].
         *
         ...
         */
        fun build(): LineItemRetrieveResponse =
    ...
    fun validate(): LineItemRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (id.asKnown() == null) 0 else 1) +
            ...
            (if (itemizableId.asKnown() == null) 0 else 1) +
            (itemizableType.asKnown()?.validity() ?: 0) +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LineItemRetrieveResponse &&
            id == other.id &&
