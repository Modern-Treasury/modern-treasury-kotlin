...
class RoutingDetailDeleteParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(routingDetailDeleteParams: RoutingDetailDeleteParams) =
            apply {
                ...
                additionalBodyProperties = routingDetailDeleteParams.additionalBodyProperties.toMutableMap()
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is RoutingDetailDeleteParams && accountsType == other.accountsType && accountId == other.accountId && id == other.id && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams && additionalBodyProperties == other.additionalBodyProperties
    }
    ...
    override fun toString() = "RoutingDetailDeleteParams{accountsType=$accountsType, accountId=$accountId, id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
