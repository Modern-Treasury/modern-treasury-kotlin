...
class ReturnListPageAsync private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(returnListPageAsync: ReturnListPageAsync) =
            apply {
        ...
        fun service(service: ReturnServiceAsync) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ReturnListPageAsync && service == other.service && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, params, headers, items)

    override fun toString() = "ReturnListPageAsync{service=$service, params=$params, headers=$headers, items=$items}"
}
