...
class LedgerEntryListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        /** Shows all ledger entries that were present on a ledger account at a particular `lock_version`. You must also specify `ledger_account_id`. */
        fun asOfLockVersion(asOfLockVersion: Long?) =
            apply {
        ...
        fun ledgerAccountPayoutId(ledgerAccountPayoutId: String?) =
            apply {
        ...
        /** Get all ledger entries that are included in the ledger account statement. */
        fun ledgerAccountStatementId(ledgerAccountStatementId: String?) =
            apply {
        ...
        /** If true, response will include the balances attached to the ledger entry. If there is no balance available, null will be returned instead. */
        fun showBalances(showBalances: Boolean?) =
            apply {
        ...
        /** If true, response will include ledger entries that were deleted. When you update a ledger transaction to specify a new set of entries, the previous entries are deleted. */
        fun showDeleted(showDeleted: Boolean?) =
            apply {
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                ...
                amount?.let { it.eq()?.let { put("amount[eq]", it.toString()) }
                ...
                ledgerAccountLockVersion?.let { it._additionalProperties().keys().forEach { key ->
                    it._additionalProperties().values(key).forEach { value ->
                ...
                orderBy?.let { it.createdAt()?.let { put("order_by[created_at]", it.toString()) }
    ...
    /** Use `gt` (>), `gte` (>=), `lt` (<), `lte` (<=), or `eq` (=) to filter by the lock_version of a ledger account. For example, for all entries created at or before before lock_version 1000 of a ledger account, use `ledger_account_lock_version%5Blte%5D=1000`. */
    class LedgerAccountLockVersion private constructor(
        private val additionalProperties: QueryParams,
        ...
        class Builder internal constructor() {
            ...
            internal fun from(ledgerAccountLockVersion: LedgerAccountLockVersion) =
                apply {
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): LedgerAccountLockVersion = LedgerAccountLockVersion(additionalProperties.build())
        }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is LedgerAccountLockVersion && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "LedgerAccountLockVersion{additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LedgerEntryListParams && id == other.id && afterCursor == other.afterCursor && amount == other.amount && asOfLockVersion == other.asOfLockVersion && direction == other.direction && effectiveAt == other.effectiveAt && effectiveDate == other.effectiveDate && ledgerAccountCategoryId == other.ledgerAccountCategoryId && ledgerAccountId == other.ledgerAccountId && ledgerAccountLockVersion == other.ledgerAccountLockVersion && ledgerAccountPayoutId == other.ledgerAccountPayoutId && ledgerAccountSettlementId == other.ledgerAccountSettlementId && ledgerAccountStatementId == other.ledgerAccountStatementId && ledgerTransactionId == other.ledgerTransactionId && metadata == other.metadata && orderBy == other.orderBy && perPage == other.perPage && showBalances == other.showBalances && showDeleted == other.showDeleted && status == other.status && updatedAt == other.updatedAt && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(id, afterCursor, amount, asOfLockVersion, direction, effectiveAt, effectiveDate, ledgerAccountCategoryId, ledgerAccountId, ledgerAccountLockVersion, ledgerAccountPayoutId, ledgerAccountSettlementId, ledgerAccountStatementId, ledgerTransactionId, metadata, orderBy, perPage, showBalances, showDeleted, status, updatedAt, additionalHeaders, additionalQueryParams)

    override fun toString() = "LedgerEntryListParams{id=$id, afterCursor=$afterCursor, amount=$amount, asOfLockVersion=$asOfLockVersion, direction=$direction, effectiveAt=$effectiveAt, effectiveDate=$effectiveDate, ledgerAccountCategoryId=$ledgerAccountCategoryId, ledgerAccountId=$ledgerAccountId, ledgerAccountLockVersion=$ledgerAccountLockVersion, ledgerAccountPayoutId=$ledgerAccountPayoutId, ledgerAccountSettlementId=$ledgerAccountSettlementId, ledgerAccountStatementId=$ledgerAccountStatementId, ledgerTransactionId=$ledgerTransactionId, metadata=$metadata, orderBy=$orderBy, perPage=$perPage, showBalances=$showBalances, showDeleted=$showDeleted, status=$status, updatedAt=$updatedAt, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
