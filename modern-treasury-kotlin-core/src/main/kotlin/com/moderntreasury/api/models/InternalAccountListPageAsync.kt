...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is InternalAccountListPageAsync && this.internalAccountsService == other.internalAccountsService && this.params == other.params && this.response == other.response /* spotless:on */
    }
    ...
    constructor(
        ...
        override fun toString() =
            "InternalAccountListPageAsync.Response{items=$items, additionalProperties=$additionalProperties}"
