...
class LedgerAccountCategoryUpdateParams private constructor(
    ...
    companion object {
        ...
        fun none(): LedgerAccountCategoryUpdateParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [LedgerAccountCategoryUpdateParams]. */
        fun builder() = Builder()
    }

    /** A builder for [LedgerAccountCategoryUpdateParams]. */
    class Builder internal constructor() {

        private var id: String? = null
        private var body: LedgerAccountCategoryUpdateRequest.Builder = LedgerAccountCategoryUpdateRequest.builder()
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        internal fun from(ledgerAccountCategoryUpdateParams: LedgerAccountCategoryUpdateParams) =
            apply {
                id = ledgerAccountCategoryUpdateParams.id
                body = ledgerAccountCategoryUpdateParams.body.toBuilder()
                additionalHeaders = ledgerAccountCategoryUpdateParams.additionalHeaders.toBuilder()
                additionalQueryParams = ledgerAccountCategoryUpdateParams.additionalQueryParams.toBuilder()
            }
         ...
         * - [name]
         */
        fun body(body: LedgerAccountCategoryUpdateRequest) =
            apply {
    ...
    fun _body(): LedgerAccountCategoryUpdateRequest = body
    ...
    class LedgerAccountCategoryUpdateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        companion object {
            ...
            /** Returns a mutable builder for constructing an instance of [LedgerAccountCategoryUpdateRequest]. */
            fun builder() = Builder()
        }
        ...
        class Builder internal constructor() {
            ...
            internal fun from(ledgerAccountCategoryUpdateRequest: LedgerAccountCategoryUpdateRequest) =
                apply {
                    ...
                    additionalProperties = ledgerAccountCategoryUpdateRequest.additionalProperties.toMutableMap()
                }
         ...
         *   expected type.
         */
        fun validate(): LedgerAccountCategoryUpdateRequest =
            apply {
                if (validated) {
                  return@apply
                }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is LedgerAccountCategoryUpdateRequest && description == other.description && externalId == other.externalId && metadata == other.metadata && name == other.name && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "LedgerAccountCategoryUpdateRequest{description=$description, externalId=$externalId, metadata=$metadata, name=$name, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LedgerAccountCategoryUpdateParams && id == other.id && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(id, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "LedgerAccountCategoryUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
