...
class LedgerAccountCategoryCreateParams private constructor(
     ...
     *
     * Unlike [ledgerAccountCategoryIds], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LedgerAccountCategoryCreateParams].
         *
    ...
    class Builder internal constructor() {
        ...
        private var body: LedgerAccountCategoryCreateRequest.Builder = LedgerAccountCategoryCreateRequest.builder()
        ...
        internal fun from(ledgerAccountCategoryCreateParams: LedgerAccountCategoryCreateParams) =
            apply {
                ...
                additionalQueryParams = ledgerAccountCategoryCreateParams.additionalQueryParams.toBuilder()
            }
         ...
         * - etc.
         */
        fun body(body: LedgerAccountCategoryCreateRequest) =
            apply {
         ...
         *
         * You should usually call [Builder.ledgerAccountCategoryIds] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         */
        fun addLedgerAccountCategoryId(ledgerAccountCategoryId: String) =
            apply {
    ...
    class LedgerAccountCategoryCreateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("ledger_account_category_ids") @ExcludeMissing ledgerAccountCategoryIds: JsonField<List<String>> = JsonMissing.of(),
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun ledgerAccountCategoryIds(): List<String>? = ledgerAccountCategoryIds.getNullable("ledger_account_category_ids")
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [LedgerAccountCategoryCreateRequest].
             *
             * The following fields are required:
             *
             * ```kotlin
        ...
        class Builder internal constructor() {
            ...
            internal fun from(ledgerAccountCategoryCreateRequest: LedgerAccountCategoryCreateRequest) =
                apply {
                    ...
                    externalId = ledgerAccountCategoryCreateRequest.externalId
                    ledgerAccountCategoryIds = ledgerAccountCategoryCreateRequest.ledgerAccountCategoryIds.map { it.toMutableList() }
                    metadata = ledgerAccountCategoryCreateRequest.metadata
                    additionalProperties = ledgerAccountCategoryCreateRequest.additionalProperties.toMutableMap()
                }
            ...
            /** The currency exponent of the ledger account category. */
            fun currencyExponent(currencyExponent: Long?) = currencyExponent(JsonField.ofNullable(currencyExponent))
            ...
            /** The array of ledger account category ids that this ledger account category should be a child of. */
            fun ledgerAccountCategoryIds(ledgerAccountCategoryIds: List<String>) = ledgerAccountCategoryIds(JsonField.of(ledgerAccountCategoryIds))
            ...
            fun addLedgerAccountCategoryId(ledgerAccountCategoryId: String) =
                apply {
                    ledgerAccountCategoryIds = (ledgerAccountCategoryIds ?: JsonField.of(mutableListOf())).also {
         ...
         *   expected type.
         */
        fun validate(): LedgerAccountCategoryCreateRequest =
            apply {
                if (validated) {
                  return@apply
                }
         ...
         */
        internal fun validity(): Int = (if (currency.asKnown() == null) 0 else 1) + (if (ledgerId.asKnown() == null) 0 else 1) + (if (name.asKnown() == null) 0 else 1) + (normalBalance.asKnown()?.validity() ?: 0) + (if (currencyExponent.asKnown() == null) 0 else 1) + (if (description.asKnown() == null) 0 else 1) + (if (externalId.asKnown() == null) 0 else 1) + (ledgerAccountCategoryIds.asKnown()?.size ?: 0) + (metadata.asKnown()?.validity() ?: 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is LedgerAccountCategoryCreateRequest && currency == other.currency && ledgerId == other.ledgerId && name == other.name && normalBalance == other.normalBalance && currencyExponent == other.currencyExponent && description == other.description && externalId == other.externalId && ledgerAccountCategoryIds == other.ledgerAccountCategoryIds && metadata == other.metadata && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(currency, ledgerId, name, normalBalance, currencyExponent, description, externalId, ledgerAccountCategoryIds, metadata, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "LedgerAccountCategoryCreateRequest{currency=$currency, ledgerId=$ledgerId, name=$name, normalBalance=$normalBalance, currencyExponent=$currencyExponent, description=$description, externalId=$externalId, ledgerAccountCategoryIds=$ledgerAccountCategoryIds, metadata=$metadata, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LedgerAccountCategoryCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "LedgerAccountCategoryCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
