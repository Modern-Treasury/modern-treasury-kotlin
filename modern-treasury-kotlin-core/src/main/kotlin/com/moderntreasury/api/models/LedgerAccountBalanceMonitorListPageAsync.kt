...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LedgerAccountBalanceMonitorListPageAsync && this.ledgerAccountBalanceMonitorsService == other.ledgerAccountBalanceMonitorsService && this.params == other.params && this.response == other.response /* spotless:on */
    }
