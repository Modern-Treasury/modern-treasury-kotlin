...
class PaymentActionCreateParams private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = paymentActionCreateParams.details().convert(MyClass::class.java)
     * ```
     */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(paymentActionCreateParams: PaymentActionCreateParams) =
            apply {
         ...
         * - etc.
         */
        fun body(body: PaymentActionCreateRequest) =
            apply {
        ...
        /** Optional. The ID of the associated actionable object. */
        fun actionableId(actionableId: String) =
            apply {
    ...
    class PaymentActionCreateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         * This arbitrary value can be deserialized into a custom type using the `convert` method:
         * ```kotlin
         * val myObject: MyClass = paymentActionCreateRequest.details().convert(MyClass::class.java)
         * ```
         */
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [PaymentActionCreateRequest].
             *
             * The following fields are required:
             *
             * ```kotlin
        ...
        class Builder internal constructor() {
            ...
            internal fun from(paymentActionCreateRequest: PaymentActionCreateRequest) =
                apply {
                    ...
                    additionalProperties = paymentActionCreateRequest.additionalProperties.toMutableMap()
                }
            ...
            /** Optional. The type of the associated actionable object. One of `payment_order`, `expected_payment`. Required if `actionable_id` is passed. */
            fun actionableType(actionableType: String) = actionableType(JsonField.of(actionableType))
         ...
         *   expected type.
         */
        fun validate(): PaymentActionCreateRequest =
            apply {
                if (validated) {
                  return@apply
                }
         ...
         */
        internal fun validity(): Int = (if (type.asKnown() == null) 0 else 1) + (if (actionableId.asKnown() == null) 0 else 1) + (if (actionableType.asKnown() == null) 0 else 1) + (if (internalAccountId.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is PaymentActionCreateRequest && type == other.type && actionableId == other.actionableId && actionableType == other.actionableType && details == other.details && internalAccountId == other.internalAccountId && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "PaymentActionCreateRequest{type=$type, actionableId=$actionableId, actionableType=$actionableType, details=$details, internalAccountId=$internalAccountId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PaymentActionCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "PaymentActionCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
