...
class LedgerAccountCreateParams private constructor(
    ...
    fun _additionalBodyProperties(): Map<String, JsonValue> = ledgerAccountCreateRequest._additionalProperties()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(ledgerAccountCreateParams: LedgerAccountCreateParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LedgerAccountCreateParams && ledgerAccountCreateRequest == other.ledgerAccountCreateRequest && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(ledgerAccountCreateRequest, additionalHeaders, additionalQueryParams)

    override fun toString() = "LedgerAccountCreateParams{ledgerAccountCreateRequest=$ledgerAccountCreateRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
