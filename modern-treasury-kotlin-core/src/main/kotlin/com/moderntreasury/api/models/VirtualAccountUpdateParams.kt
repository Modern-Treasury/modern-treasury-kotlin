...
class VirtualAccountUpdateParams private constructor(
    ...
    companion object {
        ...
        fun none(): VirtualAccountUpdateParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        private var body: VirtualAccountUpdateRequest.Builder = VirtualAccountUpdateRequest.builder()
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        internal fun from(virtualAccountUpdateParams: VirtualAccountUpdateParams) =
            apply {
         ...
         * - [name]
         */
        fun body(body: VirtualAccountUpdateRequest) =
            apply {
        ...
        /**
         * Returns an immutable instance of [VirtualAccountUpdateParams].
         *
    ...
    class VirtualAccountUpdateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        companion object {
            ...
            /** Returns a mutable builder for constructing an instance of [VirtualAccountUpdateRequest]. */
            fun builder() = Builder()
        }
        ...
        class Builder internal constructor() {
            ...
            internal fun from(virtualAccountUpdateRequest: VirtualAccountUpdateRequest) =
                apply {
                    ...
                    additionalProperties = virtualAccountUpdateRequest.additionalProperties.toMutableMap()
                }
            ...
            /**
             * Returns an immutable instance of [VirtualAccountUpdateRequest].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             */
         ...
         *   expected type.
         */
        fun validate(): VirtualAccountUpdateRequest =
            apply {
                if (validated) {
                  return@apply
                }
         ...
         */
        internal fun validity(): Int = (if (counterpartyId.asKnown() == null) 0 else 1) + (if (ledgerAccountId.asKnown() == null) 0 else 1) + (metadata.asKnown()?.validity() ?: 0) + (if (name.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is VirtualAccountUpdateRequest && counterpartyId == other.counterpartyId && ledgerAccountId == other.ledgerAccountId && metadata == other.metadata && name == other.name && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "VirtualAccountUpdateRequest{counterpartyId=$counterpartyId, ledgerAccountId=$ledgerAccountId, metadata=$metadata, name=$name, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is VirtualAccountUpdateParams && id == other.id && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(id, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "VirtualAccountUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
