...
class ExpectedPayment @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("reconciliation_method") @ExcludeMissing reconciliationMethod: JsonField<ReconciliationMethod> = JsonMissing.of(),
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun reconciliationMethod(): ReconciliationMethod? = reconciliationMethod.getNullable("reconciliation_method")
     ...
     *
     * Unlike [reconciliationMethod], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(expectedPayment: ExpectedPayment) =
            apply {
                ...
                reconciliationRuleVariables = expectedPayment.reconciliationRuleVariables.map { it.toMutableList() }
        ...
        /** One of manual if this expected payment was manually reconciled in the dashboard, automatic if it was automatically reconciled by Modern Treasury, or null if it is unreconciled. */
        fun reconciliationMethod(reconciliationMethod: ReconciliationMethod?) = reconciliationMethod(JsonField.ofNullable(reconciliationMethod))

        /**
         * Sets [Builder.reconciliationMethod] to an arbitrary JSON value.
         *
         * You should usually call [Builder.reconciliationMethod] with a well-typed [ReconciliationMethod] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun reconciliationMethod(reconciliationMethod: JsonField<ReconciliationMethod>) =
            apply {
     ...
     */
    internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (if (amountLowerBound.asKnown() == null) 0 else 1) + (if (amountReconciled.asKnown() == null) 0 else 1) + (amountReconciledDirection.asKnown()?.validity() ?: 0) + (if (amountUnreconciled.asKnown() == null) 0 else 1) + (amountUnreconciledDirection.asKnown()?.validity() ?: 0) + (if (amountUpperBound.asKnown() == null) 0 else 1) + (if (counterpartyId.asKnown() == null) 0 else 1) + (if (createdAt.asKnown() == null) 0 else 1) + (currency.asKnown()?.validity() ?: 0) + (if (dateLowerBound.asKnown() == null) 0 else 1) + (if (dateUpperBound.asKnown() == null) 0 else 1) + (if (description.asKnown() == null) 0 else 1) + (direction.asKnown()?.validity() ?: 0) + (if (externalId.asKnown() == null) 0 else 1) + (if (internalAccountId.asKnown() == null) 0 else 1) + (if (ledgerTransactionId.asKnown() == null) 0 else 1) + (if (liveMode.asKnown() == null) 0 else 1) + (metadata.asKnown()?.validity() ?: 0) + (if (object_.asKnown() == null) 0 else 1) + (reconciliationMethod.asKnown()?.validity() ?: 0) + (reconciliationRuleVariables.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (if (remittanceInformation.asKnown() == null) 0 else 1) + (if (statementDescriptor.asKnown() == null) 0 else 1) + (status.asKnown()?.validity() ?: 0) + (if (transactionId.asKnown() == null) 0 else 1) + (if (transactionLineItemId.asKnown() == null) 0 else 1) + (type.asKnown()?.validity() ?: 0) + (if (updatedAt.asKnown() == null) 0 else 1)
    ...
    /** One of manual if this expected payment was manually reconciled in the dashboard, automatic if it was automatically reconciled by Modern Treasury, or null if it is unreconciled. */
    class ReconciliationMethod @JsonCreator private constructor(
        private val value: JsonField<String>,
        ...
        /**
         * An enum containing [ReconciliationMethod]'s known values, as well as an [_UNKNOWN] member.
         *
        ...
        enum class Value {
            AUTOMATIC,
            MANUAL,
            /** An enum member indicating that [ReconciliationMethod] was instantiated with an unknown value. */
            _UNKNOWN,
        }
        ...
        fun known(): Known =
            when (this) {
                ...
                MANUAL -> Known.MANUAL
                else -> throw ModernTreasuryInvalidDataException("Unknown ReconciliationMethod: $value")
            }
         ...
         *   expected type.
         */
        fun validate(): ReconciliationMethod =
            apply {
                if (validated) {
                  return@apply
                }
