...
class PaymentReferenceListPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(paymentReferenceListPage: PaymentReferenceListPage) =
            apply {
        ...
        fun service(service: PaymentReferenceService) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PaymentReferenceListPage && service == other.service && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, params, headers, items)

    override fun toString() = "PaymentReferenceListPage{service=$service, params=$params, headers=$headers, items=$items}"
}
