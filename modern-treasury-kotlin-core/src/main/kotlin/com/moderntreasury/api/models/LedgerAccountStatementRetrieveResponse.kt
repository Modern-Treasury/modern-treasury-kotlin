...
class LedgerAccountStatementRetrieveResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("effective_at_lower_bound") @ExcludeMissing effectiveAtLowerBound: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("effective_at_upper_bound") @ExcludeMissing effectiveAtUpperBound: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("ending_balance") @ExcludeMissing endingBalance: JsonField<LedgerBalances> = JsonMissing.of(),
        ...
        @JsonProperty("ledger_account_normal_balance") @ExcludeMissing ledgerAccountNormalBalance: JsonField<TransactionDirection> = JsonMissing.of(),
        ...
        @JsonProperty("starting_balance") @ExcludeMissing startingBalance: JsonField<LedgerBalances> = JsonMissing.of(),
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun effectiveAtLowerBound(): OffsetDateTime = effectiveAtLowerBound.getRequired("effective_at_lower_bound")
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun effectiveAtUpperBound(): OffsetDateTime = effectiveAtUpperBound.getRequired("effective_at_upper_bound")
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun ledgerAccountNormalBalance(): TransactionDirection = ledgerAccountNormalBalance.getRequired("ledger_account_normal_balance")
     ...
     *
     * Unlike [effectiveAtLowerBound], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [ledgerAccountNormalBalance], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LedgerAccountStatementRetrieveResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(ledgerAccountStatementRetrieveResponse: LedgerAccountStatementRetrieveResponse) =
            apply {
                ...
                ledgerAccountLockVersion = ledgerAccountStatementRetrieveResponse.ledgerAccountLockVersion
                ledgerAccountNormalBalance = ledgerAccountStatementRetrieveResponse.ledgerAccountNormalBalance
                ...
                additionalProperties = ledgerAccountStatementRetrieveResponse.additionalProperties.toMutableMap()
            }
        ...
        /** The inclusive lower bound of the effective_at timestamp of the ledger entries to be included in the ledger account statement. */
        fun effectiveAtLowerBound(effectiveAtLowerBound: OffsetDateTime) = effectiveAtLowerBound(JsonField.of(effectiveAtLowerBound))

        /**
         * Sets [Builder.effectiveAtLowerBound] to an arbitrary JSON value.
         *
         * You should usually call [Builder.effectiveAtLowerBound] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun effectiveAtLowerBound(effectiveAtLowerBound: JsonField<OffsetDateTime>) =
            apply {
                this.effectiveAtLowerBound = effectiveAtLowerBound
            }

        /** The exclusive upper bound of the effective_at timestamp of the ledger entries to be included in the ledger account statement. */
        fun effectiveAtUpperBound(effectiveAtUpperBound: OffsetDateTime) = effectiveAtUpperBound(JsonField.of(effectiveAtUpperBound))
        ...
        /** The pending, posted, and available balances for this ledger account at the `effective_at_upper_bound`. The posted balance is the sum of all posted entries on the account. The pending balance is the sum of all pending and posted entries on the account. The available balance is the posted incoming entries minus the sum of the pending and posted outgoing amounts. */
        fun endingBalance(endingBalance: LedgerBalances) = endingBalance(JsonField.of(endingBalance))

        /**
         * Sets [Builder.endingBalance] to an arbitrary JSON value.
         *
         * You should usually call [Builder.endingBalance] with a well-typed [LedgerBalances] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun endingBalance(endingBalance: JsonField<LedgerBalances>) =
            apply {
        ...
        /** The normal balance of the ledger account. */
        fun ledgerAccountNormalBalance(ledgerAccountNormalBalance: TransactionDirection) = ledgerAccountNormalBalance(JsonField.of(ledgerAccountNormalBalance))

        /**
         * Sets [Builder.ledgerAccountNormalBalance] to an arbitrary JSON value.
         *
         * You should usually call [Builder.ledgerAccountNormalBalance] with a well-typed [TransactionDirection] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ledgerAccountNormalBalance(ledgerAccountNormalBalance: JsonField<TransactionDirection>) =
            apply {
                this.ledgerAccountNormalBalance = ledgerAccountNormalBalance
            }
        ...
        /** The pending, posted, and available balances for this ledger account at the `effective_at_lower_bound`. The posted balance is the sum of all posted entries on the account. The pending balance is the sum of all pending and posted entries on the account. The available balance is the posted incoming entries minus the sum of the pending and posted outgoing amounts. */
        fun startingBalance(startingBalance: LedgerBalances) = startingBalance(JsonField.of(startingBalance))

        /**
         * Sets [Builder.startingBalance] to an arbitrary JSON value.
         *
         * You should usually call [Builder.startingBalance] with a well-typed [LedgerBalances] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun startingBalance(startingBalance: JsonField<LedgerBalances>) =
            apply {
        ...
        fun build(): LedgerAccountStatementRetrieveResponse =
            LedgerAccountStatementRetrieveResponse(
              ...
              checkRequired(
                "effectiveAtLowerBound", effectiveAtLowerBound
              ),
              checkRequired(
     ...
     *   expected type.
     */
    fun validate(): LedgerAccountStatementRetrieveResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (if (createdAt.asKnown() == null) 0 else 1) + (if (description.asKnown() == null) 0 else 1) + (if (effectiveAtLowerBound.asKnown() == null) 0 else 1) + (if (effectiveAtUpperBound.asKnown() == null) 0 else 1) + (endingBalance.asKnown()?.validity() ?: 0) + (if (ledgerAccountId.asKnown() == null) 0 else 1) + (if (ledgerAccountLockVersion.asKnown() == null) 0 else 1) + (ledgerAccountNormalBalance.asKnown()?.validity() ?: 0) + (if (ledgerId.asKnown() == null) 0 else 1) + (if (liveMode.asKnown() == null) 0 else 1) + (metadata.asKnown()?.validity() ?: 0) + (if (object_.asKnown() == null) 0 else 1) + (startingBalance.asKnown()?.validity() ?: 0) + (if (updatedAt.asKnown() == null) 0 else 1)
