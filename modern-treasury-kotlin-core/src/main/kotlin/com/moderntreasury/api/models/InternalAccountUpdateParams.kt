...
class InternalAccountUpdateParams private constructor(
    ...
    companion object {
        ...
        fun none(): InternalAccountUpdateParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        private var body: InternalAccountUpdateRequest.Builder = InternalAccountUpdateRequest.builder()
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        internal fun from(internalAccountUpdateParams: InternalAccountUpdateParams) =
            apply {
         ...
         * - etc.
         */
        fun body(body: InternalAccountUpdateRequest) =
            apply {
    ...
    fun _body(): InternalAccountUpdateRequest = body
    ...
    class InternalAccountUpdateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(internalAccountUpdateRequest: InternalAccountUpdateRequest) =
                apply {
         ...
         *   expected type.
         */
        fun validate(): InternalAccountUpdateRequest =
            apply {
                if (validated) {
                  return@apply
                }
         ...
         */
        internal fun validity(): Int = (if (contraLedgerAccountId.asKnown() == null) 0 else 1) + (if (counterpartyId.asKnown() == null) 0 else 1) + (if (externalId.asKnown() == null) 0 else 1) + (if (ledgerAccountId.asKnown() == null) 0 else 1) + (metadata.asKnown()?.validity() ?: 0) + (if (name.asKnown() == null) 0 else 1) + (if (parentAccountId.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is InternalAccountUpdateRequest && contraLedgerAccountId == other.contraLedgerAccountId && counterpartyId == other.counterpartyId && externalId == other.externalId && ledgerAccountId == other.ledgerAccountId && metadata == other.metadata && name == other.name && parentAccountId == other.parentAccountId && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(contraLedgerAccountId, counterpartyId, externalId, ledgerAccountId, metadata, name, parentAccountId, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "InternalAccountUpdateRequest{contraLedgerAccountId=$contraLedgerAccountId, counterpartyId=$counterpartyId, externalId=$externalId, ledgerAccountId=$ledgerAccountId, metadata=$metadata, name=$name, parentAccountId=$parentAccountId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is InternalAccountUpdateParams && id == other.id && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(id, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "InternalAccountUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
