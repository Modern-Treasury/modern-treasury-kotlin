...
class InternalAccountUpdateAccountCapabilityParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [InternalAccountUpdateAccountCapabilityParams].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(internalAccountUpdateAccountCapabilityParams: InternalAccountUpdateAccountCapabilityParams) =
            apply {
                ...
                additionalHeaders = internalAccountUpdateAccountCapabilityParams.additionalHeaders.toBuilder()
                additionalQueryParams = internalAccountUpdateAccountCapabilityParams.additionalQueryParams.toBuilder()
            }
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && identifier == other.identifier && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Body{identifier=$identifier, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is InternalAccountUpdateAccountCapabilityParams && internalAccountId == other.internalAccountId && id == other.id && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(internalAccountId, id, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "InternalAccountUpdateAccountCapabilityParams{internalAccountId=$internalAccountId, id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
