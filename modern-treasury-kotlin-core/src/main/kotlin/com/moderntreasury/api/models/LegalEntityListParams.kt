...
class LegalEntityListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(legalEntityListParams: LegalEntityListParams) =
            apply {
        ...
        fun showDeleted(showDeleted: String?) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LegalEntityListParams && afterCursor == other.afterCursor && externalId == other.externalId && legalEntityType == other.legalEntityType && metadata == other.metadata && perPage == other.perPage && showDeleted == other.showDeleted && status == other.status && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(afterCursor, externalId, legalEntityType, metadata, perPage, showDeleted, status, additionalHeaders, additionalQueryParams)

    override fun toString() = "LegalEntityListParams{afterCursor=$afterCursor, externalId=$externalId, legalEntityType=$legalEntityType, metadata=$metadata, perPage=$perPage, showDeleted=$showDeleted, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
