...
class ConnectionLegalEntityUpdateParams private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ConnectionLegalEntityUpdateParams]. */
        fun builder() = Builder()
    }
    ...
    class Builder internal constructor() {
        ...
        private var body: ConnectionLegalEntityUpdateRequest.Builder = ConnectionLegalEntityUpdateRequest.builder()
        ...
        internal fun from(connectionLegalEntityUpdateParams: ConnectionLegalEntityUpdateParams) =
            apply {
                ...
                additionalQueryParams = connectionLegalEntityUpdateParams.additionalQueryParams.toBuilder()
            }
         ...
         * - [status]
         */
        fun body(body: ConnectionLegalEntityUpdateRequest) =
            apply {
    ...
    class ConnectionLegalEntityUpdateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        companion object {
            ...
            /** Returns a mutable builder for constructing an instance of [ConnectionLegalEntityUpdateRequest]. */
            fun builder() = Builder()
        }
        ...
        class Builder internal constructor() {
            ...
            internal fun from(connectionLegalEntityUpdateRequest: ConnectionLegalEntityUpdateRequest) =
                apply {
                    status = connectionLegalEntityUpdateRequest.status
                    additionalProperties = connectionLegalEntityUpdateRequest.additionalProperties.toMutableMap()
                }
            ...
            fun build(): ConnectionLegalEntityUpdateRequest =
                ConnectionLegalEntityUpdateRequest(
                  status, additionalProperties.toMutableMap()
                )
        }
         ...
         *   expected type.
         */
        fun validate(): ConnectionLegalEntityUpdateRequest =
            apply {
                if (validated) {
                  return@apply
                }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is ConnectionLegalEntityUpdateRequest && status == other.status && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "ConnectionLegalEntityUpdateRequest{status=$status, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ConnectionLegalEntityUpdateParams && id == other.id && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(id, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "ConnectionLegalEntityUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
