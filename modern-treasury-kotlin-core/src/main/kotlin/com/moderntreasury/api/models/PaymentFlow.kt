...
class PaymentFlow @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("client_token") @ExcludeMissing clientToken: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("effective_date_selection_enabled") @ExcludeMissing effectiveDateSelectionEnabled: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("existing_external_accounts_filter") @ExcludeMissing existingExternalAccountsFilter: JsonField<ExistingExternalAccountsFilter> = JsonMissing.of(),
        @JsonProperty("external_account_collection") @ExcludeMissing externalAccountCollection: JsonField<ExternalAccountCollection> = JsonMissing.of(),
        ...
        @JsonProperty("payment_order_id") @ExcludeMissing paymentOrderId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("receiving_account_id") @ExcludeMissing receivingAccountId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("selected_effective_date") @ExcludeMissing selectedEffectiveDate: JsonField<LocalDate> = JsonMissing.of(),
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun effectiveDateSelectionEnabled(): Boolean? = effectiveDateSelectionEnabled.getNullable("effective_date_selection_enabled")
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun existingExternalAccountsFilter(): ExistingExternalAccountsFilter? = existingExternalAccountsFilter.getNullable("existing_external_accounts_filter")
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun externalAccountCollection(): ExternalAccountCollection? = externalAccountCollection.getNullable("external_account_collection")
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun selectedEffectiveDate(): LocalDate? = selectedEffectiveDate.getNullable("selected_effective_date")
    ...
    @ExcludeMissing
    fun _dueDate(): JsonField<LocalDate> = dueDate

    /**
     * Returns the raw JSON value of [effectiveDateSelectionEnabled].
     *
     * Unlike [effectiveDateSelectionEnabled], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [existingExternalAccountsFilter], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("existing_external_accounts_filter")
    @ExcludeMissing
    fun _existingExternalAccountsFilter(): JsonField<ExistingExternalAccountsFilter> = existingExternalAccountsFilter

    /**
     * Returns the raw JSON value of [externalAccountCollection].
     *
     * Unlike [externalAccountCollection], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("external_account_collection")
    @ExcludeMissing
    fun _externalAccountCollection(): JsonField<ExternalAccountCollection> = externalAccountCollection
     ...
     *
     * Unlike [selectedEffectiveDate], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
        ...
        private var existingExternalAccountsFilter: JsonField<ExistingExternalAccountsFilter> = JsonMissing.of()
        private var externalAccountCollection: JsonField<ExternalAccountCollection> = JsonMissing.of()
        ...
        internal fun from(paymentFlow: PaymentFlow) =
            apply {
                id = paymentFlow.id
         ...
         *
         * You should usually call [Builder.clientToken] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun clientToken(clientToken: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.dueDate] with a well-typed [LocalDate] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun dueDate(dueDate: JsonField<LocalDate>) =
            apply {
                this.dueDate = dueDate
            }

        /** When `true`, your end-user can schedule the payment `effective_date` while completing the pre-built UI. */
        fun effectiveDateSelectionEnabled(effectiveDateSelectionEnabled: Boolean) = effectiveDateSelectionEnabled(JsonField.of(effectiveDateSelectionEnabled))

        /**
         * Sets [Builder.effectiveDateSelectionEnabled] to an arbitrary JSON value.
         *
         * You should usually call [Builder.effectiveDateSelectionEnabled] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /** When `verified` and `external_account_collection` is `enabled`, filters the list of external accounts your end-user can select to those with a `verification_status` of `verified`. */
        fun existingExternalAccountsFilter(existingExternalAccountsFilter: ExistingExternalAccountsFilter?) = existingExternalAccountsFilter(JsonField.ofNullable(existingExternalAccountsFilter))

        /**
         * Sets [Builder.existingExternalAccountsFilter] to an arbitrary JSON value.
         *
         * You should usually call [Builder.existingExternalAccountsFilter] with a well-typed [ExistingExternalAccountsFilter] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun existingExternalAccountsFilter(existingExternalAccountsFilter: JsonField<ExistingExternalAccountsFilter>) =
            apply {
                this.existingExternalAccountsFilter = existingExternalAccountsFilter
            }

        /** When `enabled`, your end-user can select from an existing external account when completing the flow. When `disabled`, your end-user must add new payment details when completing the flow. */
        fun externalAccountCollection(externalAccountCollection: ExternalAccountCollection) = externalAccountCollection(JsonField.of(externalAccountCollection))

        /**
         * Sets [Builder.externalAccountCollection] to an arbitrary JSON value.
         *
         * You should usually call [Builder.externalAccountCollection] with a well-typed [ExternalAccountCollection] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun externalAccountCollection(externalAccountCollection: JsonField<ExternalAccountCollection>) =
            apply {
        ...
        /** The ID of one of your organization's internal accounts. */
        fun originatingAccountId(originatingAccountId: String?) = originatingAccountId(JsonField.ofNullable(originatingAccountId))
        ...
        /** If present, the ID of the payment order created using this flow. */
        fun paymentOrderId(paymentOrderId: String?) = paymentOrderId(JsonField.ofNullable(paymentOrderId))

        /**
         * Sets [Builder.paymentOrderId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.paymentOrderId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun paymentOrderId(paymentOrderId: JsonField<String>) =
            apply {
        ...
        /** This field is set after your end-user selects a payment date while completing the pre-built UI. This field is always `null` unless `effective_date_selection_enabled` is `true`. */
        fun selectedEffectiveDate(selectedEffectiveDate: LocalDate?) = selectedEffectiveDate(JsonField.ofNullable(selectedEffectiveDate))

        /**
         * Sets [Builder.selectedEffectiveDate] to an arbitrary JSON value.
         *
         * You should usually call [Builder.selectedEffectiveDate] with a well-typed [LocalDate] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun selectedEffectiveDate(selectedEffectiveDate: JsonField<LocalDate>) =
            apply {
     ...
     */
    internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (if (amount.asKnown() == null) 0 else 1) + (if (clientToken.asKnown() == null) 0 else 1) + (if (counterpartyId.asKnown() == null) 0 else 1) + (if (createdAt.asKnown() == null) 0 else 1) + (if (currency.asKnown() == null) 0 else 1) + (direction.asKnown()?.validity() ?: 0) + (if (dueDate.asKnown() == null) 0 else 1) + (if (effectiveDateSelectionEnabled.asKnown() == null) 0 else 1) + (existingExternalAccountsFilter.asKnown()?.validity() ?: 0) + (externalAccountCollection.asKnown()?.validity() ?: 0) + (if (liveMode.asKnown() == null) 0 else 1) + (if (object_.asKnown() == null) 0 else 1) + (if (originatingAccountId.asKnown() == null) 0 else 1) + (if (paymentOrderId.asKnown() == null) 0 else 1) + (if (receivingAccountId.asKnown() == null) 0 else 1) + (if (selectedEffectiveDate.asKnown() == null) 0 else 1) + (status.asKnown()?.validity() ?: 0) + (if (updatedAt.asKnown() == null) 0 else 1)
    ...
    /** When `verified` and `external_account_collection` is `enabled`, filters the list of external accounts your end-user can select to those with a `verification_status` of `verified`. */
    class ExistingExternalAccountsFilter @JsonCreator private constructor(
        private val value: JsonField<String>,
        ...
        /**
         * An enum containing [ExistingExternalAccountsFilter]'s known values, as well as an [_UNKNOWN] member.
         *
         * An instance of [ExistingExternalAccountsFilter] can contain an unknown value in a couple of cases:
         *
         * - It was deserialized from data that doesn't match any known member. For example, if the SDK is on
         *   an older version than the API, then the API may respond with new members that the SDK is unaware
         *   of.
        ...
        enum class Value {
            VERIFIED,
            /** An enum member indicating that [ExistingExternalAccountsFilter] was instantiated with an unknown value. */
            _UNKNOWN,
        }
        ...
        fun known(): Known =
            when (this) {
                ...
                else -> throw ModernTreasuryInvalidDataException("Unknown ExistingExternalAccountsFilter: $value")
            }
         ...
         *   expected type.
         */
        fun validate(): ExistingExternalAccountsFilter =
            apply {
                if (validated) {
                  return@apply
                }
    ...
    /** When `enabled`, your end-user can select from an existing external account when completing the flow. When `disabled`, your end-user must add new payment details when completing the flow. */
    class ExternalAccountCollection @JsonCreator private constructor(
        private val value: JsonField<String>,
        ...
        /**
         * An enum containing [ExternalAccountCollection]'s known values, as well as an [_UNKNOWN] member.
         *
         * An instance of [ExternalAccountCollection] can contain an unknown value in a couple of cases:
         *
         * - It was deserialized from data that doesn't match any known member. For example, if the SDK is on
         *   an older version than the API, then the API may respond with new members that the SDK is unaware
         *   of.
        ...
        enum class Value {
            DISABLED,
            ENABLED,
            /** An enum member indicating that [ExternalAccountCollection] was instantiated with an unknown value. */
            _UNKNOWN,
        }
        ...
        fun known(): Known =
            when (this) {
                ...
                else -> throw ModernTreasuryInvalidDataException("Unknown ExternalAccountCollection: $value")
            }
         ...
         *   expected type.
         */
        fun validate(): ExternalAccountCollection =
            apply {
                if (validated) {
                  return@apply
                }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PaymentFlow && id == other.id && amount == other.amount && clientToken == other.clientToken && counterpartyId == other.counterpartyId && createdAt == other.createdAt && currency == other.currency && direction == other.direction && dueDate == other.dueDate && effectiveDateSelectionEnabled == other.effectiveDateSelectionEnabled && existingExternalAccountsFilter == other.existingExternalAccountsFilter && externalAccountCollection == other.externalAccountCollection && liveMode == other.liveMode && object_ == other.object_ && originatingAccountId == other.originatingAccountId && paymentOrderId == other.paymentOrderId && receivingAccountId == other.receivingAccountId && selectedEffectiveDate == other.selectedEffectiveDate && status == other.status && updatedAt == other.updatedAt && additionalProperties == other.additionalProperties
    }
