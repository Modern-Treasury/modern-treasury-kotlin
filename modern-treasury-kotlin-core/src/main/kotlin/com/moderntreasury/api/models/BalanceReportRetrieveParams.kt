...
class BalanceReportRetrieveParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(balanceReportRetrieveParams: BalanceReportRetrieveParams) =
            apply {
         ...
         *
         * You should usually call [id] with a well-typed [Id] constant instead.
    ...
    class Id @JsonCreator private constructor(
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is BalanceReportRetrieveParams && internalAccountId == other.internalAccountId && id == other.id && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(internalAccountId, id, additionalHeaders, additionalQueryParams)

    override fun toString() = "BalanceReportRetrieveParams{internalAccountId=$internalAccountId, id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
