...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         * - [metadata]
         */
        fun body(body: LedgerAccountBalanceMonitorUpdateRequest) = apply {
    ...
    private constructor(
        ...
        ) : this(description, metadata, mutableMapOf())
        ...
        internal fun validity(): Int =
            (if (description.asKnown() == null) 0 else 1) + (metadata.asKnown()?.validity() ?: 0)
