...
/** Create a new hold */
class HoldCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(holdCreateParams: HoldCreateParams) =
            apply {
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         */
        internal fun validity(): Int = (status.asKnown()?.validity() ?: 0) + (if (targetId.asKnown() == null) 0 else 1) + (targetType.asKnown()?.validity() ?: 0) + (metadata.asKnown()?.validity() ?: 0) + (if (reason.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && status == other.status && targetId == other.targetId && targetType == other.targetType && metadata == other.metadata && reason == other.reason && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(status, targetId, targetType, metadata, reason, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Body{status=$status, targetId=$targetId, targetType=$targetType, metadata=$metadata, reason=$reason, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is HoldCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "HoldCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
