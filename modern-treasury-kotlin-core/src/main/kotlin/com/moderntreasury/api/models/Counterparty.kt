...
class Counterparty @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(counterparty: Counterparty) =
            apply {
                id = counterparty.id
     ...
     */
    internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (accounts.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (if (createdAt.asKnown() == null) 0 else 1) + (if (discardedAt.asKnown() == null) 0 else 1) + (if (email.asKnown() == null) 0 else 1) + (if (externalId.asKnown() == null) 0 else 1) + (if (legalEntityId.asKnown() == null) 0 else 1) + (if (liveMode.asKnown() == null) 0 else 1) + (metadata.asKnown()?.validity() ?: 0) + (if (name.asKnown() == null) 0 else 1) + (if (object_.asKnown() == null) 0 else 1) + (if (sendRemittanceAdvice.asKnown() == null) 0 else 1) + (if (updatedAt.asKnown() == null) 0 else 1) + (if (verificationStatus.asKnown() == null) 0 else 1)
    ...
    class Account @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("updated_at") @ExcludeMissing updatedAt: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("verification_source") @ExcludeMissing verificationSource: JsonField<VerificationSource> = JsonMissing.of(),
            @JsonProperty("verification_status") @ExcludeMissing verificationStatus: JsonField<VerificationStatus> = JsonMissing.of()
        ) : this(
          id,
          accountDetails,
          accountType,
        ...
        /** @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
        fun verificationSource(): VerificationSource? = verificationSource.getNullable("verification_source")

        /** @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
        fun verificationStatus(): VerificationStatus? = verificationStatus.getNullable("verification_status")
        ...
        class Builder internal constructor() {
            ...
            fun verificationSource(verificationSource: VerificationSource?) = verificationSource(JsonField.ofNullable(verificationSource))

            /**
             * Sets [Builder.verificationSource] to an arbitrary JSON value.
             *
             * You should usually call [Builder.verificationSource] with a well-typed [VerificationSource] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun verificationSource(verificationSource: JsonField<VerificationSource>) =
                apply {
             ...
             * Sets [Builder.verificationStatus] to an arbitrary JSON value.
             *
             * You should usually call [Builder.verificationStatus] with a well-typed [VerificationStatus] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
         ...
         * Used for best match union deserialization.
         */
        internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (accountDetails.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (accountType.asKnown()?.validity() ?: 0) + (contactDetails.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (if (createdAt.asKnown() == null) 0 else 1) + (if (discardedAt.asKnown() == null) 0 else 1) + (if (externalId.asKnown() == null) 0 else 1) + (if (ledgerAccountId.asKnown() == null) 0 else 1) + (if (liveMode.asKnown() == null) 0 else 1) + (metadata.asKnown()?.validity() ?: 0) + (if (name.asKnown() == null) 0 else 1) + (if (object_.asKnown() == null) 0 else 1) + (partyAddress.asKnown()?.validity() ?: 0) + (if (partyName.asKnown() == null) 0 else 1) + (partyType.asKnown()?.validity() ?: 0) + (routingDetails.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (if (updatedAt.asKnown() == null) 0 else 1) + (verificationSource.asKnown()?.validity() ?: 0) + (verificationStatus.asKnown()?.validity() ?: 0)
        ...
        class VerificationSource @JsonCreator private constructor(
            private val value: JsonField<String>,
            ...
            enum class Value {
                ...
                MICRODEPOSITS,
                PLAID,
                /** An enum member indicating that [VerificationSource] was instantiated with an unknown value. */
                _UNKNOWN,
            }
            ...
            fun known(): Known =
                when (this) {
                    ...
                    PLAID -> Known.PLAID
                    else -> throw ModernTreasuryInvalidDataException("Unknown VerificationSource: $value")
                }
             ...
             *   expected type.
             */
            fun validate(): VerificationSource =
                apply {
                    if (validated) {
                      return@apply
                    }
        ...
        class VerificationStatus @JsonCreator private constructor(
            ...
            enum class Value {
                ...
                UNVERIFIED,
                VERIFIED,
                /** An enum member indicating that [VerificationStatus] was instantiated with an unknown value. */
                _UNKNOWN,
            }
            ...
            fun known(): Known =
                when (this) {
                    ...
                    else -> throw ModernTreasuryInvalidDataException("Unknown VerificationStatus: $value")
                }
             ...
             *   expected type.
             */
            fun validate(): VerificationStatus =
                apply {
                    if (validated) {
                      return@apply
                    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is Counterparty && id == other.id && accounts == other.accounts && createdAt == other.createdAt && discardedAt == other.discardedAt && email == other.email && externalId == other.externalId && legalEntityId == other.legalEntityId && liveMode == other.liveMode && metadata == other.metadata && name == other.name && object_ == other.object_ && sendRemittanceAdvice == other.sendRemittanceAdvice && updatedAt == other.updatedAt && verificationStatus == other.verificationStatus && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "Counterparty{id=$id, accounts=$accounts, createdAt=$createdAt, discardedAt=$discardedAt, email=$email, externalId=$externalId, legalEntityId=$legalEntityId, liveMode=$liveMode, metadata=$metadata, name=$name, object_=$object_, sendRemittanceAdvice=$sendRemittanceAdvice, updatedAt=$updatedAt, verificationStatus=$verificationStatus, additionalProperties=$additionalProperties}"
}
