...
constructor(
    ...
    internal constructor(
        ...
        override fun toString() =
            "LedgerAccountUpdateBody{name=$name, description=$description, metadata=$metadata, additionalProperties=$additionalProperties}"
    ...
    override fun toString() =
        "LedgerAccountUpdateParams{id=$id, name=$name, description=$description, metadata=$metadata, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
