...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LedgerEventHandlerListPage && this.ledgerEventHandlersService == other.ledgerEventHandlersService && this.params == other.params && this.response == other.response /* spotless:on */
    }
