...
class BalanceReport @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("balances") @ExcludeMissing balances: JsonField<List<Balance>> = JsonMissing.of(),
    ...
    class Builder internal constructor() {
        ...
        internal fun from(balanceReport: BalanceReport) =
            apply {
                id = balanceReport.id
         ...
         *
         * You should usually call [Builder.balances] with a well-typed `List<Balance>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun balances(balances: JsonField<List<Balance>>) =
            apply {
     ...
     */
    internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (if (asOfDate.asKnown() == null) 0 else 1) + (if (asOfTime.asKnown() == null) 0 else 1) + (balanceReportType.asKnown()?.validity() ?: 0) + (balances.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (if (createdAt.asKnown() == null) 0 else 1) + (if (internalAccountId.asKnown() == null) 0 else 1) + (if (liveMode.asKnown() == null) 0 else 1) + (if (object_.asKnown() == null) 0 else 1) + (if (updatedAt.asKnown() == null) 0 else 1)
    ...
    class Balance @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        private val id: JsonField<String>,
        ...
        private constructor(
            ...
            @JsonProperty("object") @ExcludeMissing object_: JsonField<String> = JsonMissing.of(),
            @JsonProperty("updated_at") @ExcludeMissing updatedAt: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("value_date") @ExcludeMissing valueDate: JsonField<LocalDate> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
            ...
            internal fun from(balance: Balance) =
                apply {
                    id = balance.id
             ...
             *
             * You should usually call [Builder.valueDate] with a well-typed [LocalDate] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun valueDate(valueDate: JsonField<LocalDate>) =
                apply {
         ...
         * Used for best match union deserialization.
         */
        internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (if (amount.asKnown() == null) 0 else 1) + (if (amountString.asKnown() == null) 0 else 1) + (if (asOfDate.asKnown() == null) 0 else 1) + (if (asOfTime.asKnown() == null) 0 else 1) + (balanceType.asKnown()?.validity() ?: 0) + (if (createdAt.asKnown() == null) 0 else 1) + (currency.asKnown()?.validity() ?: 0) + (if (liveMode.asKnown() == null) 0 else 1) + (if (object_.asKnown() == null) 0 else 1) + (if (updatedAt.asKnown() == null) 0 else 1) + (if (valueDate.asKnown() == null) 0 else 1) + (if (vendorCode.asKnown() == null) 0 else 1) + (if (vendorCodeType.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Balance && id == other.id && amount == other.amount && amountString == other.amountString && asOfDate == other.asOfDate && asOfTime == other.asOfTime && balanceType == other.balanceType && createdAt == other.createdAt && currency == other.currency && liveMode == other.liveMode && object_ == other.object_ && updatedAt == other.updatedAt && valueDate == other.valueDate && vendorCode == other.vendorCode && vendorCodeType == other.vendorCodeType && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(id, amount, amountString, asOfDate, asOfTime, balanceType, createdAt, currency, liveMode, object_, updatedAt, valueDate, vendorCode, vendorCodeType, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Balance{id=$id, amount=$amount, amountString=$amountString, asOfDate=$asOfDate, asOfTime=$asOfTime, balanceType=$balanceType, createdAt=$createdAt, currency=$currency, liveMode=$liveMode, object_=$object_, updatedAt=$updatedAt, valueDate=$valueDate, vendorCode=$vendorCode, vendorCodeType=$vendorCodeType, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() = "BalanceReport{id=$id, asOfDate=$asOfDate, asOfTime=$asOfTime, balanceReportType=$balanceReportType, balances=$balances, createdAt=$createdAt, internalAccountId=$internalAccountId, liveMode=$liveMode, object_=$object_, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
