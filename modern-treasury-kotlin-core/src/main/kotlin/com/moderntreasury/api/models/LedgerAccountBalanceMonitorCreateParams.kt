...
class LedgerAccountBalanceMonitorCreateParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LedgerAccountBalanceMonitorCreateParams].
         *
    ...
    class Builder internal constructor() {
        ...
        private var body: LedgerAccountBalanceMonitorCreateRequest.Builder = LedgerAccountBalanceMonitorCreateRequest.builder()
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        internal fun from(ledgerAccountBalanceMonitorCreateParams: LedgerAccountBalanceMonitorCreateParams) =
            apply {
                body = ledgerAccountBalanceMonitorCreateParams.body.toBuilder()
                additionalHeaders = ledgerAccountBalanceMonitorCreateParams.additionalHeaders.toBuilder()
                additionalQueryParams = ledgerAccountBalanceMonitorCreateParams.additionalQueryParams.toBuilder()
            }
         ...
         * - [metadata]
         */
        fun body(body: LedgerAccountBalanceMonitorCreateRequest) =
            apply {
         ...
         *
         * You should usually call [Builder.alertCondition] with a well-typed [AlertConditionCreateRequest] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun alertCondition(alertCondition: JsonField<AlertConditionCreateRequest>) =
            apply {
                body.alertCondition(alertCondition)
            }
    ...
    class LedgerAccountBalanceMonitorCreateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("alert_condition") @ExcludeMissing alertCondition: JsonField<AlertConditionCreateRequest> = JsonMissing.of(),
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun alertCondition(): AlertConditionCreateRequest = alertCondition.getRequired("alert_condition")
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [LedgerAccountBalanceMonitorCreateRequest].
             *
             * The following fields are required:
             *
             * ```kotlin
        ...
        class Builder internal constructor() {
            ...
            internal fun from(ledgerAccountBalanceMonitorCreateRequest: LedgerAccountBalanceMonitorCreateRequest) =
                apply {
                    ...
                    additionalProperties = ledgerAccountBalanceMonitorCreateRequest.additionalProperties.toMutableMap()
                }

            /** Describes the condition that must be satisfied for the monitor to be triggered. */
            fun alertCondition(alertCondition: AlertConditionCreateRequest) = alertCondition(JsonField.of(alertCondition))
         ...
         *   expected type.
         */
        fun validate(): LedgerAccountBalanceMonitorCreateRequest =
            apply {
                if (validated) {
                  return@apply
                }
         ...
         */
        internal fun validity(): Int = (alertCondition.asKnown()?.validity() ?: 0) + (if (ledgerAccountId.asKnown() == null) 0 else 1) + (if (description.asKnown() == null) 0 else 1) + (metadata.asKnown()?.validity() ?: 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is LedgerAccountBalanceMonitorCreateRequest && alertCondition == other.alertCondition && ledgerAccountId == other.ledgerAccountId && description == other.description && metadata == other.metadata && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "LedgerAccountBalanceMonitorCreateRequest{alertCondition=$alertCondition, ledgerAccountId=$ledgerAccountId, description=$description, metadata=$metadata, additionalProperties=$additionalProperties}"
    }

    /** Describes the condition that must be satisfied for the monitor to be triggered. */
    class AlertConditionCreateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [AlertConditionCreateRequest].
             *
             * The following fields are required:
             *
             * ```kotlin
        ...
        class Builder internal constructor() {
            ...
            internal fun from(alertConditionCreateRequest: AlertConditionCreateRequest) =
                apply {
                    ...
                    additionalProperties = alertConditionCreateRequest.additionalProperties.toMutableMap()
                }
         ...
         *   expected type.
         */
        fun validate(): AlertConditionCreateRequest =
            apply {
                if (validated) {
                  return@apply
                }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is AlertConditionCreateRequest && field == other.field && operator == other.operator && value == other.value && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "AlertConditionCreateRequest{field=$field, operator=$operator, value=$value, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LedgerAccountBalanceMonitorCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "LedgerAccountBalanceMonitorCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
