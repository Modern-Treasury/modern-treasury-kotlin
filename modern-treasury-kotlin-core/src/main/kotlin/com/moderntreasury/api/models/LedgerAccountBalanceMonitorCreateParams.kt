...
private constructor(
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is LedgerAccountBalanceMonitorCreateRequest &&
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is AlertConditionCreateRequest &&
                field == other.field &&
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LedgerAccountBalanceMonitorCreateParams &&
            body == other.body &&
