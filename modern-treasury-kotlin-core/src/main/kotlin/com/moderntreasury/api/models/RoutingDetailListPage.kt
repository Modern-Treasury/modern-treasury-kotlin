...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is RoutingDetailListPage && routingDetailsService == other.routingDetailsService && params == other.params && response == other.response /* spotless:on */
    }
