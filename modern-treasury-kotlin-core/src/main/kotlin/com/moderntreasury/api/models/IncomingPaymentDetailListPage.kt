...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is IncomingPaymentDetailListPage && incomingPaymentDetailsService == other.incomingPaymentDetailsService && params == other.params && response == other.response /* spotless:on */
    }
    ...
    fun getNextPageParams(): IncomingPaymentDetailListParams? {
        ...
        return IncomingPaymentDetailListParams.builder()
            .from(params)
    ...
    constructor(
        @JsonProperty("items")
        private val items: JsonField<List<IncomingPaymentDetail>> = JsonMissing.of(),
        ...
        @JsonProperty("items") fun _items(): JsonField<List<IncomingPaymentDetail>>? = items
