...
/** list bulk_results */
class BulkResultListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(bulkResultListParams: BulkResultListParams) =
            apply {
    ...
    /** The type of the request that created this result. bulk_request is the only supported `request_type` */
    class EntityType @JsonCreator private constructor(
    ...
    /** The type of the request that created this result. bulk_request is the only supported `request_type` */
    class RequestType @JsonCreator private constructor(
        private val value: JsonField<String>,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is BulkResultListParams && afterCursor == other.afterCursor && entityId == other.entityId && entityType == other.entityType && perPage == other.perPage && requestId == other.requestId && requestType == other.requestType && status == other.status && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(afterCursor, entityId, entityType, perPage, requestId, requestType, status, additionalHeaders, additionalQueryParams)

    override fun toString() = "BulkResultListParams{afterCursor=$afterCursor, entityId=$entityId, entityType=$entityType, perPage=$perPage, requestId=$requestId, requestType=$requestType, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
