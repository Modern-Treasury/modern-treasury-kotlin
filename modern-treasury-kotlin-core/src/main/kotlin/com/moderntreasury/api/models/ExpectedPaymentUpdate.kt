...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ExpectedPaymentUpdate]. */
        fun builder() = Builder()
    }

    /** A builder for [ExpectedPaymentUpdate]. */
    class Builder internal constructor() {
        ...
        internal fun from(expectedPaymentUpdate: ExpectedPaymentUpdate) = apply {
            amountLowerBound = expectedPaymentUpdate.amountLowerBound
            amountReconciled = expectedPaymentUpdate.amountReconciled
            amountReconciledDirection = expectedPaymentUpdate.amountReconciledDirection
            amountUnreconciled = expectedPaymentUpdate.amountUnreconciled
            amountUnreconciledDirection = expectedPaymentUpdate.amountUnreconciledDirection
            amountUpperBound = expectedPaymentUpdate.amountUpperBound
            counterpartyId = expectedPaymentUpdate.counterpartyId
            currency = expectedPaymentUpdate.currency
            dateLowerBound = expectedPaymentUpdate.dateLowerBound
            dateUpperBound = expectedPaymentUpdate.dateUpperBound
            description = expectedPaymentUpdate.description
            direction = expectedPaymentUpdate.direction
            externalId = expectedPaymentUpdate.externalId
            internalAccountId = expectedPaymentUpdate.internalAccountId
            metadata = expectedPaymentUpdate.metadata
            reconciliationFilters = expectedPaymentUpdate.reconciliationFilters
            reconciliationGroups = expectedPaymentUpdate.reconciliationGroups
            reconciliationRuleVariables =
                expectedPaymentUpdate.reconciliationRuleVariables.map { it.toMutableList() }
            remittanceInformation = expectedPaymentUpdate.remittanceInformation
            statementDescriptor = expectedPaymentUpdate.statementDescriptor
            status = expectedPaymentUpdate.status
            type = expectedPaymentUpdate.type
            additionalProperties = expectedPaymentUpdate.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ExpectedPaymentUpdate].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ExpectedPaymentUpdate =
    ...
    fun validate(): ExpectedPaymentUpdate = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExpectedPaymentUpdate &&
