...
class ForeignExchangeQuoteListPageAsync private constructor(
    ...
    override suspend fun nextPage(): ForeignExchangeQuoteListPageAsync = service.list(nextPageParams())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ForeignExchangeQuoteListPageAsync].
         *
    ...
    class Builder internal constructor() {
        ...
        fun service(service: ForeignExchangeQuoteServiceAsync) =
            apply {
                this.service = service
            }

        /** The parameters that were used to request this page. */
        fun params(params: ForeignExchangeQuoteListParams) =
            apply {
                this.params = params
            }
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<ForeignExchangeQuote>) =
            apply {
                this.items = items
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ForeignExchangeQuoteListPageAsync && service == other.service && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, params, headers, items)

    override fun toString() = "ForeignExchangeQuoteListPageAsync{service=$service, params=$params, headers=$headers, items=$items}"
}
