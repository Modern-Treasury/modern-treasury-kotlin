...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ForeignExchangeQuoteListPageAsync && this.foreignExchangeQuotesService == other.foreignExchangeQuotesService && this.params == other.params && this.response == other.response /* spotless:on */
    }
