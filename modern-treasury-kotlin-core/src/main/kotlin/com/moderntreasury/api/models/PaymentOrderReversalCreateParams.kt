...
class PaymentOrderReversalCreateParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PaymentOrderReversalCreateParams].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(paymentOrderReversalCreateParams: PaymentOrderReversalCreateParams) =
            apply {
                ...
                additionalQueryParams = paymentOrderReversalCreateParams.additionalQueryParams.toBuilder()
            }
         ...
         * - [metadata]
         */
        fun body(body: ReversalCreateRequest) =
            apply {
    ...
    class ReversalCreateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(reversalCreateRequest: ReversalCreateRequest) =
                apply {
         ...
         *   expected type.
         */
        fun validate(): ReversalCreateRequest =
            apply {
                if (validated) {
                  return@apply
                }
         ...
         */
        internal fun validity(): Int = (reason.asKnown()?.validity() ?: 0) + (ledgerTransaction.asKnown()?.validity() ?: 0) + (metadata.asKnown()?.validity() ?: 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is ReversalCreateRequest && reason == other.reason && ledgerTransaction == other.ledgerTransaction && metadata == other.metadata && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "ReversalCreateRequest{reason=$reason, ledgerTransaction=$ledgerTransaction, metadata=$metadata, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PaymentOrderReversalCreateParams && paymentOrderId == other.paymentOrderId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(paymentOrderId, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "PaymentOrderReversalCreateParams{paymentOrderId=$paymentOrderId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
