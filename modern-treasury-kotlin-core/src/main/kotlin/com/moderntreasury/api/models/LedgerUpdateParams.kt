...
class LedgerUpdateParams private constructor(
    ...
    companion object {
        ...
        fun none(): LedgerUpdateParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(ledgerUpdateParams: LedgerUpdateParams) =
            apply {
                id = ledgerUpdateParams.id
                body = ledgerUpdateParams.body.toBuilder()
         ...
         * - [name]
         */
        fun body(body: LedgerUpdateRequest) =
            apply {
        ...
        /**
         * Returns an immutable instance of [LedgerUpdateParams].
         *
    ...
    fun _body(): LedgerUpdateRequest = body
    ...
    class LedgerUpdateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(ledgerUpdateRequest: LedgerUpdateRequest) =
                apply {
            ...
            /**
             * Returns an immutable instance of [LedgerUpdateRequest].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             */
         ...
         *   expected type.
         */
        fun validate(): LedgerUpdateRequest =
            apply {
                if (validated) {
                  return@apply
                }
         ...
         */
        internal fun validity(): Int = (if (description.asKnown() == null) 0 else 1) + (metadata.asKnown()?.validity() ?: 0) + (if (name.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is LedgerUpdateRequest && description == other.description && metadata == other.metadata && name == other.name && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "LedgerUpdateRequest{description=$description, metadata=$metadata, name=$name, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LedgerUpdateParams && id == other.id && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(id, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "LedgerUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
