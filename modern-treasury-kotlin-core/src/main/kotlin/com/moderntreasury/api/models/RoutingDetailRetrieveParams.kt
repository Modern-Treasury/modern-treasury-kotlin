...
class RoutingDetailRetrieveParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(routingDetailRetrieveParams: RoutingDetailRetrieveParams) =
            apply {
        ...
        /**
         * Returns an immutable instance of [RoutingDetailRetrieveParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is RoutingDetailRetrieveParams && accountsType == other.accountsType && accountId == other.accountId && id == other.id && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(accountsType, accountId, id, additionalHeaders, additionalQueryParams)

    override fun toString() = "RoutingDetailRetrieveParams{accountsType=$accountsType, accountId=$accountId, id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
