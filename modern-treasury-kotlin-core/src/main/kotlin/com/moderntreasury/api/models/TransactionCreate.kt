...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TransactionCreate].
         *
    ...
    /** A builder for [TransactionCreate]. */
    class Builder internal constructor() {
        ...
        internal fun from(transactionCreate: TransactionCreate) = apply {
            amount = transactionCreate.amount
            asOfDate = transactionCreate.asOfDate
            direction = transactionCreate.direction
            internalAccountId = transactionCreate.internalAccountId
            vendorCode = transactionCreate.vendorCode
            vendorCodeType = transactionCreate.vendorCodeType
            metadata = transactionCreate.metadata
            posted = transactionCreate.posted
            type = transactionCreate.type
            vendorCustomerId = transactionCreate.vendorCustomerId
            vendorDescription = transactionCreate.vendorDescription
            additionalProperties = transactionCreate.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TransactionCreate].
         *
    ...
    fun validate(): TransactionCreate = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TransactionCreate &&
            amount == other.amount &&
