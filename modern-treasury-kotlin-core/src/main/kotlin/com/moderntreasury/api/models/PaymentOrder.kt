...
private constructor(
    ...
    private constructor(
        ...
        @ExcludeMissing
        currentHold: JsonField<Hold> = JsonMissing.of(),
     ...
     */
    @JsonProperty("current_hold") @ExcludeMissing fun _currentHold(): JsonField<Hold> = currentHold
     ...
     *
     * Unlike [originatingSecondaryPartyName], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("originating_secondary_party_name")
    @ExcludeMissing
    ...
    class Builder internal constructor() {
        ...
        private var originatingSecondaryPartyName: JsonField<String>? = null
        ...
        internal fun from(paymentOrder: PaymentOrder) = apply {
            ...
            originatingSecondaryPartyName = paymentOrder.originatingSecondaryPartyName
         ...
         *
         * You should usually call [Builder.currentHold] with a well-typed [Hold] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun currentHold(currentHold: JsonField<Hold>) = apply { this.currentHold = currentHold }
        ...
        fun originatingSecondaryPartyName(originatingSecondaryPartyName: String?) =
            originatingSecondaryPartyName(JsonField.ofNullable(originatingSecondaryPartyName))
         ...
         */
        fun originatingSecondaryPartyName(originatingSecondaryPartyName: JsonField<String>) =
            apply {
                this.originatingSecondaryPartyName = originatingSecondaryPartyName
            }
        ...
        fun build(): PaymentOrder =
            PaymentOrder(
                ...
                checkRequired("currentHold", currentHold),
                ...
                checkRequired("originatingSecondaryPartyName", originatingSecondaryPartyName),
    ...
    internal fun validity(): Int =
        (if (id.asKnown() == null) 0 else 1) +
            ...
            (originatingAccountType.asKnown()?.validity() ?: 0) +
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            /** When the hold was resolved */
            fun resolvedAt(resolvedAt: OffsetDateTime?) =
                resolvedAt(JsonField.ofNullable(resolvedAt))
        ...
        /** The type of target being held */
        class TargetType @JsonCreator private constructor(private val value: JsonField<String>) :
            Enum {
            ...
            enum class Value {
                PAYMENT_ORDER,
                /**
                 * An enum member indicating that [TargetType] was instantiated with an unknown
                 * value.
                 */
                _UNKNOWN,
            }
    ...
    private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            fun of(value: String) = OriginatingAccountType(JsonField.of(value))
        }
    ...
    private constructor(
        ...
        private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                val WISE_TRANSFER_ID = of("wise_transfer_id")
