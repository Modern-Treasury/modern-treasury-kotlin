...
class LedgerAccountListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(ledgerAccountListParams: LedgerAccountListParams) =
            apply {
        ...
        /** If you have specific names to retrieve in bulk, you can pass them as query parameters delimited with `name[]=`, for example `?name[]=123&name[]=abc`. */
        fun name(name: List<String>?) =
            apply {
                this.name = name?.toMutableList()
            }
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                ...
                availableBalanceAmount?.let { it.eq()?.let { put("available_balance_amount[eq]", it.toString()) }
                ...
                balances?.let { it.asOfDate()?.let { put("balances[as_of_date]", it.toString()) }
                it.effectiveAt()?.let { put("balances[effective_at]", DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(it)) }
                it.effectiveAtLowerBound()?.let { put("balances[effective_at_lower_bound]", DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(it)) }
                it.effectiveAtUpperBound()?.let { put("balances[effective_at_upper_bound]", DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(it)) }
                it._additionalProperties().keys().forEach { key ->
                    it._additionalProperties().values(key).forEach { value ->
                        put("balances[$key]", value)
                    }
                } }
                createdAt?.let { it._additionalProperties().keys().forEach { key ->
                    it._additionalProperties().values(key).forEach { value ->
                ...
                pendingBalanceAmount?.let { it.eq()?.let { put("pending_balance_amount[eq]", it.toString()) }
                ...
                postedBalanceAmount?.let { it.eq()?.let { put("posted_balance_amount[eq]", it.toString()) }
    ...
    /** Use `gt` (>), `gte` (>=), `lt` (<), `lte` (<=), `eq` (=), or `not_eq` (!=) to filter by balance amount. */
    class AvailableBalanceAmount private constructor(
        private val eq: Long?,
        private val gt: Long?,
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is AvailableBalanceAmount && eq == other.eq && gt == other.gt && gte == other.gte && lt == other.lt && lte == other.lte && notEq == other.notEq && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "AvailableBalanceAmount{eq=$eq, gt=$gt, gte=$gte, lt=$lt, lte=$lte, notEq=$notEq, additionalProperties=$additionalProperties}"
    }

    /** Use `balances[effective_at_lower_bound]` and `balances[effective_at_upper_bound]` to get the balances change between the two timestamps. The lower bound is inclusive while the upper bound is exclusive of the provided timestamps. If no value is supplied the balances will be retrieved not including that bound. */
    class Balances private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(balances: Balances) =
                apply {
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Balances && asOfDate == other.asOfDate && effectiveAt == other.effectiveAt && effectiveAtLowerBound == other.effectiveAtLowerBound && effectiveAtUpperBound == other.effectiveAtUpperBound && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Balances{asOfDate=$asOfDate, effectiveAt=$effectiveAt, effectiveAtLowerBound=$effectiveAtLowerBound, effectiveAtUpperBound=$effectiveAtUpperBound, additionalProperties=$additionalProperties}"
    }
    ...
    /** Use `gt` (>), `gte` (>=), `lt` (<), `lte` (<=), `eq` (=), or `not_eq` (!=) to filter by balance amount. */
    class PendingBalanceAmount private constructor(
        private val eq: Long?,
        private val gt: Long?,
        private val gte: Long?,
        private val lt: Long?,
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is PendingBalanceAmount && eq == other.eq && gt == other.gt && gte == other.gte && lt == other.lt && lte == other.lte && notEq == other.notEq && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "PendingBalanceAmount{eq=$eq, gt=$gt, gte=$gte, lt=$lt, lte=$lte, notEq=$notEq, additionalProperties=$additionalProperties}"
    }

    /** Use `gt` (>), `gte` (>=), `lt` (<), `lte` (<=), `eq` (=), or `not_eq` (!=) to filter by balance amount. */
    class PostedBalanceAmount private constructor(
        private val eq: Long?,
        private val gt: Long?,
        private val gte: Long?,
        private val lt: Long?,
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is PostedBalanceAmount && eq == other.eq && gt == other.gt && gte == other.gte && lt == other.lt && lte == other.lte && notEq == other.notEq && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "PostedBalanceAmount{eq=$eq, gt=$gt, gte=$gte, lt=$lt, lte=$lte, notEq=$notEq, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LedgerAccountListParams && id == other.id && afterCursor == other.afterCursor && availableBalanceAmount == other.availableBalanceAmount && balances == other.balances && createdAt == other.createdAt && currency == other.currency && externalId == other.externalId && ledgerAccountCategoryId == other.ledgerAccountCategoryId && ledgerId == other.ledgerId && metadata == other.metadata && name == other.name && normalBalance == other.normalBalance && pendingBalanceAmount == other.pendingBalanceAmount && perPage == other.perPage && postedBalanceAmount == other.postedBalanceAmount && updatedAt == other.updatedAt && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(id, afterCursor, availableBalanceAmount, balances, createdAt, currency, externalId, ledgerAccountCategoryId, ledgerId, metadata, name, normalBalance, pendingBalanceAmount, perPage, postedBalanceAmount, updatedAt, additionalHeaders, additionalQueryParams)

    override fun toString() = "LedgerAccountListParams{id=$id, afterCursor=$afterCursor, availableBalanceAmount=$availableBalanceAmount, balances=$balances, createdAt=$createdAt, currency=$currency, externalId=$externalId, ledgerAccountCategoryId=$ledgerAccountCategoryId, ledgerId=$ledgerId, metadata=$metadata, name=$name, normalBalance=$normalBalance, pendingBalanceAmount=$pendingBalanceAmount, perPage=$perPage, postedBalanceAmount=$postedBalanceAmount, updatedAt=$updatedAt, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
