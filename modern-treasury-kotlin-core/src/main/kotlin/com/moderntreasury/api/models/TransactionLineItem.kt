...
class TransactionLineItem @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("reconcilable") @ExcludeMissing reconcilable: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("reconciliation_group_id") @ExcludeMissing reconciliationGroupId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("transactable_id") @ExcludeMissing transactableId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("transactable_type") @ExcludeMissing transactableType: JsonField<TransactableType> = JsonMissing.of(),
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun reconciliationGroupId(): String? = reconciliationGroupId.getNullable("reconciliation_group_id")
     ...
     *
     * Unlike [reconciliationGroupId], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [transactableType], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(transactionLineItem: TransactionLineItem) =
            apply {
        ...
        /** The ID of the reconciled Expected Payment, otherwise `null`. */
        fun expectedPaymentId(expectedPaymentId: String?) = expectedPaymentId(JsonField.ofNullable(expectedPaymentId))
         ...
         *
         * You should usually call [Builder.reconcilable] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun reconcilable(reconcilable: JsonField<Boolean>) =
            apply {
                this.reconcilable = reconcilable
            }

        /** The ID of the reconciliation group this line item belongs to, otherwise `null`. */
        fun reconciliationGroupId(reconciliationGroupId: String?) = reconciliationGroupId(JsonField.ofNullable(reconciliationGroupId))

        /**
         * Sets [Builder.reconciliationGroupId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.reconciliationGroupId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun reconciliationGroupId(reconciliationGroupId: JsonField<String>) =
            apply {
                this.reconciliationGroupId = reconciliationGroupId
            }

        /** If a matching object exists in Modern Treasury, the ID will be populated here, otherwise `null`. */
        fun transactableId(transactableId: String?) = transactableId(JsonField.ofNullable(transactableId))

        /**
         * Sets [Builder.transactableId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.transactableId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun transactableId(transactableId: JsonField<String>) =
            apply {
                this.transactableId = transactableId
            }

        /** If a matching object exists in Modern Treasury, the type will be populated here, otherwise `null`. */
        fun transactableType(transactableType: TransactableType?) = transactableType(JsonField.ofNullable(transactableType))

        /**
         * Sets [Builder.transactableType] to an arbitrary JSON value.
         *
         * You should usually call [Builder.transactableType] with a well-typed [TransactableType] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun transactableType(transactableType: JsonField<TransactableType>) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): TransactionLineItem =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (if (amount.asKnown() == null) 0 else 1) + (if (counterpartyId.asKnown() == null) 0 else 1) + (if (createdAt.asKnown() == null) 0 else 1) + (if (description.asKnown() == null) 0 else 1) + (if (discardedAt.asKnown() == null) 0 else 1) + (if (expectedPaymentId.asKnown() == null) 0 else 1) + (if (liveMode.asKnown() == null) 0 else 1) + (if (object_.asKnown() == null) 0 else 1) + (if (reconcilable.asKnown() == null) 0 else 1) + (if (reconciliationGroupId.asKnown() == null) 0 else 1) + (if (transactableId.asKnown() == null) 0 else 1) + (transactableType.asKnown()?.validity() ?: 0) + (if (transactionId.asKnown() == null) 0 else 1) + (type.asKnown()?.validity() ?: 0) + (if (updatedAt.asKnown() == null) 0 else 1)

    /** If a matching object exists in Modern Treasury, the type will be populated here, otherwise `null`. */
    class TransactableType @JsonCreator private constructor(
        ...
        enum class Value {
            ...
            RETURN,
            REVERSAL,
            /** An enum member indicating that [TransactableType] was instantiated with an unknown value. */
            _UNKNOWN,
        }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is TransactionLineItem && id == other.id && amount == other.amount && counterpartyId == other.counterpartyId && createdAt == other.createdAt && description == other.description && discardedAt == other.discardedAt && expectedPaymentId == other.expectedPaymentId && liveMode == other.liveMode && object_ == other.object_ && reconcilable == other.reconcilable && reconciliationGroupId == other.reconciliationGroupId && transactableId == other.transactableId && transactableType == other.transactableType && transactionId == other.transactionId && type == other.type && updatedAt == other.updatedAt && additionalProperties == other.additionalProperties
    }
