...
class PaymentFlowListPageAsync private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(paymentFlowListPageAsync: PaymentFlowListPageAsync) =
            apply {
        ...
        fun service(service: PaymentFlowServiceAsync) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PaymentFlowListPageAsync && service == other.service && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, params, headers, items)

    override fun toString() = "PaymentFlowListPageAsync{service=$service, params=$params, headers=$headers, items=$items}"
}
