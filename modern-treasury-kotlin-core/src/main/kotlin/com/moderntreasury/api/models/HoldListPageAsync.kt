...
class HoldListPageAsync private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(holdListPageAsync: HoldListPageAsync) =
            apply {
        ...
        fun service(service: HoldServiceAsync) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is HoldListPageAsync && service == other.service && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, params, headers, items)

    override fun toString() = "HoldListPageAsync{service=$service, params=$params, headers=$headers, items=$items}"
}
