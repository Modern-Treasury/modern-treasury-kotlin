...
class Connection @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("vendor_name") @ExcludeMissing vendorName: JsonField<String> = JsonMissing.of()
    ) : this(
      id,
      createdAt,
      discardedAt,
    ...
    @ExcludeMissing
    fun _vendorName(): JsonField<String> = vendorName
    ...
    class Builder internal constructor() {
         ...
         *
         * You should usually call [Builder.vendorName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun vendorName(vendorName: JsonField<String>) =
            apply {
     ...
     */
    internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (if (createdAt.asKnown() == null) 0 else 1) + (if (discardedAt.asKnown() == null) 0 else 1) + (if (liveMode.asKnown() == null) 0 else 1) + (if (object_.asKnown() == null) 0 else 1) + (if (updatedAt.asKnown() == null) 0 else 1) + (if (vendorCustomerId.asKnown() == null) 0 else 1) + (if (vendorId.asKnown() == null) 0 else 1) + (if (vendorName.asKnown() == null) 0 else 1)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is Connection && id == other.id && createdAt == other.createdAt && discardedAt == other.discardedAt && liveMode == other.liveMode && object_ == other.object_ && updatedAt == other.updatedAt && vendorCustomerId == other.vendorCustomerId && vendorId == other.vendorId && vendorName == other.vendorName && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "Connection{id=$id, createdAt=$createdAt, discardedAt=$discardedAt, liveMode=$liveMode, object_=$object_, updatedAt=$updatedAt, vendorCustomerId=$vendorCustomerId, vendorId=$vendorId, vendorName=$vendorName, additionalProperties=$additionalProperties}"
}
