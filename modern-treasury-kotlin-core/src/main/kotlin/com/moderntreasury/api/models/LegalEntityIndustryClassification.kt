...
class LegalEntityIndustryClassification @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("classification_codes") @ExcludeMissing classificationCodes: JsonField<List<String>> = JsonMissing.of(),
        @JsonProperty("classification_type") @ExcludeMissing classificationType: JsonField<ClassificationType> = JsonMissing.of(),
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun classificationCodes(): List<String> = classificationCodes.getRequired("classification_codes")
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun classificationType(): ClassificationType = classificationType.getRequired("classification_type")
     ...
     *
     * Unlike [classificationCodes], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [classificationType], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LegalEntityIndustryClassification].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(legalEntityIndustryClassification: LegalEntityIndustryClassification) =
            apply {
                ...
                classificationCodes = legalEntityIndustryClassification.classificationCodes.map { it.toMutableList() }
                ...
                additionalProperties = legalEntityIndustryClassification.additionalProperties.toMutableMap()
            }
        ...
        /** The industry classification codes for the legal entity. */
        fun classificationCodes(classificationCodes: List<String>) = classificationCodes(JsonField.of(classificationCodes))

        /**
         * Sets [Builder.classificationCodes] to an arbitrary JSON value.
         *
         * You should usually call [Builder.classificationCodes] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun classificationCodes(classificationCodes: JsonField<List<String>>) =
            apply {
         ...
         */
        fun addClassificationCode(classificationCode: String) =
            apply {
                classificationCodes = (classificationCodes ?: JsonField.of(mutableListOf())).also {
                    checkKnown("classificationCodes", it).add(classificationCode)
                }
            }

        /** The classification system of the classification codes. */
        fun classificationType(classificationType: ClassificationType) = classificationType(JsonField.of(classificationType))

        /**
         * Sets [Builder.classificationType] to an arbitrary JSON value.
         *
         * You should usually call [Builder.classificationType] with a well-typed [ClassificationType] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun classificationType(classificationType: JsonField<ClassificationType>) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): LegalEntityIndustryClassification =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (classificationCodes.asKnown()?.size ?: 0) + (classificationType.asKnown()?.validity() ?: 0) + (if (createdAt.asKnown() == null) 0 else 1) + (if (discardedAt.asKnown() == null) 0 else 1) + (if (liveMode.asKnown() == null) 0 else 1) + (if (object_.asKnown() == null) 0 else 1) + (if (updatedAt.asKnown() == null) 0 else 1)

    /** The classification system of the classification codes. */
    class ClassificationType @JsonCreator private constructor(
        ...
        enum class Value {
            ...
            UKSIC,
            UNSPSC,
            /** An enum member indicating that [ClassificationType] was instantiated with an unknown value. */
            _UNKNOWN,
        }
        ...
        fun known(): Known =
            when (this) {
                ...
                UKSIC -> Known.UKSIC
                UNSPSC -> Known.UNSPSC
                else -> throw ModernTreasuryInvalidDataException("Unknown ClassificationType: $value")
            }
         ...
         *   expected type.
         */
        fun validate(): ClassificationType =
            apply {
                if (validated) {
                  return@apply
                }
    ...
    override fun toString() = "LegalEntityIndustryClassification{id=$id, classificationCodes=$classificationCodes, classificationType=$classificationType, createdAt=$createdAt, discardedAt=$discardedAt, liveMode=$liveMode, object_=$object_, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
