...
class JournalEntryListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(journalEntryListParams: JournalEntryListParams) =
            apply {
        ...
        /** The ID of the journal report */
        fun journalReportId(journalReportId: String) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is JournalEntryListParams && journalReportId == other.journalReportId && page == other.page && perPage == other.perPage && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(journalReportId, page, perPage, additionalHeaders, additionalQueryParams)

    override fun toString() = "JournalEntryListParams{journalReportId=$journalReportId, page=$page, perPage=$perPage, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
