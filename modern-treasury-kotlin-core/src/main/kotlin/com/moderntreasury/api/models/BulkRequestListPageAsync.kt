...
class BulkRequestListPageAsync private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(bulkRequestListPageAsync: BulkRequestListPageAsync) =
            apply {
        ...
        fun service(service: BulkRequestServiceAsync) =
            apply {
                this.service = service
            }

        /** The parameters that were used to request this page. */
        fun params(params: BulkRequestListParams) =
            apply {
                this.params = params
            }
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<BulkRequest>) =
            apply {
                this.items = items
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is BulkRequestListPageAsync && service == other.service && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, params, headers, items)

    override fun toString() = "BulkRequestListPageAsync{service=$service, params=$params, headers=$headers, items=$items}"
}
