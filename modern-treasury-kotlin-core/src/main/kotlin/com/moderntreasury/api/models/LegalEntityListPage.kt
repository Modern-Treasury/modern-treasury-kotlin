...
class LegalEntityListPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(legalEntityListPage: LegalEntityListPage) =
            apply {
        ...
        fun service(service: LegalEntityService) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LegalEntityListPage && service == other.service && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, params, headers, items)

    override fun toString() = "LegalEntityListPage{service=$service, params=$params, headers=$headers, items=$items}"
}
