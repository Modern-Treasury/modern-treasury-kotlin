...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DocumentRetrieveParams && this.id == other.id && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders /* spotless:on */
    }
    ...
    override fun toString() =
        "DocumentRetrieveParams{id=$id, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(documentRetrieveParams: DocumentRetrieveParams) = apply {
            this.id = documentRetrieveParams.id
