...
/** update payment_flow */
class PaymentFlowUpdateParams private constructor(
    ...
    /** A builder for [PaymentFlowUpdateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(paymentFlowUpdateParams: PaymentFlowUpdateParams) =
            apply {
                id = paymentFlowUpdateParams.id
                body = paymentFlowUpdateParams.body.toBuilder()
                additionalHeaders = paymentFlowUpdateParams.additionalHeaders.toBuilder()
         ...
         * - [status]
         */
        fun body(body: PaymentFlowUpdateRequest) =
            apply {
        ...
        /**
         * Returns an immutable instance of [PaymentFlowUpdateParams].
         *
    ...
    class PaymentFlowUpdateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(paymentFlowUpdateRequest: PaymentFlowUpdateRequest) =
                apply {
            ...
            /**
             * Returns an immutable instance of [PaymentFlowUpdateRequest].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             *
             * The following fields are required:
         ...
         *   expected type.
         */
        fun validate(): PaymentFlowUpdateRequest =
            apply {
                if (validated) {
                  return@apply
                }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is PaymentFlowUpdateRequest && status == other.status && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "PaymentFlowUpdateRequest{status=$status, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PaymentFlowUpdateParams && id == other.id && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(id, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "PaymentFlowUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
