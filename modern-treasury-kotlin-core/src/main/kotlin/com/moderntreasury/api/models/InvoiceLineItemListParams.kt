...
class InvoiceLineItemListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(invoiceLineItemListParams: InvoiceLineItemListParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is InvoiceLineItemListParams && invoiceId == other.invoiceId && afterCursor == other.afterCursor && perPage == other.perPage && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(invoiceId, afterCursor, perPage, additionalHeaders, additionalQueryParams)

    override fun toString() = "InvoiceLineItemListParams{invoiceId=$invoiceId, afterCursor=$afterCursor, perPage=$perPage, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
