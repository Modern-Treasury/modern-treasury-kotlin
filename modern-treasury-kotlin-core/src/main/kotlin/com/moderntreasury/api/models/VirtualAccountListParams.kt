...
class VirtualAccountListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(virtualAccountListParams: VirtualAccountListParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is VirtualAccountListParams && afterCursor == other.afterCursor && counterpartyId == other.counterpartyId && internalAccountId == other.internalAccountId && metadata == other.metadata && perPage == other.perPage && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(afterCursor, counterpartyId, internalAccountId, metadata, perPage, additionalHeaders, additionalQueryParams)

    override fun toString() = "VirtualAccountListParams{afterCursor=$afterCursor, counterpartyId=$counterpartyId, internalAccountId=$internalAccountId, metadata=$metadata, perPage=$perPage, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
