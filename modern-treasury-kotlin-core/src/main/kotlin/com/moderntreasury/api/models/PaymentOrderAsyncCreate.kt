...
private constructor(
     ...
     */
    @Deprecated("deprecated") fun accounting(): Accounting? = accounting.getNullable("accounting")
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PaymentOrderAsyncCreate].
         *
    ...
    /** A builder for [PaymentOrderAsyncCreate]. */
    class Builder internal constructor() {
        ...
        internal fun from(paymentOrderAsyncCreate: PaymentOrderAsyncCreate) = apply {
            amount = paymentOrderAsyncCreate.amount
            direction = paymentOrderAsyncCreate.direction
            originatingAccountId = paymentOrderAsyncCreate.originatingAccountId
            type = paymentOrderAsyncCreate.type
            accounting = paymentOrderAsyncCreate.accounting
            accountingCategoryId = paymentOrderAsyncCreate.accountingCategoryId
            accountingLedgerClassId = paymentOrderAsyncCreate.accountingLedgerClassId
            chargeBearer = paymentOrderAsyncCreate.chargeBearer
            currency = paymentOrderAsyncCreate.currency
            description = paymentOrderAsyncCreate.description
            effectiveDate = paymentOrderAsyncCreate.effectiveDate
            expiresAt = paymentOrderAsyncCreate.expiresAt
            fallbackType = paymentOrderAsyncCreate.fallbackType
            foreignExchangeContract = paymentOrderAsyncCreate.foreignExchangeContract
            foreignExchangeIndicator = paymentOrderAsyncCreate.foreignExchangeIndicator
            ledgerTransaction = paymentOrderAsyncCreate.ledgerTransaction
            ledgerTransactionId = paymentOrderAsyncCreate.ledgerTransactionId
            lineItems = paymentOrderAsyncCreate.lineItems.map { it.toMutableList() }
            metadata = paymentOrderAsyncCreate.metadata
            nsfProtected = paymentOrderAsyncCreate.nsfProtected
            originatingPartyName = paymentOrderAsyncCreate.originatingPartyName
            priority = paymentOrderAsyncCreate.priority
            processAfter = paymentOrderAsyncCreate.processAfter
            purpose = paymentOrderAsyncCreate.purpose
            receivingAccount = paymentOrderAsyncCreate.receivingAccount
            receivingAccountId = paymentOrderAsyncCreate.receivingAccountId
            reconciliationStatus = paymentOrderAsyncCreate.reconciliationStatus
            remittanceInformation = paymentOrderAsyncCreate.remittanceInformation
            sendRemittanceAdvice = paymentOrderAsyncCreate.sendRemittanceAdvice
            statementDescriptor = paymentOrderAsyncCreate.statementDescriptor
            subtype = paymentOrderAsyncCreate.subtype
            transactionMonitoringEnabled = paymentOrderAsyncCreate.transactionMonitoringEnabled
            ultimateOriginatingPartyIdentifier =
                paymentOrderAsyncCreate.ultimateOriginatingPartyIdentifier
            ultimateOriginatingPartyName = paymentOrderAsyncCreate.ultimateOriginatingPartyName
            ultimateReceivingPartyIdentifier =
                paymentOrderAsyncCreate.ultimateReceivingPartyIdentifier
            ultimateReceivingPartyName = paymentOrderAsyncCreate.ultimateReceivingPartyName
            additionalProperties = paymentOrderAsyncCreate.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PaymentOrderAsyncCreate].
         *
         ...
         */
        fun build(): PaymentOrderAsyncCreate =
    ...
    fun validate(): PaymentOrderAsyncCreate = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PaymentOrderAsyncCreate &&
            amount == other.amount &&
