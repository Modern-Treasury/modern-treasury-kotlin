...
/** create payment_flow */
class PaymentFlowCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(paymentFlowCreateParams: PaymentFlowCreateParams) =
            apply {
         ...
         * - etc.
         */
        fun body(body: PaymentFlowCreateRequest) =
            apply {
    ...
    class PaymentFlowCreateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(paymentFlowCreateRequest: PaymentFlowCreateRequest) =
                apply {
         ...
         *   expected type.
         */
        fun validate(): PaymentFlowCreateRequest =
            apply {
                if (validated) {
                  return@apply
                }
         ...
         */
        internal fun validity(): Int = (if (amount.asKnown() == null) 0 else 1) + (if (counterpartyId.asKnown() == null) 0 else 1) + (if (currency.asKnown() == null) 0 else 1) + (direction.asKnown()?.validity() ?: 0) + (if (originatingAccountId.asKnown() == null) 0 else 1) + (if (dueDate.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is PaymentFlowCreateRequest && amount == other.amount && counterpartyId == other.counterpartyId && currency == other.currency && direction == other.direction && originatingAccountId == other.originatingAccountId && dueDate == other.dueDate && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "PaymentFlowCreateRequest{amount=$amount, counterpartyId=$counterpartyId, currency=$currency, direction=$direction, originatingAccountId=$originatingAccountId, dueDate=$dueDate, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PaymentFlowCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "PaymentFlowCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
