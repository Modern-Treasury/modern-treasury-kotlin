...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ExternalAccountListPageAsync && this.externalAccountsService == other.externalAccountsService && this.params == other.params && this.response == other.response /* spotless:on */
    }
    ...
    constructor(
        ...
        override fun toString() =
            "ExternalAccountListPageAsync.Response{items=$items, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: ExternalAccountListPageAsync,
    ) : Flow<ExternalAccount> {
