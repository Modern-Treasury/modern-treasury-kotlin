...
class AccountDetailRetrieveParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(accountDetailRetrieveParams: AccountDetailRetrieveParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is AccountDetailRetrieveParams && accountsType == other.accountsType && accountId == other.accountId && id == other.id && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(accountsType, accountId, id, additionalHeaders, additionalQueryParams)

    override fun toString() = "AccountDetailRetrieveParams{accountsType=$accountsType, accountId=$accountId, id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
