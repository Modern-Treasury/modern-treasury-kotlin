...
/** Update a hold */
class HoldUpdateParams private constructor(
     ...
     */
    fun resolution(): String? = body.resolution()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [HoldUpdateParams].
         *
    ...
    /** A builder for [HoldUpdateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(holdUpdateParams: HoldUpdateParams) =
            apply {
                id = holdUpdateParams.id
                body = holdUpdateParams.body.toBuilder()
                additionalHeaders = holdUpdateParams.additionalHeaders.toBuilder()
                additionalQueryParams = holdUpdateParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [HoldUpdateParams].
         *
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         */
        internal fun validity(): Int = (status.asKnown()?.validity() ?: 0) + (if (resolution.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && status == other.status && resolution == other.resolution && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(status, resolution, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Body{status=$status, resolution=$resolution, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is HoldUpdateParams && id == other.id && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(id, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "HoldUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
