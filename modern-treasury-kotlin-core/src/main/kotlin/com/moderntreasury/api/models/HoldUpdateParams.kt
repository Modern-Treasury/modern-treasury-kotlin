...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(holdUpdateParams: HoldUpdateParams) = apply {
    ...
    private constructor(
        ...
        ) : this(status, resolution, mutableMapOf())
        ...
        internal fun validity(): Int =
            (status.asKnown()?.validity() ?: 0) + (if (resolution.asKnown() == null) 0 else 1)
        ...
        override fun toString() =
            "Body{status=$status, resolution=$resolution, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is HoldUpdateParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "HoldUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
