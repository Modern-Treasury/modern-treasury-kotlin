...
class LineItemRetrieveParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(lineItemRetrieveParams: LineItemRetrieveParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LineItemRetrieveParams && itemizableType == other.itemizableType && itemizableId == other.itemizableId && id == other.id && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(itemizableType, itemizableId, id, additionalHeaders, additionalQueryParams)

    override fun toString() = "LineItemRetrieveParams{itemizableType=$itemizableType, itemizableId=$itemizableId, id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
