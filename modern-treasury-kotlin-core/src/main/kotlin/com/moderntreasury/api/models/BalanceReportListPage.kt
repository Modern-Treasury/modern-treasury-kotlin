...
class BalanceReportListPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(balanceReportListPage: BalanceReportListPage) =
            apply {
        ...
        fun service(service: BalanceReportService) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is BalanceReportListPage && service == other.service && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, params, headers, items)

    override fun toString() = "BalanceReportListPage{service=$service, params=$params, headers=$headers, items=$items}"
}
