...
class ExpectedPaymentListPageAsync private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(expectedPaymentListPageAsync: ExpectedPaymentListPageAsync) =
            apply {
        ...
        fun service(service: ExpectedPaymentServiceAsync) =
            apply {
                this.service = service
            }

        /** The parameters that were used to request this page. */
        fun params(params: ExpectedPaymentListParams) =
            apply {
                this.params = params
            }
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<ExpectedPayment>) =
            apply {
                this.items = items
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ExpectedPaymentListPageAsync && service == other.service && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, params, headers, items)

    override fun toString() = "ExpectedPaymentListPageAsync{service=$service, params=$params, headers=$headers, items=$items}"
}
