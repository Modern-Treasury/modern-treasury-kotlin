...
class LineItemListPageAsync private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(lineItemListPageAsync: LineItemListPageAsync) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LineItemListPageAsync && service == other.service && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, params, headers, items)

    override fun toString() = "LineItemListPageAsync{service=$service, params=$params, headers=$headers, items=$items}"
}
