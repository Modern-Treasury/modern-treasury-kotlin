...
class PaymentOrderCreateParams private constructor(
     ...
     *
     * Unlike [originatingAccountId], this method doesn't throw if the multipart field has an unexpected type.
     */
     ...
     *
     * Unlike [accountingCategoryId], this method doesn't throw if the multipart field has an unexpected type.
     */
    @Deprecated("deprecated")
     ...
     *
     * Unlike [accountingLedgerClassId], this method doesn't throw if the multipart field has an unexpected type.
     */
    @Deprecated("deprecated")
     ...
     *
     * Unlike [chargeBearer], this method doesn't throw if the multipart field has an unexpected type.
     */
     ...
     *
     * Unlike [effectiveDate], this method doesn't throw if the multipart field has an unexpected type.
     */
     ...
     *
     * Unlike [fallbackType], this method doesn't throw if the multipart field has an unexpected type.
     */
     ...
     *
     * Unlike [foreignExchangeContract], this method doesn't throw if the multipart field has an unexpected type.
     */
     ...
     *
     * Unlike [foreignExchangeIndicator], this method doesn't throw if the multipart field has an unexpected type.
     */
    fun _foreignExchangeIndicator(): MultipartField<ForeignExchangeIndicator> = body._foreignExchangeIndicator()

    /**
     * Returns the raw multipart value of [ledgerTransaction].
     *
     * Unlike [ledgerTransaction], this method doesn't throw if the multipart field has an unexpected type.
     */
    fun _ledgerTransaction(): MultipartField<LedgerTransactionCreateRequest> = body._ledgerTransaction()

    /**
     * Returns the raw multipart value of [ledgerTransactionId].
     *
     * Unlike [ledgerTransactionId], this method doesn't throw if the multipart field has an unexpected type.
     */
     ...
     *
     * Unlike [nsfProtected], this method doesn't throw if the multipart field has an unexpected type.
     */
     ...
     *
     * Unlike [originatingPartyName], this method doesn't throw if the multipart field has an unexpected type.
     */
     ...
     *
     * Unlike [processAfter], this method doesn't throw if the multipart field has an unexpected type.
     */
     ...
     *
     * Unlike [receivingAccount], this method doesn't throw if the multipart field has an unexpected type.
     */
     ...
     *
     * Unlike [receivingAccountId], this method doesn't throw if the multipart field has an unexpected type.
     */
     ...
     *
     * Unlike [reconciliationStatus], this method doesn't throw if the multipart field has an unexpected type.
     */
     ...
     *
     * Unlike [remittanceInformation], this method doesn't throw if the multipart field has an unexpected type.
     */
     ...
     *
     * Unlike [sendRemittanceAdvice], this method doesn't throw if the multipart field has an unexpected type.
     */
     ...
     *
     * Unlike [statementDescriptor], this method doesn't throw if the multipart field has an unexpected type.
     */
     ...
     *
     * Unlike [transactionMonitoringEnabled], this method doesn't throw if the multipart field has an unexpected type.
     */
    @Deprecated("deprecated")
    fun _transactionMonitoringEnabled(): MultipartField<Boolean> = body._transactionMonitoringEnabled()

    /**
     * Returns the raw multipart value of [ultimateOriginatingAccountId].
     *
     * Unlike [ultimateOriginatingAccountId], this method doesn't throw if the multipart field has an unexpected type.
     */
    fun _ultimateOriginatingAccountId(): MultipartField<String> = body._ultimateOriginatingAccountId()

    /**
     * Returns the raw multipart value of [ultimateOriginatingPartyAddress].
     *
     * Unlike [ultimateOriginatingPartyAddress], this method doesn't throw if the multipart field has an unexpected type.
     */
    fun _ultimateOriginatingPartyAddress(): MultipartField<UltimateOriginatingPartyAddress> = body._ultimateOriginatingPartyAddress()

    /**
     * Returns the raw multipart value of [ultimateOriginatingPartyIdentifier].
     *
     * Unlike [ultimateOriginatingPartyIdentifier], this method doesn't throw if the multipart field has an unexpected type.
     */
    fun _ultimateOriginatingPartyIdentifier(): MultipartField<String> = body._ultimateOriginatingPartyIdentifier()

    /**
     * Returns the raw multipart value of [ultimateOriginatingPartyName].
     *
     * Unlike [ultimateOriginatingPartyName], this method doesn't throw if the multipart field has an unexpected type.
     */
    fun _ultimateOriginatingPartyName(): MultipartField<String> = body._ultimateOriginatingPartyName()

    /**
     * Returns the raw multipart value of [ultimateReceivingPartyIdentifier].
     *
     * Unlike [ultimateReceivingPartyIdentifier], this method doesn't throw if the multipart field has an unexpected type.
     */
    fun _ultimateReceivingPartyIdentifier(): MultipartField<String> = body._ultimateReceivingPartyIdentifier()

    /**
     * Returns the raw multipart value of [ultimateReceivingPartyName].
     *
     * Unlike [ultimateReceivingPartyName], this method doesn't throw if the multipart field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(paymentOrderCreateParams: PaymentOrderCreateParams) =
            apply {
         ...
         * - etc.
         */
        fun body(body: PaymentOrderCreateRequest) =
            apply {
         ...
         * supported value.
         */
        fun amount(amount: MultipartField<Long>) =
            apply {
                body.amount(amount)
            }
         ...
         * supported value.
         */
        fun direction(direction: MultipartField<Direction>) =
            apply {
                body.direction(direction)
            }
         ...
         * supported value.
         */
        fun originatingAccountId(originatingAccountId: MultipartField<String>) =
            apply {
                body.originatingAccountId(originatingAccountId)
            }
         ...
         * supported value.
         */
        fun type(type: MultipartField<PaymentOrderType>) =
            apply {
                body.type(type)
            }
         ...
         */
        @Deprecated("deprecated")
        fun accounting(accounting: MultipartField<Accounting>) =
            apply {
                body.accounting(accounting)
            }
         ...
         */
        @Deprecated("deprecated")
        fun accountingCategoryId(accountingCategoryId: MultipartField<String>) =
            apply {
                body.accountingCategoryId(accountingCategoryId)
            }
         ...
         */
        @Deprecated("deprecated")
        fun accountingLedgerClassId(accountingLedgerClassId: MultipartField<String>) =
            apply {
                body.accountingLedgerClassId(accountingLedgerClassId)
            }
         ...
         * supported value.
         */
        fun chargeBearer(chargeBearer: MultipartField<ChargeBearer>) =
            apply {
                body.chargeBearer(chargeBearer)
            }
         ...
         * supported value.
         */
        fun currency(currency: MultipartField<Currency>) =
            apply {
                body.currency(currency)
            }
         ...
         * supported value.
         */
        fun description(description: MultipartField<String>) =
            apply {
                body.description(description)
            }
         ...
         *
         * You should usually call [Builder.documents] with a well-typed `List<DocumentCreateRequest>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun documents(documents: MultipartField<List<DocumentCreateRequest>>) =
            apply {
                body.documents(documents)
            }
         ...
         */
        fun addDocument(document: DocumentCreateRequest) =
            apply {
         ...
         * supported value.
         */
        fun effectiveDate(effectiveDate: MultipartField<LocalDate>) =
            apply {
                body.effectiveDate(effectiveDate)
            }
         ...
         * supported value.
         */
        fun expiresAt(expiresAt: MultipartField<OffsetDateTime>) =
            apply {
                body.expiresAt(expiresAt)
            }
         ...
         * supported value.
         */
        fun externalId(externalId: MultipartField<String>) =
            apply {
                body.externalId(externalId)
            }
         ...
         * supported value.
         */
        fun fallbackType(fallbackType: MultipartField<FallbackType>) =
            apply {
                body.fallbackType(fallbackType)
            }
         ...
         * supported value.
         */
        fun foreignExchangeContract(foreignExchangeContract: MultipartField<String>) =
            apply {
                body.foreignExchangeContract(foreignExchangeContract)
            }
         ...
         * supported value.
         */
        fun foreignExchangeIndicator(foreignExchangeIndicator: MultipartField<ForeignExchangeIndicator>) =
            apply {
                body.foreignExchangeIndicator(foreignExchangeIndicator)
            }
         ...
         * supported value.
         */
        fun ledgerTransactionId(ledgerTransactionId: MultipartField<String>) =
            apply {
                body.ledgerTransactionId(ledgerTransactionId)
            }
         ...
         * supported value.
         */
        fun lineItems(lineItems: MultipartField<List<LineItemRequest>>) =
            apply {
                body.lineItems(lineItems)
            }
         ...
         * supported value.
         */
        fun metadata(metadata: MultipartField<Metadata>) =
            apply {
                body.metadata(metadata)
            }
         ...
         * supported value.
         */
        fun nsfProtected(nsfProtected: MultipartField<Boolean>) =
            apply {
                body.nsfProtected(nsfProtected)
            }
         ...
         * supported value.
         */
        fun originatingPartyName(originatingPartyName: MultipartField<String>) =
            apply {
                body.originatingPartyName(originatingPartyName)
            }
         ...
         * supported value.
         */
        fun priority(priority: MultipartField<Priority>) =
            apply {
                body.priority(priority)
            }
         ...
         * supported value.
         */
        fun processAfter(processAfter: MultipartField<OffsetDateTime>) =
            apply {
                body.processAfter(processAfter)
            }
         ...
         * supported value.
         */
        fun purpose(purpose: MultipartField<String>) =
            apply {
                body.purpose(purpose)
            }
         ...
         * supported value.
         */
        fun receivingAccount(receivingAccount: MultipartField<ReceivingAccount>) =
            apply {
                body.receivingAccount(receivingAccount)
            }
         ...
         * supported value.
         */
        fun receivingAccountId(receivingAccountId: MultipartField<String>) =
            apply {
                body.receivingAccountId(receivingAccountId)
            }
         ...
         * supported value.
         */
        fun remittanceInformation(remittanceInformation: MultipartField<String>) =
            apply {
                body.remittanceInformation(remittanceInformation)
            }
         ...
         * supported value.
         */
        fun sendRemittanceAdvice(sendRemittanceAdvice: MultipartField<Boolean>) =
            apply {
                body.sendRemittanceAdvice(sendRemittanceAdvice)
            }
         ...
         * supported value.
         */
        fun statementDescriptor(statementDescriptor: MultipartField<String>) =
            apply {
                body.statementDescriptor(statementDescriptor)
            }
         ...
         * supported value.
         */
        fun subtype(subtype: MultipartField<PaymentOrderSubtype>) =
            apply {
                body.subtype(subtype)
            }
        ...
        /**
         * Sets [Builder.ultimateOriginatingAccountId] to an arbitrary multipart value.
         *
         ...
         * supported value.
         */
        fun ultimateOriginatingAccountId(ultimateOriginatingAccountId: MultipartField<String>) =
            apply {
                body.ultimateOriginatingAccountId(ultimateOriginatingAccountId)
            }
        ...
        /**
         * Sets [Builder.ultimateOriginatingPartyAddress] to an arbitrary multipart value.
         *
         ...
         * supported value.
         */
        fun ultimateOriginatingPartyAddress(ultimateOriginatingPartyAddress: MultipartField<UltimateOriginatingPartyAddress>) =
            apply {
                body.ultimateOriginatingPartyAddress(ultimateOriginatingPartyAddress)
            }
         ...
         * supported value.
         */
        fun ultimateOriginatingPartyIdentifier(ultimateOriginatingPartyIdentifier: MultipartField<String>) =
            apply {
                body.ultimateOriginatingPartyIdentifier(ultimateOriginatingPartyIdentifier)
            }
         ...
         * supported value.
         */
        fun ultimateReceivingPartyIdentifier(ultimateReceivingPartyIdentifier: MultipartField<String>) =
            apply {
                body.ultimateReceivingPartyIdentifier(ultimateReceivingPartyIdentifier)
            }
    ...
    fun _body(): Map<String, MultipartField<*>> =
        (mapOf(
          ...
          "ultimate_originating_account_id" to _ultimateOriginatingAccountId(),
          "ultimate_originating_party_address" to _ultimateOriginatingPartyAddress(),
          ...
          "vendor_attributes" to _vendorAttributes(),
    ...
    class PaymentOrderCreateRequest private constructor(
        ...
        private val ultimateOriginatingAccountId: MultipartField<String>,
        private val ultimateOriginatingPartyAddress: MultipartField<UltimateOriginatingPartyAddress>,
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun originatingAccountId(): String = originatingAccountId.value.getRequired("originating_account_id")
         ...
         */
        @Deprecated("deprecated")
        fun accountingCategoryId(): String? = accountingCategoryId.value.getNullable("accounting_category_id")
         ...
         */
        @Deprecated("deprecated")
        fun accountingLedgerClassId(): String? = accountingLedgerClassId.value.getNullable("accounting_ledger_class_id")
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun foreignExchangeContract(): String? = foreignExchangeContract.value.getNullable("foreign_exchange_contract")
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun foreignExchangeIndicator(): ForeignExchangeIndicator? = foreignExchangeIndicator.value.getNullable("foreign_exchange_indicator")
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun ledgerTransaction(): LedgerTransactionCreateRequest? = ledgerTransaction.value.getNullable("ledger_transaction")
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun ledgerTransactionId(): String? = ledgerTransactionId.value.getNullable("ledger_transaction_id")
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun originatingPartyName(): String? = originatingPartyName.value.getNullable("originating_party_name")
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun receivingAccount(): ReceivingAccount? = receivingAccount.value.getNullable("receiving_account")
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun receivingAccountId(): String? = receivingAccountId.value.getNullable("receiving_account_id")
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun reconciliationStatus(): ReconciliationStatus? = reconciliationStatus.value.getNullable("reconciliation_status")
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun remittanceInformation(): String? = remittanceInformation.value.getNullable("remittance_information")
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun sendRemittanceAdvice(): Boolean? = sendRemittanceAdvice.value.getNullable("send_remittance_advice")
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun statementDescriptor(): String? = statementDescriptor.value.getNullable("statement_descriptor")
         ...
         */
        @Deprecated("deprecated")
        fun transactionMonitoringEnabled(): Boolean? = transactionMonitoringEnabled.value.getNullable("transaction_monitoring_enabled")
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun ultimateOriginatingAccountId(): String? = ultimateOriginatingAccountId.value.getNullable("ultimate_originating_account_id")
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun ultimateOriginatingPartyAddress(): UltimateOriginatingPartyAddress? = ultimateOriginatingPartyAddress.value.getNullable("ultimate_originating_party_address")
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun ultimateOriginatingPartyIdentifier(): String? = ultimateOriginatingPartyIdentifier.value.getNullable("ultimate_originating_party_identifier")
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun ultimateOriginatingPartyName(): String? = ultimateOriginatingPartyName.value.getNullable("ultimate_originating_party_name")
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun ultimateReceivingPartyIdentifier(): String? = ultimateReceivingPartyIdentifier.value.getNullable("ultimate_receiving_party_identifier")
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun ultimateReceivingPartyName(): String? = ultimateReceivingPartyName.value.getNullable("ultimate_receiving_party_name")
        ...
        @JsonProperty("amount")
        @ExcludeMissing
        fun _amount(): MultipartField<Long> = amount
        ...
        @JsonProperty("type")
        @ExcludeMissing
        fun _type(): MultipartField<PaymentOrderType> = type
        ...
        @ExcludeMissing
        fun _foreignExchangeIndicator(): MultipartField<ForeignExchangeIndicator> = foreignExchangeIndicator
        ...
        @ExcludeMissing
        fun _purpose(): MultipartField<String> = purpose
        ...
        @ExcludeMissing
        fun _ultimateOriginatingAccountId(): MultipartField<String> = ultimateOriginatingAccountId
        ...
        @ExcludeMissing
        fun _ultimateOriginatingPartyAddress(): MultipartField<UltimateOriginatingPartyAddress> = ultimateOriginatingPartyAddress
        ...
        @ExcludeMissing
        fun _ultimateOriginatingPartyIdentifier(): MultipartField<String> = ultimateOriginatingPartyIdentifier
        ...
        @ExcludeMissing
        fun _ultimateReceivingPartyIdentifier(): MultipartField<String> = ultimateReceivingPartyIdentifier
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [PaymentOrderCreateRequest].
             *
             * The following fields are required:
             *
             * ```kotlin
        ...
        class Builder internal constructor() {
            ...
            private var foreignExchangeIndicator: MultipartField<ForeignExchangeIndicator> = MultipartField.of(null)
            private var ledgerTransaction: MultipartField<LedgerTransactionCreateRequest> = MultipartField.of(null)
            ...
            private var reconciliationStatus: MultipartField<ReconciliationStatus> = MultipartField.of(null)
            ...
            private var transactionMonitoringEnabled: MultipartField<Boolean> = MultipartField.of(null)
            private var ultimateOriginatingAccountId: MultipartField<String> = MultipartField.of(null)
            private var ultimateOriginatingPartyAddress: MultipartField<UltimateOriginatingPartyAddress> = MultipartField.of(null)
            private var ultimateOriginatingPartyIdentifier: MultipartField<String> = MultipartField.of(null)
            private var ultimateOriginatingPartyName: MultipartField<String> = MultipartField.of(null)
            private var ultimateReceivingPartyIdentifier: MultipartField<String> = MultipartField.of(null)
            ...
            internal fun from(paymentOrderCreateRequest: PaymentOrderCreateRequest) =
                apply {
                    ...
                    transactionMonitoringEnabled = paymentOrderCreateRequest.transactionMonitoringEnabled
                    ultimateOriginatingAccountId = paymentOrderCreateRequest.ultimateOriginatingAccountId
                    ultimateOriginatingPartyAddress = paymentOrderCreateRequest.ultimateOriginatingPartyAddress
                    ultimateOriginatingPartyIdentifier = paymentOrderCreateRequest.ultimateOriginatingPartyIdentifier
                    ultimateOriginatingPartyName = paymentOrderCreateRequest.ultimateOriginatingPartyName
                    ultimateReceivingPartyIdentifier = paymentOrderCreateRequest.ultimateReceivingPartyIdentifier
                    ultimateReceivingPartyName = paymentOrderCreateRequest.ultimateReceivingPartyName
                    vendorAttributes = paymentOrderCreateRequest.vendorAttributes
            ...
            /** The ID of one of your organization's internal accounts. */
            fun originatingAccountId(originatingAccountId: String) = originatingAccountId(MultipartField.of(originatingAccountId))
            ...
            /** The ID of one of your accounting categories. Note that these will only be accessible if your accounting system has been connected. */
            @Deprecated("deprecated")
            fun accountingCategoryId(accountingCategoryId: String?) = accountingCategoryId(MultipartField.of(accountingCategoryId))
            ...
            /** The ID of one of your accounting ledger classes. Note that these will only be accessible if your accounting system has been connected. */
            @Deprecated("deprecated")
            fun accountingLedgerClassId(accountingLedgerClassId: String?) = accountingLedgerClassId(MultipartField.of(accountingLedgerClassId))
            ...
            /** The party that will pay the fees for the payment order. See https://docs.moderntreasury.com/payments/docs/charge-bearer to understand the differences between the options. */
            fun chargeBearer(chargeBearer: ChargeBearer?) = chargeBearer(MultipartField.of(chargeBearer))
            ...
            /** An array of documents to be attached to the payment order. Note that if you attach documents, the request's content type must be `multipart/form-data`. */
            fun documents(documents: List<DocumentCreateRequest>) =
                documents(MultipartField.builder<List<DocumentCreateRequest>>()
                    .value(documents)
            ...
            fun addDocument(document: DocumentCreateRequest) =
                apply {
                    documents = (documents ?: MultipartField.builder<MutableList<DocumentCreateRequest>>()
                        .value(mutableListOf())
                        .contentType("application/octet-stream")
                        .build()).also {
            ...
            /** Date transactions are to be posted to the participants' account. Defaults to the current business day or the next business day if the current day is a bank holiday or weekend. Format: yyyy-mm-dd. */
            fun effectiveDate(effectiveDate: LocalDate) = effectiveDate(MultipartField.of(effectiveDate))
            ...
            /** A payment type to fallback to if the original type is not valid for the receiving account. Currently, this only supports falling back from RTP to ACH (type=rtp and fallback_type=ach) */
            fun fallbackType(fallbackType: FallbackType) = fallbackType(MultipartField.of(fallbackType))
            ...
            /** If present, indicates a specific foreign exchange contract number that has been generated by your financial institution. */
            fun foreignExchangeContract(foreignExchangeContract: String?) = foreignExchangeContract(MultipartField.of(foreignExchangeContract))
            ...
            /** Indicates the type of FX transfer to initiate, can be either `variable_to_fixed`, `fixed_to_variable`, or `null` if the payment order currency matches the originating account currency. */
            fun foreignExchangeIndicator(foreignExchangeIndicator: ForeignExchangeIndicator?) = foreignExchangeIndicator(MultipartField.of(foreignExchangeIndicator))
            ...
            /** Specifies a ledger transaction object that will be created with the payment order. If the ledger transaction cannot be created, then the payment order creation will fail. The resulting ledger transaction will mirror the status of the payment order. */
            fun ledgerTransaction(ledgerTransaction: LedgerTransactionCreateRequest) = ledgerTransaction(MultipartField.of(ledgerTransaction))
            ...
            /** Either ledger_transaction or ledger_transaction_id can be provided. Only a pending ledger transaction can be attached upon payment order creation. Once the payment order is created, the status of the ledger transaction tracks the payment order automatically. */
            fun ledgerTransactionId(ledgerTransactionId: String) = ledgerTransactionId(MultipartField.of(ledgerTransactionId))
            ...
            /** An array of line items that must sum up to the amount of the payment order. */
            fun lineItems(lineItems: List<LineItemRequest>) = lineItems(MultipartField.of(lineItems))
            ...
            fun addLineItem(lineItem: LineItemRequest) =
                apply {
                    lineItems = (lineItems ?: MultipartField.of(mutableListOf())).also {
            ...
            /** If present, this will replace your default company name on receiver's bank statement. This field can only be used for ACH payments currently. For ACH, only the first 16 characters of this string will be used. Any additional characters will be truncated. */
            fun originatingPartyName(originatingPartyName: String?) = originatingPartyName(MultipartField.of(originatingPartyName))
            ...
            /** If present, Modern Treasury will not process the payment until after this time. If `process_after` is past the cutoff for `effective_date`, `process_after` will take precedence and `effective_date` will automatically update to reflect the earliest possible sending date after `process_after`. Format is ISO8601 timestamp. */
            fun processAfter(processAfter: OffsetDateTime?) = processAfter(MultipartField.of(processAfter))
            ...
            /** Either `receiving_account` or `receiving_account_id` must be present. When using `receiving_account_id`, you may pass the id of an external account or an internal account. */
            fun receivingAccount(receivingAccount: ReceivingAccount) = receivingAccount(MultipartField.of(receivingAccount))
            ...
            /** Either `receiving_account` or `receiving_account_id` must be present. When using `receiving_account_id`, you may pass the id of an external account or an internal account. */
            fun receivingAccountId(receivingAccountId: String) = receivingAccountId(MultipartField.of(receivingAccountId))
            ...
            /** One of `unreconciled`, `tentatively_reconciled` or `reconciled`. */
            fun reconciliationStatus(reconciliationStatus: ReconciliationStatus) = reconciliationStatus(MultipartField.of(reconciliationStatus))
            ...
            /** For `ach`, this field will be passed through on an addenda record. For `wire` payments the field will be passed through as the "Originator to Beneficiary Information", also known as OBI or Fedwire tag 6000. */
            fun remittanceInformation(remittanceInformation: String?) = remittanceInformation(MultipartField.of(remittanceInformation))
            ...
            /** Send an email to the counterparty when the payment order is sent to the bank. If `null`, `send_remittance_advice` on the Counterparty is used. */
            fun sendRemittanceAdvice(sendRemittanceAdvice: Boolean?) = sendRemittanceAdvice(MultipartField.of(sendRemittanceAdvice))
            ...
            /** An optional descriptor which will appear in the receiver's statement. For `check` payments this field will be used as the memo line. For `ach` the maximum length is 10 characters. Note that for ACH payments, the name on your bank account will be included automatically by the bank, so you can use the characters for other useful information. For `eft` the maximum length is 15 characters. */
            fun statementDescriptor(statementDescriptor: String?) = statementDescriptor(MultipartField.of(statementDescriptor))
            ...
            /** A flag that determines whether a payment order should go through transaction monitoring. */
            @Deprecated("deprecated")
            fun transactionMonitoringEnabled(transactionMonitoringEnabled: Boolean) = transactionMonitoringEnabled(MultipartField.of(transactionMonitoringEnabled))
            ...
            /** The ultimate originating account ID. Can be a `virtual_account` or `internal_account`. */
            fun ultimateOriginatingAccountId(ultimateOriginatingAccountId: String) = ultimateOriginatingAccountId(MultipartField.of(ultimateOriginatingAccountId))
            ...
            /** Address of the ultimate originator of the payment order. */
            fun ultimateOriginatingPartyAddress(ultimateOriginatingPartyAddress: UltimateOriginatingPartyAddress?) = ultimateOriginatingPartyAddress(MultipartField.of(ultimateOriginatingPartyAddress))
            ...
            /** Identifier of the ultimate originator of the payment order. */
            fun ultimateOriginatingPartyIdentifier(ultimateOriginatingPartyIdentifier: String?) = ultimateOriginatingPartyIdentifier(MultipartField.of(ultimateOriginatingPartyIdentifier))
            ...
            /** Name of the ultimate originator of the payment order. */
            fun ultimateOriginatingPartyName(ultimateOriginatingPartyName: String?) = ultimateOriginatingPartyName(MultipartField.of(ultimateOriginatingPartyName))
            ...
            /** Identifier of the ultimate funds recipient. */
            fun ultimateReceivingPartyIdentifier(ultimateReceivingPartyIdentifier: String?) = ultimateReceivingPartyIdentifier(MultipartField.of(ultimateReceivingPartyIdentifier))
            ...
            /** Name of the ultimate funds recipient. */
            fun ultimateReceivingPartyName(ultimateReceivingPartyName: String?) = ultimateReceivingPartyName(MultipartField.of(ultimateReceivingPartyName))
         ...
         *   expected type.
         */
        fun validate(): PaymentOrderCreateRequest =
            apply {
                if (validated) {
                  return@apply
                }
    ...
    @Deprecated("deprecated")
    class Accounting private constructor(
         ...
         *
         * Unlike [accountId], this method doesn't throw if the multipart field has an unexpected type.
         */
        @Deprecated("deprecated")
         ...
         *
         * Unlike [classId], this method doesn't throw if the multipart field has an unexpected type.
         */
        @Deprecated("deprecated")
        ...
        class Builder internal constructor() {
             ...
             */
            @Deprecated("deprecated")
            fun accountId(accountId: MultipartField<String>) =
                apply {
             ...
             */
            @Deprecated("deprecated")
            fun classId(classId: MultipartField<String>) =
                apply {
    ...
    class DocumentCreateRequest private constructor(
        ...
        /** @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
        fun documentableType(): DocumentableType? = documentableType.value.getNullable("documentable_type")
         ...
         *
         * Unlike [documentType], this method doesn't throw if the multipart field has an unexpected type.
         */
         ...
         *
         * Unlike [documentableId], this method doesn't throw if the multipart field has an unexpected type.
         */
         ...
         *
         * Unlike [documentableType], this method doesn't throw if the multipart field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
            ...
            internal fun from(documentCreateRequest: DocumentCreateRequest) =
                apply {
             ...
             *
             * You should usually call [Builder.documentType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun documentType(documentType: MultipartField<String>) =
                apply {
                    this.documentType = documentType
                }

            /** The unique identifier for the associated object. */
            fun documentableId(documentableId: String) = documentableId(MultipartField.of(documentableId))

            /**
             * Sets [Builder.documentableId] to an arbitrary multipart value.
             *
             * You should usually call [Builder.documentableId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun documentableId(documentableId: MultipartField<String>) =
                apply {
                    this.documentableId = documentableId
                }

            fun documentableType(documentableType: DocumentableType) = documentableType(MultipartField.of(documentableType))

            /**
             * Sets [Builder.documentableType] to an arbitrary multipart value.
             *
             * You should usually call [Builder.documentableType] with a well-typed [DocumentableType] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun documentableType(documentableType: MultipartField<DocumentableType>) =
                apply {
         ...
         *   expected type.
         */
        fun validate(): DocumentCreateRequest =
            apply {
                if (validated) {
                  return@apply
                }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is DocumentCreateRequest && file == other.file && documentType == other.documentType && documentableId == other.documentableId && documentableType == other.documentableType && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(file, documentType, documentableId, documentableType, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "DocumentCreateRequest{file=$file, documentType=$documentType, documentableId=$documentableId, documentableType=$documentableType, additionalProperties=$additionalProperties}"
    }
    ...
    class LineItemRequest private constructor(
        private val amount: MultipartField<Long>,
        private val accountingCategoryId: MultipartField<String>,
        private val description: MultipartField<String>,
        private val metadata: MultipartField<Metadata>,
    ...
    /** Either `receiving_account` or `receiving_account_id` must be present. When using `receiving_account_id`, you may pass the id of an external account or an internal account. */
    class ReceivingAccount private constructor(
        ...
        /** @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
        fun accountDetails(): List<AccountDetail>? = accountDetails.value.getNullable("account_details")
        ...
        /** @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
        fun contactDetails(): List<ContactDetailCreateRequest>? = contactDetails.value.getNullable("contact_details")
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun ledgerAccount(): LedgerAccountCreateRequest? = ledgerAccount.value.getNullable("ledger_account")
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun plaidProcessorToken(): String? = plaidProcessorToken.value.getNullable("plaid_processor_token")

        /** @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
        fun routingDetails(): List<RoutingDetail>? = routingDetails.value.getNullable("routing_details")

        /**
         * Returns the raw multipart value of [accountDetails].
         *
         * Unlike [accountDetails], this method doesn't throw if the multipart field has an unexpected type.
         */
         ...
         *
         * Unlike [accountType], this method doesn't throw if the multipart field has an unexpected type.
         */
         ...
         *
         * Unlike [contactDetails], this method doesn't throw if the multipart field has an unexpected type.
         */
         ...
         *
         * Unlike [ledgerAccount], this method doesn't throw if the multipart field has an unexpected type.
         */
        ...
        @JsonProperty("name")
        @ExcludeMissing
        fun _name(): MultipartField<String> = name

        /**
         * Returns the raw multipart value of [partyAddress].
         *
         * Unlike [partyAddress], this method doesn't throw if the multipart field has an unexpected type.
         */
         ...
         *
         * Unlike [partyIdentifier], this method doesn't throw if the multipart field has an unexpected type.
         */
         ...
         *
         * Unlike [partyName], this method doesn't throw if the multipart field has an unexpected type.
         */
         ...
         *
         * Unlike [partyType], this method doesn't throw if the multipart field has an unexpected type.
         */
         ...
         *
         * Unlike [plaidProcessorToken], this method doesn't throw if the multipart field has an unexpected type.
         */
         ...
         *
         * Unlike [routingDetails], this method doesn't throw if the multipart field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
            ...
            private var contactDetails: MultipartField<MutableList<ContactDetailCreateRequest>>? = null
            private var externalId: MultipartField<String> = MultipartField.of(null)
            private var ledgerAccount: MultipartField<LedgerAccountCreateRequest> = MultipartField.of(null)
            private var metadata: MultipartField<Metadata> = MultipartField.of(null)
            ...
            fun accountDetails(accountDetails: List<AccountDetail>) = accountDetails(MultipartField.of(accountDetails))
             ...
             * supported value.
             */
            fun accountDetails(accountDetails: MultipartField<List<AccountDetail>>) =
                apply {
            ...
            fun addAccountDetail(accountDetail: AccountDetail) =
                apply {
                    accountDetails = (accountDetails ?: MultipartField.of(mutableListOf())).also {
                        checkKnown("accountDetails", it).add(accountDetail)
                    }
                }

            /** Can be `checking`, `savings` or `other`. */
            fun accountType(accountType: ExternalAccountType) = accountType(MultipartField.of(accountType))
             ...
             * supported value.
             */
            fun accountType(accountType: MultipartField<ExternalAccountType>) =
                apply {
                    this.accountType = accountType
                }

            fun contactDetails(contactDetails: List<ContactDetailCreateRequest>) = contactDetails(MultipartField.of(contactDetails))
            ...
            fun addContactDetail(contactDetail: ContactDetailCreateRequest) =
                apply {
                    contactDetails = (contactDetails ?: MultipartField.of(mutableListOf())).also {
            ...
            /** Specifies a ledger account object that will be created with the external account. The resulting ledger account is linked to the external account for auto-ledgering Payment objects. See https://docs.moderntreasury.com/docs/linking-to-other-modern-treasury-objects for more details. */
            fun ledgerAccount(ledgerAccount: LedgerAccountCreateRequest) = ledgerAccount(MultipartField.of(ledgerAccount))
             ...
             * supported value.
             */
            fun ledgerAccount(ledgerAccount: MultipartField<LedgerAccountCreateRequest>) =
                apply {
             ...
             * supported value.
             */
            fun name(name: MultipartField<String>) =
                apply {
                    this.name = name
                }

            /** Required if receiving wire payments. */
            fun partyAddress(partyAddress: AddressRequest) = partyAddress(MultipartField.of(partyAddress))
             ...
             * supported value.
             */
            fun partyAddress(partyAddress: MultipartField<AddressRequest>) =
                apply {
                    this.partyAddress = partyAddress
                }

            fun partyIdentifier(partyIdentifier: String) = partyIdentifier(MultipartField.of(partyIdentifier))
             ...
             * supported value.
             */
            fun partyIdentifier(partyIdentifier: MultipartField<String>) =
                apply {
             ...
             * supported value.
             */
            fun partyName(partyName: MultipartField<String>) =
                apply {
             ...
             * supported value.
             */
            fun partyType(partyType: MultipartField<PartyType>) =
                apply {
                    this.partyType = partyType
                }

            /** If you've enabled the Modern Treasury + Plaid integration in your Plaid account, you can pass the processor token in this field. */
            fun plaidProcessorToken(plaidProcessorToken: String) = plaidProcessorToken(MultipartField.of(plaidProcessorToken))
             ...
             * supported value.
             */
            fun plaidProcessorToken(plaidProcessorToken: MultipartField<String>) =
                apply {
                    this.plaidProcessorToken = plaidProcessorToken
                }

            fun routingDetails(routingDetails: List<RoutingDetail>) = routingDetails(MultipartField.of(routingDetails))
             ...
             * supported value.
             */
            fun routingDetails(routingDetails: MultipartField<List<RoutingDetail>>) =
                apply {
            ...
            fun addRoutingDetail(routingDetail: RoutingDetail) =
                apply {
                    routingDetails = (routingDetails ?: MultipartField.of(mutableListOf())).also {
        ...
        class AccountDetail private constructor(
            ...
            /** @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
            fun accountNumberType(): AccountNumberType? = accountNumberType.value.getNullable("account_number_type")

            /**
             * Returns the raw multipart value of [accountNumber].
             *
             * Unlike [accountNumber], this method doesn't throw if the multipart field has an unexpected type.
             */
             ...
             *
             * Unlike [accountNumberType], this method doesn't throw if the multipart field has an unexpected type.
             */
            ...
            class Builder internal constructor() {
                ...
                private var accountNumberType: MultipartField<AccountNumberType> = MultipartField.of(null)
                private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()
                ...
                fun accountNumber(accountNumber: String) = accountNumber(MultipartField.of(accountNumber))
                 ...
                 * supported value.
                 */
                fun accountNumber(accountNumber: MultipartField<String>) =
                    apply {
                        this.accountNumber = accountNumber
                    }

                fun accountNumberType(accountNumberType: AccountNumberType) = accountNumberType(MultipartField.of(accountNumberType))
        ...
        class RoutingDetail private constructor(
            ...
            /** @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value). */
            fun routingNumberType(): RoutingNumberType = routingNumberType.value.getRequired("routing_number_type")
             ...
             *
             * Unlike [routingNumber], this method doesn't throw if the multipart field has an unexpected type.
             */
             ...
             *
             * Unlike [routingNumberType], this method doesn't throw if the multipart field has an unexpected type.
             */
             ...
             *
             * Unlike [paymentType], this method doesn't throw if the multipart field has an unexpected type.
             */
            ...
            class Builder internal constructor() {
                ...
                fun routingNumber(routingNumber: String) = routingNumber(MultipartField.of(routingNumber))
                 ...
                 * supported value.
                 */
                fun routingNumber(routingNumber: MultipartField<String>) =
                    apply {
                        this.routingNumber = routingNumber
                    }

                fun routingNumberType(routingNumberType: RoutingNumberType) = routingNumberType(MultipartField.of(routingNumberType))
                ...
                fun paymentType(paymentType: PaymentType) = paymentType(MultipartField.of(paymentType))
                 ...
                 * supported value.
                 */
                fun paymentType(paymentType: MultipartField<PaymentType>) =
                    apply {
    ...
    /** Address of the ultimate originator of the payment order. */
    class UltimateOriginatingPartyAddress private constructor(
        ...
        @JsonProperty("line1")
        @ExcludeMissing
        fun _line1(): MultipartField<String> = line1
        ...
        @JsonProperty("line2")
        @ExcludeMissing
        fun _line2(): MultipartField<String> = line2

        /**
         * Returns the raw multipart value of [locality].
         *
         * Unlike [locality], this method doesn't throw if the multipart field has an unexpected type.
         */
         ...
         *
         * Unlike [postalCode], this method doesn't throw if the multipart field has an unexpected type.
         */
        ...
        @JsonProperty("region")
        @ExcludeMissing
        fun _region(): MultipartField<String> = region
        ...
        class Builder internal constructor() {
             ...
             * supported value.
             */
            fun country(country: MultipartField<String>) =
                apply {
             ...
             * supported value.
             */
            fun line1(line1: MultipartField<String>) =
                apply {
                    this.line1 = line1
                }
             ...
             * supported value.
             */
            fun line2(line2: MultipartField<String>) =
                apply {
                    this.line2 = line2
                }
             ...
             * supported value.
             */
            fun locality(locality: MultipartField<String>) =
                apply {
             ...
             * supported value.
             */
            fun postalCode(postalCode: MultipartField<String>) =
                apply {
             ...
             * supported value.
             */
            fun region(region: MultipartField<String>) =
                apply {
                    this.region = region
                }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PaymentOrderCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "PaymentOrderCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
