...
class PaymentOrderReversalListPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(paymentOrderReversalListPage: PaymentOrderReversalListPage) =
            apply {
        ...
        fun service(service: ReversalService) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PaymentOrderReversalListPage && service == other.service && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, params, headers, items)

    override fun toString() = "PaymentOrderReversalListPage{service=$service, params=$params, headers=$headers, items=$items}"
}
