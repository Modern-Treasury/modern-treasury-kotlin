...
class ExternalAccountListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(externalAccountListParams: ExternalAccountListParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ExternalAccountListParams && afterCursor == other.afterCursor && counterpartyId == other.counterpartyId && externalId == other.externalId && metadata == other.metadata && partyName == other.partyName && perPage == other.perPage && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(afterCursor, counterpartyId, externalId, metadata, partyName, perPage, additionalHeaders, additionalQueryParams)

    override fun toString() = "ExternalAccountListParams{afterCursor=$afterCursor, counterpartyId=$counterpartyId, externalId=$externalId, metadata=$metadata, partyName=$partyName, perPage=$perPage, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
