...
class Address @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
     ...
     */
    internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (if (country.asKnown() == null) 0 else 1) + (if (createdAt.asKnown() == null) 0 else 1) + (if (line1.asKnown() == null) 0 else 1) + (if (line2.asKnown() == null) 0 else 1) + (if (liveMode.asKnown() == null) 0 else 1) + (if (locality.asKnown() == null) 0 else 1) + (if (object_.asKnown() == null) 0 else 1) + (if (postalCode.asKnown() == null) 0 else 1) + (if (region.asKnown() == null) 0 else 1) + (if (updatedAt.asKnown() == null) 0 else 1)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is Address && id == other.id && country == other.country && createdAt == other.createdAt && line1 == other.line1 && line2 == other.line2 && liveMode == other.liveMode && locality == other.locality && object_ == other.object_ && postalCode == other.postalCode && region == other.region && updatedAt == other.updatedAt && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "Address{id=$id, country=$country, createdAt=$createdAt, line1=$line1, line2=$line2, liveMode=$liveMode, locality=$locality, object_=$object_, postalCode=$postalCode, region=$region, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
