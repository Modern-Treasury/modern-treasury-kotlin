...
class ChildLegalEntityCreate @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(childLegalEntityCreate: ChildLegalEntityCreate) =
            apply {
                ...
                doingBusinessAsNames = childLegalEntityCreate.doingBusinessAsNames.map { it.toMutableList() }
                ...
                industryClassifications = childLegalEntityCreate.industryClassifications.map { it.toMutableList() }
                intendedUse = childLegalEntityCreate.intendedUse
                lastName = childLegalEntityCreate.lastName
                legalEntityAssociations = childLegalEntityCreate.legalEntityAssociations.map { it.toMutableList() }
                ...
                operatingJurisdictions = childLegalEntityCreate.operatingJurisdictions.map { it.toMutableList() }
                ...
                primarySocialMediaSites = childLegalEntityCreate.primarySocialMediaSites.map { it.toMutableList() }
                ...
                termsOfUse = childLegalEntityCreate.termsOfUse
                thirdPartyVerification = childLegalEntityCreate.thirdPartyVerification
                thirdPartyVerifications = childLegalEntityCreate.thirdPartyVerifications.map { it.toMutableList() }
     ...
     *   expected type.
     */
    fun validate(): ChildLegalEntityCreate =
        apply {
            if (validated) {
              return@apply
            }
