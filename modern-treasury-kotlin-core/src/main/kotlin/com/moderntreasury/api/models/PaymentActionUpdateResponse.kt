...
class PaymentActionUpdateResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(paymentActionUpdateResponse: PaymentActionUpdateResponse) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): PaymentActionUpdateResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun toString() = "PaymentActionUpdateResponse{id=$id, actionableId=$actionableId, actionableType=$actionableType, createdAt=$createdAt, details=$details, internalAccountId=$internalAccountId, liveMode=$liveMode, object_=$object_, status=$status, type=$type, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
