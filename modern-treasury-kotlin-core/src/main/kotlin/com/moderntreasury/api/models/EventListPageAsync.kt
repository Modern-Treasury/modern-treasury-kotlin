...
class EventListPageAsync private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(eventListPageAsync: EventListPageAsync) =
            apply {
        ...
        fun service(service: EventServiceAsync) =
            apply {
                this.service = service
            }

        /** The parameters that were used to request this page. */
        fun params(params: EventListParams) =
            apply {
                this.params = params
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is EventListPageAsync && service == other.service && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, params, headers, items)

    override fun toString() = "EventListPageAsync{service=$service, params=$params, headers=$headers, items=$items}"
}
