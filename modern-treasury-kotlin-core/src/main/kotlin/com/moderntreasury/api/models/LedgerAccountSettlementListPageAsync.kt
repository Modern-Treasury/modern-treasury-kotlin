...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LedgerAccountSettlementListPageAsync && this.ledgerAccountSettlementsService == other.ledgerAccountSettlementsService && this.params == other.params && this.response == other.response /* spotless:on */
    }
    ...
    constructor(
        ...
        override fun toString() =
            "LedgerAccountSettlementListPageAsync.Response{items=$items, additionalProperties=$additionalProperties}"
