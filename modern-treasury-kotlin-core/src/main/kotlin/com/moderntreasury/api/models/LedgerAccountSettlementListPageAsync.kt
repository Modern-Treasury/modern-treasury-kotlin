...
class LedgerAccountSettlementListPageAsync private constructor(
    ...
    override suspend fun nextPage(): LedgerAccountSettlementListPageAsync = service.list(nextPageParams())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LedgerAccountSettlementListPageAsync].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(ledgerAccountSettlementListPageAsync: LedgerAccountSettlementListPageAsync) =
            apply {
        ...
        fun service(service: LedgerAccountSettlementServiceAsync) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LedgerAccountSettlementListPageAsync && service == other.service && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, params, headers, items)

    override fun toString() = "LedgerAccountSettlementListPageAsync{service=$service, params=$params, headers=$headers, items=$items}"
}
