...
class AccountDetail @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("account_number_safe") @ExcludeMissing accountNumberSafe: JsonField<String> = JsonMissing.of(),
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun accountNumberType(): AccountNumberType = accountNumberType.getRequired("account_number_type")
     ...
     *
     * Unlike [accountNumberSafe], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
        ...
        /** The last 4 digits of the account_number. */
        fun accountNumberSafe(accountNumberSafe: String) = accountNumberSafe(JsonField.of(accountNumberSafe))

        /**
         * Sets [Builder.accountNumberSafe] to an arbitrary JSON value.
         *
         * You should usually call [Builder.accountNumberSafe] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun accountNumberSafe(accountNumberSafe: JsonField<String>) =
            apply {
        ...
        fun build(): AccountDetail =
            AccountDetail(
              ...
              checkRequired(
                "accountNumberSafe", accountNumberSafe
              ),
              checkRequired(
     ...
     */
    internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (if (accountNumberSafe.asKnown() == null) 0 else 1) + (accountNumberType.asKnown()?.validity() ?: 0) + (if (createdAt.asKnown() == null) 0 else 1) + (if (discardedAt.asKnown() == null) 0 else 1) + (if (liveMode.asKnown() == null) 0 else 1) + (if (object_.asKnown() == null) 0 else 1) + (if (updatedAt.asKnown() == null) 0 else 1) + (if (accountNumber.asKnown() == null) 0 else 1)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is AccountDetail && id == other.id && accountNumberSafe == other.accountNumberSafe && accountNumberType == other.accountNumberType && createdAt == other.createdAt && discardedAt == other.discardedAt && liveMode == other.liveMode && object_ == other.object_ && updatedAt == other.updatedAt && accountNumber == other.accountNumber && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "AccountDetail{id=$id, accountNumberSafe=$accountNumberSafe, accountNumberType=$accountNumberType, createdAt=$createdAt, discardedAt=$discardedAt, liveMode=$liveMode, object_=$object_, updatedAt=$updatedAt, accountNumber=$accountNumber, additionalProperties=$additionalProperties}"
}
