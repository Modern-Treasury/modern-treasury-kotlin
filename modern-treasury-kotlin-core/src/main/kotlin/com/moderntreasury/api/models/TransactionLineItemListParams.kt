...
class TransactionLineItemListParams private constructor(
    private val id: Id?,
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [TransactionLineItemListParams]. */
        fun builder() = Builder()
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(transactionLineItemListParams: TransactionLineItemListParams) =
            apply {
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                id?.let { it._additionalProperties().keys().forEach { key ->
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is TransactionLineItemListParams && id == other.id && afterCursor == other.afterCursor && perPage == other.perPage && transactionId == other.transactionId && type == other.type && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(id, afterCursor, perPage, transactionId, type, additionalHeaders, additionalQueryParams)

    override fun toString() = "TransactionLineItemListParams{id=$id, afterCursor=$afterCursor, perPage=$perPage, transactionId=$transactionId, type=$type, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
