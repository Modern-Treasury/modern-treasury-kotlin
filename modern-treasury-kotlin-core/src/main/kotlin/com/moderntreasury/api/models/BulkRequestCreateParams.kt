...
/** create bulk_request */
class BulkRequestCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(bulkRequestCreateParams: BulkRequestCreateParams) =
            apply {
         ...
         * - [metadata]
         */
        fun body(body: BulkRequestCreateRequest) =
            apply {
         ...
         *
         * You should usually call [Builder.actionType] with a well-typed [ActionType] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun actionType(actionType: JsonField<ActionType>) =
            apply {
                body.actionType(actionType)
            }
         ...
         *
         * You should usually call [Builder.resourceType] with a well-typed [ResourceType] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun resourceType(resourceType: JsonField<ResourceType>) =
            apply {
                body.resourceType(resourceType)
            }
         ...
         *
         * You should usually call [Builder.resources] with a well-typed `List<Resource>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun resources(resources: JsonField<List<Resource>>) =
            apply {
                body.resources(resources)
            }
        ...
        /** Alias for calling [addResource] with `Resource.ofPaymentOrderAsyncCreateRequest(paymentOrderAsyncCreateRequest)`. */
        ...
        /** Alias for calling [addResource] with `Resource.ofExpectedPaymentCreateRequest(expectedPaymentCreateRequest)`. */
        ...
        /** Alias for calling [addResource] with `Resource.ofLedgerTransactionCreateRequest(ledgerTransactionCreateRequest)`. */
        ...
        /** Alias for calling [addResource] with `Resource.ofLedgerAccountCreateRequest(ledgerAccountCreateRequest)`. */
        fun addResource(ledgerAccountCreateRequest: LedgerAccountCreateRequest) =
            apply {
                body.addResource(ledgerAccountCreateRequest)
            }

        /** Alias for calling [addResource] with `Resource.ofJsonValue(jsonValue)`. */
        fun addResource(jsonValue: JsonValue) =
            apply {
                body.addResource(jsonValue)
            }
        ...
        fun addResource(id: Resource.Id) =
            apply {
                body.addResource(id)
            }

        /** Alias for calling [addResource] with `Resource.ofPaymentOrderUpdateRequestWithId(paymentOrderUpdateRequestWithId)`. */
        ...
        /** Alias for calling [addResource] with `Resource.ofExpectedPaymentUpdateRequestWithId(expectedPaymentUpdateRequestWithId)`. */
        fun addResource(expectedPaymentUpdateRequestWithId: Resource.ExpectedPaymentUpdateRequestWithId) =
            apply {
                body.addResource(expectedPaymentUpdateRequestWithId)
            }

        /** Alias for calling [addResource] with `Resource.ofTransactionUpdateRequestWithId(transactionUpdateRequestWithId)`. */
        ...
        /** Alias for calling [addResource] with `Resource.ofLedgerTransactionUpdateRequestWithId(ledgerTransactionUpdateRequestWithId)`. */
        fun addResource(ledgerTransactionUpdateRequestWithId: Resource.LedgerTransactionUpdateRequestWithId) =
            apply {
                body.addResource(ledgerTransactionUpdateRequestWithId)
            }

        /** Alias for calling [addResource] with `Resource.ofLedgerAccountUpdateRequestWithId(ledgerAccountUpdateRequestWithId)`. */
        fun addResource(ledgerAccountUpdateRequestWithId: Resource.LedgerAccountUpdateRequestWithId) =
            apply {
                body.addResource(ledgerAccountUpdateRequestWithId)
            }
    ...
    class BulkRequestCreateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("action_type") @ExcludeMissing actionType: JsonField<ActionType> = JsonMissing.of(),
            @JsonProperty("resource_type") @ExcludeMissing resourceType: JsonField<ResourceType> = JsonMissing.of(),
            @JsonProperty("resources") @ExcludeMissing resources: JsonField<List<Resource>> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
            ...
            internal fun from(bulkRequestCreateRequest: BulkRequestCreateRequest) =
                apply {
            ...
            fun addResource(resource: Resource) =
                apply {
                    resources = (resources ?: JsonField.of(mutableListOf())).also {
                        checkKnown("resources", it).add(resource)
                    }
                }

            /** Alias for calling [addResource] with `Resource.ofPaymentOrderAsyncCreateRequest(paymentOrderAsyncCreateRequest)`. */
            fun addResource(paymentOrderAsyncCreateRequest: Resource.PaymentOrderAsyncCreateRequest) = addResource(Resource.ofPaymentOrderAsyncCreateRequest(paymentOrderAsyncCreateRequest))

            /** Alias for calling [addResource] with `Resource.ofExpectedPaymentCreateRequest(expectedPaymentCreateRequest)`. */
            fun addResource(expectedPaymentCreateRequest: Resource.ExpectedPaymentCreateRequest) = addResource(Resource.ofExpectedPaymentCreateRequest(expectedPaymentCreateRequest))

            /** Alias for calling [addResource] with `Resource.ofLedgerTransactionCreateRequest(ledgerTransactionCreateRequest)`. */
            fun addResource(ledgerTransactionCreateRequest: LedgerTransactionCreateRequest) = addResource(Resource.ofLedgerTransactionCreateRequest(ledgerTransactionCreateRequest))

            /** Alias for calling [addResource] with `Resource.ofLedgerAccountCreateRequest(ledgerAccountCreateRequest)`. */
            fun addResource(ledgerAccountCreateRequest: LedgerAccountCreateRequest) = addResource(Resource.ofLedgerAccountCreateRequest(ledgerAccountCreateRequest))

            /** Alias for calling [addResource] with `Resource.ofJsonValue(jsonValue)`. */
            fun addResource(jsonValue: JsonValue) = addResource(Resource.ofJsonValue(jsonValue))
            ...
            /** Alias for calling [addResource] with `Resource.ofPaymentOrderUpdateRequestWithId(paymentOrderUpdateRequestWithId)`. */
            fun addResource(paymentOrderUpdateRequestWithId: Resource.PaymentOrderUpdateRequestWithId) = addResource(Resource.ofPaymentOrderUpdateRequestWithId(paymentOrderUpdateRequestWithId))

            /** Alias for calling [addResource] with `Resource.ofExpectedPaymentUpdateRequestWithId(expectedPaymentUpdateRequestWithId)`. */
            fun addResource(expectedPaymentUpdateRequestWithId: Resource.ExpectedPaymentUpdateRequestWithId) = addResource(Resource.ofExpectedPaymentUpdateRequestWithId(expectedPaymentUpdateRequestWithId))

            /** Alias for calling [addResource] with `Resource.ofTransactionUpdateRequestWithId(transactionUpdateRequestWithId)`. */
            fun addResource(transactionUpdateRequestWithId: Resource.TransactionUpdateRequestWithId) = addResource(Resource.ofTransactionUpdateRequestWithId(transactionUpdateRequestWithId))

            /** Alias for calling [addResource] with `Resource.ofLedgerTransactionUpdateRequestWithId(ledgerTransactionUpdateRequestWithId)`. */
            fun addResource(ledgerTransactionUpdateRequestWithId: Resource.LedgerTransactionUpdateRequestWithId) = addResource(Resource.ofLedgerTransactionUpdateRequestWithId(ledgerTransactionUpdateRequestWithId))

            /** Alias for calling [addResource] with `Resource.ofLedgerAccountUpdateRequestWithId(ledgerAccountUpdateRequestWithId)`. */
            fun addResource(ledgerAccountUpdateRequestWithId: Resource.LedgerAccountUpdateRequestWithId) = addResource(Resource.ofLedgerAccountUpdateRequestWithId(ledgerAccountUpdateRequestWithId))
         ...
         *   expected type.
         */
        fun validate(): BulkRequestCreateRequest =
            apply {
                if (validated) {
                  return@apply
                }
         ...
         */
        internal fun validity(): Int = (actionType.asKnown()?.validity() ?: 0) + (resourceType.asKnown()?.validity() ?: 0) + (resources.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (metadata.asKnown()?.validity() ?: 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is BulkRequestCreateRequest && actionType == other.actionType && resourceType == other.resourceType && resources == other.resources && metadata == other.metadata && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "BulkRequestCreateRequest{actionType=$actionType, resourceType=$resourceType, resources=$resources, metadata=$metadata, additionalProperties=$additionalProperties}"
    }

    /** One of create, or update. */
    class ActionType @JsonCreator private constructor(
    ...
    /** One of payment_order, expected_payment, or ledger_transaction. */
    class ResourceType @JsonCreator private constructor(
        private val value: JsonField<String>,
    ...
    class Resource private constructor(
        ...
        private val ledgerTransactionUpdateRequestWithId: LedgerTransactionUpdateRequestWithId? = null,
        private val ledgerAccountUpdateRequestWithId: LedgerAccountUpdateRequestWithId? = null,
        private val _json: JsonValue? = null,

    ) {

        fun paymentOrderAsyncCreateRequest(): PaymentOrderAsyncCreateRequest? = paymentOrderAsyncCreateRequest

        fun expectedPaymentCreateRequest(): ExpectedPaymentCreateRequest? = expectedPaymentCreateRequest

        fun ledgerTransactionCreateRequest(): LedgerTransactionCreateRequest? = ledgerTransactionCreateRequest
        ...
        fun paymentOrderUpdateRequestWithId(): PaymentOrderUpdateRequestWithId? = paymentOrderUpdateRequestWithId

        fun expectedPaymentUpdateRequestWithId(): ExpectedPaymentUpdateRequestWithId? = expectedPaymentUpdateRequestWithId

        fun transactionUpdateRequestWithId(): TransactionUpdateRequestWithId? = transactionUpdateRequestWithId

        fun ledgerTransactionUpdateRequestWithId(): LedgerTransactionUpdateRequestWithId? = ledgerTransactionUpdateRequestWithId

        fun ledgerAccountUpdateRequestWithId(): LedgerAccountUpdateRequestWithId? = ledgerAccountUpdateRequestWithId
        ...
        fun isExpectedPaymentUpdateRequestWithId(): Boolean = expectedPaymentUpdateRequestWithId != null

        fun isTransactionUpdateRequestWithId(): Boolean = transactionUpdateRequestWithId != null

        fun isLedgerTransactionUpdateRequestWithId(): Boolean = ledgerTransactionUpdateRequestWithId != null

        fun isLedgerAccountUpdateRequestWithId(): Boolean = ledgerAccountUpdateRequestWithId != null

        fun asPaymentOrderAsyncCreateRequest(): PaymentOrderAsyncCreateRequest = paymentOrderAsyncCreateRequest.getOrThrow("paymentOrderAsyncCreateRequest")

        fun asExpectedPaymentCreateRequest(): ExpectedPaymentCreateRequest = expectedPaymentCreateRequest.getOrThrow("expectedPaymentCreateRequest")

        fun asLedgerTransactionCreateRequest(): LedgerTransactionCreateRequest = ledgerTransactionCreateRequest.getOrThrow("ledgerTransactionCreateRequest")

        fun asLedgerAccountCreateRequest(): LedgerAccountCreateRequest = ledgerAccountCreateRequest.getOrThrow("ledgerAccountCreateRequest")
        ...
        fun asPaymentOrderUpdateRequestWithId(): PaymentOrderUpdateRequestWithId = paymentOrderUpdateRequestWithId.getOrThrow("paymentOrderUpdateRequestWithId")

        fun asExpectedPaymentUpdateRequestWithId(): ExpectedPaymentUpdateRequestWithId = expectedPaymentUpdateRequestWithId.getOrThrow("expectedPaymentUpdateRequestWithId")

        fun asTransactionUpdateRequestWithId(): TransactionUpdateRequestWithId = transactionUpdateRequestWithId.getOrThrow("transactionUpdateRequestWithId")

        fun asLedgerTransactionUpdateRequestWithId(): LedgerTransactionUpdateRequestWithId = ledgerTransactionUpdateRequestWithId.getOrThrow("ledgerTransactionUpdateRequestWithId")

        fun asLedgerAccountUpdateRequestWithId(): LedgerAccountUpdateRequestWithId = ledgerAccountUpdateRequestWithId.getOrThrow("ledgerAccountUpdateRequestWithId")
         ...
         * import com.moderntreasury.api.core.JsonValue
         *
         * val result: String? = resource.accept(object : Resource.Visitor<String?> {
         *     override fun visitPaymentOrderAsyncCreateRequest(paymentOrderAsyncCreateRequest: PaymentOrderAsyncCreateRequest): String? = paymentOrderAsyncCreateRequest.toString()
         *
         *     // ...
         *
        ...
        fun <T> accept(visitor: Visitor<T>): T =
            when {
                paymentOrderAsyncCreateRequest != null -> visitor.visitPaymentOrderAsyncCreateRequest(paymentOrderAsyncCreateRequest)
                expectedPaymentCreateRequest != null -> visitor.visitExpectedPaymentCreateRequest(expectedPaymentCreateRequest)
                ledgerTransactionCreateRequest != null -> visitor.visitLedgerTransactionCreateRequest(ledgerTransactionCreateRequest)
                ledgerAccountCreateRequest != null -> visitor.visitLedgerAccountCreateRequest(ledgerAccountCreateRequest)
                jsonValue != null -> visitor.visitJsonValue(jsonValue)
                jsonValue != null -> visitor.visitJsonValue(jsonValue)
                id != null -> visitor.visitId(id)
                paymentOrderUpdateRequestWithId != null -> visitor.visitPaymentOrderUpdateRequestWithId(paymentOrderUpdateRequestWithId)
                expectedPaymentUpdateRequestWithId != null -> visitor.visitExpectedPaymentUpdateRequestWithId(expectedPaymentUpdateRequestWithId)
                transactionUpdateRequestWithId != null -> visitor.visitTransactionUpdateRequestWithId(transactionUpdateRequestWithId)
                ledgerTransactionUpdateRequestWithId != null -> visitor.visitLedgerTransactionUpdateRequestWithId(ledgerTransactionUpdateRequestWithId)
                ledgerAccountUpdateRequestWithId != null -> visitor.visitLedgerAccountUpdateRequestWithId(ledgerAccountUpdateRequestWithId)
        ...
        fun validate(): Resource =
            apply {
                ...
                accept(object : Visitor<Unit> {
                    override fun visitPaymentOrderAsyncCreateRequest(paymentOrderAsyncCreateRequest: PaymentOrderAsyncCreateRequest) {
                      paymentOrderAsyncCreateRequest.validate()
                    }

                    override fun visitExpectedPaymentCreateRequest(expectedPaymentCreateRequest: ExpectedPaymentCreateRequest) {
                      expectedPaymentCreateRequest.validate()
                    }

                    override fun visitLedgerTransactionCreateRequest(ledgerTransactionCreateRequest: LedgerTransactionCreateRequest) {
                      ledgerTransactionCreateRequest.validate()
                    }

                    override fun visitLedgerAccountCreateRequest(ledgerAccountCreateRequest: LedgerAccountCreateRequest) {
                    ...
                    override fun visitPaymentOrderUpdateRequestWithId(paymentOrderUpdateRequestWithId: PaymentOrderUpdateRequestWithId) {
                      paymentOrderUpdateRequestWithId.validate()
                    }

                    override fun visitExpectedPaymentUpdateRequestWithId(expectedPaymentUpdateRequestWithId: ExpectedPaymentUpdateRequestWithId) {
                      expectedPaymentUpdateRequestWithId.validate()
                    }

                    override fun visitTransactionUpdateRequestWithId(transactionUpdateRequestWithId: TransactionUpdateRequestWithId) {
                      transactionUpdateRequestWithId.validate()
                    }

                    override fun visitLedgerTransactionUpdateRequestWithId(ledgerTransactionUpdateRequestWithId: LedgerTransactionUpdateRequestWithId) {
                      ledgerTransactionUpdateRequestWithId.validate()
                    }

                    override fun visitLedgerAccountUpdateRequestWithId(ledgerAccountUpdateRequestWithId: LedgerAccountUpdateRequestWithId) {
                      ledgerAccountUpdateRequestWithId.validate()
                    }
                })
                validated = true
            }
        ...
        internal fun validity(): Int =
            accept(object : Visitor<Int> {
                override fun visitPaymentOrderAsyncCreateRequest(paymentOrderAsyncCreateRequest: PaymentOrderAsyncCreateRequest) = paymentOrderAsyncCreateRequest.validity()

                override fun visitExpectedPaymentCreateRequest(expectedPaymentCreateRequest: ExpectedPaymentCreateRequest) = expectedPaymentCreateRequest.validity()

                override fun visitLedgerTransactionCreateRequest(ledgerTransactionCreateRequest: LedgerTransactionCreateRequest) = ledgerTransactionCreateRequest.validity()

                override fun visitLedgerAccountCreateRequest(ledgerAccountCreateRequest: LedgerAccountCreateRequest) = ledgerAccountCreateRequest.validity()
                ...
                override fun visitPaymentOrderUpdateRequestWithId(paymentOrderUpdateRequestWithId: PaymentOrderUpdateRequestWithId) = paymentOrderUpdateRequestWithId.validity()

                override fun visitExpectedPaymentUpdateRequestWithId(expectedPaymentUpdateRequestWithId: ExpectedPaymentUpdateRequestWithId) = expectedPaymentUpdateRequestWithId.validity()

                override fun visitTransactionUpdateRequestWithId(transactionUpdateRequestWithId: TransactionUpdateRequestWithId) = transactionUpdateRequestWithId.validity()

                override fun visitLedgerTransactionUpdateRequestWithId(ledgerTransactionUpdateRequestWithId: LedgerTransactionUpdateRequestWithId) = ledgerTransactionUpdateRequestWithId.validity()

                override fun visitLedgerAccountUpdateRequestWithId(ledgerAccountUpdateRequestWithId: LedgerAccountUpdateRequestWithId) = ledgerAccountUpdateRequestWithId.validity()
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Resource && paymentOrderAsyncCreateRequest == other.paymentOrderAsyncCreateRequest && expectedPaymentCreateRequest == other.expectedPaymentCreateRequest && ledgerTransactionCreateRequest == other.ledgerTransactionCreateRequest && ledgerAccountCreateRequest == other.ledgerAccountCreateRequest && jsonValue == other.jsonValue && jsonValue == other.jsonValue && id == other.id && paymentOrderUpdateRequestWithId == other.paymentOrderUpdateRequestWithId && expectedPaymentUpdateRequestWithId == other.expectedPaymentUpdateRequestWithId && transactionUpdateRequestWithId == other.transactionUpdateRequestWithId && ledgerTransactionUpdateRequestWithId == other.ledgerTransactionUpdateRequestWithId && ledgerAccountUpdateRequestWithId == other.ledgerAccountUpdateRequestWithId
        }

        override fun hashCode(): Int = Objects.hash(paymentOrderAsyncCreateRequest, expectedPaymentCreateRequest, ledgerTransactionCreateRequest, ledgerAccountCreateRequest, jsonValue, jsonValue, id, paymentOrderUpdateRequestWithId, expectedPaymentUpdateRequestWithId, transactionUpdateRequestWithId, ledgerTransactionUpdateRequestWithId, ledgerAccountUpdateRequestWithId)

        override fun toString(): String =
            when {
                paymentOrderAsyncCreateRequest != null -> "Resource{paymentOrderAsyncCreateRequest=$paymentOrderAsyncCreateRequest}"
                expectedPaymentCreateRequest != null -> "Resource{expectedPaymentCreateRequest=$expectedPaymentCreateRequest}"
                ledgerTransactionCreateRequest != null -> "Resource{ledgerTransactionCreateRequest=$ledgerTransactionCreateRequest}"
                ledgerAccountCreateRequest != null -> "Resource{ledgerAccountCreateRequest=$ledgerAccountCreateRequest}"
                jsonValue != null -> "Resource{jsonValue=$jsonValue}"
                jsonValue != null -> "Resource{jsonValue=$jsonValue}"
                id != null -> "Resource{id=$id}"
                paymentOrderUpdateRequestWithId != null -> "Resource{paymentOrderUpdateRequestWithId=$paymentOrderUpdateRequestWithId}"
                expectedPaymentUpdateRequestWithId != null -> "Resource{expectedPaymentUpdateRequestWithId=$expectedPaymentUpdateRequestWithId}"
                transactionUpdateRequestWithId != null -> "Resource{transactionUpdateRequestWithId=$transactionUpdateRequestWithId}"
                ledgerTransactionUpdateRequestWithId != null -> "Resource{ledgerTransactionUpdateRequestWithId=$ledgerTransactionUpdateRequestWithId}"
                ledgerAccountUpdateRequestWithId != null -> "Resource{ledgerAccountUpdateRequestWithId=$ledgerAccountUpdateRequestWithId}"
        ...
        companion object {
            ...
            fun ofPaymentOrderAsyncCreateRequest(paymentOrderAsyncCreateRequest: PaymentOrderAsyncCreateRequest) = Resource(paymentOrderAsyncCreateRequest = paymentOrderAsyncCreateRequest)

            fun ofExpectedPaymentCreateRequest(expectedPaymentCreateRequest: ExpectedPaymentCreateRequest) = Resource(expectedPaymentCreateRequest = expectedPaymentCreateRequest)

            fun ofLedgerTransactionCreateRequest(ledgerTransactionCreateRequest: LedgerTransactionCreateRequest) = Resource(ledgerTransactionCreateRequest = ledgerTransactionCreateRequest)

            fun ofLedgerAccountCreateRequest(ledgerAccountCreateRequest: LedgerAccountCreateRequest) = Resource(ledgerAccountCreateRequest = ledgerAccountCreateRequest)

            fun ofJsonValue(jsonValue: JsonValue) = Resource(jsonValue = jsonValue)

            fun ofJsonValue(jsonValue: JsonValue) = Resource(jsonValue = jsonValue)

            fun ofId(id: Id) = Resource(id = id)

            fun ofPaymentOrderUpdateRequestWithId(paymentOrderUpdateRequestWithId: PaymentOrderUpdateRequestWithId) = Resource(paymentOrderUpdateRequestWithId = paymentOrderUpdateRequestWithId)

            fun ofExpectedPaymentUpdateRequestWithId(expectedPaymentUpdateRequestWithId: ExpectedPaymentUpdateRequestWithId) = Resource(expectedPaymentUpdateRequestWithId = expectedPaymentUpdateRequestWithId)

            fun ofTransactionUpdateRequestWithId(transactionUpdateRequestWithId: TransactionUpdateRequestWithId) = Resource(transactionUpdateRequestWithId = transactionUpdateRequestWithId)

            fun ofLedgerTransactionUpdateRequestWithId(ledgerTransactionUpdateRequestWithId: LedgerTransactionUpdateRequestWithId) = Resource(ledgerTransactionUpdateRequestWithId = ledgerTransactionUpdateRequestWithId)

            fun ofLedgerAccountUpdateRequestWithId(ledgerAccountUpdateRequestWithId: LedgerAccountUpdateRequestWithId) = Resource(ledgerAccountUpdateRequestWithId = ledgerAccountUpdateRequestWithId)
        }

        /** An interface that defines how to map each variant of [Resource] to a value of type [T]. */
        interface Visitor<out T> {

            fun visitPaymentOrderAsyncCreateRequest(paymentOrderAsyncCreateRequest: PaymentOrderAsyncCreateRequest): T

            fun visitExpectedPaymentCreateRequest(expectedPaymentCreateRequest: ExpectedPaymentCreateRequest): T

            fun visitLedgerTransactionCreateRequest(ledgerTransactionCreateRequest: LedgerTransactionCreateRequest): T

            fun visitLedgerAccountCreateRequest(ledgerAccountCreateRequest: LedgerAccountCreateRequest): T
            ...
            fun visitPaymentOrderUpdateRequestWithId(paymentOrderUpdateRequestWithId: PaymentOrderUpdateRequestWithId): T

            fun visitExpectedPaymentUpdateRequestWithId(expectedPaymentUpdateRequestWithId: ExpectedPaymentUpdateRequestWithId): T

            fun visitTransactionUpdateRequestWithId(transactionUpdateRequestWithId: TransactionUpdateRequestWithId): T

            fun visitLedgerTransactionUpdateRequestWithId(ledgerTransactionUpdateRequestWithId: LedgerTransactionUpdateRequestWithId): T

            fun visitLedgerAccountUpdateRequestWithId(ledgerAccountUpdateRequestWithId: LedgerAccountUpdateRequestWithId): T

            /**
             * Maps an unknown variant of [Resource] to a value of type [T].
             *
             * An instance of [Resource] can contain an unknown variant if it was deserialized from data
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): Resource {
              ...
              val bestMatches = sequenceOf(
                      ...
                      tryDeserialize(node, jacksonTypeRef<ExpectedPaymentCreateRequest>())
                          ?.let {
                              Resource(expectedPaymentCreateRequest = it, _json = json)
                          },
                      ...
                      tryDeserialize(node, jacksonTypeRef<LedgerAccountCreateRequest>())
                          ?.let {
                              Resource(ledgerAccountCreateRequest = it, _json = json)
                          },
                      tryDeserialize(node, jacksonTypeRef<Id>())
                          ?.let {
                      ...
                      tryDeserialize(node, jacksonTypeRef<LedgerTransactionUpdateRequestWithId>())
                          ?.let {
                              Resource(ledgerTransactionUpdateRequestWithId = it, _json = json)
                          },
                      tryDeserialize(node, jacksonTypeRef<LedgerAccountUpdateRequestWithId>())
                          ?.let {
                              Resource(ledgerAccountUpdateRequestWithId = it, _json = json)
                          },
                      tryDeserialize(node, jacksonTypeRef<JsonValue>())
                          ?.let {
                              Resource(jsonValue = it, _json = json)
                          },
                      tryDeserialize(node, jacksonTypeRef<JsonValue>())
                          ?.let {
                              Resource(jsonValue = it, _json = json)
              ...
              return when (bestMatches.size) {
                  // This can happen if what we're deserializing is completely incompatible with all the possible variants.
        ...
        internal class Serializer : BaseSerializer<Resource>(Resource::class) {
            ...
            override fun serialize(value: Resource, generator: JsonGenerator, provider: SerializerProvider) {
              when {
                  value.paymentOrderAsyncCreateRequest != null -> generator.writeObject(value.paymentOrderAsyncCreateRequest)
                  value.expectedPaymentCreateRequest != null -> generator.writeObject(value.expectedPaymentCreateRequest)
                  value.ledgerTransactionCreateRequest != null -> generator.writeObject(value.ledgerTransactionCreateRequest)
                  value.ledgerAccountCreateRequest != null -> generator.writeObject(value.ledgerAccountCreateRequest)
                  value.jsonValue != null -> generator.writeObject(value.jsonValue)
                  value.jsonValue != null -> generator.writeObject(value.jsonValue)
                  value.id != null -> generator.writeObject(value.id)
                  value.paymentOrderUpdateRequestWithId != null -> generator.writeObject(value.paymentOrderUpdateRequestWithId)
                  value.expectedPaymentUpdateRequestWithId != null -> generator.writeObject(value.expectedPaymentUpdateRequestWithId)
                  value.transactionUpdateRequestWithId != null -> generator.writeObject(value.transactionUpdateRequestWithId)
                  value.ledgerTransactionUpdateRequestWithId != null -> generator.writeObject(value.ledgerTransactionUpdateRequestWithId)
                  value.ledgerAccountUpdateRequestWithId != null -> generator.writeObject(value.ledgerAccountUpdateRequestWithId)
        ...
        class PaymentOrderAsyncCreateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            class Builder internal constructor() {
                ...
                internal fun from(paymentOrderAsyncCreateRequest: PaymentOrderAsyncCreateRequest) =
                    apply {
                        ...
                        reconciliationStatus = paymentOrderAsyncCreateRequest.reconciliationStatus
            ...
            class UltimateOriginatingPartyAddress @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(ultimateOriginatingPartyAddress: UltimateOriginatingPartyAddress) =
                        apply {
        ...
        class ExpectedPaymentCreateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            @JsonCreator
            private constructor(
                @JsonProperty("amount_lower_bound") @ExcludeMissing amountLowerBound: JsonField<Long> = JsonMissing.of(),
                @JsonProperty("amount_reconciled") @ExcludeMissing amountReconciled: JsonField<Long> = JsonMissing.of(),
                @JsonProperty("amount_reconciled_direction") @ExcludeMissing amountReconciledDirection: JsonField<AmountReconciledDirection> = JsonMissing.of(),
                @JsonProperty("amount_unreconciled") @ExcludeMissing amountUnreconciled: JsonField<Long> = JsonMissing.of(),
                @JsonProperty("amount_unreconciled_direction") @ExcludeMissing amountUnreconciledDirection: JsonField<AmountUnreconciledDirection> = JsonMissing.of(),
                @JsonProperty("amount_upper_bound") @ExcludeMissing amountUpperBound: JsonField<Long> = JsonMissing.of(),
                @JsonProperty("counterparty_id") @ExcludeMissing counterpartyId: JsonField<String> = JsonMissing.of(),
                @JsonProperty("currency") @ExcludeMissing currency: JsonField<Currency> = JsonMissing.of(),
                @JsonProperty("date_lower_bound") @ExcludeMissing dateLowerBound: JsonField<LocalDate> = JsonMissing.of(),
                @JsonProperty("date_upper_bound") @ExcludeMissing dateUpperBound: JsonField<LocalDate> = JsonMissing.of(),
                @JsonProperty("description") @ExcludeMissing description: JsonField<String> = JsonMissing.of(),
                @JsonProperty("direction") @ExcludeMissing direction: JsonField<Direction> = JsonMissing.of(),
                @JsonProperty("external_id") @ExcludeMissing externalId: JsonField<String> = JsonMissing.of(),
                ...
                @JsonProperty("line_items") @ExcludeMissing lineItems: JsonField<List<LineItemRequest>> = JsonMissing.of(),
                @JsonProperty("metadata") @ExcludeMissing metadata: JsonField<Metadata> = JsonMissing.of(),
                @JsonProperty("reconciliation_filters") @ExcludeMissing reconciliationFilters: JsonValue = JsonMissing.of(),
                @JsonProperty("reconciliation_groups") @ExcludeMissing reconciliationGroups: JsonValue = JsonMissing.of(),
                @JsonProperty("reconciliation_rule_variables") @ExcludeMissing reconciliationRuleVariables: JsonField<List<ReconciliationRule>> = JsonMissing.of(),
                @JsonProperty("remittance_information") @ExcludeMissing remittanceInformation: JsonField<String> = JsonMissing.of(),
                @JsonProperty("statement_descriptor") @ExcludeMissing statementDescriptor: JsonField<String> = JsonMissing.of(),
                @JsonProperty("type") @ExcludeMissing type: JsonField<ExpectedPaymentType> = JsonMissing.of()
            ) : this(
              amountLowerBound,
              amountReconciled,
             ...
             * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun amountReconciledDirection(): AmountReconciledDirection? = amountReconciledDirection.getNullable("amount_reconciled_direction")
             ...
             * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun amountUnreconciledDirection(): AmountUnreconciledDirection? = amountUnreconciledDirection.getNullable("amount_unreconciled_direction")
             ...
             * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun reconciliationRuleVariables(): List<ReconciliationRule>? = reconciliationRuleVariables.getNullable("reconciliation_rule_variables")
             ...
             *
             * Unlike [amountLowerBound], this method doesn't throw if the JSON field has an unexpected type.
             */
             ...
             *
             * Unlike [amountReconciled], this method doesn't throw if the JSON field has an unexpected type.
             */
             ...
             *
             * Unlike [amountReconciledDirection], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("amount_reconciled_direction")
            @ExcludeMissing
            fun _amountReconciledDirection(): JsonField<AmountReconciledDirection> = amountReconciledDirection

            /**
             * Returns the raw JSON value of [amountUnreconciled].
             *
             * Unlike [amountUnreconciled], this method doesn't throw if the JSON field has an unexpected type.
             */
             ...
             *
             * Unlike [amountUnreconciledDirection], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("amount_unreconciled_direction")
            @ExcludeMissing
            fun _amountUnreconciledDirection(): JsonField<AmountUnreconciledDirection> = amountUnreconciledDirection

            /**
             * Returns the raw JSON value of [amountUpperBound].
             *
             * Unlike [amountUpperBound], this method doesn't throw if the JSON field has an unexpected type.
             */
             ...
             *
             * Unlike [reconciliationRuleVariables], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("reconciliation_rule_variables")
            @ExcludeMissing
            fun _reconciliationRuleVariables(): JsonField<List<ReconciliationRule>> = reconciliationRuleVariables
            ...
            @JsonProperty("type")
            @ExcludeMissing
            fun _type(): JsonField<ExpectedPaymentType> = type
            ...
            companion object {
                ...
                /** Returns a mutable builder for constructing an instance of [ExpectedPaymentCreateRequest]. */
                fun builder() = Builder()
            }
            ...
            class Builder internal constructor() {
                ...
                private var amountReconciledDirection: JsonField<AmountReconciledDirection> = JsonMissing.of()
                private var amountUnreconciled: JsonField<Long> = JsonMissing.of()
                private var amountUnreconciledDirection: JsonField<AmountUnreconciledDirection> = JsonMissing.of()
                ...
                internal fun from(expectedPaymentCreateRequest: ExpectedPaymentCreateRequest) =
                    apply {
                        ...
                        amountReconciled = expectedPaymentCreateRequest.amountReconciled
                        amountReconciledDirection = expectedPaymentCreateRequest.amountReconciledDirection
                        amountUnreconciled = expectedPaymentCreateRequest.amountUnreconciled
                        amountUnreconciledDirection = expectedPaymentCreateRequest.amountUnreconciledDirection
                        ...
                        reconciliationRuleVariables = expectedPaymentCreateRequest.reconciliationRuleVariables.map { it.toMutableList() }
                        ...
                        additionalProperties = expectedPaymentCreateRequest.additionalProperties.toMutableMap()
                    }

                /** The lowest amount this expected payment may be equal to. Value in specified currency's smallest unit. e.g. $10 would be represented as 1000. */
                fun amountLowerBound(amountLowerBound: Long?) = amountLowerBound(JsonField.ofNullable(amountLowerBound))
                 ...
                 *
                 * You should usually call [Builder.amountLowerBound] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun amountLowerBound(amountLowerBound: JsonField<Long>) =
                    apply {
                        this.amountLowerBound = amountLowerBound
                    }

                /** The amount reconciled for this expected payment. Value in specified currency's smallest unit. e.g. $10 would be represented as 1000. */
                fun amountReconciled(amountReconciled: Long?) = amountReconciled(JsonField.ofNullable(amountReconciled))
                 ...
                 *
                 * You should usually call [Builder.amountReconciled] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun amountReconciled(amountReconciled: JsonField<Long>) =
                    apply {
                        this.amountReconciled = amountReconciled
                    }

                /** One of credit or debit. Indicates whether amount_reconciled is a credit or debit amount. */
                fun amountReconciledDirection(amountReconciledDirection: AmountReconciledDirection?) = amountReconciledDirection(JsonField.ofNullable(amountReconciledDirection))

                /**
                 * Sets [Builder.amountReconciledDirection] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.amountReconciledDirection] with a well-typed [AmountReconciledDirection] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun amountReconciledDirection(amountReconciledDirection: JsonField<AmountReconciledDirection>) =
                    apply {
                        this.amountReconciledDirection = amountReconciledDirection
                    }

                /** The amount that remains unreconciled for this expected payment. Value in specified currency's smallest unit. e.g. $10 would be represented as 1000. */
                fun amountUnreconciled(amountUnreconciled: Long?) = amountUnreconciled(JsonField.ofNullable(amountUnreconciled))
                 ...
                 * This unboxed primitive overload exists for backwards compatibility.
                 */
                fun amountUnreconciled(amountUnreconciled: Long) = amountUnreconciled(amountUnreconciled as Long?)

                /**
                 * Sets [Builder.amountUnreconciled] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.amountUnreconciled] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun amountUnreconciled(amountUnreconciled: JsonField<Long>) =
                    apply {
                        this.amountUnreconciled = amountUnreconciled
                    }

                /** One of credit or debit. Indicates whether amount_unreconciled is a credit or debit amount. */
                fun amountUnreconciledDirection(amountUnreconciledDirection: AmountUnreconciledDirection?) = amountUnreconciledDirection(JsonField.ofNullable(amountUnreconciledDirection))

                /**
                 * Sets [Builder.amountUnreconciledDirection] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.amountUnreconciledDirection] with a well-typed [AmountUnreconciledDirection] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun amountUnreconciledDirection(amountUnreconciledDirection: JsonField<AmountUnreconciledDirection>) =
                    apply {
                        this.amountUnreconciledDirection = amountUnreconciledDirection
                    }

                /** The highest amount this expected payment may be equal to. Value in specified currency's smallest unit. e.g. $10 would be represented as 1000. */
                fun amountUpperBound(amountUpperBound: Long?) = amountUpperBound(JsonField.ofNullable(amountUpperBound))
                 ...
                 *
                 * You should usually call [Builder.amountUpperBound] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun amountUpperBound(amountUpperBound: JsonField<Long>) =
                    apply {
                        this.amountUpperBound = amountUpperBound
                    }

                /** The ID of the counterparty you expect for this payment. */
                fun counterpartyId(counterpartyId: String?) = counterpartyId(JsonField.ofNullable(counterpartyId))
                ...
                /** The earliest date the payment may come in. Format: yyyy-mm-dd */
                fun dateLowerBound(dateLowerBound: LocalDate?) = dateLowerBound(JsonField.ofNullable(dateLowerBound))

                /**
                 * Sets [Builder.dateLowerBound] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.dateLowerBound] with a well-typed [LocalDate] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun dateLowerBound(dateLowerBound: JsonField<LocalDate>) =
                    apply {
                        this.dateLowerBound = dateLowerBound
                    }

                /** The latest date the payment may come in. Format: yyyy-mm-dd */
                fun dateUpperBound(dateUpperBound: LocalDate?) = dateUpperBound(JsonField.ofNullable(dateUpperBound))

                /**
                 * Sets [Builder.dateUpperBound] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.dateUpperBound] with a well-typed [LocalDate] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun dateUpperBound(dateUpperBound: JsonField<LocalDate>) =
                    apply {
                ...
                /** The ID of the Internal Account for the expected payment. */
                fun internalAccountId(internalAccountId: String?) = internalAccountId(JsonField.ofNullable(internalAccountId))
                ...
                /** The reconciliation filters you have for this payment. */
                fun reconciliationFilters(reconciliationFilters: JsonValue) =
                    apply {
                        this.reconciliationFilters = reconciliationFilters
                    }

                /** The reconciliation groups you have for this payment. */
                fun reconciliationGroups(reconciliationGroups: JsonValue) =
                    apply {
                        this.reconciliationGroups = reconciliationGroups
                    }

                /** An array of reconciliation rule variables for this payment. */
                fun reconciliationRuleVariables(reconciliationRuleVariables: List<ReconciliationRule>?) = reconciliationRuleVariables(JsonField.ofNullable(reconciliationRuleVariables))

                /**
                 * Sets [Builder.reconciliationRuleVariables] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.reconciliationRuleVariables] with a well-typed `List<ReconciliationRule>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun reconciliationRuleVariables(reconciliationRuleVariables: JsonField<List<ReconciliationRule>>) =
                    apply {
                        this.reconciliationRuleVariables = reconciliationRuleVariables.map { it.toMutableList() }
                    }
                ...
                fun addReconciliationRuleVariable(reconciliationRuleVariable: ReconciliationRule) =
                    apply {
                        reconciliationRuleVariables = (reconciliationRuleVariables ?: JsonField.of(mutableListOf())).also {
                 ...
                 * Sets [Builder.type] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.type] with a well-typed [ExpectedPaymentType] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun type(type: JsonField<ExpectedPaymentType>) =
                    apply {
                        this.type = type
                    }
             ...
             *   expected type.
             */
            fun validate(): ExpectedPaymentCreateRequest =
                apply {
                    if (validated) {
                      return@apply
                    }
             ...
             * Used for best match union deserialization.
             */
            internal fun validity(): Int = (if (amountLowerBound.asKnown() == null) 0 else 1) + (if (amountReconciled.asKnown() == null) 0 else 1) + (amountReconciledDirection.asKnown()?.validity() ?: 0) + (if (amountUnreconciled.asKnown() == null) 0 else 1) + (amountUnreconciledDirection.asKnown()?.validity() ?: 0) + (if (amountUpperBound.asKnown() == null) 0 else 1) + (if (counterpartyId.asKnown() == null) 0 else 1) + (currency.asKnown()?.validity() ?: 0) + (if (dateLowerBound.asKnown() == null) 0 else 1) + (if (dateUpperBound.asKnown() == null) 0 else 1) + (if (description.asKnown() == null) 0 else 1) + (direction.asKnown()?.validity() ?: 0) + (if (externalId.asKnown() == null) 0 else 1) + (if (internalAccountId.asKnown() == null) 0 else 1) + (ledgerTransaction.asKnown()?.validity() ?: 0) + (if (ledgerTransactionId.asKnown() == null) 0 else 1) + (lineItems.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (metadata.asKnown()?.validity() ?: 0) + (reconciliationRuleVariables.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (if (remittanceInformation.asKnown() == null) 0 else 1) + (if (statementDescriptor.asKnown() == null) 0 else 1) + (type.asKnown()?.validity() ?: 0)

            /** One of credit or debit. Indicates whether amount_reconciled is a credit or debit amount. */
            class AmountReconciledDirection @JsonCreator private constructor(
                private val value: JsonField<String>,
                ...
                /**
                 * An enum containing [AmountReconciledDirection]'s known values, as well as an [_UNKNOWN] member.
                 *
                 * An instance of [AmountReconciledDirection] can contain an unknown value in a couple of cases:
                 *
                 * - It was deserialized from data that doesn't match any known member. For example, if the SDK is on
                 *   an older version than the API, then the API may respond with new members that the SDK is unaware
                 *   of.
                ...
                enum class Value {
                    CREDIT,
                    DEBIT,
                    /** An enum member indicating that [AmountReconciledDirection] was instantiated with an unknown value. */
                    _UNKNOWN,
                }
                ...
                fun known(): Known =
                    when (this) {
                        CREDIT -> Known.CREDIT
                        DEBIT -> Known.DEBIT
                        else -> throw ModernTreasuryInvalidDataException("Unknown AmountReconciledDirection: $value")
                    }
                 ...
                 *   expected type.
                 */
                fun validate(): AmountReconciledDirection =
                    apply {
                        if (validated) {
                          return@apply
                        }
            ...
            /** One of credit or debit. Indicates whether amount_unreconciled is a credit or debit amount. */
            class AmountUnreconciledDirection @JsonCreator private constructor(
                private val value: JsonField<String>,
                ...
                /**
                 * An enum containing [AmountUnreconciledDirection]'s known values, as well as an [_UNKNOWN] member.
                 *
                 * An instance of [AmountUnreconciledDirection] can contain an unknown value in a couple of cases:
                 *
                 * - It was deserialized from data that doesn't match any known member. For example, if the SDK is on
                 *   an older version than the API, then the API may respond with new members that the SDK is unaware
                 *   of.
                ...
                enum class Value {
                    CREDIT,
                    DEBIT,
                    /** An enum member indicating that [AmountUnreconciledDirection] was instantiated with an unknown value. */
                    _UNKNOWN,
                }
                ...
                fun known(): Known =
                    when (this) {
                        CREDIT -> Known.CREDIT
                        DEBIT -> Known.DEBIT
                        else -> throw ModernTreasuryInvalidDataException("Unknown AmountUnreconciledDirection: $value")
                    }
                 ...
                 *   expected type.
                 */
                fun validate(): AmountUnreconciledDirection =
                    apply {
                        if (validated) {
                          return@apply
                        }
        ...
        class Id @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            class Builder internal constructor() {
                ...
                fun build(): Id =
                    Id(
                      id, additionalProperties.toMutableMap()
                    )
            }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is Id && id == other.id && additionalProperties == other.additionalProperties
            }
        ...
        class PaymentOrderUpdateRequestWithId @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val id: JsonField<String>,
            private val accounting: JsonField<Accounting>,
            private val accountingCategoryId: JsonField<String>,
            private val accountingLedgerClassId: JsonField<String>,
            ...
            companion object {
                ...
                /** Returns a mutable builder for constructing an instance of [PaymentOrderUpdateRequestWithId]. */
                fun builder() = Builder()
            }
            ...
            class Builder internal constructor() {
                ...
                internal fun from(paymentOrderUpdateRequestWithId: PaymentOrderUpdateRequestWithId) =
                    apply {
                        ...
                        accountingLedgerClassId = paymentOrderUpdateRequestWithId.accountingLedgerClassId
                        ...
                        externalId = paymentOrderUpdateRequestWithId.externalId
                        fallbackType = paymentOrderUpdateRequestWithId.fallbackType
                        foreignExchangeContract = paymentOrderUpdateRequestWithId.foreignExchangeContract
                        foreignExchangeIndicator = paymentOrderUpdateRequestWithId.foreignExchangeIndicator
                        ...
                        ultimateOriginatingPartyIdentifier = paymentOrderUpdateRequestWithId.ultimateOriginatingPartyIdentifier
                        ultimateOriginatingPartyName = paymentOrderUpdateRequestWithId.ultimateOriginatingPartyName
                        ultimateReceivingPartyIdentifier = paymentOrderUpdateRequestWithId.ultimateReceivingPartyIdentifier
                        ultimateReceivingPartyName = paymentOrderUpdateRequestWithId.ultimateReceivingPartyName
                        additionalProperties = paymentOrderUpdateRequestWithId.additionalProperties.toMutableMap()
                    }
             ...
             *   expected type.
             */
            fun validate(): PaymentOrderUpdateRequestWithId =
                apply {
                    if (validated) {
                      return@apply
                    }
             ...
             * Used for best match union deserialization.
             */
            internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (accounting.asKnown()?.validity() ?: 0) + (if (accountingCategoryId.asKnown() == null) 0 else 1) + (if (accountingLedgerClassId.asKnown() == null) 0 else 1) + (if (amount.asKnown() == null) 0 else 1) + (chargeBearer.asKnown()?.validity() ?: 0) + (if (counterpartyId.asKnown() == null) 0 else 1) + (currency.asKnown()?.validity() ?: 0) + (if (description.asKnown() == null) 0 else 1) + (direction.asKnown()?.validity() ?: 0) + (if (effectiveDate.asKnown() == null) 0 else 1) + (if (expiresAt.asKnown() == null) 0 else 1) + (if (externalId.asKnown() == null) 0 else 1) + (fallbackType.asKnown()?.validity() ?: 0) + (if (foreignExchangeContract.asKnown() == null) 0 else 1) + (foreignExchangeIndicator.asKnown()?.validity() ?: 0) + (lineItems.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (metadata.asKnown()?.validity() ?: 0) + (if (nsfProtected.asKnown() == null) 0 else 1) + (if (originatingAccountId.asKnown() == null) 0 else 1) + (if (originatingPartyName.asKnown() == null) 0 else 1) + (priority.asKnown()?.validity() ?: 0) + (if (processAfter.asKnown() == null) 0 else 1) + (if (purpose.asKnown() == null) 0 else 1) + (receivingAccount.asKnown()?.validity() ?: 0) + (if (receivingAccountId.asKnown() == null) 0 else 1) + (reconciliationStatus.asKnown()?.validity() ?: 0) + (if (remittanceInformation.asKnown() == null) 0 else 1) + (if (sendRemittanceAdvice.asKnown() == null) 0 else 1) + (if (statementDescriptor.asKnown() == null) 0 else 1) + (status.asKnown()?.validity() ?: 0) + (subtype.asKnown()?.validity() ?: 0) + (type.asKnown()?.validity() ?: 0) + (if (ultimateOriginatingPartyIdentifier.asKnown() == null) 0 else 1) + (if (ultimateOriginatingPartyName.asKnown() == null) 0 else 1) + (if (ultimateReceivingPartyIdentifier.asKnown() == null) 0 else 1) + (if (ultimateReceivingPartyName.asKnown() == null) 0 else 1)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is PaymentOrderUpdateRequestWithId && id == other.id && accounting == other.accounting && accountingCategoryId == other.accountingCategoryId && accountingLedgerClassId == other.accountingLedgerClassId && amount == other.amount && chargeBearer == other.chargeBearer && counterpartyId == other.counterpartyId && currency == other.currency && description == other.description && direction == other.direction && effectiveDate == other.effectiveDate && expiresAt == other.expiresAt && externalId == other.externalId && fallbackType == other.fallbackType && foreignExchangeContract == other.foreignExchangeContract && foreignExchangeIndicator == other.foreignExchangeIndicator && lineItems == other.lineItems && metadata == other.metadata && nsfProtected == other.nsfProtected && originatingAccountId == other.originatingAccountId && originatingPartyName == other.originatingPartyName && priority == other.priority && processAfter == other.processAfter && purpose == other.purpose && receivingAccount == other.receivingAccount && receivingAccountId == other.receivingAccountId && reconciliationStatus == other.reconciliationStatus && remittanceInformation == other.remittanceInformation && sendRemittanceAdvice == other.sendRemittanceAdvice && statementDescriptor == other.statementDescriptor && status == other.status && subtype == other.subtype && type == other.type && ultimateOriginatingPartyIdentifier == other.ultimateOriginatingPartyIdentifier && ultimateOriginatingPartyName == other.ultimateOriginatingPartyName && ultimateReceivingPartyIdentifier == other.ultimateReceivingPartyIdentifier && ultimateReceivingPartyName == other.ultimateReceivingPartyName && additionalProperties == other.additionalProperties
            }

            private val hashCode: Int by lazy { Objects.hash(id, accounting, accountingCategoryId, accountingLedgerClassId, amount, chargeBearer, counterpartyId, currency, description, direction, effectiveDate, expiresAt, externalId, fallbackType, foreignExchangeContract, foreignExchangeIndicator, lineItems, metadata, nsfProtected, originatingAccountId, originatingPartyName, priority, processAfter, purpose, receivingAccount, receivingAccountId, reconciliationStatus, remittanceInformation, sendRemittanceAdvice, statementDescriptor, status, subtype, type, ultimateOriginatingPartyIdentifier, ultimateOriginatingPartyName, ultimateReceivingPartyIdentifier, ultimateReceivingPartyName, additionalProperties) }

            override fun hashCode(): Int = hashCode

            override fun toString() = "PaymentOrderUpdateRequestWithId{id=$id, accounting=$accounting, accountingCategoryId=$accountingCategoryId, accountingLedgerClassId=$accountingLedgerClassId, amount=$amount, chargeBearer=$chargeBearer, counterpartyId=$counterpartyId, currency=$currency, description=$description, direction=$direction, effectiveDate=$effectiveDate, expiresAt=$expiresAt, externalId=$externalId, fallbackType=$fallbackType, foreignExchangeContract=$foreignExchangeContract, foreignExchangeIndicator=$foreignExchangeIndicator, lineItems=$lineItems, metadata=$metadata, nsfProtected=$nsfProtected, originatingAccountId=$originatingAccountId, originatingPartyName=$originatingPartyName, priority=$priority, processAfter=$processAfter, purpose=$purpose, receivingAccount=$receivingAccount, receivingAccountId=$receivingAccountId, reconciliationStatus=$reconciliationStatus, remittanceInformation=$remittanceInformation, sendRemittanceAdvice=$sendRemittanceAdvice, statementDescriptor=$statementDescriptor, status=$status, subtype=$subtype, type=$type, ultimateOriginatingPartyIdentifier=$ultimateOriginatingPartyIdentifier, ultimateOriginatingPartyName=$ultimateOriginatingPartyName, ultimateReceivingPartyIdentifier=$ultimateReceivingPartyIdentifier, ultimateReceivingPartyName=$ultimateReceivingPartyName, additionalProperties=$additionalProperties}"
        }

        class ExpectedPaymentUpdateRequestWithId @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val id: JsonField<String>,
            private val amountLowerBound: JsonField<Long>,
            private val amountReconciled: JsonField<Long>,
            private val amountReconciledDirection: JsonField<AmountReconciledDirection>,
            ...
            companion object {
                ...
                /** Returns a mutable builder for constructing an instance of [ExpectedPaymentUpdateRequestWithId]. */
                fun builder() = Builder()
            }
            ...
            class Builder internal constructor() {
                ...
                internal fun from(expectedPaymentUpdateRequestWithId: ExpectedPaymentUpdateRequestWithId) =
                    apply {
                        ...
                        amountReconciledDirection = expectedPaymentUpdateRequestWithId.amountReconciledDirection
                        amountUnreconciled = expectedPaymentUpdateRequestWithId.amountUnreconciled
                        amountUnreconciledDirection = expectedPaymentUpdateRequestWithId.amountUnreconciledDirection
                        ...
                        reconciliationRuleVariables = expectedPaymentUpdateRequestWithId.reconciliationRuleVariables.map { it.toMutableList() }
                        ...
                        additionalProperties = expectedPaymentUpdateRequestWithId.additionalProperties.toMutableMap()
                    }
             ...
             *   expected type.
             */
            fun validate(): ExpectedPaymentUpdateRequestWithId =
                apply {
                    if (validated) {
                      return@apply
                    }
             ...
             * Used for best match union deserialization.
             */
            internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (if (amountLowerBound.asKnown() == null) 0 else 1) + (if (amountReconciled.asKnown() == null) 0 else 1) + (amountReconciledDirection.asKnown()?.validity() ?: 0) + (if (amountUnreconciled.asKnown() == null) 0 else 1) + (amountUnreconciledDirection.asKnown()?.validity() ?: 0) + (if (amountUpperBound.asKnown() == null) 0 else 1) + (if (counterpartyId.asKnown() == null) 0 else 1) + (currency.asKnown()?.validity() ?: 0) + (if (dateLowerBound.asKnown() == null) 0 else 1) + (if (dateUpperBound.asKnown() == null) 0 else 1) + (if (description.asKnown() == null) 0 else 1) + (direction.asKnown()?.validity() ?: 0) + (if (externalId.asKnown() == null) 0 else 1) + (if (internalAccountId.asKnown() == null) 0 else 1) + (metadata.asKnown()?.validity() ?: 0) + (reconciliationRuleVariables.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (if (remittanceInformation.asKnown() == null) 0 else 1) + (if (statementDescriptor.asKnown() == null) 0 else 1) + (status.asKnown()?.validity() ?: 0) + (type.asKnown()?.validity() ?: 0)
        ...
        class TransactionUpdateRequestWithId @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            companion object {
                ...
                /** Returns a mutable builder for constructing an instance of [TransactionUpdateRequestWithId]. */
                fun builder() = Builder()
            }
            ...
            class Builder internal constructor() {
                ...
                internal fun from(transactionUpdateRequestWithId: TransactionUpdateRequestWithId) =
                    apply {
                        ...
                        additionalProperties = transactionUpdateRequestWithId.additionalProperties.toMutableMap()
                    }
             ...
             *   expected type.
             */
            fun validate(): TransactionUpdateRequestWithId =
                apply {
                    if (validated) {
                      return@apply
                    }
             ...
             * Used for best match union deserialization.
             */
            internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (metadata.asKnown()?.validity() ?: 0)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is TransactionUpdateRequestWithId && id == other.id && metadata == other.metadata && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "TransactionUpdateRequestWithId{id=$id, metadata=$metadata, additionalProperties=$additionalProperties}"
        }

        class LedgerTransactionUpdateRequestWithId @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val id: JsonField<String>,
            private val description: JsonField<String>,
             ...
             * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun ledgerEntries(): List<LedgerEntryCreateRequest>? = ledgerEntries.getNullable("ledger_entries")
            ...
            companion object {
                ...
                /** Returns a mutable builder for constructing an instance of [LedgerTransactionUpdateRequestWithId]. */
                fun builder() = Builder()
            }
            ...
            class Builder internal constructor() {
                ...
                internal fun from(ledgerTransactionUpdateRequestWithId: LedgerTransactionUpdateRequestWithId) =
                    apply {
                        ...
                        externalId = ledgerTransactionUpdateRequestWithId.externalId
                        ledgerEntries = ledgerTransactionUpdateRequestWithId.ledgerEntries.map { it.toMutableList() }
                        ...
                        additionalProperties = ledgerTransactionUpdateRequestWithId.additionalProperties.toMutableMap()
                    }
             ...
             *   expected type.
             */
            fun validate(): LedgerTransactionUpdateRequestWithId =
                apply {
                    if (validated) {
                      return@apply
                    }
             ...
             * Used for best match union deserialization.
             */
            internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (if (description.asKnown() == null) 0 else 1) + (if (effectiveAt.asKnown() == null) 0 else 1) + (if (externalId.asKnown() == null) 0 else 1) + (ledgerEntries.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (if (ledgerableId.asKnown() == null) 0 else 1) + (ledgerableType.asKnown()?.validity() ?: 0) + (metadata.asKnown()?.validity() ?: 0) + (status.asKnown()?.validity() ?: 0)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is LedgerTransactionUpdateRequestWithId && id == other.id && description == other.description && effectiveAt == other.effectiveAt && externalId == other.externalId && ledgerEntries == other.ledgerEntries && ledgerableId == other.ledgerableId && ledgerableType == other.ledgerableType && metadata == other.metadata && status == other.status && additionalProperties == other.additionalProperties
            }

            private val hashCode: Int by lazy { Objects.hash(id, description, effectiveAt, externalId, ledgerEntries, ledgerableId, ledgerableType, metadata, status, additionalProperties) }

            override fun hashCode(): Int = hashCode

            override fun toString() = "LedgerTransactionUpdateRequestWithId{id=$id, description=$description, effectiveAt=$effectiveAt, externalId=$externalId, ledgerEntries=$ledgerEntries, ledgerableId=$ledgerableId, ledgerableType=$ledgerableType, metadata=$metadata, status=$status, additionalProperties=$additionalProperties}"
        }

        class LedgerAccountUpdateRequestWithId @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val id: JsonField<String>,
            private val description: JsonField<String>,
            private val externalId: JsonField<String>,
            private val metadata: JsonField<Metadata>,
            ...
            companion object {
                ...
                /** Returns a mutable builder for constructing an instance of [LedgerAccountUpdateRequestWithId]. */
                fun builder() = Builder()
            }

            /** A builder for [LedgerAccountUpdateRequestWithId]. */
            class Builder internal constructor() {
                ...
                internal fun from(ledgerAccountUpdateRequestWithId: LedgerAccountUpdateRequestWithId) =
                    apply {
                        id = ledgerAccountUpdateRequestWithId.id
                        description = ledgerAccountUpdateRequestWithId.description
                        externalId = ledgerAccountUpdateRequestWithId.externalId
                        metadata = ledgerAccountUpdateRequestWithId.metadata
                        name = ledgerAccountUpdateRequestWithId.name
                        additionalProperties = ledgerAccountUpdateRequestWithId.additionalProperties.toMutableMap()
                    }
                ...
                /**
                 * Returns an immutable instance of [LedgerAccountUpdateRequestWithId].
                 *
                 * Further updates to this [Builder] will not mutate the returned instance.
                 */
                fun build(): LedgerAccountUpdateRequestWithId =
                    LedgerAccountUpdateRequestWithId(
                      id,
                      description,
                      externalId,
             ...
             *   expected type.
             */
            fun validate(): LedgerAccountUpdateRequestWithId =
                apply {
                    if (validated) {
                      return@apply
                    }
             ...
             * Used for best match union deserialization.
             */
            internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (if (description.asKnown() == null) 0 else 1) + (if (externalId.asKnown() == null) 0 else 1) + (metadata.asKnown()?.validity() ?: 0) + (if (name.asKnown() == null) 0 else 1)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is LedgerAccountUpdateRequestWithId && id == other.id && description == other.description && externalId == other.externalId && metadata == other.metadata && name == other.name && additionalProperties == other.additionalProperties
            }

            private val hashCode: Int by lazy { Objects.hash(id, description, externalId, metadata, name, additionalProperties) }

            override fun hashCode(): Int = hashCode

            override fun toString() = "LedgerAccountUpdateRequestWithId{id=$id, description=$description, externalId=$externalId, metadata=$metadata, name=$name, additionalProperties=$additionalProperties}"
        }
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is BulkRequestCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "BulkRequestCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
