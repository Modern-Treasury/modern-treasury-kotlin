...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is VirtualAccountListPageAsync && this.virtualAccountsService == other.virtualAccountsService && this.params == other.params && this.response == other.response /* spotless:on */
    }
    ...
    constructor(
        ...
        override fun toString() =
            "VirtualAccountListPageAsync.Response{items=$items, additionalProperties=$additionalProperties}"
