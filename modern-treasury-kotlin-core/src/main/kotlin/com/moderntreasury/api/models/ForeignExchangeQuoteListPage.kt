...
class ForeignExchangeQuoteListPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(foreignExchangeQuoteListPage: ForeignExchangeQuoteListPage) =
            apply {
        ...
        fun service(service: ForeignExchangeQuoteService) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ForeignExchangeQuoteListPage && service == other.service && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, params, headers, items)

    override fun toString() = "ForeignExchangeQuoteListPage{service=$service, params=$params, headers=$headers, items=$items}"
}
