...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ExpectedPaymentListPage && this.expectedPaymentsService == other.expectedPaymentsService && this.params == other.params && this.response == other.response /* spotless:on */
    }
