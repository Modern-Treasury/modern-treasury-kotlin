...
class ExpectedPaymentListPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(expectedPaymentListPage: ExpectedPaymentListPage) =
            apply {
        ...
        fun service(service: ExpectedPaymentService) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ExpectedPaymentListPage && service == other.service && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, params, headers, items)

    override fun toString() = "ExpectedPaymentListPage{service=$service, params=$params, headers=$headers, items=$items}"
}
