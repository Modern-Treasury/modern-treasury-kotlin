...
class TransactionListPageAsync private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(transactionListPageAsync: TransactionListPageAsync) =
            apply {
        ...
        fun service(service: TransactionServiceAsync) =
            apply {
                this.service = service
            }

        /** The parameters that were used to request this page. */
        fun params(params: TransactionListParams) =
            apply {
                this.params = params
            }
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<Transaction>) =
            apply {
                this.items = items
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is TransactionListPageAsync && service == other.service && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, params, headers, items)

    override fun toString() = "TransactionListPageAsync{service=$service, params=$params, headers=$headers, items=$items}"
}
