...
class LedgerEntryUpdateParams private constructor(
    ...
    /** A builder for [LedgerEntryUpdateParams]. */
    class Builder internal constructor() {

        private var id: String? = null
        private var body: LedgerEntryUpdateRequest.Builder = LedgerEntryUpdateRequest.builder()
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        internal fun from(ledgerEntryUpdateParams: LedgerEntryUpdateParams) =
            apply {
                id = ledgerEntryUpdateParams.id
                body = ledgerEntryUpdateParams.body.toBuilder()
                additionalHeaders = ledgerEntryUpdateParams.additionalHeaders.toBuilder()
         ...
         * - [metadata]
         */
        fun body(body: LedgerEntryUpdateRequest) =
            apply {
    ...
    fun _body(): LedgerEntryUpdateRequest = body
    ...
    class LedgerEntryUpdateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        companion object {
            ...
            /** Returns a mutable builder for constructing an instance of [LedgerEntryUpdateRequest]. */
            fun builder() = Builder()
        }

        /** A builder for [LedgerEntryUpdateRequest]. */
        class Builder internal constructor() {

            private var metadata: JsonField<Metadata> = JsonMissing.of()
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

            internal fun from(ledgerEntryUpdateRequest: LedgerEntryUpdateRequest) =
                apply {
                    metadata = ledgerEntryUpdateRequest.metadata
                    additionalProperties = ledgerEntryUpdateRequest.additionalProperties.toMutableMap()
                }
         ...
         *   expected type.
         */
        fun validate(): LedgerEntryUpdateRequest =
            apply {
                if (validated) {
                  return@apply
                }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is LedgerEntryUpdateRequest && metadata == other.metadata && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "LedgerEntryUpdateRequest{metadata=$metadata, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LedgerEntryUpdateParams && id == other.id && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(id, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "LedgerEntryUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
