...
class CounterpartyListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(counterpartyListParams: CounterpartyListParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CounterpartyListParams && afterCursor == other.afterCursor && createdAtLowerBound == other.createdAtLowerBound && createdAtUpperBound == other.createdAtUpperBound && email == other.email && externalId == other.externalId && legalEntityId == other.legalEntityId && metadata == other.metadata && name == other.name && perPage == other.perPage && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(afterCursor, createdAtLowerBound, createdAtUpperBound, email, externalId, legalEntityId, metadata, name, perPage, additionalHeaders, additionalQueryParams)

    override fun toString() = "CounterpartyListParams{afterCursor=$afterCursor, createdAtLowerBound=$createdAtLowerBound, createdAtUpperBound=$createdAtUpperBound, email=$email, externalId=$externalId, legalEntityId=$legalEntityId, metadata=$metadata, name=$name, perPage=$perPage, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
