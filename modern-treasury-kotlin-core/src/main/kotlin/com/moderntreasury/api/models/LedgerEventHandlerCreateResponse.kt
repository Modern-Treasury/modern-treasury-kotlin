...
@JsonDeserialize(builder = LedgerEventHandlerCreateResponse.Builder::class)
@NoAutoDetect
class LedgerEventHandlerCreateResponse
private constructor(
    ...
    fun validate(): LedgerEventHandlerCreateResponse = apply {
        if (!validated) {
            id()
            object_()
            liveMode()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LedgerEventHandlerCreateResponse &&
            this.id == other.id &&
    ...
    class Builder {
        ...
        internal fun from(ledgerEventHandlerCreateResponse: LedgerEventHandlerCreateResponse) =
            apply {
                this.id = ledgerEventHandlerCreateResponse.id
                this.object_ = ledgerEventHandlerCreateResponse.object_
                this.liveMode = ledgerEventHandlerCreateResponse.liveMode
                this.createdAt = ledgerEventHandlerCreateResponse.createdAt
                this.updatedAt = ledgerEventHandlerCreateResponse.updatedAt
                this.discardedAt = ledgerEventHandlerCreateResponse.discardedAt
                this.name = ledgerEventHandlerCreateResponse.name
                this.description = ledgerEventHandlerCreateResponse.description
                this.ledgerTransactionTemplate =
                    ledgerEventHandlerCreateResponse.ledgerTransactionTemplate
                this.conditions = ledgerEventHandlerCreateResponse.conditions
                this.metadata = ledgerEventHandlerCreateResponse.metadata
                additionalProperties(ledgerEventHandlerCreateResponse.additionalProperties)
            }
        ...
        fun build(): LedgerEventHandlerCreateResponse =
            LedgerEventHandlerCreateResponse(
                id,
                object_,
                liveMode,
