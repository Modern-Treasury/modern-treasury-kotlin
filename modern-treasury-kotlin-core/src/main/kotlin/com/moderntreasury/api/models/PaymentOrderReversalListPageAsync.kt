...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PaymentOrderReversalListPageAsync && this.reversalsService == other.reversalsService && this.params == other.params && this.response == other.response /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(reversalsService, params, response) /* spotless:on */
    }
    ...
    constructor(
        ...
        override fun toString() =
            "PaymentOrderReversalListPageAsync.Response{items=$items, additionalProperties=$additionalProperties}"
