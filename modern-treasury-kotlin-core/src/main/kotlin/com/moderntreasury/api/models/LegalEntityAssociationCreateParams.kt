...
constructor(
    ...
    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(parentLegalEntityId, relationshipTypes, childLegalEntity, childLegalEntityId, ownershipPercentage, title, additionalQueryParams, additionalHeaders, additionalBodyProperties) /* spotless:on */
    }
