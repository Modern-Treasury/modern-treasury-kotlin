...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AccountDetailCreate].
         *
    ...
    /** A builder for [AccountDetailCreate]. */
    class Builder internal constructor() {
        ...
        internal fun from(accountDetailCreate: AccountDetailCreate) = apply {
            accountNumber = accountDetailCreate.accountNumber
            accountNumberType = accountDetailCreate.accountNumberType
            additionalProperties = accountDetailCreate.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AccountDetailCreate].
         *
    ...
    fun validate(): AccountDetailCreate = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AccountDetailCreate &&
    ...
    override fun toString() =
        "AccountDetailCreate{accountNumber=$accountNumber, accountNumberType=$accountNumberType, additionalProperties=$additionalProperties}"
}
