...
class LedgerTransactionVersion @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("archived_reason") @ExcludeMissing archivedReason: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("ledger_entries") @ExcludeMissing ledgerEntries: JsonField<List<LedgerEntryOfTransactionVersion>> = JsonMissing.of(),
        ...
        @JsonProperty("partially_posts_ledger_transaction_id") @ExcludeMissing partiallyPostsLedgerTransactionId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("posted_at") @ExcludeMissing postedAt: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("reversed_by_ledger_transaction_id") @ExcludeMissing reversedByLedgerTransactionId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("reverses_ledger_transaction_id") @ExcludeMissing reversesLedgerTransactionId: JsonField<String> = JsonMissing.of(),
     ...
     */
    fun archivedReason(): String? = archivedReason.getNullable("archived_reason")
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun ledgerEntries(): List<LedgerEntryOfTransactionVersion> = ledgerEntries.getRequired("ledger_entries")
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun partiallyPostsLedgerTransactionId(): String? = partiallyPostsLedgerTransactionId.getNullable("partially_posts_ledger_transaction_id")
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun reversedByLedgerTransactionId(): String? = reversedByLedgerTransactionId.getNullable("reversed_by_ledger_transaction_id")
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun reversesLedgerTransactionId(): String? = reversesLedgerTransactionId.getNullable("reverses_ledger_transaction_id")
     ...
     *
     * Unlike [partiallyPostsLedgerTransactionId], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [reversedByLedgerTransactionId], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [reversesLedgerTransactionId], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(ledgerTransactionVersion: LedgerTransactionVersion) =
            apply {
                ...
                partiallyPostsLedgerTransactionId = ledgerTransactionVersion.partiallyPostsLedgerTransactionId
        ...
        /** System-set reason why the ledger transaction was archived; currently only 'balance_lock_failure' for transactions that violated balance constraints. Only populated when archive_on_balance_lock_failure is true and a balance lock violation occurs, otherwise null. */
        fun archivedReason(archivedReason: String?) = archivedReason(JsonField.ofNullable(archivedReason))

        /**
         * Sets [Builder.archivedReason] to an arbitrary JSON value.
         *
         * You should usually call [Builder.archivedReason] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun archivedReason(archivedReason: JsonField<String>) =
            apply {
        ...
        /** An array of ledger entry objects. */
        fun ledgerEntries(ledgerEntries: List<LedgerEntryOfTransactionVersion>) = ledgerEntries(JsonField.of(ledgerEntries))

        /**
         * Sets [Builder.ledgerEntries] to an arbitrary JSON value.
         *
         * You should usually call [Builder.ledgerEntries] with a well-typed `List<LedgerEntryOfTransactionVersion>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ledgerEntries(ledgerEntries: JsonField<List<LedgerEntryOfTransactionVersion>>) =
            apply {
         ...
         */
        fun addLedgerEntry(ledgerEntry: LedgerEntryOfTransactionVersion) =
            apply {
         ...
         *
         * You should usually call [Builder.ledgerId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ledgerId(ledgerId: JsonField<String>) =
            apply {
        ...
        /** If the ledger transaction can be reconciled to another object in Modern Treasury, the type will be populated here, otherwise null. This can be one of payment_order, incoming_payment_detail, expected_payment, return, or reversal. */
        fun ledgerableType(ledgerableType: LedgerableType?) = ledgerableType(JsonField.ofNullable(ledgerableType))
        ...
        /** The ID of the ledger transaction that this ledger transaction partially posts. */
        fun partiallyPostsLedgerTransactionId(partiallyPostsLedgerTransactionId: String?) = partiallyPostsLedgerTransactionId(JsonField.ofNullable(partiallyPostsLedgerTransactionId))

        /**
         * Sets [Builder.partiallyPostsLedgerTransactionId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.partiallyPostsLedgerTransactionId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun partiallyPostsLedgerTransactionId(partiallyPostsLedgerTransactionId: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.postedAt] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun postedAt(postedAt: JsonField<OffsetDateTime>) =
            apply {
                this.postedAt = postedAt
            }

        /** The ID of the ledger transaction that reversed this ledger transaction. */
        fun reversedByLedgerTransactionId(reversedByLedgerTransactionId: String?) = reversedByLedgerTransactionId(JsonField.ofNullable(reversedByLedgerTransactionId))

        /**
         * Sets [Builder.reversedByLedgerTransactionId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.reversedByLedgerTransactionId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /** The ID of the original ledger transaction. that this ledger transaction reverses. */
        fun reversesLedgerTransactionId(reversesLedgerTransactionId: String?) = reversesLedgerTransactionId(JsonField.ofNullable(reversesLedgerTransactionId))

        /**
         * Sets [Builder.reversesLedgerTransactionId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.reversesLedgerTransactionId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun reversesLedgerTransactionId(reversesLedgerTransactionId: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.version] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        fun build(): LedgerTransactionVersion =
            LedgerTransactionVersion(
              ...
              checkRequired(
                "partiallyPostsLedgerTransactionId", partiallyPostsLedgerTransactionId
              ),
              checkRequired(
                "postedAt", postedAt
              ),
              checkRequired(
                "reversedByLedgerTransactionId", reversedByLedgerTransactionId
              ),
              checkRequired(
                "reversesLedgerTransactionId", reversesLedgerTransactionId
              ),
              checkRequired(
                "status", status
              ),
     ...
     *   expected type.
     */
    fun validate(): LedgerTransactionVersion =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (if (archivedReason.asKnown() == null) 0 else 1) + (if (createdAt.asKnown() == null) 0 else 1) + (if (description.asKnown() == null) 0 else 1) + (if (effectiveAt.asKnown() == null) 0 else 1) + (if (effectiveDate.asKnown() == null) 0 else 1) + (if (externalId.asKnown() == null) 0 else 1) + (ledgerEntries.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (if (ledgerId.asKnown() == null) 0 else 1) + (if (ledgerTransactionId.asKnown() == null) 0 else 1) + (if (ledgerableId.asKnown() == null) 0 else 1) + (ledgerableType.asKnown()?.validity() ?: 0) + (if (liveMode.asKnown() == null) 0 else 1) + (metadata.asKnown()?.validity() ?: 0) + (if (object_.asKnown() == null) 0 else 1) + (if (partiallyPostsLedgerTransactionId.asKnown() == null) 0 else 1) + (if (postedAt.asKnown() == null) 0 else 1) + (if (reversedByLedgerTransactionId.asKnown() == null) 0 else 1) + (if (reversesLedgerTransactionId.asKnown() == null) 0 else 1) + (status.asKnown()?.validity() ?: 0) + (if (version.asKnown() == null) 0 else 1)

    class LedgerEntryOfTransactionVersion @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        private val id: JsonField<String>,
        ...
        private constructor(
            ...
            @JsonProperty("effective_at") @ExcludeMissing effectiveAt: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("ledger_account_currency") @ExcludeMissing ledgerAccountCurrency: JsonField<String> = JsonMissing.of(),
            @JsonProperty("ledger_account_currency_exponent") @ExcludeMissing ledgerAccountCurrencyExponent: JsonField<Long> = JsonMissing.of(),
            @JsonProperty("ledger_account_id") @ExcludeMissing ledgerAccountId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("ledger_account_lock_version") @ExcludeMissing ledgerAccountLockVersion: JsonField<Long> = JsonMissing.of(),
            @JsonProperty("ledger_transaction_id") @ExcludeMissing ledgerTransactionId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("live_mode") @ExcludeMissing liveMode: JsonField<Boolean> = JsonMissing.of(),
            @JsonProperty("metadata") @ExcludeMissing metadata: JsonField<Metadata> = JsonMissing.of(),
            @JsonProperty("object") @ExcludeMissing object_: JsonField<String> = JsonMissing.of(),
            @JsonProperty("resulting_ledger_account_balances") @ExcludeMissing resultingLedgerAccountBalances: JsonField<LedgerBalances> = JsonMissing.of(),
            @JsonProperty("status") @ExcludeMissing status: JsonField<Status> = JsonMissing.of()
        ) : this(
          id,
          amount,
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun ledgerAccountCurrency(): String = ledgerAccountCurrency.getRequired("ledger_account_currency")
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun ledgerAccountCurrencyExponent(): Long = ledgerAccountCurrencyExponent.getRequired("ledger_account_currency_exponent")
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun ledgerAccountLockVersion(): Long? = ledgerAccountLockVersion.getNullable("ledger_account_lock_version")
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun resultingLedgerAccountBalances(): LedgerBalances? = resultingLedgerAccountBalances.getNullable("resulting_ledger_account_balances")
         ...
         *
         * Unlike [ledgerAccountCurrency], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [ledgerAccountCurrencyExponent], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [ledgerAccountLockVersion], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [resultingLedgerAccountBalances], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("resulting_ledger_account_balances")
        @ExcludeMissing
        fun _resultingLedgerAccountBalances(): JsonField<LedgerBalances> = resultingLedgerAccountBalances
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [LedgerEntryOfTransactionVersion].
             *
             * The following fields are required:
             *
             * ```kotlin
        ...
        class Builder internal constructor() {
            ...
            internal fun from(ledgerEntryOfTransactionVersion: LedgerEntryOfTransactionVersion) =
                apply {
                    ...
                    amountString = ledgerEntryOfTransactionVersion.amountString
                    ...
                    ledgerAccountCurrencyExponent = ledgerEntryOfTransactionVersion.ledgerAccountCurrencyExponent
                    ledgerAccountId = ledgerEntryOfTransactionVersion.ledgerAccountId
                    ledgerAccountLockVersion = ledgerEntryOfTransactionVersion.ledgerAccountLockVersion
                    ...
                    resultingLedgerAccountBalances = ledgerEntryOfTransactionVersion.resultingLedgerAccountBalances
                    status = ledgerEntryOfTransactionVersion.status
                    additionalProperties = ledgerEntryOfTransactionVersion.additionalProperties.toMutableMap()
                }
            ...
            /** The currency of the ledger account. */
            fun ledgerAccountCurrency(ledgerAccountCurrency: String) = ledgerAccountCurrency(JsonField.of(ledgerAccountCurrency))

            /**
             * Sets [Builder.ledgerAccountCurrency] to an arbitrary JSON value.
             *
             * You should usually call [Builder.ledgerAccountCurrency] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun ledgerAccountCurrency(ledgerAccountCurrency: JsonField<String>) =
                apply {
                    this.ledgerAccountCurrency = ledgerAccountCurrency
                }

            /** The currency exponent of the ledger account. */
            fun ledgerAccountCurrencyExponent(ledgerAccountCurrencyExponent: Long) = ledgerAccountCurrencyExponent(JsonField.of(ledgerAccountCurrencyExponent))

            /**
             * Sets [Builder.ledgerAccountCurrencyExponent] to an arbitrary JSON value.
             *
             * You should usually call [Builder.ledgerAccountCurrencyExponent] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /** The ledger account that this ledger entry is associated with. */
            fun ledgerAccountId(ledgerAccountId: String) = ledgerAccountId(JsonField.of(ledgerAccountId))

            /**
             * Sets [Builder.ledgerAccountId] to an arbitrary JSON value.
             *
             * You should usually call [Builder.ledgerAccountId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun ledgerAccountId(ledgerAccountId: JsonField<String>) =
                apply {
                    this.ledgerAccountId = ledgerAccountId
                }

            /** Lock version of the ledger account. This can be passed when creating a ledger transaction to only succeed if no ledger transactions have posted since the given version. See our post about Designing the Ledgers API with Optimistic Locking for more details. */
            fun ledgerAccountLockVersion(ledgerAccountLockVersion: Long?) = ledgerAccountLockVersion(JsonField.ofNullable(ledgerAccountLockVersion))
             ...
             */
            fun ledgerAccountLockVersion(ledgerAccountLockVersion: Long) = ledgerAccountLockVersion(ledgerAccountLockVersion as Long?)

            /**
             * Sets [Builder.ledgerAccountLockVersion] to an arbitrary JSON value.
             *
             * You should usually call [Builder.ledgerAccountLockVersion] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun ledgerAccountLockVersion(ledgerAccountLockVersion: JsonField<Long>) =
                apply {
            ...
            /** The pending, posted, and available balances for this ledger entry's ledger account. The posted balance is the sum of all posted entries on the account. The pending balance is the sum of all pending and posted entries on the account. The available balance is the posted incoming entries minus the sum of the pending and posted outgoing amounts. Please see https://docs.moderntreasury.com/docs/transaction-status-and-balances for more details. */
            fun resultingLedgerAccountBalances(resultingLedgerAccountBalances: LedgerBalances?) = resultingLedgerAccountBalances(JsonField.ofNullable(resultingLedgerAccountBalances))

            /**
             * Sets [Builder.resultingLedgerAccountBalances] to an arbitrary JSON value.
             *
             * You should usually call [Builder.resultingLedgerAccountBalances] with a well-typed [LedgerBalances] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun resultingLedgerAccountBalances(resultingLedgerAccountBalances: JsonField<LedgerBalances>) =
                apply {
                    this.resultingLedgerAccountBalances = resultingLedgerAccountBalances
                }
            ...
            fun build(): LedgerEntryOfTransactionVersion =
                LedgerEntryOfTransactionVersion(
                  ...
                  checkRequired(
                    "ledgerAccountCurrency", ledgerAccountCurrency
                  ),
                  checkRequired(
                    "ledgerAccountCurrencyExponent", ledgerAccountCurrencyExponent
                  ),
                  checkRequired(
                    "ledgerAccountId", ledgerAccountId
                  ),
                  checkRequired(
                    "ledgerAccountLockVersion", ledgerAccountLockVersion
                  ),
                  checkRequired(
                    "ledgerTransactionId", ledgerTransactionId
                  ),
                  ...
                  checkRequired(
                    "resultingLedgerAccountBalances", resultingLedgerAccountBalances
                  ),
                  checkRequired(
                    "status", status
                  ),
         ...
         *   expected type.
         */
        fun validate(): LedgerEntryOfTransactionVersion =
            apply {
                if (validated) {
                  return@apply
                }
         ...
         * Used for best match union deserialization.
         */
        internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (if (amount.asKnown() == null) 0 else 1) + (if (amountString.asKnown() == null) 0 else 1) + (if (createdAt.asKnown() == null) 0 else 1) + (direction.asKnown()?.validity() ?: 0) + (if (effectiveAt.asKnown() == null) 0 else 1) + (if (ledgerAccountCurrency.asKnown() == null) 0 else 1) + (if (ledgerAccountCurrencyExponent.asKnown() == null) 0 else 1) + (if (ledgerAccountId.asKnown() == null) 0 else 1) + (if (ledgerAccountLockVersion.asKnown() == null) 0 else 1) + (if (ledgerTransactionId.asKnown() == null) 0 else 1) + (if (liveMode.asKnown() == null) 0 else 1) + (metadata.asKnown()?.validity() ?: 0) + (if (object_.asKnown() == null) 0 else 1) + (resultingLedgerAccountBalances.asKnown()?.validity() ?: 0) + (status.asKnown()?.validity() ?: 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is LedgerEntryOfTransactionVersion && id == other.id && amount == other.amount && amountString == other.amountString && createdAt == other.createdAt && direction == other.direction && effectiveAt == other.effectiveAt && ledgerAccountCurrency == other.ledgerAccountCurrency && ledgerAccountCurrencyExponent == other.ledgerAccountCurrencyExponent && ledgerAccountId == other.ledgerAccountId && ledgerAccountLockVersion == other.ledgerAccountLockVersion && ledgerTransactionId == other.ledgerTransactionId && liveMode == other.liveMode && metadata == other.metadata && object_ == other.object_ && resultingLedgerAccountBalances == other.resultingLedgerAccountBalances && status == other.status && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(id, amount, amountString, createdAt, direction, effectiveAt, ledgerAccountCurrency, ledgerAccountCurrencyExponent, ledgerAccountId, ledgerAccountLockVersion, ledgerTransactionId, liveMode, metadata, object_, resultingLedgerAccountBalances, status, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "LedgerEntryOfTransactionVersion{id=$id, amount=$amount, amountString=$amountString, createdAt=$createdAt, direction=$direction, effectiveAt=$effectiveAt, ledgerAccountCurrency=$ledgerAccountCurrency, ledgerAccountCurrencyExponent=$ledgerAccountCurrencyExponent, ledgerAccountId=$ledgerAccountId, ledgerAccountLockVersion=$ledgerAccountLockVersion, ledgerTransactionId=$ledgerTransactionId, liveMode=$liveMode, metadata=$metadata, object_=$object_, resultingLedgerAccountBalances=$resultingLedgerAccountBalances, status=$status, additionalProperties=$additionalProperties}"
    }
