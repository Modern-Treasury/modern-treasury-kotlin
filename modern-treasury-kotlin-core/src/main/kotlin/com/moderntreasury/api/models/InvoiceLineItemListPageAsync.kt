...
class InvoiceLineItemListPageAsync private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(invoiceLineItemListPageAsync: InvoiceLineItemListPageAsync) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is InvoiceLineItemListPageAsync && service == other.service && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, params, headers, items)

    override fun toString() = "InvoiceLineItemListPageAsync{service=$service, params=$params, headers=$headers, items=$items}"
}
