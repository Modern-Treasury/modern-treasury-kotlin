...
class PaymentActionRetrieveResponse
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(paymentActionRetrieveResponse: PaymentActionRetrieveResponse) = apply {
    ...
    fun validate(): PaymentActionRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PaymentActionRetrieveResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "PaymentActionRetrieveResponse{id=$id, actionableId=$actionableId, actionableType=$actionableType, createdAt=$createdAt, details=$details, internalAccountId=$internalAccountId, liveMode=$liveMode, object_=$object_, status=$status, type=$type, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
