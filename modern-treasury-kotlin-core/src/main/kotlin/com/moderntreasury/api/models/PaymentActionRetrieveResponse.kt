...
class PaymentActionRetrieveResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("actionable_id") @ExcludeMissing actionableId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("actionable_type") @ExcludeMissing actionableType: JsonField<String> = JsonMissing.of(),
     ...
     * ```kotlin
     * val myObject: MyClass = paymentActionRetrieveResponse.details().convert(MyClass::class.java)
     * ```
     */
    @JsonProperty("details")
    @ExcludeMissing
    fun _details(): JsonValue = details
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PaymentActionRetrieveResponse].
         *
    ...
    /** A builder for [PaymentActionRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(paymentActionRetrieveResponse: PaymentActionRetrieveResponse) =
            apply {
                id = paymentActionRetrieveResponse.id
                actionableId = paymentActionRetrieveResponse.actionableId
                actionableType = paymentActionRetrieveResponse.actionableType
                createdAt = paymentActionRetrieveResponse.createdAt
                details = paymentActionRetrieveResponse.details
                internalAccountId = paymentActionRetrieveResponse.internalAccountId
                liveMode = paymentActionRetrieveResponse.liveMode
                object_ = paymentActionRetrieveResponse.object_
                status = paymentActionRetrieveResponse.status
                type = paymentActionRetrieveResponse.type
                updatedAt = paymentActionRetrieveResponse.updatedAt
                additionalProperties = paymentActionRetrieveResponse.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.actionableId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun actionableId(actionableId: JsonField<String>) =
            apply {
                this.actionableId = actionableId
            }

        /** The type of the associated actionable object. One of `payment_order`, `expected_payment`. */
        fun actionableType(actionableType: String?) = actionableType(JsonField.ofNullable(actionableType))

        /**
         * Sets [Builder.actionableType] to an arbitrary JSON value.
         *
         * You should usually call [Builder.actionableType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun actionableType(actionableType: JsonField<String>) =
            apply {
        ...
        /**
         * Returns an immutable instance of [PaymentActionRetrieveResponse].
         *
         ...
         */
        fun build(): PaymentActionRetrieveResponse =
     ...
     *   expected type.
     */
    fun validate(): PaymentActionRetrieveResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (if (actionableId.asKnown() == null) 0 else 1) + (if (actionableType.asKnown() == null) 0 else 1) + (if (createdAt.asKnown() == null) 0 else 1) + (if (internalAccountId.asKnown() == null) 0 else 1) + (if (liveMode.asKnown() == null) 0 else 1) + (if (object_.asKnown() == null) 0 else 1) + (if (status.asKnown() == null) 0 else 1) + (if (type.asKnown() == null) 0 else 1) + (if (updatedAt.asKnown() == null) 0 else 1)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PaymentActionRetrieveResponse && id == other.id && actionableId == other.actionableId && actionableType == other.actionableType && createdAt == other.createdAt && details == other.details && internalAccountId == other.internalAccountId && liveMode == other.liveMode && object_ == other.object_ && status == other.status && type == other.type && updatedAt == other.updatedAt && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "PaymentActionRetrieveResponse{id=$id, actionableId=$actionableId, actionableType=$actionableType, createdAt=$createdAt, details=$details, internalAccountId=$internalAccountId, liveMode=$liveMode, object_=$object_, status=$status, type=$type, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
