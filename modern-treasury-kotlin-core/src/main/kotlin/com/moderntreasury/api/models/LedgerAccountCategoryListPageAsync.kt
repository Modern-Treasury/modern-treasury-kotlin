...
class LedgerAccountCategoryListPageAsync private constructor(
    ...
    override suspend fun nextPage(): LedgerAccountCategoryListPageAsync = service.list(nextPageParams())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LedgerAccountCategoryListPageAsync].
         *
    ...
    class Builder internal constructor() {
        ...
        fun service(service: LedgerAccountCategoryServiceAsync) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LedgerAccountCategoryListPageAsync && service == other.service && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, params, headers, items)

    override fun toString() = "LedgerAccountCategoryListPageAsync{service=$service, params=$params, headers=$headers, items=$items}"
}
