...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LedgerAccountCategoryListPageAsync && this.ledgerAccountCategoriesService == other.ledgerAccountCategoriesService && this.params == other.params && this.response == other.response /* spotless:on */
    }
