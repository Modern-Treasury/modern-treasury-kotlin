...
class LegalEntityAssociationInlineCreate @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("relationship_types") @ExcludeMissing relationshipTypes: JsonField<List<RelationshipType>> = JsonMissing.of(),
        @JsonProperty("child_legal_entity") @ExcludeMissing childLegalEntity: JsonField<ChildLegalEntityCreate> = JsonMissing.of(),
        @JsonProperty("child_legal_entity_id") @ExcludeMissing childLegalEntityId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("ownership_percentage") @ExcludeMissing ownershipPercentage: JsonField<Long> = JsonMissing.of(),
    ...
    fun relationshipTypes(): List<RelationshipType> = relationshipTypes.getRequired("relationship_types")
     ...
     */
    fun childLegalEntity(): ChildLegalEntityCreate? = childLegalEntity.getNullable("child_legal_entity")
     ...
     *
     * Unlike [relationshipTypes], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [childLegalEntity], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [childLegalEntityId], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [ownershipPercentage], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LegalEntityAssociationInlineCreate].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(legalEntityAssociationInlineCreate: LegalEntityAssociationInlineCreate) =
            apply {
                relationshipTypes = legalEntityAssociationInlineCreate.relationshipTypes.map { it.toMutableList() }
                ...
                additionalProperties = legalEntityAssociationInlineCreate.additionalProperties.toMutableMap()
            }

        fun relationshipTypes(relationshipTypes: List<RelationshipType>) = relationshipTypes(JsonField.of(relationshipTypes))

        /**
         * Sets [Builder.relationshipTypes] to an arbitrary JSON value.
         *
         * You should usually call [Builder.relationshipTypes] with a well-typed `List<RelationshipType>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         */
        fun addRelationshipType(relationshipType: RelationshipType) =
            apply {
                relationshipTypes = (relationshipTypes ?: JsonField.of(mutableListOf())).also {
                    checkKnown("relationshipTypes", it).add(relationshipType)
                }
            }

        /** The child legal entity. */
        fun childLegalEntity(childLegalEntity: ChildLegalEntityCreate) = childLegalEntity(JsonField.of(childLegalEntity))

        /**
         * Sets [Builder.childLegalEntity] to an arbitrary JSON value.
         *
         * You should usually call [Builder.childLegalEntity] with a well-typed [ChildLegalEntityCreate] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun childLegalEntity(childLegalEntity: JsonField<ChildLegalEntityCreate>) =
            apply {
                this.childLegalEntity = childLegalEntity
            }

        /** The ID of the child legal entity. */
        fun childLegalEntityId(childLegalEntityId: String) = childLegalEntityId(JsonField.of(childLegalEntityId))

        /**
         * Sets [Builder.childLegalEntityId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.childLegalEntityId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun childLegalEntityId(childLegalEntityId: JsonField<String>) =
            apply {
                this.childLegalEntityId = childLegalEntityId
            }

        /** The child entity's ownership percentage iff they are a beneficial owner. */
        fun ownershipPercentage(ownershipPercentage: Long?) = ownershipPercentage(JsonField.ofNullable(ownershipPercentage))
         ...
         */
        fun ownershipPercentage(ownershipPercentage: Long) = ownershipPercentage(ownershipPercentage as Long?)

        /**
         * Sets [Builder.ownershipPercentage] to an arbitrary JSON value.
         *
         * You should usually call [Builder.ownershipPercentage] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ownershipPercentage(ownershipPercentage: JsonField<Long>) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): LegalEntityAssociationInlineCreate =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    internal fun validity(): Int = (relationshipTypes.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (childLegalEntity.asKnown()?.validity() ?: 0) + (if (childLegalEntityId.asKnown() == null) 0 else 1) + (if (ownershipPercentage.asKnown() == null) 0 else 1) + (if (title.asKnown() == null) 0 else 1)

    /** A list of relationship types for how the child entity relates to parent entity. */
    class RelationshipType @JsonCreator private constructor(
        ...
        enum class Value {
            ...
            BENEFICIAL_OWNER,
            CONTROL_PERSON,
            /** An enum member indicating that [RelationshipType] was instantiated with an unknown value. */
            _UNKNOWN,
        }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LegalEntityAssociationInlineCreate && relationshipTypes == other.relationshipTypes && childLegalEntity == other.childLegalEntity && childLegalEntityId == other.childLegalEntityId && ownershipPercentage == other.ownershipPercentage && title == other.title && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "LegalEntityAssociationInlineCreate{relationshipTypes=$relationshipTypes, childLegalEntity=$childLegalEntity, childLegalEntityId=$childLegalEntityId, ownershipPercentage=$ownershipPercentage, title=$title, additionalProperties=$additionalProperties}"
}
