...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ConnectionLegalEntityListPage && this.connectionLegalEntitiesService == other.connectionLegalEntitiesService && this.params == other.params && this.response == other.response /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(connectionLegalEntitiesService, params, response) /* spotless:on */
    }
    ...
    constructor(
        ...
        override fun toString() =
            "ConnectionLegalEntityListPage.Response{items=$items, additionalProperties=$additionalProperties}"
