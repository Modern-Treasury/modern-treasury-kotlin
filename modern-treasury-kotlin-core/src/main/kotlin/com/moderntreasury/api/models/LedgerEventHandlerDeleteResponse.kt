...
@JsonDeserialize(builder = LedgerEventHandlerDeleteResponse.Builder::class)
@NoAutoDetect
class LedgerEventHandlerDeleteResponse
private constructor(
    ...
    fun validate(): LedgerEventHandlerDeleteResponse = apply {
        if (!validated) {
            id()
            object_()
            liveMode()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LedgerEventHandlerDeleteResponse &&
            this.id == other.id &&
    ...
    class Builder {
        ...
        internal fun from(ledgerEventHandlerDeleteResponse: LedgerEventHandlerDeleteResponse) =
            apply {
                this.id = ledgerEventHandlerDeleteResponse.id
                this.object_ = ledgerEventHandlerDeleteResponse.object_
                this.liveMode = ledgerEventHandlerDeleteResponse.liveMode
                this.createdAt = ledgerEventHandlerDeleteResponse.createdAt
                this.updatedAt = ledgerEventHandlerDeleteResponse.updatedAt
                this.discardedAt = ledgerEventHandlerDeleteResponse.discardedAt
                this.name = ledgerEventHandlerDeleteResponse.name
                this.description = ledgerEventHandlerDeleteResponse.description
                this.ledgerTransactionTemplate =
                    ledgerEventHandlerDeleteResponse.ledgerTransactionTemplate
                this.conditions = ledgerEventHandlerDeleteResponse.conditions
                this.metadata = ledgerEventHandlerDeleteResponse.metadata
                additionalProperties(ledgerEventHandlerDeleteResponse.additionalProperties)
            }
        ...
        fun build(): LedgerEventHandlerDeleteResponse =
