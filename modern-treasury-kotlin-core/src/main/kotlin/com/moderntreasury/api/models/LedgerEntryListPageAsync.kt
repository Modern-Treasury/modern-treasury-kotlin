...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LedgerEntryListPageAsync && ledgerEntriesService == other.ledgerEntriesService && params == other.params && response == other.response /* spotless:on */
    }
