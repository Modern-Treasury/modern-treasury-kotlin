...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LedgerEntryListPageAsync && this.ledgerEntriesService == other.ledgerEntriesService && this.params == other.params && this.response == other.response /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(ledgerEntriesService, params, response) /* spotless:on */
    }

    override fun toString() =
        "LedgerEntryListPageAsync{ledgerEntriesService=$ledgerEntriesService, params=$params, response=$response}"
    ...
    constructor(
        ...
        override fun toString() =
            "LedgerEntryListPageAsync.Response{items=$items, additionalProperties=$additionalProperties}"
