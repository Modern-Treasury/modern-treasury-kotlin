...
class LineItemListParams private constructor(
    ...
    /** A builder for [LineItemListParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(lineItemListParams: LineItemListParams) =
            apply {
        ...
        /**
         * Returns an immutable instance of [LineItemListParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LineItemListParams && itemizableType == other.itemizableType && itemizableId == other.itemizableId && afterCursor == other.afterCursor && perPage == other.perPage && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(itemizableType, itemizableId, afterCursor, perPage, additionalHeaders, additionalQueryParams)

    override fun toString() = "LineItemListParams{itemizableType=$itemizableType, itemizableId=$itemizableId, afterCursor=$afterCursor, perPage=$perPage, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
