...
class LedgerAccountBalanceMonitor @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("alert_condition") @ExcludeMissing alertCondition: JsonField<AlertCondition> = JsonMissing.of(),
        @JsonProperty("created_at") @ExcludeMissing createdAt: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("current_ledger_account_balance_state") @ExcludeMissing currentLedgerAccountBalanceState: JsonField<CurrentLedgerAccountBalanceState> = JsonMissing.of(),
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun currentLedgerAccountBalanceState(): CurrentLedgerAccountBalanceState = currentLedgerAccountBalanceState.getRequired("current_ledger_account_balance_state")
     ...
     *
     * Unlike [currentLedgerAccountBalanceState], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("current_ledger_account_balance_state")
    @ExcludeMissing
    fun _currentLedgerAccountBalanceState(): JsonField<CurrentLedgerAccountBalanceState> = currentLedgerAccountBalanceState
    ...
    class Builder internal constructor() {
        ...
        private var currentLedgerAccountBalanceState: JsonField<CurrentLedgerAccountBalanceState>? = null
        ...
        internal fun from(ledgerAccountBalanceMonitor: LedgerAccountBalanceMonitor) =
            apply {
                ...
                currentLedgerAccountBalanceState = ledgerAccountBalanceMonitor.currentLedgerAccountBalanceState
        ...
        /** Describes the condition that must be satisfied for the monitor to be triggered. */
        fun alertCondition(alertCondition: AlertCondition) = alertCondition(JsonField.of(alertCondition))

        /**
         * Sets [Builder.alertCondition] to an arbitrary JSON value.
         *
         * You should usually call [Builder.alertCondition] with a well-typed [AlertCondition] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun alertCondition(alertCondition: JsonField<AlertCondition>) =
            apply {
        ...
        /** The ledger account's balances and the monitor state as of the current ledger account lock version. */
        fun currentLedgerAccountBalanceState(currentLedgerAccountBalanceState: CurrentLedgerAccountBalanceState) = currentLedgerAccountBalanceState(JsonField.of(currentLedgerAccountBalanceState))

        /**
         * Sets [Builder.currentLedgerAccountBalanceState] to an arbitrary JSON value.
         *
         * You should usually call [Builder.currentLedgerAccountBalanceState] with a well-typed [CurrentLedgerAccountBalanceState] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun currentLedgerAccountBalanceState(currentLedgerAccountBalanceState: JsonField<CurrentLedgerAccountBalanceState>) =
            apply {
                this.currentLedgerAccountBalanceState = currentLedgerAccountBalanceState
            }
     ...
     *   expected type.
     */
    fun validate(): LedgerAccountBalanceMonitor =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (alertCondition.asKnown()?.validity() ?: 0) + (if (createdAt.asKnown() == null) 0 else 1) + (currentLedgerAccountBalanceState.asKnown()?.validity() ?: 0) + (if (description.asKnown() == null) 0 else 1) + (if (discardedAt.asKnown() == null) 0 else 1) + (if (ledgerAccountId.asKnown() == null) 0 else 1) + (if (liveMode.asKnown() == null) 0 else 1) + (metadata.asKnown()?.validity() ?: 0) + (if (object_.asKnown() == null) 0 else 1) + (if (updatedAt.asKnown() == null) 0 else 1)

    /** Describes the condition that must be satisfied for the monitor to be triggered. */
    class AlertCondition @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonProperty("value")
        @ExcludeMissing
        fun _value(): JsonField<Long> = value
        ...
        class Builder internal constructor() {
            ...
            internal fun from(alertCondition: AlertCondition) =
                apply {
             ...
             *
             * You should usually call [Builder.field] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun field(field: JsonField<String>) =
                apply {
                    this.field = field
                }
             ...
             *
             * You should usually call [Builder.operator] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun operator(operator: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.value] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun value(value: JsonField<Long>) =
                apply {
                    this.value = value
                }
         ...
         * Used for best match union deserialization.
         */
        internal fun validity(): Int = (if (field.asKnown() == null) 0 else 1) + (if (operator.asKnown() == null) 0 else 1) + (if (value.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is AlertCondition && field == other.field && operator == other.operator && value == other.value && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "AlertCondition{field=$field, operator=$operator, value=$value, additionalProperties=$additionalProperties}"
    }

    /** The ledger account's balances and the monitor state as of the current ledger account lock version. */
    class CurrentLedgerAccountBalanceState @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("balances") @ExcludeMissing balances: JsonField<LedgerBalances> = JsonMissing.of(),
            @JsonProperty("ledger_account_lock_version") @ExcludeMissing ledgerAccountLockVersion: JsonField<Long> = JsonMissing.of(),
            @JsonProperty("triggered") @ExcludeMissing triggered: JsonField<Boolean> = JsonMissing.of()
        ) : this(
          balances,
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun ledgerAccountLockVersion(): Long = ledgerAccountLockVersion.getRequired("ledger_account_lock_version")
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [CurrentLedgerAccountBalanceState].
             *
             * The following fields are required:
             *
             * ```kotlin
        ...
        class Builder internal constructor() {
            ...
            internal fun from(currentLedgerAccountBalanceState: CurrentLedgerAccountBalanceState) =
                apply {
                    ...
                    ledgerAccountLockVersion = currentLedgerAccountBalanceState.ledgerAccountLockVersion
                    triggered = currentLedgerAccountBalanceState.triggered
                    additionalProperties = currentLedgerAccountBalanceState.additionalProperties.toMutableMap()
                }
             ...
             *
             * You should usually call [Builder.balances] with a well-typed [LedgerBalances] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun balances(balances: JsonField<LedgerBalances>) =
                apply {
                    this.balances = balances
                }

            /** The current lock version of the ledger account. */
            fun ledgerAccountLockVersion(ledgerAccountLockVersion: Long) = ledgerAccountLockVersion(JsonField.of(ledgerAccountLockVersion))
             ...
             *
             * You should usually call [Builder.triggered] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun triggered(triggered: JsonField<Boolean>) =
                apply {
         ...
         *   expected type.
         */
        fun validate(): CurrentLedgerAccountBalanceState =
            apply {
                if (validated) {
                  return@apply
                }
         ...
         * Used for best match union deserialization.
         */
        internal fun validity(): Int = (balances.asKnown()?.validity() ?: 0) + (if (ledgerAccountLockVersion.asKnown() == null) 0 else 1) + (if (triggered.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is CurrentLedgerAccountBalanceState && balances == other.balances && ledgerAccountLockVersion == other.ledgerAccountLockVersion && triggered == other.triggered && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "CurrentLedgerAccountBalanceState{balances=$balances, ledgerAccountLockVersion=$ledgerAccountLockVersion, triggered=$triggered, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LedgerAccountBalanceMonitor && id == other.id && alertCondition == other.alertCondition && createdAt == other.createdAt && currentLedgerAccountBalanceState == other.currentLedgerAccountBalanceState && description == other.description && discardedAt == other.discardedAt && ledgerAccountId == other.ledgerAccountId && liveMode == other.liveMode && metadata == other.metadata && object_ == other.object_ && updatedAt == other.updatedAt && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "LedgerAccountBalanceMonitor{id=$id, alertCondition=$alertCondition, createdAt=$createdAt, currentLedgerAccountBalanceState=$currentLedgerAccountBalanceState, description=$description, discardedAt=$discardedAt, ledgerAccountId=$ledgerAccountId, liveMode=$liveMode, metadata=$metadata, object_=$object_, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
