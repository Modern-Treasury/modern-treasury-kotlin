...
class PaymentOrderUpdateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(paymentOrderUpdateParams: PaymentOrderUpdateParams) =
            apply {
         ...
         * - etc.
         */
        fun body(body: PaymentOrderUpdateRequest) =
            apply {
    ...
    class PaymentOrderUpdateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        companion object {
            ...
            /** Returns a mutable builder for constructing an instance of [PaymentOrderUpdateRequest]. */
            fun builder() = Builder()
        }
        ...
        class Builder internal constructor() {
            ...
            internal fun from(paymentOrderUpdateRequest: PaymentOrderUpdateRequest) =
                apply {
                    ...
                    externalId = paymentOrderUpdateRequest.externalId
                    ...
                    reconciliationStatus = paymentOrderUpdateRequest.reconciliationStatus
                    ...
                    ultimateOriginatingPartyIdentifier = paymentOrderUpdateRequest.ultimateOriginatingPartyIdentifier
                    ultimateOriginatingPartyName = paymentOrderUpdateRequest.ultimateOriginatingPartyName
                    ultimateReceivingPartyIdentifier = paymentOrderUpdateRequest.ultimateReceivingPartyIdentifier
         ...
         *   expected type.
         */
        fun validate(): PaymentOrderUpdateRequest =
            apply {
                if (validated) {
                  return@apply
                }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PaymentOrderUpdateParams && id == other.id && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(id, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "PaymentOrderUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
