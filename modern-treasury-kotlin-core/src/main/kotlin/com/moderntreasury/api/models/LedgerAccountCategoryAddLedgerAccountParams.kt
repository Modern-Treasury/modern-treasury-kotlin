...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LedgerAccountCategoryAddLedgerAccountParams && this.id == other.id && this.ledgerAccountId == other.ledgerAccountId && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders && this.additionalBodyProperties == other.additionalBodyProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "LedgerAccountCategoryAddLedgerAccountParams{id=$id, ledgerAccountId=$ledgerAccountId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
