...
class BulkRequestListPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(bulkRequestListPage: BulkRequestListPage) =
            apply {
        ...
        fun service(service: BulkRequestService) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is BulkRequestListPage && service == other.service && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, params, headers, items)

    override fun toString() = "BulkRequestListPage{service=$service, params=$params, headers=$headers, items=$items}"
}
