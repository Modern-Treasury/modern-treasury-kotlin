...
class InternalAccountUpdateAccountCapabilityResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [InternalAccountUpdateAccountCapabilityResponse].
         *
    ...
    /** A builder for [InternalAccountUpdateAccountCapabilityResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(internalAccountUpdateAccountCapabilityResponse: InternalAccountUpdateAccountCapabilityResponse) =
            apply {
                id = internalAccountUpdateAccountCapabilityResponse.id
                createdAt = internalAccountUpdateAccountCapabilityResponse.createdAt
                direction = internalAccountUpdateAccountCapabilityResponse.direction
                discardedAt = internalAccountUpdateAccountCapabilityResponse.discardedAt
                identifier = internalAccountUpdateAccountCapabilityResponse.identifier
                liveMode = internalAccountUpdateAccountCapabilityResponse.liveMode
                object_ = internalAccountUpdateAccountCapabilityResponse.object_
                paymentType = internalAccountUpdateAccountCapabilityResponse.paymentType
                updatedAt = internalAccountUpdateAccountCapabilityResponse.updatedAt
                additionalProperties = internalAccountUpdateAccountCapabilityResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [InternalAccountUpdateAccountCapabilityResponse].
         *
         ...
         */
        fun build(): InternalAccountUpdateAccountCapabilityResponse =
     ...
     *   expected type.
     */
    fun validate(): InternalAccountUpdateAccountCapabilityResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun toString() = "InternalAccountUpdateAccountCapabilityResponse{id=$id, createdAt=$createdAt, direction=$direction, discardedAt=$discardedAt, identifier=$identifier, liveMode=$liveMode, object_=$object_, paymentType=$paymentType, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
