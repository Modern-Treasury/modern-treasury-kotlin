...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [PaymentOrderUpdate]. */
        fun builder() = Builder()
    }

    /** A builder for [PaymentOrderUpdate]. */
    class Builder internal constructor() {
        ...
        internal fun from(paymentOrderUpdate: PaymentOrderUpdate) = apply {
            accounting = paymentOrderUpdate.accounting
            accountingCategoryId = paymentOrderUpdate.accountingCategoryId
            accountingLedgerClassId = paymentOrderUpdate.accountingLedgerClassId
            amount = paymentOrderUpdate.amount
            chargeBearer = paymentOrderUpdate.chargeBearer
            counterpartyId = paymentOrderUpdate.counterpartyId
            currency = paymentOrderUpdate.currency
            description = paymentOrderUpdate.description
            direction = paymentOrderUpdate.direction
            effectiveDate = paymentOrderUpdate.effectiveDate
            expiresAt = paymentOrderUpdate.expiresAt
            fallbackType = paymentOrderUpdate.fallbackType
            foreignExchangeContract = paymentOrderUpdate.foreignExchangeContract
            foreignExchangeIndicator = paymentOrderUpdate.foreignExchangeIndicator
            lineItems = paymentOrderUpdate.lineItems.map { it.toMutableList() }
            metadata = paymentOrderUpdate.metadata
            nsfProtected = paymentOrderUpdate.nsfProtected
            originatingAccountId = paymentOrderUpdate.originatingAccountId
            originatingPartyName = paymentOrderUpdate.originatingPartyName
            priority = paymentOrderUpdate.priority
            processAfter = paymentOrderUpdate.processAfter
            purpose = paymentOrderUpdate.purpose
            receivingAccount = paymentOrderUpdate.receivingAccount
            receivingAccountId = paymentOrderUpdate.receivingAccountId
            reconciliationStatus = paymentOrderUpdate.reconciliationStatus
            remittanceInformation = paymentOrderUpdate.remittanceInformation
            sendRemittanceAdvice = paymentOrderUpdate.sendRemittanceAdvice
            statementDescriptor = paymentOrderUpdate.statementDescriptor
            status = paymentOrderUpdate.status
            subtype = paymentOrderUpdate.subtype
            type = paymentOrderUpdate.type
            ultimateOriginatingPartyIdentifier =
                paymentOrderUpdate.ultimateOriginatingPartyIdentifier
            ultimateOriginatingPartyName = paymentOrderUpdate.ultimateOriginatingPartyName
            ultimateReceivingPartyIdentifier = paymentOrderUpdate.ultimateReceivingPartyIdentifier
            ultimateReceivingPartyName = paymentOrderUpdate.ultimateReceivingPartyName
            additionalProperties = paymentOrderUpdate.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PaymentOrderUpdate].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PaymentOrderUpdate =
            PaymentOrderUpdate(
                accounting,
                accountingCategoryId,
                accountingLedgerClassId,
    ...
    fun validate(): PaymentOrderUpdate = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PaymentOrderUpdate &&
