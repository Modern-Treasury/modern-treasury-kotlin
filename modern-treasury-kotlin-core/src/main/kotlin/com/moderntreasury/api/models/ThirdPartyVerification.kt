...
class ThirdPartyVerification @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("vendor_verification_id") @ExcludeMissing vendorVerificationId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("verification_category") @ExcludeMissing verificationCategory: JsonField<VerificationCategory> = JsonMissing.of(),
        @JsonProperty("verification_method") @ExcludeMissing verificationMethod: JsonField<String> = JsonMissing.of(),
        @JsonProperty("verification_time") @ExcludeMissing verificationTime: JsonField<OffsetDateTime> = JsonMissing.of(),
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun verificationCategory(): VerificationCategory = verificationCategory.getRequired("verification_category")
    ...
    @JsonProperty("vendor")
    @ExcludeMissing
    fun _vendor(): JsonField<Vendor> = vendor

    /**
     * Returns the raw JSON value of [vendorVerificationId].
     *
     * Unlike [vendorVerificationId], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [verificationCategory], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [verificationTime], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(thirdPartyVerification: ThirdPartyVerification) =
            apply {
         ...
         *
         * You should usually call [Builder.outcome] with a well-typed [Outcome] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun outcome(outcome: JsonField<Outcome>) =
            apply {
         ...
         *
         * You should usually call [Builder.vendor] with a well-typed [Vendor] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun vendor(vendor: JsonField<Vendor>) =
            apply {
                this.vendor = vendor
            }

        /** The identification of the third party verification in `vendor`'s system. */
        fun vendorVerificationId(vendorVerificationId: String) = vendorVerificationId(JsonField.of(vendorVerificationId))

        /**
         * Sets [Builder.vendorVerificationId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.vendorVerificationId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun vendorVerificationId(vendorVerificationId: JsonField<String>) =
            apply {
                this.vendorVerificationId = vendorVerificationId
            }

        /** The category of verification performed. */
        fun verificationCategory(verificationCategory: VerificationCategory) = verificationCategory(JsonField.of(verificationCategory))

        /**
         * Sets [Builder.verificationCategory] to an arbitrary JSON value.
         *
         * You should usually call [Builder.verificationCategory] with a well-typed [VerificationCategory] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /** The method used to perform the verification. */
        fun verificationMethod(verificationMethod: String) = verificationMethod(JsonField.of(verificationMethod))

        /**
         * Sets [Builder.verificationMethod] to an arbitrary JSON value.
         *
         * You should usually call [Builder.verificationMethod] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun verificationMethod(verificationMethod: JsonField<String>) =
            apply {
                this.verificationMethod = verificationMethod
            }

        /** The timestamp when the verification was performed. */
        fun verificationTime(verificationTime: OffsetDateTime) = verificationTime(JsonField.of(verificationTime))

        /**
         * Sets [Builder.verificationTime] to an arbitrary JSON value.
         *
         * You should usually call [Builder.verificationTime] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun verificationTime(verificationTime: JsonField<OffsetDateTime>) =
            apply {
         ...
         *
         * You should usually call [Builder.comment] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
     ...
     *   expected type.
     */
    fun validate(): ThirdPartyVerification =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    internal fun validity(): Int = (outcome.asKnown()?.validity() ?: 0) + (vendor.asKnown()?.validity() ?: 0) + (if (vendorVerificationId.asKnown() == null) 0 else 1) + (verificationCategory.asKnown()?.validity() ?: 0) + (if (verificationMethod.asKnown() == null) 0 else 1) + (if (verificationTime.asKnown() == null) 0 else 1) + (if (comment.asKnown() == null) 0 else 1)

    /** The outcome of the verification. One of `passed` or `failed`. */
    class Outcome @JsonCreator private constructor(
    ...
    /** The vendor that performed the verification, e.g. `persona`. */
    class Vendor @JsonCreator private constructor(
        private val value: JsonField<String>,
    ...
    /** The category of verification performed. */
    class VerificationCategory @JsonCreator private constructor(
        private val value: JsonField<String>,
        ...
        /**
         * An enum containing [VerificationCategory]'s known values, as well as an [_UNKNOWN] member.
         *
        ...
        enum class Value {
            ...
            GOVERNMENT_ID_NUMBER,
            ADVERSE_MEDIA,
            /** An enum member indicating that [VerificationCategory] was instantiated with an unknown value. */
            _UNKNOWN,
        }
        ...
        fun known(): Known =
            when (this) {
                ...
                else -> throw ModernTreasuryInvalidDataException("Unknown VerificationCategory: $value")
            }
         ...
         *   expected type.
         */
        fun validate(): VerificationCategory =
            apply {
                if (validated) {
                  return@apply
                }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ThirdPartyVerification && outcome == other.outcome && vendor == other.vendor && vendorVerificationId == other.vendorVerificationId && verificationCategory == other.verificationCategory && verificationMethod == other.verificationMethod && verificationTime == other.verificationTime && comment == other.comment && additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(outcome, vendor, vendorVerificationId, verificationCategory, verificationMethod, verificationTime, comment, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() = "ThirdPartyVerification{outcome=$outcome, vendor=$vendor, vendorVerificationId=$vendorVerificationId, verificationCategory=$verificationCategory, verificationMethod=$verificationMethod, verificationTime=$verificationTime, comment=$comment, additionalProperties=$additionalProperties}"
}
