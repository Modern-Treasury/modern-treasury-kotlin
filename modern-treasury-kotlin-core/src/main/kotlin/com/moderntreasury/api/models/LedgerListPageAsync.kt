...
class LedgerListPageAsync private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(ledgerListPageAsync: LedgerListPageAsync) =
            apply {
        ...
        fun service(service: LedgerServiceAsync) =
            apply {
                this.service = service
            }

        /** The parameters that were used to request this page. */
        fun params(params: LedgerListParams) =
            apply {
                this.params = params
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LedgerListPageAsync && service == other.service && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, params, headers, items)

    override fun toString() = "LedgerListPageAsync{service=$service, params=$params, headers=$headers, items=$items}"
}
