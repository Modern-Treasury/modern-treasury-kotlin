...
class LedgerTransactionVersionListPageAsync private constructor(
    ...
    override suspend fun nextPage(): LedgerTransactionVersionListPageAsync = service.list(nextPageParams())
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LedgerTransactionVersionListPageAsync && service == other.service && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, params, headers, items)

    override fun toString() = "LedgerTransactionVersionListPageAsync{service=$service, params=$params, headers=$headers, items=$items}"
}
