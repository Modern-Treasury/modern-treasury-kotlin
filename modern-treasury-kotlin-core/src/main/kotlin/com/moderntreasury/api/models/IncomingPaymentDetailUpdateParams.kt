...
class IncomingPaymentDetailUpdateParams private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [IncomingPaymentDetailUpdateParams]. */
        fun builder() = Builder()
    }
    ...
    class Builder internal constructor() {
        ...
        private var body: IncomingPaymentDetailUpdateRequest.Builder = IncomingPaymentDetailUpdateRequest.builder()
        ...
        internal fun from(incomingPaymentDetailUpdateParams: IncomingPaymentDetailUpdateParams) =
            apply {
                ...
                additionalQueryParams = incomingPaymentDetailUpdateParams.additionalQueryParams.toBuilder()
            }
         ...
         * - [metadata]
         */
        fun body(body: IncomingPaymentDetailUpdateRequest) =
            apply {
    ...
    fun _body(): IncomingPaymentDetailUpdateRequest = body
    ...
    class IncomingPaymentDetailUpdateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        companion object {
            ...
            /** Returns a mutable builder for constructing an instance of [IncomingPaymentDetailUpdateRequest]. */
            fun builder() = Builder()
        }
        ...
        class Builder internal constructor() {
            ...
            internal fun from(incomingPaymentDetailUpdateRequest: IncomingPaymentDetailUpdateRequest) =
                apply {
                    metadata = incomingPaymentDetailUpdateRequest.metadata
                    additionalProperties = incomingPaymentDetailUpdateRequest.additionalProperties.toMutableMap()
                }
            ...
            /**
             * Returns an immutable instance of [IncomingPaymentDetailUpdateRequest].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): IncomingPaymentDetailUpdateRequest =
                IncomingPaymentDetailUpdateRequest(
                  metadata, additionalProperties.toMutableMap()
                )
        }
         ...
         *   expected type.
         */
        fun validate(): IncomingPaymentDetailUpdateRequest =
            apply {
                if (validated) {
                  return@apply
                }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is IncomingPaymentDetailUpdateRequest && metadata == other.metadata && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "IncomingPaymentDetailUpdateRequest{metadata=$metadata, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is IncomingPaymentDetailUpdateParams && id == other.id && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(id, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "IncomingPaymentDetailUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
