...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         * - [metadata]
         */
        fun body(body: IncomingPaymentDetailUpdateRequest) = apply { this.body = body.toBuilder() }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            fun build(): IncomingPaymentDetailUpdateRequest =
                IncomingPaymentDetailUpdateRequest(metadata, additionalProperties.toMutableMap())
        }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is IncomingPaymentDetailUpdateRequest &&
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IncomingPaymentDetailUpdateParams &&
            id == other.id &&
            body == other.body &&
