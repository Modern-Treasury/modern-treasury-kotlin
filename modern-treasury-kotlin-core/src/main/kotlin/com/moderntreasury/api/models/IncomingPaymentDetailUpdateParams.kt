...
constructor(
    ...
    internal constructor(
        ...
        class Builder {
            ...
            fun build(): IncomingPaymentDetailUpdateBody =
                IncomingPaymentDetailUpdateBody(metadata, additionalProperties.toUnmodifiable())
        }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is IncomingPaymentDetailUpdateBody && this.metadata == other.metadata && this.additionalProperties == other.additionalProperties /* spotless:on */
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is IncomingPaymentDetailUpdateParams && this.id == other.id && this.metadata == other.metadata && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders && this.additionalBodyProperties == other.additionalBodyProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "IncomingPaymentDetailUpdateParams{id=$id, metadata=$metadata, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
