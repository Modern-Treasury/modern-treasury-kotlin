...
class VirtualAccountCreateParams private constructor(
     ...
     *
     * Unlike [creditLedgerAccountId], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [debitLedgerAccountId], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
        ...
        private var body: VirtualAccountCreateRequest.Builder = VirtualAccountCreateRequest.builder()
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        internal fun from(virtualAccountCreateParams: VirtualAccountCreateParams) =
            apply {
         ...
         * - etc.
         */
        fun body(body: VirtualAccountCreateRequest) =
            apply {
         ...
         *
         * You should usually call [Builder.accountDetails] with a well-typed `List<AccountDetailCreateRequest>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         */
        fun addAccountDetail(accountDetail: AccountDetailCreateRequest) =
            apply {
         ...
         *
         * You should usually call [Builder.creditLedgerAccountId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun creditLedgerAccountId(creditLedgerAccountId: JsonField<String>) =
            apply {
                body.creditLedgerAccountId(creditLedgerAccountId)
            }
         ...
         *
         * You should usually call [Builder.debitLedgerAccountId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun debitLedgerAccountId(debitLedgerAccountId: JsonField<String>) =
            apply {
                body.debitLedgerAccountId(debitLedgerAccountId)
            }
         ...
         *
         * You should usually call [Builder.routingDetails] with a well-typed `List<RoutingDetailCreateRequest>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addRoutingDetail(routingDetail: RoutingDetailCreateRequest) =
            apply {
    ...
    class VirtualAccountCreateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("account_details") @ExcludeMissing accountDetails: JsonField<List<AccountDetailCreateRequest>> = JsonMissing.of(),
            @JsonProperty("counterparty_id") @ExcludeMissing counterpartyId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("credit_ledger_account_id") @ExcludeMissing creditLedgerAccountId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("debit_ledger_account_id") @ExcludeMissing debitLedgerAccountId: JsonField<String> = JsonMissing.of(),
            ...
            @JsonProperty("routing_details") @ExcludeMissing routingDetails: JsonField<List<RoutingDetailCreateRequest>> = JsonMissing.of()
        ) : this(
          internalAccountId,
          name,
          accountDetails,
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun accountDetails(): List<AccountDetailCreateRequest>? = accountDetails.getNullable("account_details")
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun creditLedgerAccountId(): String? = creditLedgerAccountId.getNullable("credit_ledger_account_id")
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun debitLedgerAccountId(): String? = debitLedgerAccountId.getNullable("debit_ledger_account_id")
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun routingDetails(): List<RoutingDetailCreateRequest>? = routingDetails.getNullable("routing_details")
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [VirtualAccountCreateRequest].
             *
             * The following fields are required:
             *
             * ```kotlin
        ...
        class Builder internal constructor() {
            ...
            internal fun from(virtualAccountCreateRequest: VirtualAccountCreateRequest) =
                apply {
                    internalAccountId = virtualAccountCreateRequest.internalAccountId
                    name = virtualAccountCreateRequest.name
                    accountDetails = virtualAccountCreateRequest.accountDetails.map { it.toMutableList() }
                    ...
                    routingDetails = virtualAccountCreateRequest.routingDetails.map { it.toMutableList() }
                    additionalProperties = virtualAccountCreateRequest.additionalProperties.toMutableMap()
                }
            ...
            /** An array of account detail objects. */
            fun accountDetails(accountDetails: List<AccountDetailCreateRequest>) = accountDetails(JsonField.of(accountDetails))
            ...
            /** The ID of a credit normal ledger account. When money leaves the virtual account, this ledger account will be credited. Must be accompanied by a debit_ledger_account_id if present. */
            fun creditLedgerAccountId(creditLedgerAccountId: String) = creditLedgerAccountId(JsonField.of(creditLedgerAccountId))
            ...
            /** The ID of a debit normal ledger account. When money enters the virtual account, this ledger account will be debited. Must be accompanied by a credit_ledger_account_id if present. */
            fun debitLedgerAccountId(debitLedgerAccountId: String) = debitLedgerAccountId(JsonField.of(debitLedgerAccountId))
            ...
            /** An array of routing detail objects. */
            fun routingDetails(routingDetails: List<RoutingDetailCreateRequest>) = routingDetails(JsonField.of(routingDetails))
         ...
         *   expected type.
         */
        fun validate(): VirtualAccountCreateRequest =
            apply {
                if (validated) {
                  return@apply
                }
         ...
         */
        internal fun validity(): Int = (if (internalAccountId.asKnown() == null) 0 else 1) + (if (name.asKnown() == null) 0 else 1) + (accountDetails.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (if (counterpartyId.asKnown() == null) 0 else 1) + (if (creditLedgerAccountId.asKnown() == null) 0 else 1) + (if (debitLedgerAccountId.asKnown() == null) 0 else 1) + (if (description.asKnown() == null) 0 else 1) + (ledgerAccount.asKnown()?.validity() ?: 0) + (metadata.asKnown()?.validity() ?: 0) + (routingDetails.asKnown()?.sumOf { it.validity().toInt() } ?: 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is VirtualAccountCreateRequest && internalAccountId == other.internalAccountId && name == other.name && accountDetails == other.accountDetails && counterpartyId == other.counterpartyId && creditLedgerAccountId == other.creditLedgerAccountId && debitLedgerAccountId == other.debitLedgerAccountId && description == other.description && ledgerAccount == other.ledgerAccount && metadata == other.metadata && routingDetails == other.routingDetails && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "VirtualAccountCreateRequest{internalAccountId=$internalAccountId, name=$name, accountDetails=$accountDetails, counterpartyId=$counterpartyId, creditLedgerAccountId=$creditLedgerAccountId, debitLedgerAccountId=$debitLedgerAccountId, description=$description, ledgerAccount=$ledgerAccount, metadata=$metadata, routingDetails=$routingDetails, additionalProperties=$additionalProperties}"
    }

    class AccountDetailCreateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [AccountDetailCreateRequest].
             *
             * The following fields are required:
             *
             * ```kotlin
        ...
        class Builder internal constructor() {
            ...
            internal fun from(accountDetailCreateRequest: AccountDetailCreateRequest) =
                apply {
                    accountNumber = accountDetailCreateRequest.accountNumber
                    accountNumberType = accountDetailCreateRequest.accountNumberType
                    additionalProperties = accountDetailCreateRequest.additionalProperties.toMutableMap()
                }
         ...
         *   expected type.
         */
        fun validate(): AccountDetailCreateRequest =
            apply {
                if (validated) {
                  return@apply
                }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is AccountDetailCreateRequest && accountNumber == other.accountNumber && accountNumberType == other.accountNumberType && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "AccountDetailCreateRequest{accountNumber=$accountNumber, accountNumberType=$accountNumberType, additionalProperties=$additionalProperties}"
    }
    ...
    class RoutingDetailCreateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [RoutingDetailCreateRequest].
             *
             * The following fields are required:
             *
             * ```kotlin
        ...
        class Builder internal constructor() {
            ...
            internal fun from(routingDetailCreateRequest: RoutingDetailCreateRequest) =
                apply {
                    ...
                    additionalProperties = routingDetailCreateRequest.additionalProperties.toMutableMap()
                }
         ...
         *   expected type.
         */
        fun validate(): RoutingDetailCreateRequest =
            apply {
                if (validated) {
                  return@apply
                }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is RoutingDetailCreateRequest && routingNumber == other.routingNumber && routingNumberType == other.routingNumberType && paymentType == other.paymentType && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "RoutingDetailCreateRequest{routingNumber=$routingNumber, routingNumberType=$routingNumberType, paymentType=$paymentType, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is VirtualAccountCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "VirtualAccountCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
