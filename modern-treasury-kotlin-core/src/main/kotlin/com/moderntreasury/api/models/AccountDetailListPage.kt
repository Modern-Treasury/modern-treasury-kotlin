...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AccountDetailListPage && this.accountDetailsService == other.accountDetailsService && this.params == other.params && this.response == other.response /* spotless:on */
    }
    ...
    constructor(
        ...
        override fun toString() =
            "AccountDetailListPage.Response{items=$items, additionalProperties=$additionalProperties}"
