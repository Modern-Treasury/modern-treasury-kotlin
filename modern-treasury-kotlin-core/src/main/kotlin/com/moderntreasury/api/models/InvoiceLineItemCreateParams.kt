...
class InvoiceLineItemCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        private var body: InvoiceLineItemCreateRequest.Builder = InvoiceLineItemCreateRequest.builder()
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        internal fun from(invoiceLineItemCreateParams: InvoiceLineItemCreateParams) =
            apply {
         ...
         * - etc.
         */
        fun body(body: InvoiceLineItemCreateRequest) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is InvoiceLineItemCreateParams && invoiceId == other.invoiceId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(invoiceId, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "InvoiceLineItemCreateParams{invoiceId=$invoiceId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
