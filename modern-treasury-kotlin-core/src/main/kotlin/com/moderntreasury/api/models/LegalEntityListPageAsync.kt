...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LegalEntityListPageAsync && this.legalEntitiesService == other.legalEntitiesService && this.params == other.params && this.response == other.response /* spotless:on */
    }
