...
class LegalEntityListPageAsync private constructor(
    ...
    override suspend fun nextPage(): LegalEntityListPageAsync = service.list(nextPageParams())

    fun autoPager(): AutoPagerAsync<LegalEntity> = AutoPagerAsync.from(this)
    ...
    class Builder internal constructor() {
        ...
        internal fun from(legalEntityListPageAsync: LegalEntityListPageAsync) =
            apply {
        ...
        fun service(service: LegalEntityServiceAsync) =
            apply {
                this.service = service
            }

        /** The parameters that were used to request this page. */
        fun params(params: LegalEntityListParams) =
            apply {
                this.params = params
            }
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<LegalEntity>) =
            apply {
                this.items = items
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LegalEntityListPageAsync && service == other.service && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, params, headers, items)

    override fun toString() = "LegalEntityListPageAsync{service=$service, params=$params, headers=$headers, items=$items}"
}
