...
private constructor(
    private val transactionCreate: TransactionCreate,
    ...
    fun _additionalBodyProperties(): Map<String, JsonValue> =
        transactionCreate._additionalProperties()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(transactionCreateParams: TransactionCreateParams) = apply {
            transactionCreate = transactionCreateParams.transactionCreate
        ...
        fun transactionCreate(transactionCreate: TransactionCreate) = apply {
        ...
        fun build(): TransactionCreateParams =
            TransactionCreateParams(
                checkRequired("transactionCreate", transactionCreate),
                additionalHeaders.build(),
                additionalQueryParams.build(),
            )
    }

    fun _body(): TransactionCreate = transactionCreate
    ...
    override fun hashCode(): Int =
        Objects.hash(transactionCreate, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "TransactionCreateParams{transactionCreate=$transactionCreate, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
