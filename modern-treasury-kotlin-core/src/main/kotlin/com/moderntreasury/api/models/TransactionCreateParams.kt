...
/** create transaction */
class TransactionCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(transactionCreateParams: TransactionCreateParams) =
            apply {
         ...
         * - etc.
         */
        fun body(body: TransactionCreateRequest) =
            apply {
        ...
        /** When applicable, the bank-given code that determines the transaction's category. For most banks this is the BAI2/BTRS transaction code. */
        fun vendorCode(vendorCode: String?) =
            apply {
        ...
        /** The transaction amount as a string, preserving full precision for values that may exceed safe integer limits in some languages. */
        fun amountString(amountString: String) =
            apply {
    ...
    class TransactionCreateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(transactionCreateRequest: TransactionCreateRequest) =
                apply {
         ...
         *   expected type.
         */
        fun validate(): TransactionCreateRequest =
            apply {
                if (validated) {
                  return@apply
                }
         ...
         */
        internal fun validity(): Int = (if (asOfDate.asKnown() == null) 0 else 1) + (if (direction.asKnown() == null) 0 else 1) + (if (internalAccountId.asKnown() == null) 0 else 1) + (if (vendorCode.asKnown() == null) 0 else 1) + (if (vendorCodeType.asKnown() == null) 0 else 1) + (if (amount.asKnown() == null) 0 else 1) + (if (amountString.asKnown() == null) 0 else 1) + (metadata.asKnown()?.validity() ?: 0) + (if (posted.asKnown() == null) 0 else 1) + (type.asKnown()?.validity() ?: 0) + (if (vendorCustomerId.asKnown() == null) 0 else 1) + (if (vendorDescription.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is TransactionCreateRequest && asOfDate == other.asOfDate && direction == other.direction && internalAccountId == other.internalAccountId && vendorCode == other.vendorCode && vendorCodeType == other.vendorCodeType && amount == other.amount && amountString == other.amountString && metadata == other.metadata && posted == other.posted && type == other.type && vendorCustomerId == other.vendorCustomerId && vendorDescription == other.vendorDescription && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(asOfDate, direction, internalAccountId, vendorCode, vendorCodeType, amount, amountString, metadata, posted, type, vendorCustomerId, vendorDescription, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "TransactionCreateRequest{asOfDate=$asOfDate, direction=$direction, internalAccountId=$internalAccountId, vendorCode=$vendorCode, vendorCodeType=$vendorCodeType, amount=$amount, amountString=$amountString, metadata=$metadata, posted=$posted, type=$type, vendorCustomerId=$vendorCustomerId, vendorDescription=$vendorDescription, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is TransactionCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "TransactionCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
