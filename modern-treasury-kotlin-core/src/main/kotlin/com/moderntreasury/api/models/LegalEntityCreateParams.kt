...
private constructor(
     ...
     *   the server responded with an unexpected value).
     */
    fun businessDesignation(): BusinessDesignation? = body.businessDesignation()
     ...
     * ```
     */
    @Deprecated("deprecated") fun _complianceDetails(): JsonValue = body._complianceDetails()
     ...
     * type.
     */
    fun _businessDesignation(): JsonField<BusinessDesignation> = body._businessDesignation()
    ...
    class Builder internal constructor() {
        ...
        /** Legal designation associated with the business. */
        fun businessDesignation(businessDesignation: BusinessDesignation?) = apply {
            body.businessDesignation(businessDesignation)
        }
        ...
        /** ISO 10383 market identifier code. */
        fun listedExchange(listedExchange: String?) = apply { body.listedExchange(listedExchange) }
        ...
        /** Array of regulatory bodies overseeing this institution. */
        fun regulators(regulators: List<LegalEntityRegulator>?) = apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addRegulator(regulator: LegalEntityRegulator) = apply { body.addRegulator(regulator) }
        ...
        /** The UUID of the parent legal entity in the service provider tree. */
        fun serviceProviderLegalEntityId(serviceProviderLegalEntityId: String?) = apply {
    ...
    private constructor(
         ...
         * Returns the raw JSON value of [businessDesignation].
         *
         * Unlike [businessDesignation], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("business_designation")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [listedExchange].
         *
         * Unlike [listedExchange], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("listed_exchange")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [tickerSymbol].
         *
         * Unlike [tickerSymbol], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("ticker_symbol")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            private var businessDesignation: JsonField<BusinessDesignation> = JsonMissing.of()
            ...
            internal fun from(legalEntityCreateRequest: LegalEntityCreateRequest) = apply {
                ...
                businessDesignation = legalEntityCreateRequest.businessDesignation
             ...
             *
             * You should usually call [Builder.businessDesignation] with a well-typed
             * [BusinessDesignation] value instead. This method is primarily for setting the field
             ...
             *
             * You should usually call [Builder.legalEntityAssociations] with a well-typed
             * `List<LegalEntityAssociationInlineCreate>` value instead. This method is primarily
            ...
            fun addLegalEntityAssociation(
                legalEntityAssociation: LegalEntityAssociationInlineCreate
            ) = apply {
                legalEntityAssociations =
             ...
             * Sets [Builder.serviceProviderLegalEntityId] to an arbitrary JSON value.
             *
             * You should usually call [Builder.serviceProviderLegalEntityId] with a well-typed
            ...
            fun tickerSymbol(tickerSymbol: String?) =
                tickerSymbol(JsonField.ofNullable(tickerSymbol))

            /**
             * Sets [Builder.tickerSymbol] to an arbitrary JSON value.
             *
             * You should usually call [Builder.tickerSymbol] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun tickerSymbol(tickerSymbol: JsonField<String>) = apply {
