...
/** create legal_entity */
class LegalEntityCreateParams private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = legalEntityCreateParams.complianceDetails().convert(MyClass::class.java)
     * ```
     */
    @Deprecated("deprecated")
    fun _complianceDetails(): JsonValue = body._complianceDetails()
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun industryClassifications(): List<LegalEntityIndustryClassification>? = body.industryClassifications()
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun legalEntityAssociations(): List<LegalEntityAssociationInlineCreate>? = body.legalEntityAssociations()
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun listedExchange(): String? = body.listedExchange()
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun regulators(): List<LegalEntityRegulator>? = body.regulators()
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun termsOfUse(): TermsOfUse? = body.termsOfUse()
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun tickerSymbol(): String? = body.tickerSymbol()

    /** @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
    fun wealthAndEmploymentDetails(): WealthAndEmploymentDetails? = body.wealthAndEmploymentDetails()
     ...
     */
    fun _industryClassifications(): JsonField<List<LegalEntityIndustryClassification>> = body._industryClassifications()
     ...
     */
    fun _legalEntityAssociations(): JsonField<List<LegalEntityAssociationInlineCreate>> = body._legalEntityAssociations()
     ...
     */
    fun _listedExchange(): JsonField<String> = body._listedExchange()
     ...
     */
    fun _regulators(): JsonField<List<LegalEntityRegulator>> = body._regulators()
     ...
     */
    @Deprecated("deprecated")
    fun _thirdPartyVerification(): JsonField<ThirdPartyVerification> = body._thirdPartyVerification()
     ...
     */
    fun _thirdPartyVerifications(): JsonField<List<ThirdPartyVerification>> = body._thirdPartyVerifications()
     ...
     */
    fun _tickerSymbol(): JsonField<String> = body._tickerSymbol()
     ...
     */
    fun _wealthAndEmploymentDetails(): JsonField<WealthAndEmploymentDetails> = body._wealthAndEmploymentDetails()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(legalEntityCreateParams: LegalEntityCreateParams) =
            apply {
         ...
         * - etc.
         */
        fun body(body: LegalEntityCreateRequest) =
            apply {
        ...
        /** A list of documents to attach to the legal entity (e.g. articles of incorporation, certificate of good standing, proof of address). */
        fun documents(documents: List<Document>) =
            apply {
        ...
        /** A list of industry classifications for the legal entity. */
        fun industryClassifications(industryClassifications: List<LegalEntityIndustryClassification>) =
            apply {
                body.industryClassifications(industryClassifications)
            }
        ...
        /** A description of the intended use of the legal entity. */
        fun intendedUse(intendedUse: String?) =
            apply {
                body.intendedUse(intendedUse)
            }
        ...
        /** The legal entity associations and its child legal entities. */
        fun legalEntityAssociations(legalEntityAssociations: List<LegalEntityAssociationInlineCreate>?) =
            apply {
                body.legalEntityAssociations(legalEntityAssociations)
            }
        ...
        fun addLegalEntityAssociation(legalEntityAssociation: LegalEntityAssociationInlineCreate) =
            apply {
                body.addLegalEntityAssociation(legalEntityAssociation)
            }
        ...
        fun listedExchange(listedExchange: String?) =
            apply {
                body.listedExchange(listedExchange)
            }
        ...
        fun addRegulator(regulator: LegalEntityRegulator) =
            apply {
                body.addRegulator(regulator)
            }

        /** The risk rating of the legal entity. One of low, medium, high. */
        fun riskRating(riskRating: RiskRating?) =
            apply {
                body.riskRating(riskRating)
            }
        ...
        /** Acceptance of terms of use by the legal entity. */
        fun termsOfUse(termsOfUse: TermsOfUse?) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LegalEntityCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "LegalEntityCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
