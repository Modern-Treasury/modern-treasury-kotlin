...
import com.moderntreasury.api.models.ChildLegalEntity
import com.moderntreasury.api.models.LegalEntityAssociation
import java.time.OffsetDateTime
import java.util.Collections
import java.util.Objects

class LegalEntityAssociation @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("child_legal_entity") @ExcludeMissing childLegalEntity: JsonField<ChildLegalEntity> = JsonMissing.of(),
        ...
        @JsonProperty("parent_legal_entity_id") @ExcludeMissing parentLegalEntityId: JsonField<String> = JsonMissing.of(),
     ...
     *
     * Unlike [parentLegalEntityId], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(legalEntityAssociation: LegalEntityAssociation) =
            apply {
        ...
        /** The child legal entity. */
        fun childLegalEntity(childLegalEntity: ChildLegalEntity) = childLegalEntity(JsonField.of(childLegalEntity))

        /**
         * Sets [Builder.childLegalEntity] to an arbitrary JSON value.
         *
         * You should usually call [Builder.childLegalEntity] with a well-typed [ChildLegalEntity] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun childLegalEntity(childLegalEntity: JsonField<ChildLegalEntity>) =
            apply {
        ...
        /** The ID of the parent legal entity. This must be a business legal entity. */
        fun parentLegalEntityId(parentLegalEntityId: String) = parentLegalEntityId(JsonField.of(parentLegalEntityId))

        /**
         * Sets [Builder.parentLegalEntityId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.parentLegalEntityId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun parentLegalEntityId(parentLegalEntityId: JsonField<String>) =
            apply {
        ...
        fun build(): LegalEntityAssociation =
            LegalEntityAssociation(
              ...
              checkRequired(
                "childLegalEntity", childLegalEntity
              ),
              checkRequired(
                "createdAt", createdAt
              ),
     ...
     *   expected type.
     */
    fun validate(): LegalEntityAssociation =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (childLegalEntity.asKnown()?.validity() ?: 0) + (if (createdAt.asKnown() == null) 0 else 1) + (if (discardedAt.asKnown() == null) 0 else 1) + (if (liveMode.asKnown() == null) 0 else 1) + (if (object_.asKnown() == null) 0 else 1) + (if (ownershipPercentage.asKnown() == null) 0 else 1) + (if (parentLegalEntityId.asKnown() == null) 0 else 1) + (relationshipTypes.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (if (title.asKnown() == null) 0 else 1) + (if (updatedAt.asKnown() == null) 0 else 1)
