...
private constructor(
    ...
    private constructor(
        ...
        @ExcludeMissing
        ledgerEventHandlerId: JsonField<String> = JsonMissing.of(),
    ...
    /**
     * Returns the raw JSON value of [ledgerEventHandlerId].
     *
     * Unlike [ledgerEventHandlerId], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("ledger_event_handler_id")
    @ExcludeMissing
    ...
    class Builder internal constructor() {
        ...
        /**
         * Sets [Builder.ledgerEventHandlerId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.ledgerEventHandlerId] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /**
         * Returns an immutable instance of [LedgerableEvent].
         *
    ...
    internal fun validity(): Int =
        (if (id.asKnown() == null) 0 else 1) +
            ...
            (if (ledgerEventHandlerId.asKnown() == null) 0 else 1) +
