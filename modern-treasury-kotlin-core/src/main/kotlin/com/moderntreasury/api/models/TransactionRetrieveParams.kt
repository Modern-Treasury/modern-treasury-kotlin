...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is TransactionRetrieveParams && this.id == other.id && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders /* spotless:on */
    }
    ...
    override fun toString() =
        "TransactionRetrieveParams{id=$id, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
