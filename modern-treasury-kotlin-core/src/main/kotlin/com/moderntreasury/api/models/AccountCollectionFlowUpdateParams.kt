...
class AccountCollectionFlowUpdateParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AccountCollectionFlowUpdateParams].
         *
    ...
    /** A builder for [AccountCollectionFlowUpdateParams]. */
    class Builder internal constructor() {

        private var id: String? = null
        private var body: AccountCollectionFlowUpdateRequest.Builder = AccountCollectionFlowUpdateRequest.builder()
        ...
        internal fun from(accountCollectionFlowUpdateParams: AccountCollectionFlowUpdateParams) =
            apply {
                ...
                additionalQueryParams = accountCollectionFlowUpdateParams.additionalQueryParams.toBuilder()
            }
         ...
         * - [status]
         */
        fun body(body: AccountCollectionFlowUpdateRequest) =
            apply {
        ...
        /**
         * Returns an immutable instance of [AccountCollectionFlowUpdateParams].
         *
    ...
    fun _body(): AccountCollectionFlowUpdateRequest = body
    ...
    class AccountCollectionFlowUpdateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [AccountCollectionFlowUpdateRequest].
             *
             * The following fields are required:
             *
             * ```kotlin
        ...
        class Builder internal constructor() {
            ...
            internal fun from(accountCollectionFlowUpdateRequest: AccountCollectionFlowUpdateRequest) =
                apply {
                    status = accountCollectionFlowUpdateRequest.status
                    additionalProperties = accountCollectionFlowUpdateRequest.additionalProperties.toMutableMap()
                }
            ...
            /**
             * Returns an immutable instance of [AccountCollectionFlowUpdateRequest].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             *
             * The following fields are required:
         ...
         *   expected type.
         */
        fun validate(): AccountCollectionFlowUpdateRequest =
            apply {
                if (validated) {
                  return@apply
                }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is AccountCollectionFlowUpdateRequest && status == other.status && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "AccountCollectionFlowUpdateRequest{status=$status, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is AccountCollectionFlowUpdateParams && id == other.id && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(id, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "AccountCollectionFlowUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
