...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         * - [status]
         */
        fun body(body: AccountCollectionFlowUpdateRequest) = apply { this.body = body.toBuilder() }
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is AccountCollectionFlowUpdateRequest &&
                status == other.status &&
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AccountCollectionFlowUpdateParams &&
            id == other.id &&
            body == other.body &&
