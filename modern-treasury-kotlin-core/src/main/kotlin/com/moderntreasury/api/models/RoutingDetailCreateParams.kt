...
class RoutingDetailCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(routingDetailCreateParams: RoutingDetailCreateParams) =
            apply {
         ...
         * - [paymentType]
         */
        fun body(body: RoutingDetailCreateRequest) =
            apply {
    ...
    class AccountsType @JsonCreator private constructor(
        private val value: JsonField<String>,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is RoutingDetailCreateParams && accountsType == other.accountsType && accountId == other.accountId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(accountsType, accountId, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "RoutingDetailCreateParams{accountsType=$accountsType, accountId=$accountId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
