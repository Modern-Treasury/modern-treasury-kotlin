...
class LedgerAccountStatementCreateResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LedgerAccountStatementCreateResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(ledgerAccountStatementCreateResponse: LedgerAccountStatementCreateResponse) =
            apply {
                ...
                ledgerAccountNormalBalance = ledgerAccountStatementCreateResponse.ledgerAccountNormalBalance
                ...
                additionalProperties = ledgerAccountStatementCreateResponse.additionalProperties.toMutableMap()
            }
     ...
     *   expected type.
     */
    fun validate(): LedgerAccountStatementCreateResponse =
        apply {
            if (validated) {
              return@apply
            }
