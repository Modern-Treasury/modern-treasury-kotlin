...
class Invoice @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("amount_remaining") @ExcludeMissing amountRemaining: JsonField<Long> = JsonMissing.of(),
        @JsonProperty("contact_details") @ExcludeMissing contactDetails: JsonField<List<ContactDetail>> = JsonMissing.of(),
        @JsonProperty("counterparty_billing_address") @ExcludeMissing counterpartyBillingAddress: JsonField<CounterpartyBillingAddress> = JsonMissing.of(),
        @JsonProperty("counterparty_id") @ExcludeMissing counterpartyId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("counterparty_shipping_address") @ExcludeMissing counterpartyShippingAddress: JsonField<CounterpartyShippingAddress> = JsonMissing.of(),
        ...
        @JsonProperty("due_date") @ExcludeMissing dueDate: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("expected_payments") @ExcludeMissing expectedPayments: JsonField<List<ExpectedPayment>> = JsonMissing.of(),
        @JsonProperty("fallback_payment_method") @ExcludeMissing fallbackPaymentMethod: JsonField<String> = JsonMissing.of(),
        @JsonProperty("hosted_url") @ExcludeMissing hostedUrl: JsonField<String> = JsonMissing.of(),
        @JsonProperty("invoicer_address") @ExcludeMissing invoicerAddress: JsonField<InvoicerAddress> = JsonMissing.of(),
        @JsonProperty("invoicer_name") @ExcludeMissing invoicerName: JsonField<String> = JsonMissing.of(),
        @JsonProperty("issued_at") @ExcludeMissing issuedAt: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("ledger_account_settlement_id") @ExcludeMissing ledgerAccountSettlementId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("live_mode") @ExcludeMissing liveMode: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("metadata") @ExcludeMissing metadata: JsonField<Metadata> = JsonMissing.of(),
        @JsonProperty("notification_email_addresses") @ExcludeMissing notificationEmailAddresses: JsonField<List<String>> = JsonMissing.of(),
        @JsonProperty("notifications_enabled") @ExcludeMissing notificationsEnabled: JsonField<Boolean> = JsonMissing.of(),
        ...
        @JsonProperty("paid_at") @ExcludeMissing paidAt: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("payment_effective_date") @ExcludeMissing paymentEffectiveDate: JsonField<LocalDate> = JsonMissing.of(),
        @JsonProperty("payment_method") @ExcludeMissing paymentMethod: JsonField<PaymentMethod> = JsonMissing.of(),
        @JsonProperty("payment_orders") @ExcludeMissing paymentOrders: JsonField<List<PaymentOrder>> = JsonMissing.of(),
        ...
        @JsonProperty("recipient_email") @ExcludeMissing recipientEmail: JsonField<String> = JsonMissing.of(),
        @JsonProperty("recipient_name") @ExcludeMissing recipientName: JsonField<String> = JsonMissing.of(),
        @JsonProperty("remind_after_overdue_days") @ExcludeMissing remindAfterOverdueDays: JsonField<List<Long>> = JsonMissing.of(),
        @JsonProperty("status") @ExcludeMissing status: JsonField<Status> = JsonMissing.of(),
        @JsonProperty("total_amount") @ExcludeMissing totalAmount: JsonField<Long> = JsonMissing.of(),
        @JsonProperty("transaction_line_item_ids") @ExcludeMissing transactionLineItemIds: JsonField<List<String>> = JsonMissing.of(),
        @JsonProperty("updated_at") @ExcludeMissing updatedAt: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("virtual_account_id") @ExcludeMissing virtualAccountId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("voided_at") @ExcludeMissing voidedAt: JsonField<OffsetDateTime> = JsonMissing.of()
    ) : this(
      id,
      amountPaid,
      amountRemaining,
     ...
     */
    fun counterpartyBillingAddress(): CounterpartyBillingAddress? = counterpartyBillingAddress.getNullable("counterparty_billing_address")
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun counterpartyShippingAddress(): CounterpartyShippingAddress? = counterpartyShippingAddress.getNullable("counterparty_shipping_address")
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun expectedPayments(): List<ExpectedPayment> = expectedPayments.getRequired("expected_payments")
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun fallbackPaymentMethod(): String? = fallbackPaymentMethod.getNullable("fallback_payment_method")
    ...
    fun ledgerAccountSettlementId(): String? = ledgerAccountSettlementId.getNullable("ledger_account_settlement_id")
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun notificationEmailAddresses(): List<String>? = notificationEmailAddresses.getNullable("notification_email_addresses")
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun paymentEffectiveDate(): LocalDate? = paymentEffectiveDate.getNullable("payment_effective_date")
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun remindAfterOverdueDays(): List<Long>? = remindAfterOverdueDays.getNullable("remind_after_overdue_days")
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun transactionLineItemIds(): List<String> = transactionLineItemIds.getRequired("transaction_line_item_ids")
    ...
    @ExcludeMissing
    fun _amountPaid(): JsonField<Long> = amountPaid
     ...
     *
     * Unlike [counterpartyBillingAddress], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("counterparty_billing_address")
    @ExcludeMissing
    fun _counterpartyBillingAddress(): JsonField<CounterpartyBillingAddress> = counterpartyBillingAddress
     ...
     *
     * Unlike [counterpartyShippingAddress], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("counterparty_shipping_address")
    @ExcludeMissing
    fun _counterpartyShippingAddress(): JsonField<CounterpartyShippingAddress> = counterpartyShippingAddress
     ...
     *
     * Unlike [expectedPayments], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [fallbackPaymentMethod], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @ExcludeMissing
    fun _hostedUrl(): JsonField<String> = hostedUrl
     ...
     *
     * Unlike [ledgerAccountSettlementId], this method doesn't throw if the JSON field has an unexpected type.
     */
    @Deprecated("deprecated")
     ...
     *
     * Unlike [notificationEmailAddresses], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [notificationsEnabled], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [paymentEffectiveDate], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @ExcludeMissing
    fun _pdfUrl(): JsonField<String> = pdfUrl
     ...
     *
     * Unlike [remindAfterOverdueDays], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [transactionLineItemIds], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [virtualAccountId], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(invoice: Invoice) =
            apply {
                ...
                notificationEmailAddresses = invoice.notificationEmailAddresses.map { it.toMutableList() }
         ...
         *
         * You should usually call [Builder.amountPaid] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun amountPaid(amountPaid: JsonField<Long>) =
            apply {
         ...
         *
         * You should usually call [Builder.amountRemaining] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun amountRemaining(amountRemaining: JsonField<Long>) =
            apply {
                this.amountRemaining = amountRemaining
            }

        /** The invoicer's contact details displayed at the top of the invoice. */
        fun contactDetails(contactDetails: List<ContactDetail>) = contactDetails(JsonField.of(contactDetails))

        /**
         * Sets [Builder.contactDetails] to an arbitrary JSON value.
         *
         * You should usually call [Builder.contactDetails] with a well-typed `List<ContactDetail>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun contactDetails(contactDetails: JsonField<List<ContactDetail>>) =
            apply {
        ...
        /** The counterparty's billing address. */
        fun counterpartyBillingAddress(counterpartyBillingAddress: CounterpartyBillingAddress?) = counterpartyBillingAddress(JsonField.ofNullable(counterpartyBillingAddress))

        /**
         * Sets [Builder.counterpartyBillingAddress] to an arbitrary JSON value.
         *
         * You should usually call [Builder.counterpartyBillingAddress] with a well-typed [CounterpartyBillingAddress] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun counterpartyBillingAddress(counterpartyBillingAddress: JsonField<CounterpartyBillingAddress>) =
            apply {
        ...
        /** The counterparty's shipping address where physical goods should be delivered. */
        fun counterpartyShippingAddress(counterpartyShippingAddress: CounterpartyShippingAddress?) = counterpartyShippingAddress(JsonField.ofNullable(counterpartyShippingAddress))

        /**
         * Sets [Builder.counterpartyShippingAddress] to an arbitrary JSON value.
         *
         * You should usually call [Builder.counterpartyShippingAddress] with a well-typed [CounterpartyShippingAddress] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun counterpartyShippingAddress(counterpartyShippingAddress: JsonField<CounterpartyShippingAddress>) =
            apply {
         ...
         *
         * You should usually call [Builder.dueDate] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /** The expected payments created for an unpaid invoice. */
        fun expectedPayments(expectedPayments: List<ExpectedPayment>) = expectedPayments(JsonField.of(expectedPayments))

        /**
         * Sets [Builder.expectedPayments] to an arbitrary JSON value.
         *
         * You should usually call [Builder.expectedPayments] with a well-typed `List<ExpectedPayment>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun expectedPayments(expectedPayments: JsonField<List<ExpectedPayment>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addExpectedPayment(expectedPayment: ExpectedPayment) =
            apply {
                expectedPayments = (expectedPayments ?: JsonField.of(mutableListOf())).also {
                    checkKnown("expectedPayments", it).add(expectedPayment)
                }
            }

        /** When payment_method is automatic, the fallback payment method to use when an automatic payment fails. One of `manual` or `ui`. */
        fun fallbackPaymentMethod(fallbackPaymentMethod: String?) = fallbackPaymentMethod(JsonField.ofNullable(fallbackPaymentMethod))

        /**
         * Sets [Builder.fallbackPaymentMethod] to an arbitrary JSON value.
         *
         * You should usually call [Builder.fallbackPaymentMethod] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fallbackPaymentMethod(fallbackPaymentMethod: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.hostedUrl] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun hostedUrl(hostedUrl: JsonField<String>) =
            apply {
                this.hostedUrl = hostedUrl
            }

        /** The invoice issuer's business address. */
        fun invoicerAddress(invoicerAddress: InvoicerAddress?) = invoicerAddress(JsonField.ofNullable(invoicerAddress))

        /**
         * Sets [Builder.invoicerAddress] to an arbitrary JSON value.
         *
         * You should usually call [Builder.invoicerAddress] with a well-typed [InvoicerAddress] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun invoicerAddress(invoicerAddress: JsonField<InvoicerAddress>) =
            apply {
         ...
         *
         * You should usually call [Builder.invoicerName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun invoicerName(invoicerName: JsonField<String>) =
            apply {
        ...
        /** The ledger account settlement object linked to the invoice. */
        @Deprecated("deprecated")
        fun ledgerAccountSettlementId(ledgerAccountSettlementId: String?) = ledgerAccountSettlementId(JsonField.ofNullable(ledgerAccountSettlementId))

        /**
         * Sets [Builder.ledgerAccountSettlementId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.ledgerAccountSettlementId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        @Deprecated("deprecated")
        fun ledgerAccountSettlementId(ledgerAccountSettlementId: JsonField<String>) =
            apply {
        ...
        /** Emails in addition to the counterparty email to send invoice status notifications to. At least one email is required if notifications are enabled and the counterparty doesn't have an email. */
        fun notificationEmailAddresses(notificationEmailAddresses: List<String>?) = notificationEmailAddresses(JsonField.ofNullable(notificationEmailAddresses))

        /**
         * Sets [Builder.notificationEmailAddresses] to an arbitrary JSON value.
         *
         * You should usually call [Builder.notificationEmailAddresses] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun notificationEmailAddresses(notificationEmailAddresses: JsonField<List<String>>) =
            apply {
                this.notificationEmailAddresses = notificationEmailAddresses.map { it.toMutableList() }
            }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addNotificationEmailAddress(notificationEmailAddress: String) =
            apply {
                notificationEmailAddresses = (notificationEmailAddresses ?: JsonField.of(mutableListOf())).also {
                    checkKnown("notificationEmailAddresses", it).add(notificationEmailAddress)
                }
            }

        /** If true, the invoice will send email notifications to the invoice recipients about invoice status changes. */
        fun notificationsEnabled(notificationsEnabled: Boolean) = notificationsEnabled(JsonField.of(notificationsEnabled))

        /**
         * Sets [Builder.notificationsEnabled] to an arbitrary JSON value.
         *
         * You should usually call [Builder.notificationsEnabled] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun notificationsEnabled(notificationsEnabled: JsonField<Boolean>) =
            apply {
         ...
         *
         * You should usually call [Builder.number] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun number(number: JsonField<String>) =
            apply {
                this.number = number
            }
         ...
         *
         * You should usually call [Builder.paidAt] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /** Date transactions are to be posted to the participants' account. Defaults to the current business day or the next business day if the current day is a bank holiday or weekend. Format: yyyy-mm-dd. */
        fun paymentEffectiveDate(paymentEffectiveDate: LocalDate?) = paymentEffectiveDate(JsonField.ofNullable(paymentEffectiveDate))

        /**
         * Sets [Builder.paymentEffectiveDate] to an arbitrary JSON value.
         *
         * You should usually call [Builder.paymentEffectiveDate] with a well-typed [LocalDate] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun paymentEffectiveDate(paymentEffectiveDate: JsonField<LocalDate>) =
            apply {
                this.paymentEffectiveDate = paymentEffectiveDate
            }

        /** When opening an invoice, whether to show the embedded payment UI , automatically debit the recipient, or rely on manual payment from the recipient. */
        fun paymentMethod(paymentMethod: PaymentMethod?) = paymentMethod(JsonField.ofNullable(paymentMethod))

        /**
         * Sets [Builder.paymentMethod] to an arbitrary JSON value.
         *
         * You should usually call [Builder.paymentMethod] with a well-typed [PaymentMethod] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun paymentMethod(paymentMethod: JsonField<PaymentMethod>) =
            apply {
                this.paymentMethod = paymentMethod
            }

        /** The payment orders created for paying the invoice through the invoice payment UI. */
        fun paymentOrders(paymentOrders: List<PaymentOrder>) = paymentOrders(JsonField.of(paymentOrders))

        /**
         * Sets [Builder.paymentOrders] to an arbitrary JSON value.
         *
         * You should usually call [Builder.paymentOrders] with a well-typed `List<PaymentOrder>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun paymentOrders(paymentOrders: JsonField<List<PaymentOrder>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addPaymentOrder(paymentOrder: PaymentOrder) =
            apply {
                paymentOrders = (paymentOrders ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.pdfUrl] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun pdfUrl(pdfUrl: JsonField<String>) =
            apply {
                this.pdfUrl = pdfUrl
            }

        /** The receiving account ID. Can be an `internal_account`. */
        fun receivingAccountId(receivingAccountId: String?) = receivingAccountId(JsonField.ofNullable(receivingAccountId))
        ...
        /** The email of the recipient of the invoice. Leaving this value as null will fallback to using the counterparty's name. */
        fun recipientEmail(recipientEmail: String?) = recipientEmail(JsonField.ofNullable(recipientEmail))

        /**
         * Sets [Builder.recipientEmail] to an arbitrary JSON value.
         *
         * You should usually call [Builder.recipientEmail] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun recipientEmail(recipientEmail: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.recipientName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /** Number of days after due date when overdue reminder emails will be sent out to invoice recipients. */
        fun remindAfterOverdueDays(remindAfterOverdueDays: List<Long>?) = remindAfterOverdueDays(JsonField.ofNullable(remindAfterOverdueDays))

        /**
         * Sets [Builder.remindAfterOverdueDays] to an arbitrary JSON value.
         *
         * You should usually call [Builder.remindAfterOverdueDays] with a well-typed `List<Long>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun remindAfterOverdueDays(remindAfterOverdueDays: JsonField<List<Long>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addRemindAfterOverdueDay(remindAfterOverdueDay: Long) =
            apply {
                remindAfterOverdueDays = (remindAfterOverdueDays ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.totalAmount] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun totalAmount(totalAmount: JsonField<Long>) =
            apply {
                this.totalAmount = totalAmount
            }

        /** IDs of transaction line items associated with an invoice. */
        fun transactionLineItemIds(transactionLineItemIds: List<String>) = transactionLineItemIds(JsonField.of(transactionLineItemIds))

        /**
         * Sets [Builder.transactionLineItemIds] to an arbitrary JSON value.
         *
         * You should usually call [Builder.transactionLineItemIds] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun transactionLineItemIds(transactionLineItemIds: JsonField<List<String>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addTransactionLineItemId(transactionLineItemId: String) =
            apply {
                transactionLineItemIds = (transactionLineItemIds ?: JsonField.of(mutableListOf())).also {
        ...
        /** The ID of the virtual account the invoice should be paid to. */
        fun virtualAccountId(virtualAccountId: String?) = virtualAccountId(JsonField.ofNullable(virtualAccountId))

        /**
         * Sets [Builder.virtualAccountId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.virtualAccountId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun virtualAccountId(virtualAccountId: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.voidedAt] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        fun build(): Invoice =
            Invoice(
              ...
              checkRequired(
                "remindAfterOverdueDays", remindAfterOverdueDays
              ).map { it.toImmutable() },
              checkRequired(
                "status", status
              ),
              ...
              checkRequired(
                "transactionLineItemIds", transactionLineItemIds
              ).map { it.toImmutable() },
              checkRequired(
                "updatedAt", updatedAt
              ),
     ...
     */
    internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (if (amountPaid.asKnown() == null) 0 else 1) + (if (amountRemaining.asKnown() == null) 0 else 1) + (contactDetails.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (counterpartyBillingAddress.asKnown()?.validity() ?: 0) + (if (counterpartyId.asKnown() == null) 0 else 1) + (counterpartyShippingAddress.asKnown()?.validity() ?: 0) + (if (createdAt.asKnown() == null) 0 else 1) + (currency.asKnown()?.validity() ?: 0) + (if (description.asKnown() == null) 0 else 1) + (if (dueDate.asKnown() == null) 0 else 1) + (expectedPayments.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (if (fallbackPaymentMethod.asKnown() == null) 0 else 1) + (if (hostedUrl.asKnown() == null) 0 else 1) + (invoicerAddress.asKnown()?.validity() ?: 0) + (if (invoicerName.asKnown() == null) 0 else 1) + (if (issuedAt.asKnown() == null) 0 else 1) + (if (ledgerAccountSettlementId.asKnown() == null) 0 else 1) + (if (liveMode.asKnown() == null) 0 else 1) + (metadata.asKnown()?.validity() ?: 0) + (notificationEmailAddresses.asKnown()?.size ?: 0) + (if (notificationsEnabled.asKnown() == null) 0 else 1) + (if (number.asKnown() == null) 0 else 1) + (if (object_.asKnown() == null) 0 else 1) + (if (originatingAccountId.asKnown() == null) 0 else 1) + (if (paidAt.asKnown() == null) 0 else 1) + (if (paymentEffectiveDate.asKnown() == null) 0 else 1) + (paymentMethod.asKnown()?.validity() ?: 0) + (paymentOrders.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (paymentType.asKnown()?.validity() ?: 0) + (if (pdfUrl.asKnown() == null) 0 else 1) + (if (receivingAccountId.asKnown() == null) 0 else 1) + (if (recipientEmail.asKnown() == null) 0 else 1) + (if (recipientName.asKnown() == null) 0 else 1) + (remindAfterOverdueDays.asKnown()?.size ?: 0) + (status.asKnown()?.validity() ?: 0) + (if (totalAmount.asKnown() == null) 0 else 1) + (transactionLineItemIds.asKnown()?.size ?: 0) + (if (updatedAt.asKnown() == null) 0 else 1) + (if (virtualAccountId.asKnown() == null) 0 else 1) + (if (voidedAt.asKnown() == null) 0 else 1)

    /** The counterparty's billing address. */
    class CounterpartyBillingAddress @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [CounterpartyBillingAddress].
             *
             * The following fields are required:
             *
             * ```kotlin
        ...
        class Builder internal constructor() {
            ...
            internal fun from(counterpartyBillingAddress: CounterpartyBillingAddress) =
                apply {
                    ...
                    additionalProperties = counterpartyBillingAddress.additionalProperties.toMutableMap()
                }
         ...
         *   expected type.
         */
        fun validate(): CounterpartyBillingAddress =
            apply {
                if (validated) {
                  return@apply
                }
         ...
         * Used for best match union deserialization.
         */
        internal fun validity(): Int = (if (country.asKnown() == null) 0 else 1) + (if (line1.asKnown() == null) 0 else 1) + (if (locality.asKnown() == null) 0 else 1) + (if (postalCode.asKnown() == null) 0 else 1) + (if (region.asKnown() == null) 0 else 1) + (if (line2.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is CounterpartyBillingAddress && country == other.country && line1 == other.line1 && locality == other.locality && postalCode == other.postalCode && region == other.region && line2 == other.line2 && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "CounterpartyBillingAddress{country=$country, line1=$line1, locality=$locality, postalCode=$postalCode, region=$region, line2=$line2, additionalProperties=$additionalProperties}"
    }

    /** The counterparty's shipping address where physical goods should be delivered. */
    class CounterpartyShippingAddress @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        private val country: JsonField<String>,
        private val line1: JsonField<String>,
        private val locality: JsonField<String>,
        private val postalCode: JsonField<String>,
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [CounterpartyShippingAddress].
             *
             * The following fields are required:
             *
             * ```kotlin
        ...
        class Builder internal constructor() {
            ...
            internal fun from(counterpartyShippingAddress: CounterpartyShippingAddress) =
                apply {
                    ...
                    additionalProperties = counterpartyShippingAddress.additionalProperties.toMutableMap()
                }
         ...
         *   expected type.
         */
        fun validate(): CounterpartyShippingAddress =
            apply {
                if (validated) {
                  return@apply
                }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is CounterpartyShippingAddress && country == other.country && line1 == other.line1 && locality == other.locality && postalCode == other.postalCode && region == other.region && line2 == other.line2 && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "CounterpartyShippingAddress{country=$country, line1=$line1, locality=$locality, postalCode=$postalCode, region=$region, line2=$line2, additionalProperties=$additionalProperties}"
    }

    /** The invoice issuer's business address. */
    class InvoicerAddress @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        private val country: JsonField<String>,
        private val line1: JsonField<String>,
        private val locality: JsonField<String>,
        private val postalCode: JsonField<String>,
        ...
        class Builder internal constructor() {
            ...
            internal fun from(invoicerAddress: InvoicerAddress) =
                apply {
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is InvoicerAddress && country == other.country && line1 == other.line1 && locality == other.locality && postalCode == other.postalCode && region == other.region && line2 == other.line2 && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "InvoicerAddress{country=$country, line1=$line1, locality=$locality, postalCode=$postalCode, region=$region, line2=$line2, additionalProperties=$additionalProperties}"
    }
    ...
    /** When opening an invoice, whether to show the embedded payment UI , automatically debit the recipient, or rely on manual payment from the recipient. */
    class PaymentMethod @JsonCreator private constructor(
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is Invoice && id == other.id && amountPaid == other.amountPaid && amountRemaining == other.amountRemaining && contactDetails == other.contactDetails && counterpartyBillingAddress == other.counterpartyBillingAddress && counterpartyId == other.counterpartyId && counterpartyShippingAddress == other.counterpartyShippingAddress && createdAt == other.createdAt && currency == other.currency && description == other.description && dueDate == other.dueDate && expectedPayments == other.expectedPayments && fallbackPaymentMethod == other.fallbackPaymentMethod && hostedUrl == other.hostedUrl && invoicerAddress == other.invoicerAddress && invoicerName == other.invoicerName && issuedAt == other.issuedAt && ledgerAccountSettlementId == other.ledgerAccountSettlementId && liveMode == other.liveMode && metadata == other.metadata && notificationEmailAddresses == other.notificationEmailAddresses && notificationsEnabled == other.notificationsEnabled && number == other.number && object_ == other.object_ && originatingAccountId == other.originatingAccountId && paidAt == other.paidAt && paymentEffectiveDate == other.paymentEffectiveDate && paymentMethod == other.paymentMethod && paymentOrders == other.paymentOrders && paymentType == other.paymentType && pdfUrl == other.pdfUrl && receivingAccountId == other.receivingAccountId && recipientEmail == other.recipientEmail && recipientName == other.recipientName && remindAfterOverdueDays == other.remindAfterOverdueDays && status == other.status && totalAmount == other.totalAmount && transactionLineItemIds == other.transactionLineItemIds && updatedAt == other.updatedAt && virtualAccountId == other.virtualAccountId && voidedAt == other.voidedAt && additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(id, amountPaid, amountRemaining, contactDetails, counterpartyBillingAddress, counterpartyId, counterpartyShippingAddress, createdAt, currency, description, dueDate, expectedPayments, fallbackPaymentMethod, hostedUrl, invoicerAddress, invoicerName, issuedAt, ledgerAccountSettlementId, liveMode, metadata, notificationEmailAddresses, notificationsEnabled, number, object_, originatingAccountId, paidAt, paymentEffectiveDate, paymentMethod, paymentOrders, paymentType, pdfUrl, receivingAccountId, recipientEmail, recipientName, remindAfterOverdueDays, status, totalAmount, transactionLineItemIds, updatedAt, virtualAccountId, voidedAt, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() = "Invoice{id=$id, amountPaid=$amountPaid, amountRemaining=$amountRemaining, contactDetails=$contactDetails, counterpartyBillingAddress=$counterpartyBillingAddress, counterpartyId=$counterpartyId, counterpartyShippingAddress=$counterpartyShippingAddress, createdAt=$createdAt, currency=$currency, description=$description, dueDate=$dueDate, expectedPayments=$expectedPayments, fallbackPaymentMethod=$fallbackPaymentMethod, hostedUrl=$hostedUrl, invoicerAddress=$invoicerAddress, invoicerName=$invoicerName, issuedAt=$issuedAt, ledgerAccountSettlementId=$ledgerAccountSettlementId, liveMode=$liveMode, metadata=$metadata, notificationEmailAddresses=$notificationEmailAddresses, notificationsEnabled=$notificationsEnabled, number=$number, object_=$object_, originatingAccountId=$originatingAccountId, paidAt=$paidAt, paymentEffectiveDate=$paymentEffectiveDate, paymentMethod=$paymentMethod, paymentOrders=$paymentOrders, paymentType=$paymentType, pdfUrl=$pdfUrl, receivingAccountId=$receivingAccountId, recipientEmail=$recipientEmail, recipientName=$recipientName, remindAfterOverdueDays=$remindAfterOverdueDays, status=$status, totalAmount=$totalAmount, transactionLineItemIds=$transactionLineItemIds, updatedAt=$updatedAt, virtualAccountId=$virtualAccountId, voidedAt=$voidedAt, additionalProperties=$additionalProperties}"
}
