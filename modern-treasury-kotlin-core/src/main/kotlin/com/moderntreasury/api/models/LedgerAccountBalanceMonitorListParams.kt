...
class LedgerAccountBalanceMonitorListParams private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [LedgerAccountBalanceMonitorListParams]. */
        fun builder() = Builder()
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(ledgerAccountBalanceMonitorListParams: LedgerAccountBalanceMonitorListParams) =
            apply {
                ...
                additionalQueryParams = ledgerAccountBalanceMonitorListParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LedgerAccountBalanceMonitorListParams && id == other.id && afterCursor == other.afterCursor && ledgerAccountId == other.ledgerAccountId && metadata == other.metadata && perPage == other.perPage && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(id, afterCursor, ledgerAccountId, metadata, perPage, additionalHeaders, additionalQueryParams)

    override fun toString() = "LedgerAccountBalanceMonitorListParams{id=$id, afterCursor=$afterCursor, ledgerAccountId=$ledgerAccountId, metadata=$metadata, perPage=$perPage, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
