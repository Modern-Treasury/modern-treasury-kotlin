...
/** get event */
class EventRetrieveParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(eventRetrieveParams: EventRetrieveParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is EventRetrieveParams && id == other.id && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(id, additionalHeaders, additionalQueryParams)

    override fun toString() = "EventRetrieveParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
