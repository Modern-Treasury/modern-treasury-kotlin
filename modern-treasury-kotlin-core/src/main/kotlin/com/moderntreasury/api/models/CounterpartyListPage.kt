...
class CounterpartyListPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(counterpartyListPage: CounterpartyListPage) =
            apply {
        ...
        fun service(service: CounterpartyService) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CounterpartyListPage && service == other.service && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, params, headers, items)

    override fun toString() = "CounterpartyListPage{service=$service, params=$params, headers=$headers, items=$items}"
}
