...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LedgerEventHandlerListPageAsync && this.ledgerEventHandlersService == other.ledgerEventHandlersService && this.params == other.params && this.response == other.response /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(ledgerEventHandlersService, params, response) /* spotless:on */
    }
    ...
    constructor(
        ...
        override fun toString() =
            "LedgerEventHandlerListPageAsync.Response{items=$items, additionalProperties=$additionalProperties}"
