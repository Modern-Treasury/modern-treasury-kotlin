...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ConnectionLegalEntityListPageAsync && this.connectionLegalEntitiesService == other.connectionLegalEntitiesService && this.params == other.params && this.response == other.response /* spotless:on */
    }
