...
class ValidationValidateRoutingNumberParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ValidationValidateRoutingNumberParams].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(validationValidateRoutingNumberParams: ValidationValidateRoutingNumberParams) =
            apply {
                ...
                additionalQueryParams = validationValidateRoutingNumberParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ValidationValidateRoutingNumberParams && routingNumber == other.routingNumber && routingNumberType == other.routingNumberType && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(routingNumber, routingNumberType, additionalHeaders, additionalQueryParams)

    override fun toString() = "ValidationValidateRoutingNumberParams{routingNumber=$routingNumber, routingNumberType=$routingNumberType, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
