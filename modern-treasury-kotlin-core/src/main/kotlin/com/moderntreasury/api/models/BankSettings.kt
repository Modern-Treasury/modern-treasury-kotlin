...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BankSettings && this.id == other.id && this.object_ == other.object_ && this.liveMode == other.liveMode && this.createdAt == other.createdAt && this.updatedAt == other.updatedAt && this.discardedAt == other.discardedAt && this.enableBackupWithholding == other.enableBackupWithholding && this.backupWithholdingPercentage == other.backupWithholdingPercentage && this.privacyOptOut == other.privacyOptOut && this.regulationO == other.regulationO && this.additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun hashCode(): Int {
        if (hashCode == 0) {
            hashCode = /* spotless:off */ Objects.hash(id, object_, liveMode, createdAt, updatedAt, discardedAt, enableBackupWithholding, backupWithholdingPercentage, privacyOptOut, regulationO, additionalProperties) /* spotless:on */
        }
        return hashCode
    }
