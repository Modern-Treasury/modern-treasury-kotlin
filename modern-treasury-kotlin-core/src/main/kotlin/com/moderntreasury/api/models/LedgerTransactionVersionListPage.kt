...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LedgerTransactionVersionListPage && this.versionsService == other.versionsService && this.params == other.params && this.response == other.response /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(versionsService, params, response) /* spotless:on */
    }
    ...
    constructor(
        ...
        override fun toString() =
            "LedgerTransactionVersionListPage.Response{items=$items, additionalProperties=$additionalProperties}"
