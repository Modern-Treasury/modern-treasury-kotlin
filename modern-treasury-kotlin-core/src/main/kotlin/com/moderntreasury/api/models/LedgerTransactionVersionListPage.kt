...
class LedgerTransactionVersionListPage private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LedgerTransactionVersionListPage].
         *
    ...
    class Builder internal constructor() {
        ...
        fun service(service: VersionService) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LedgerTransactionVersionListPage && service == other.service && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, params, headers, items)

    override fun toString() = "LedgerTransactionVersionListPage{service=$service, params=$params, headers=$headers, items=$items}"
}
