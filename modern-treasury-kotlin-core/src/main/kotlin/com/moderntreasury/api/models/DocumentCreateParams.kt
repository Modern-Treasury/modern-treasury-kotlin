...
/** Create a document. */
class DocumentCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(documentCreateParams: DocumentCreateParams) =
            apply {
         ...
         * - [documentableType]
         */
        fun body(body: DocumentCreateRequest) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is DocumentCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "DocumentCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
