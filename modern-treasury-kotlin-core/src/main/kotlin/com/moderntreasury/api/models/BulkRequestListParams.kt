...
constructor(
    ...
    override fun toString() =
        "BulkRequestListParams{actionType=$actionType, afterCursor=$afterCursor, metadata=$metadata, perPage=$perPage, resourceType=$resourceType, status=$status, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(bulkRequestListParams: BulkRequestListParams) = apply {
            ...
            additionalBodyProperties(bulkRequestListParams.additionalBodyProperties)
        }
