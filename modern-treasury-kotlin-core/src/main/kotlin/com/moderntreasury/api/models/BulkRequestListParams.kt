...
/** list bulk_requests */
class BulkRequestListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(bulkRequestListParams: BulkRequestListParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is BulkRequestListParams && actionType == other.actionType && afterCursor == other.afterCursor && metadata == other.metadata && perPage == other.perPage && resourceType == other.resourceType && status == other.status && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(actionType, afterCursor, metadata, perPage, resourceType, status, additionalHeaders, additionalQueryParams)

    override fun toString() = "BulkRequestListParams{actionType=$actionType, afterCursor=$afterCursor, metadata=$metadata, perPage=$perPage, resourceType=$resourceType, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
