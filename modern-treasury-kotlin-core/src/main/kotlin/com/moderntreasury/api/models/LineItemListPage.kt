...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LineItemListPage && lineItemsService == other.lineItemsService && params == other.params && response == other.response /* spotless:on */
    }
    ...
    @JsonCreator
    constructor(
        @JsonProperty("items") private val items: JsonField<List<LineItem>> = JsonMissing.of(),
