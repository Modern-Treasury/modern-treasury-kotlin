...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LineItemListPage && this.lineItemsService == other.lineItemsService && this.params == other.params && this.response == other.response /* spotless:on */
    }
    ...
    constructor(
        ...
        override fun toString() =
            "LineItemListPage.Response{items=$items, additionalProperties=$additionalProperties}"
