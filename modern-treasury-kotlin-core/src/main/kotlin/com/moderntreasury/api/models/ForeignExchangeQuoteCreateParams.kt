...
class ForeignExchangeQuoteCreateParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ForeignExchangeQuoteCreateParams].
         *
    ...
    class Builder internal constructor() {
        ...
        private var body: ForeignExchangeQuoteCreateRequest.Builder = ForeignExchangeQuoteCreateRequest.builder()
        ...
        internal fun from(foreignExchangeQuoteCreateParams: ForeignExchangeQuoteCreateParams) =
            apply {
                ...
                additionalQueryParams = foreignExchangeQuoteCreateParams.additionalQueryParams.toBuilder()
            }
         ...
         * - etc.
         */
        fun body(body: ForeignExchangeQuoteCreateRequest) =
            apply {
         ...
         *
         * You should usually call [Builder.targetCurrency] with a well-typed [Currency] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun targetCurrency(targetCurrency: JsonField<Currency>) =
            apply {
                body.targetCurrency(targetCurrency)
            }

        /** Amount in the lowest denomination of the `base_currency` to convert, often called the "sell" amount. */
        fun baseAmount(baseAmount: Long) =
            apply {
         ...
         *
         * You should usually call [Builder.baseAmount] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun baseAmount(baseAmount: JsonField<Long>) =
            apply {
                body.baseAmount(baseAmount)
            }

        /** Currency to convert, often called the "sell" currency. */
        fun baseCurrency(baseCurrency: Currency) =
            apply {
         ...
         *
         * You should usually call [Builder.baseCurrency] with a well-typed [Currency] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun baseCurrency(baseCurrency: JsonField<Currency>) =
            apply {
                body.baseCurrency(baseCurrency)
            }
        ...
        /** Amount in the lowest denomination of the `target_currency`, often called the "buy" amount. */
        fun targetAmount(targetAmount: Long) =
            apply {
         ...
         *
         * You should usually call [Builder.targetAmount] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun targetAmount(targetAmount: JsonField<Long>) =
            apply {
                body.targetAmount(targetAmount)
            }
    ...
    class ForeignExchangeQuoteCreateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("target_currency") @ExcludeMissing targetCurrency: JsonField<Currency> = JsonMissing.of(),
            @JsonProperty("base_amount") @ExcludeMissing baseAmount: JsonField<Long> = JsonMissing.of(),
            @JsonProperty("base_currency") @ExcludeMissing baseCurrency: JsonField<Currency> = JsonMissing.of(),
            @JsonProperty("effective_at") @ExcludeMissing effectiveAt: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("target_amount") @ExcludeMissing targetAmount: JsonField<Long> = JsonMissing.of()
        ) : this(
          internalAccountId,
          targetCurrency,
          baseAmount,
        ...
        @ExcludeMissing
        fun _baseAmount(): JsonField<Long> = baseAmount
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [ForeignExchangeQuoteCreateRequest].
             *
             * The following fields are required:
             *
             * ```kotlin
        ...
        class Builder internal constructor() {
            ...
            internal fun from(foreignExchangeQuoteCreateRequest: ForeignExchangeQuoteCreateRequest) =
                apply {
                    ...
                    additionalProperties = foreignExchangeQuoteCreateRequest.additionalProperties.toMutableMap()
                }
         ...
         *   expected type.
         */
        fun validate(): ForeignExchangeQuoteCreateRequest =
            apply {
                if (validated) {
                  return@apply
                }
         ...
         */
        internal fun validity(): Int = (if (internalAccountId.asKnown() == null) 0 else 1) + (targetCurrency.asKnown()?.validity() ?: 0) + (if (baseAmount.asKnown() == null) 0 else 1) + (baseCurrency.asKnown()?.validity() ?: 0) + (if (effectiveAt.asKnown() == null) 0 else 1) + (if (targetAmount.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is ForeignExchangeQuoteCreateRequest && internalAccountId == other.internalAccountId && targetCurrency == other.targetCurrency && baseAmount == other.baseAmount && baseCurrency == other.baseCurrency && effectiveAt == other.effectiveAt && targetAmount == other.targetAmount && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "ForeignExchangeQuoteCreateRequest{internalAccountId=$internalAccountId, targetCurrency=$targetCurrency, baseAmount=$baseAmount, baseCurrency=$baseCurrency, effectiveAt=$effectiveAt, targetAmount=$targetAmount, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ForeignExchangeQuoteCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "ForeignExchangeQuoteCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
