...
class VirtualAccountListPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(virtualAccountListPage: VirtualAccountListPage) =
            apply {
        ...
        fun service(service: VirtualAccountService) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is VirtualAccountListPage && service == other.service && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, params, headers, items)

    override fun toString() = "VirtualAccountListPage{service=$service, params=$params, headers=$headers, items=$items}"
}
