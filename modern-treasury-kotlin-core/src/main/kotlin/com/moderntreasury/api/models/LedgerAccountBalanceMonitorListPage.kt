...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LedgerAccountBalanceMonitorListPage && this.ledgerAccountBalanceMonitorsService == other.ledgerAccountBalanceMonitorsService && this.params == other.params && this.response == other.response /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(ledgerAccountBalanceMonitorsService, params, response) /* spotless:on */
    }
    ...
    constructor(
        ...
        override fun toString() =
            "LedgerAccountBalanceMonitorListPage.Response{items=$items, additionalProperties=$additionalProperties}"
