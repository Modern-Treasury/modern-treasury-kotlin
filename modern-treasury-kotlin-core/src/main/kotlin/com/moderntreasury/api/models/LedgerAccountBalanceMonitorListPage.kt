...
class LedgerAccountBalanceMonitorListPage private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LedgerAccountBalanceMonitorListPage].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(ledgerAccountBalanceMonitorListPage: LedgerAccountBalanceMonitorListPage) =
            apply {
        ...
        fun service(service: LedgerAccountBalanceMonitorService) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LedgerAccountBalanceMonitorListPage && service == other.service && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, params, headers, items)

    override fun toString() = "LedgerAccountBalanceMonitorListPage{service=$service, params=$params, headers=$headers, items=$items}"
}
