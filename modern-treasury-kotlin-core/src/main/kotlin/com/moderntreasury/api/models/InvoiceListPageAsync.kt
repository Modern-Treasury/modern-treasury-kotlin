...
class InvoiceListPageAsync private constructor(
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is InvoiceListPageAsync && service == other.service && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, params, headers, items)

    override fun toString() = "InvoiceListPageAsync{service=$service, params=$params, headers=$headers, items=$items}"
}
