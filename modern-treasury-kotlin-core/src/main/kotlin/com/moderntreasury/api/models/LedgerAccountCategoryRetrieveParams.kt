...
class LedgerAccountCategoryRetrieveParams private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [LedgerAccountCategoryRetrieveParams]. */
        fun builder() = Builder()
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(ledgerAccountCategoryRetrieveParams: LedgerAccountCategoryRetrieveParams) =
            apply {
                ...
                additionalQueryParams = ledgerAccountCategoryRetrieveParams.additionalQueryParams.toBuilder()
            }
    ...
    class Balances private constructor(
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Balances && asOfDate == other.asOfDate && effectiveAt == other.effectiveAt && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Balances{asOfDate=$asOfDate, effectiveAt=$effectiveAt, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LedgerAccountCategoryRetrieveParams && id == other.id && balances == other.balances && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(id, balances, additionalHeaders, additionalQueryParams)

    override fun toString() = "LedgerAccountCategoryRetrieveParams{id=$id, balances=$balances, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
