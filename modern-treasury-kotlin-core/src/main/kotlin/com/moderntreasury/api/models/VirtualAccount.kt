...
class VirtualAccount @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(virtualAccount: VirtualAccount) =
            apply {
        ...
        /** The ID of a credit normal ledger account. When money enters the virtual account, this ledger account will be credited. Must be accompanied by a debit_ledger_account_id if present. */
        fun creditLedgerAccountId(creditLedgerAccountId: String?) = creditLedgerAccountId(JsonField.ofNullable(creditLedgerAccountId))
        ...
        /** The ID of a debit normal ledger account. When money enters the virtual account, this ledger account will be debited. Must be accompanied by a credit_ledger_account_id if present. */
        fun debitLedgerAccountId(debitLedgerAccountId: String?) = debitLedgerAccountId(JsonField.ofNullable(debitLedgerAccountId))
     ...
     */
    internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (accountDetails.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (if (counterpartyId.asKnown() == null) 0 else 1) + (if (createdAt.asKnown() == null) 0 else 1) + (if (creditLedgerAccountId.asKnown() == null) 0 else 1) + (if (debitLedgerAccountId.asKnown() == null) 0 else 1) + (if (description.asKnown() == null) 0 else 1) + (if (discardedAt.asKnown() == null) 0 else 1) + (if (internalAccountId.asKnown() == null) 0 else 1) + (if (ledgerAccountId.asKnown() == null) 0 else 1) + (if (liveMode.asKnown() == null) 0 else 1) + (metadata.asKnown()?.validity() ?: 0) + (if (name.asKnown() == null) 0 else 1) + (if (object_.asKnown() == null) 0 else 1) + (routingDetails.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (if (updatedAt.asKnown() == null) 0 else 1)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is VirtualAccount && id == other.id && accountDetails == other.accountDetails && counterpartyId == other.counterpartyId && createdAt == other.createdAt && creditLedgerAccountId == other.creditLedgerAccountId && debitLedgerAccountId == other.debitLedgerAccountId && description == other.description && discardedAt == other.discardedAt && internalAccountId == other.internalAccountId && ledgerAccountId == other.ledgerAccountId && liveMode == other.liveMode && metadata == other.metadata && name == other.name && object_ == other.object_ && routingDetails == other.routingDetails && updatedAt == other.updatedAt && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "VirtualAccount{id=$id, accountDetails=$accountDetails, counterpartyId=$counterpartyId, createdAt=$createdAt, creditLedgerAccountId=$creditLedgerAccountId, debitLedgerAccountId=$debitLedgerAccountId, description=$description, discardedAt=$discardedAt, internalAccountId=$internalAccountId, ledgerAccountId=$ledgerAccountId, liveMode=$liveMode, metadata=$metadata, name=$name, object_=$object_, routingDetails=$routingDetails, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
