...
class AccountDetailCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(accountDetailCreateParams: AccountDetailCreateParams) =
            apply {
         ...
         * - [accountNumberType]
         */
        fun body(body: AccountDetailCreateRequest) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is AccountDetailCreateParams && accountsType == other.accountsType && accountId == other.accountId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(accountsType, accountId, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "AccountDetailCreateParams{accountsType=$accountsType, accountId=$accountId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
