...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LineItemListResponse].
         *
    ...
    /** A builder for [LineItemListResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(lineItemListResponse: LineItemListResponse) = apply {
            id = lineItemListResponse.id
            accounting = lineItemListResponse.accounting
            accountingCategoryId = lineItemListResponse.accountingCategoryId
            accountingLedgerClassId = lineItemListResponse.accountingLedgerClassId
            amount = lineItemListResponse.amount
            createdAt = lineItemListResponse.createdAt
            description = lineItemListResponse.description
            itemizableId = lineItemListResponse.itemizableId
            itemizableType = lineItemListResponse.itemizableType
            liveMode = lineItemListResponse.liveMode
            metadata = lineItemListResponse.metadata
            object_ = lineItemListResponse.object_
            updatedAt = lineItemListResponse.updatedAt
        ...
        /**
         * Returns an immutable instance of [LineItemListResponse].
         *
