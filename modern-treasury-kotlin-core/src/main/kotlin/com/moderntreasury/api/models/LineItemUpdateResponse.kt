...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LineItemUpdateResponse].
         *
    ...
    /** A builder for [LineItemUpdateResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(lineItemUpdateResponse: LineItemUpdateResponse) = apply {
            id = lineItemUpdateResponse.id
            accounting = lineItemUpdateResponse.accounting
            accountingCategoryId = lineItemUpdateResponse.accountingCategoryId
            accountingLedgerClassId = lineItemUpdateResponse.accountingLedgerClassId
            amount = lineItemUpdateResponse.amount
            createdAt = lineItemUpdateResponse.createdAt
            description = lineItemUpdateResponse.description
            itemizableId = lineItemUpdateResponse.itemizableId
            itemizableType = lineItemUpdateResponse.itemizableType
            liveMode = lineItemUpdateResponse.liveMode
            metadata = lineItemUpdateResponse.metadata
            object_ = lineItemUpdateResponse.object_
            updatedAt = lineItemUpdateResponse.updatedAt
            additionalProperties = lineItemUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LineItemUpdateResponse].
         *
         ...
         */
        fun build(): LineItemUpdateResponse =
    ...
    fun validate(): LineItemUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LineItemUpdateResponse &&
            id == other.id &&
