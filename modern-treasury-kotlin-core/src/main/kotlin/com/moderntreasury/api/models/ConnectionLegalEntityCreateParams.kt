...
class ConnectionLegalEntityCreateParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ConnectionLegalEntityCreateParams].
         *
    ...
    class Builder internal constructor() {
        ...
        private var body: ConnectionLegalEntityCreateRequest.Builder = ConnectionLegalEntityCreateRequest.builder()
        ...
        internal fun from(connectionLegalEntityCreateParams: ConnectionLegalEntityCreateParams) =
            apply {
                ...
                additionalQueryParams = connectionLegalEntityCreateParams.additionalQueryParams.toBuilder()
            }
         ...
         * - [legalEntityId]
         */
        fun body(body: ConnectionLegalEntityCreateRequest) =
            apply {
         ...
         *
         * You should usually call [Builder.legalEntity] with a well-typed [LegalEntity] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun legalEntity(legalEntity: JsonField<LegalEntity>) =
            apply {
                body.legalEntity(legalEntity)
            }
    ...
    class ConnectionLegalEntityCreateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("legal_entity") @ExcludeMissing legalEntity: JsonField<LegalEntity> = JsonMissing.of(),
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [ConnectionLegalEntityCreateRequest].
             *
             * The following fields are required:
             *
             * ```kotlin
        ...
        class Builder internal constructor() {
            ...
            internal fun from(connectionLegalEntityCreateRequest: ConnectionLegalEntityCreateRequest) =
                apply {
                    ...
                    additionalProperties = connectionLegalEntityCreateRequest.additionalProperties.toMutableMap()
                }
         ...
         *   expected type.
         */
        fun validate(): ConnectionLegalEntityCreateRequest =
            apply {
                if (validated) {
                  return@apply
                }
         ...
         */
        internal fun validity(): Int = (if (connectionId.asKnown() == null) 0 else 1) + (legalEntity.asKnown()?.validity() ?: 0) + (if (legalEntityId.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is ConnectionLegalEntityCreateRequest && connectionId == other.connectionId && legalEntity == other.legalEntity && legalEntityId == other.legalEntityId && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "ConnectionLegalEntityCreateRequest{connectionId=$connectionId, legalEntity=$legalEntity, legalEntityId=$legalEntityId, additionalProperties=$additionalProperties}"
    }
    ...
    class LegalEntity @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         * Used for best match union deserialization.
         */
        internal fun validity(): Int = (addresses.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (bankSettings.asKnown()?.validity() ?: 0) + (if (businessDescription.asKnown() == null) 0 else 1) + (if (businessName.asKnown() == null) 0 else 1) + (if (citizenshipCountry.asKnown() == null) 0 else 1) + (if (connectionId.asKnown() == null) 0 else 1) + (if (countryOfIncorporation.asKnown() == null) 0 else 1) + (if (dateFormed.asKnown() == null) 0 else 1) + (if (dateOfBirth.asKnown() == null) 0 else 1) + (documents.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (doingBusinessAsNames.asKnown()?.size ?: 0) + (if (email.asKnown() == null) 0 else 1) + (if (expectedActivityVolume.asKnown() == null) 0 else 1) + (if (externalId.asKnown() == null) 0 else 1) + (if (firstName.asKnown() == null) 0 else 1) + (identifications.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (industryClassifications.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (if (intendedUse.asKnown() == null) 0 else 1) + (if (lastName.asKnown() == null) 0 else 1) + (legalEntityAssociations.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (legalEntityType.asKnown()?.validity() ?: 0) + (legalStructure.asKnown()?.validity() ?: 0) + (if (listedExchange.asKnown() == null) 0 else 1) + (metadata.asKnown()?.validity() ?: 0) + (if (middleName.asKnown() == null) 0 else 1) + (operatingJurisdictions.asKnown()?.size ?: 0) + (phoneNumbers.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (if (politicallyExposedPerson.asKnown() == null) 0 else 1) + (if (preferredName.asKnown() == null) 0 else 1) + (if (prefix.asKnown() == null) 0 else 1) + (primarySocialMediaSites.asKnown()?.size ?: 0) + (regulators.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (riskRating.asKnown()?.validity() ?: 0) + (if (serviceProviderLegalEntityId.asKnown() == null) 0 else 1) + (if (suffix.asKnown() == null) 0 else 1) + (termsOfUse.asKnown()?.validity() ?: 0) + (thirdPartyVerification.asKnown()?.validity() ?: 0) + (thirdPartyVerifications.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (if (tickerSymbol.asKnown() == null) 0 else 1) + (wealthAndEmploymentDetails.asKnown()?.validity() ?: 0) + (if (website.asKnown() == null) 0 else 1)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ConnectionLegalEntityCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "ConnectionLegalEntityCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
