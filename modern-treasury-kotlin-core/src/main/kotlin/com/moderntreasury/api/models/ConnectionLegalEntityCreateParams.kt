...
private constructor(
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is ConnectionLegalEntityCreateRequest &&
        ...
        private val hashCode: Int by lazy {
            Objects.hash(connectionId, legalEntity, legalEntityId, additionalProperties)
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(legalEntity: LegalEntity) = apply {
                ...
                operatingJurisdictions =
                    legalEntity.operatingJurisdictions.map { it.toMutableList() }
                ...
                primarySocialMediaSites =
                    legalEntity.primarySocialMediaSites.map { it.toMutableList() }
                ...
                thirdPartyVerifications =
                    legalEntity.thirdPartyVerifications.map { it.toMutableList() }
        ...
        private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("vendor")
                @ExcludeMissing
                vendor: JsonField<Vendor> = JsonMissing.of(),
             ...
             *   value).
             */
            fun verificationTime(): OffsetDateTime =
                verificationTime.getRequired("verification_time")
             ...
             *
             * Unlike [verificationTime], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("verification_time")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                ...
                internal fun from(thirdPartyVerification: ThirdPartyVerification) = apply {
                    ...
                    additionalProperties =
                        thirdPartyVerification.additionalProperties.toMutableMap()
                }
                 ...
                 *
                 * You should usually call [Builder.vendor] with a well-typed [Vendor] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 * [VerificationCategory] value instead. This method is primarily for setting the
                 * field to an undocumented or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.verificationMethod] with a well-typed [String]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.verificationTime] with a well-typed
            ...
            /** The vendor that performed the verification, e.g. `persona`. */
            class Vendor @JsonCreator private constructor(private val value: JsonField<String>) :
                Enum {
                ...
                enum class Value {
                    ...
                    VERIFF,
                    /**
                     * An enum member indicating that [Vendor] was instantiated with an unknown
                     * value.
                     */
                    _UNKNOWN,
                }
            ...
            private constructor(private val value: JsonField<String>) : Enum {
                ...
                /**
                 * An enum containing [VerificationCategory]'s known values, as well as an
                 * [_UNKNOWN] member.
                 *
                ...
                enum class Value {
                    ...
                    ADVERSE_MEDIA,
                    /**
                     * An enum member indicating that [VerificationCategory] was instantiated with
                     * an unknown value.
                     */
                    _UNKNOWN,
                }
