...
class LedgerEntryListPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(ledgerEntryListPage: LedgerEntryListPage) =
            apply {
        ...
        fun service(service: LedgerEntryService) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LedgerEntryListPage && service == other.service && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, params, headers, items)

    override fun toString() = "LedgerEntryListPage{service=$service, params=$params, headers=$headers, items=$items}"
}
