...
class BulkResult @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("entity_type") @ExcludeMissing entityType: JsonField<EntityType> = JsonMissing.of(),
        @JsonProperty("live_mode") @ExcludeMissing liveMode: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("object") @ExcludeMissing object_: JsonField<String> = JsonMissing.of(),
        @JsonProperty("request_id") @ExcludeMissing requestId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("request_params") @ExcludeMissing requestParams: JsonField<RequestParams> = JsonMissing.of(),
        @JsonProperty("request_type") @ExcludeMissing requestType: JsonField<RequestType> = JsonMissing.of(),
    ...
    class Builder internal constructor() {
        ...
        internal fun from(bulkResult: BulkResult) =
            apply {
                id = bulkResult.id
        ...
        fun entity(expectedPayment: ExpectedPayment) = entity(Entity.ofExpectedPayment(expectedPayment))

        /** Alias for calling [entity] with `Entity.ofLedgerTransaction(ledgerTransaction)`. */
        fun entity(ledgerTransaction: LedgerTransaction) = entity(Entity.ofLedgerTransaction(ledgerTransaction))
         ...
         *
         * You should usually call [Builder.entityType] with a well-typed [EntityType] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun entityType(entityType: JsonField<EntityType>) =
            apply {
         ...
         *
         * You should usually call [Builder.requestId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /** An optional object that contains the provided input params for the request that created this result. This is an item in the `resources` array for the bulk_request */
        fun requestParams(requestParams: RequestParams?) = requestParams(JsonField.ofNullable(requestParams))

        /**
         * Sets [Builder.requestParams] to an arbitrary JSON value.
         *
         * You should usually call [Builder.requestParams] with a well-typed [RequestParams] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun requestParams(requestParams: JsonField<RequestParams>) =
            apply {
         ...
         *
         * You should usually call [Builder.requestType] with a well-typed [RequestType] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun requestType(requestType: JsonField<RequestType>) =
            apply {
     ...
     */
    internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (if (createdAt.asKnown() == null) 0 else 1) + (entity.asKnown()?.validity() ?: 0) + (if (entityId.asKnown() == null) 0 else 1) + (entityType.asKnown()?.validity() ?: 0) + (if (liveMode.asKnown() == null) 0 else 1) + (if (object_.asKnown() == null) 0 else 1) + (if (requestId.asKnown() == null) 0 else 1) + (requestParams.asKnown()?.validity() ?: 0) + (requestType.asKnown()?.validity() ?: 0) + (status.asKnown()?.validity() ?: 0) + (if (updatedAt.asKnown() == null) 0 else 1)
    ...
    class Entity private constructor(
        ...
        fun asLedgerTransaction(): LedgerTransaction = ledgerTransaction.getOrThrow("ledgerTransaction")
        ...
        internal fun validity(): Int =
            accept(object : Visitor<Int> {
                override fun visitPaymentOrder(paymentOrder: PaymentOrder) = paymentOrder.validity()

                override fun visitExpectedPayment(expectedPayment: ExpectedPayment) = expectedPayment.validity()

                override fun visitLedgerTransaction(ledgerTransaction: LedgerTransaction) = ledgerTransaction.validity()

                override fun visitLedgerAccount(ledgerAccount: LedgerAccount) = ledgerAccount.validity()
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Entity && paymentOrder == other.paymentOrder && expectedPayment == other.expectedPayment && ledgerTransaction == other.ledgerTransaction && ledgerAccount == other.ledgerAccount && transaction == other.transaction && bulkError == other.bulkError
        }

        override fun hashCode(): Int = Objects.hash(paymentOrder, expectedPayment, ledgerTransaction, ledgerAccount, transaction, bulkError)
        ...
        companion object {
            ...
            fun ofExpectedPayment(expectedPayment: ExpectedPayment) = Entity(expectedPayment = expectedPayment)

            fun ofLedgerTransaction(ledgerTransaction: LedgerTransaction) = Entity(ledgerTransaction = ledgerTransaction)

            fun ofLedgerAccount(ledgerAccount: LedgerAccount) = Entity(ledgerAccount = ledgerAccount)
        ...
        interface Visitor<out T> {
             ...
             *
             * An instance of [Entity] can contain an unknown variant if it was deserialized from data
        ...
        internal class Deserializer : BaseDeserializer<Entity>(Entity::class) {
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): Entity {
              ...
              val bestMatches = sequenceOf(
                      tryDeserialize(node, jacksonTypeRef<PaymentOrder>())
                          ?.let {
                              Entity(paymentOrder = it, _json = json)
                          },
                      tryDeserialize(node, jacksonTypeRef<ExpectedPayment>())
                          ?.let {
                              Entity(expectedPayment = it, _json = json)
                          },
                      tryDeserialize(node, jacksonTypeRef<LedgerTransaction>())
                          ?.let {
                              Entity(ledgerTransaction = it, _json = json)
                          },
                      tryDeserialize(node, jacksonTypeRef<LedgerAccount>())
                          ?.let {
                              Entity(ledgerAccount = it, _json = json)
                          },
                      tryDeserialize(node, jacksonTypeRef<Transaction>())
                          ?.let {
                              Entity(transaction = it, _json = json)
                          },
                      tryDeserialize(node, jacksonTypeRef<BulkError>())
                          ?.let {
        ...
        internal class Serializer : BaseSerializer<Entity>(Entity::class) {
            ...
            override fun serialize(value: Entity, generator: JsonGenerator, provider: SerializerProvider) {
              when {
                  ...
                  value.ledgerTransaction != null -> generator.writeObject(value.ledgerTransaction)
        ...
        class BulkError @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val id: JsonField<String>,
            private val createdAt: JsonField<OffsetDateTime>,
            private val liveMode: JsonField<Boolean>,
            private val object_: JsonField<String>,
            ...
            private constructor(
                ...
                @JsonProperty("live_mode") @ExcludeMissing liveMode: JsonField<Boolean> = JsonMissing.of(),
                @JsonProperty("object") @ExcludeMissing object_: JsonField<String> = JsonMissing.of(),
                @JsonProperty("request_errors") @ExcludeMissing requestErrors: JsonField<List<RequestError>> = JsonMissing.of(),
                @JsonProperty("updated_at") @ExcludeMissing updatedAt: JsonField<OffsetDateTime> = JsonMissing.of()
            ) : this(
              id,
              createdAt,
             ...
             *
             * Unlike [requestErrors], this method doesn't throw if the JSON field has an unexpected type.
             */
            ...
            class Builder internal constructor() {
                ...
                internal fun from(bulkError: BulkError) =
                    apply {
                        id = bulkError.id
                ...
                fun requestErrors(requestErrors: List<RequestError>) = requestErrors(JsonField.of(requestErrors))

                /**
                 * Sets [Builder.requestErrors] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.requestErrors] with a well-typed `List<RequestError>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun requestErrors(requestErrors: JsonField<List<RequestError>>) =
                    apply {
                 ...
                 */
                fun addRequestError(requestError: RequestError) =
                    apply {
                        requestErrors = (requestErrors ?: JsonField.of(mutableListOf())).also {
             ...
             * Used for best match union deserialization.
             */
            internal fun validity(): Int = (if (id.asKnown() == null) 0 else 1) + (if (createdAt.asKnown() == null) 0 else 1) + (if (liveMode.asKnown() == null) 0 else 1) + (if (object_.asKnown() == null) 0 else 1) + (requestErrors.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (if (updatedAt.asKnown() == null) 0 else 1)

            class RequestError @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                ...
                private constructor(
                    ...
                    @JsonProperty("parameter") @ExcludeMissing parameter: JsonField<String> = JsonMissing.of()
                ) : this(
                  code,
                  message,
                  parameter,
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(requestError: RequestError) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.parameter] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun parameter(parameter: JsonField<String>) =
                        apply {
                 ...
                 * Used for best match union deserialization.
                 */
                internal fun validity(): Int = (if (code.asKnown() == null) 0 else 1) + (if (message.asKnown() == null) 0 else 1) + (if (parameter.asKnown() == null) 0 else 1)
                ...
                override fun equals(other: Any?): Boolean {
                  ...
                  return other is RequestError && code == other.code && message == other.message && parameter == other.parameter && additionalProperties == other.additionalProperties
                }
                ...
                override fun toString() = "RequestError{code=$code, message=$message, parameter=$parameter, additionalProperties=$additionalProperties}"
            }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is BulkError && id == other.id && createdAt == other.createdAt && liveMode == other.liveMode && object_ == other.object_ && requestErrors == other.requestErrors && updatedAt == other.updatedAt && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "BulkError{id=$id, createdAt=$createdAt, liveMode=$liveMode, object_=$object_, requestErrors=$requestErrors, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
        }
    }
    ...
    /** An optional object that contains the provided input params for the request that created this result. This is an item in the `resources` array for the bulk_request */
    class RequestParams @JsonCreator private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(requestParams: RequestParams) =
                apply {
    ...
    override fun toString() = "BulkResult{id=$id, createdAt=$createdAt, entity=$entity, entityId=$entityId, entityType=$entityType, liveMode=$liveMode, object_=$object_, requestId=$requestId, requestParams=$requestParams, requestType=$requestType, status=$status, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
