...
class IdentificationCreateParams
private constructor(
    private val body: StandaloneIdentificationCreateRequest,
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IdentificationCreateParams].
         *
    ...
    /** A builder for [IdentificationCreateParams]. */
    class Builder internal constructor() {

        private var body: StandaloneIdentificationCreateRequest.Builder =
            StandaloneIdentificationCreateRequest.builder()
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        internal fun from(identificationCreateParams: IdentificationCreateParams) = apply {
            body = identificationCreateParams.body.toBuilder()
            additionalHeaders = identificationCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = identificationCreateParams.additionalQueryParams.toBuilder()
        }
         ...
         * - etc.
         */
        fun body(body: StandaloneIdentificationCreateRequest) = apply {
        ...
        /**
         * Returns an immutable instance of [IdentificationCreateParams].
         *
         ...
         */
        fun build(): IdentificationCreateParams =
    ...
    fun _body(): StandaloneIdentificationCreateRequest = body

    override fun _headers(): Headers = additionalHeaders

    override fun _queryParams(): QueryParams = additionalQueryParams

    class StandaloneIdentificationCreateRequest
    ...
    private constructor(
        ...
        companion object {
             ...
             * [StandaloneIdentificationCreateRequest].
             *
             * The following fields are required:
             * ```kotlin
             * .idNumber()
        ...
        /** A builder for [StandaloneIdentificationCreateRequest]. */
        class Builder internal constructor() {
            ...
            internal fun from(
                standaloneIdentificationCreateRequest: StandaloneIdentificationCreateRequest
            ) = apply {
                idNumber = standaloneIdentificationCreateRequest.idNumber
                idType = standaloneIdentificationCreateRequest.idType
                legalEntityId = standaloneIdentificationCreateRequest.legalEntityId
                documents =
                    standaloneIdentificationCreateRequest.documents.map { it.toMutableList() }
                expirationDate = standaloneIdentificationCreateRequest.expirationDate
                issuingCountry = standaloneIdentificationCreateRequest.issuingCountry
                issuingRegion = standaloneIdentificationCreateRequest.issuingRegion
                additionalProperties =
                    standaloneIdentificationCreateRequest.additionalProperties.toMutableMap()
            }
            ...
            /**
             * Returns an immutable instance of [StandaloneIdentificationCreateRequest].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             *
             * The following fields are required:
             ...
             * @throws IllegalStateException if any required field is unset.
             */
            fun build(): StandaloneIdentificationCreateRequest =
                StandaloneIdentificationCreateRequest(
         ...
         *   its expected type.
         */
        fun validate(): StandaloneIdentificationCreateRequest = apply {
            if (validated) {
                return@apply
            }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is StandaloneIdentificationCreateRequest &&
        ...
        override fun toString() =
            "StandaloneIdentificationCreateRequest{idNumber=$idNumber, idType=$idType, legalEntityId=$legalEntityId, documents=$documents, expirationDate=$expirationDate, issuingCountry=$issuingCountry, issuingRegion=$issuingRegion, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IdentificationCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "IdentificationCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
