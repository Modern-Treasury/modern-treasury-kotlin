...
/** Get a list of holds. */
class HoldListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(holdListParams: HoldListParams) =
            apply {
                afterCursor = holdListParams.afterCursor
                metadata = holdListParams.metadata
                perPage = holdListParams.perPage
                status = holdListParams.status
                targetId = holdListParams.targetId
                targetType = holdListParams.targetType
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is HoldListParams && afterCursor == other.afterCursor && metadata == other.metadata && perPage == other.perPage && status == other.status && targetId == other.targetId && targetType == other.targetType && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(afterCursor, metadata, perPage, status, targetId, targetType, additionalHeaders, additionalQueryParams)

    override fun toString() = "HoldListParams{afterCursor=$afterCursor, metadata=$metadata, perPage=$perPage, status=$status, targetId=$targetId, targetType=$targetType, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
