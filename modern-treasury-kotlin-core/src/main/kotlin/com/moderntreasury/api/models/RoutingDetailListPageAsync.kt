...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is RoutingDetailListPageAsync && this.routingDetailsService == other.routingDetailsService && this.params == other.params && this.response == other.response /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(routingDetailsService, params, response) /* spotless:on */
    }
