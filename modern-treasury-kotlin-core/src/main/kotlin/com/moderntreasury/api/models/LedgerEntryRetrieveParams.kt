...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LedgerEntryRetrieveParams && this.id == other.id && this.showBalances == other.showBalances && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(id, showBalances, additionalQueryParams, additionalHeaders) /* spotless:on */
    }

    override fun toString() =
        "LedgerEntryRetrieveParams{id=$id, showBalances=$showBalances, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
