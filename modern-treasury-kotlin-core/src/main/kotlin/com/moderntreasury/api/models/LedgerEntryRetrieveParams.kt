...
class LedgerEntryRetrieveParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(ledgerEntryRetrieveParams: LedgerEntryRetrieveParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LedgerEntryRetrieveParams && id == other.id && showBalances == other.showBalances && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(id, showBalances, additionalHeaders, additionalQueryParams)

    override fun toString() = "LedgerEntryRetrieveParams{id=$id, showBalances=$showBalances, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
