...
class TransactionLineItemListPage private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(transactionLineItemListPage: TransactionLineItemListPage) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is TransactionLineItemListPage && service == other.service && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, params, headers, items)

    override fun toString() = "TransactionLineItemListPage{service=$service, params=$params, headers=$headers, items=$items}"
}
