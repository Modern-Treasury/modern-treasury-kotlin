...
private constructor(
    ...
    fun getNextPageParams(): TransactionLineItemListParams? {
        ...
        return TransactionLineItemListParams.builder()
            .from(params)
    ...
    constructor(
        ...
        override fun toString() =
            "TransactionLineItemListPage.Response{items=$items, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: TransactionLineItemListPage,
