...
/** update line item */
class LineItemUpdateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(lineItemUpdateParams: LineItemUpdateParams) =
            apply {
        ...
        fun itemizableId(itemizableId: String) =
            apply {
         ...
         * - [metadata]
         */
        fun body(body: LineItemUpdateRequest) =
            apply {
    ...
    class LineItemUpdateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(lineItemUpdateRequest: LineItemUpdateRequest) =
                apply {
         ...
         *   expected type.
         */
        fun validate(): LineItemUpdateRequest =
            apply {
                if (validated) {
                  return@apply
                }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is LineItemUpdateRequest && metadata == other.metadata && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "LineItemUpdateRequest{metadata=$metadata, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LineItemUpdateParams && itemizableType == other.itemizableType && itemizableId == other.itemizableId && id == other.id && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(itemizableType, itemizableId, id, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "LineItemUpdateParams{itemizableType=$itemizableType, itemizableId=$itemizableId, id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
