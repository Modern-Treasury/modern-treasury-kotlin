...
class CounterpartyCollectAccountParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CounterpartyCollectAccountParams].
         *
    ...
    class Builder internal constructor() {
        ...
        private var body: CounterpartyCollectAccountRequest.Builder = CounterpartyCollectAccountRequest.builder()
        ...
        internal fun from(counterpartyCollectAccountParams: CounterpartyCollectAccountParams) =
            apply {
                ...
                additionalQueryParams = counterpartyCollectAccountParams.additionalQueryParams.toBuilder()
            }
         ...
         * - [sendEmail]
         */
        fun body(body: CounterpartyCollectAccountRequest) =
            apply {
         ...
         *
         * You should usually call [Builder.customRedirect] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun customRedirect(customRedirect: JsonField<String>) =
            apply {
                body.customRedirect(customRedirect)
            }
         ...
         *
         * You should usually call [Builder.fields] with a well-typed `List<Field>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /** By default, Modern Treasury will send an email to your counterparty that includes a link to the form they must fill out. However, if you would like to send the counterparty the link, you can set this parameter to `false`. The JSON body will include the link to the secure Modern Treasury form. */
        fun sendEmail(sendEmail: Boolean) =
            apply {
         ...
         *
         * You should usually call [Builder.sendEmail] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun sendEmail(sendEmail: JsonField<Boolean>) =
            apply {
                body.sendEmail(sendEmail)
            }
    ...
    class CounterpartyCollectAccountRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("custom_redirect") @ExcludeMissing customRedirect: JsonField<String> = JsonMissing.of(),
            @JsonProperty("fields") @ExcludeMissing fields: JsonField<List<Field>> = JsonMissing.of(),
            @JsonProperty("send_email") @ExcludeMissing sendEmail: JsonField<Boolean> = JsonMissing.of()
        ) : this(
          direction,
          customRedirect,
          fields,
        ...
        @ExcludeMissing
        fun _sendEmail(): JsonField<Boolean> = sendEmail
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [CounterpartyCollectAccountRequest].
             *
             * The following fields are required:
             *
             * ```kotlin
        ...
        class Builder internal constructor() {
            ...
            internal fun from(counterpartyCollectAccountRequest: CounterpartyCollectAccountRequest) =
                apply {
                    ...
                    additionalProperties = counterpartyCollectAccountRequest.additionalProperties.toMutableMap()
                }
            ...
            /** The URL you want your customer to visit upon filling out the form. By default, they will be sent to a Modern Treasury landing page. This must be a valid HTTPS URL if set. */
            fun customRedirect(customRedirect: String) = customRedirect(JsonField.of(customRedirect))
         ...
         *   expected type.
         */
        fun validate(): CounterpartyCollectAccountRequest =
            apply {
                if (validated) {
                  return@apply
                }
         ...
         */
        internal fun validity(): Int = (direction.asKnown()?.validity() ?: 0) + (if (customRedirect.asKnown() == null) 0 else 1) + (fields.asKnown()?.sumOf { it.validity().toInt() } ?: 0) + (if (sendEmail.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is CounterpartyCollectAccountRequest && direction == other.direction && customRedirect == other.customRedirect && fields == other.fields && sendEmail == other.sendEmail && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "CounterpartyCollectAccountRequest{direction=$direction, customRedirect=$customRedirect, fields=$fields, sendEmail=$sendEmail, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CounterpartyCollectAccountParams && id == other.id && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(id, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "CounterpartyCollectAccountParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
