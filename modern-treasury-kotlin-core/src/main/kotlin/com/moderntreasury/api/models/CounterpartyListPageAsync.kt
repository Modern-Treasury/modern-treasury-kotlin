...
class CounterpartyListPageAsync private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(counterpartyListPageAsync: CounterpartyListPageAsync) =
            apply {
        ...
        fun service(service: CounterpartyServiceAsync) =
            apply {
                this.service = service
            }

        /** The parameters that were used to request this page. */
        fun params(params: CounterpartyListParams) =
            apply {
                this.params = params
            }
        ...
        /** The response that this page was parsed from. */
        fun items(items: List<Counterparty>) =
            apply {
                this.items = items
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CounterpartyListPageAsync && service == other.service && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, params, headers, items)

    override fun toString() = "CounterpartyListPageAsync{service=$service, params=$params, headers=$headers, items=$items}"
}
