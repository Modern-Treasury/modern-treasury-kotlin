...
interface ModernTreasuryClientAsync {
    ...
    suspend fun ping(params: ClientPingParams = ClientPingParams.none(), requestOptions: RequestOptions = RequestOptions.none()): PingResponse
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: (ClientOptions.Builder) -> Unit): ModernTreasuryClientAsync.WithRawResponse
        ...
        @MustBeClosed
        suspend fun ping(params: ClientPingParams = ClientPingParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<PingResponse>
