...
internal class LedgerEntryServiceTest {
    ...
    fun retrieve() {
      ...
      val ledgerEntry = ledgerEntryService.retrieve(LedgerEntryRetrieveParams.builder()
          .id("id")
          .showBalances(true)
          .build())
    ...
    fun update() {
      ...
      val ledgerEntry = ledgerEntryService.update(LedgerEntryUpdateParams.builder()
          .id("id")
