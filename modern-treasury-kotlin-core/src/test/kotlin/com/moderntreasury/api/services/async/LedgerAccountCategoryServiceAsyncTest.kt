...
internal class LedgerAccountCategoryServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val ledgerAccountCategory = ledgerAccountCategoryServiceAsync.create(LedgerAccountCategoryCreateParams.builder()
          .currency("currency")
    ...
    suspend fun retrieve() {
      ...
      val ledgerAccountCategory = ledgerAccountCategoryServiceAsync.retrieve(LedgerAccountCategoryRetrieveParams.builder()
          .id("id")
    ...
    suspend fun update() {
      ...
      val ledgerAccountCategory = ledgerAccountCategoryServiceAsync.update(LedgerAccountCategoryUpdateParams.builder()
          .id("id")
          .description("description")
          .externalId("external_id")
    ...
    suspend fun addLedgerAccount() {
      ...
      ledgerAccountCategoryServiceAsync.addLedgerAccount(LedgerAccountCategoryAddLedgerAccountParams.builder()
          .id("id")
    ...
    suspend fun addNestedCategory() {
      ...
      ledgerAccountCategoryServiceAsync.addNestedCategory(LedgerAccountCategoryAddNestedCategoryParams.builder()
          .id("id")
    ...
    suspend fun removeLedgerAccount() {
      ...
      ledgerAccountCategoryServiceAsync.removeLedgerAccount(LedgerAccountCategoryRemoveLedgerAccountParams.builder()
          .id("id")
          .ledgerAccountId("ledger_account_id")
          .build())
    }
    ...
    suspend fun removeNestedCategory() {
      ...
      ledgerAccountCategoryServiceAsync.removeNestedCategory(LedgerAccountCategoryRemoveNestedCategoryParams.builder()
          .id("id")
          .subCategoryId("sub_category_id")
          .build())
    }
