...
internal class CounterpartyServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val counterparty = counterpartyServiceAsync.create(CounterpartyCreateParams.builder()
          .name("name")
          .accounting(CounterpartyCreateParams.Accounting.builder()
              .type(CounterpartyCreateParams.Accounting.Type.CUSTOMER)
              .build())
          .addAccount(CounterpartyCreateParams.Account.builder()
              .addAccountDetail(CounterpartyCreateParams.Account.AccountDetail.builder()
                  .accountNumber("account_number")
                  .accountNumberType(CounterpartyCreateParams.Account.AccountDetail.AccountNumberType.AU_NUMBER)
                  .build())
              ...
              .ledgerAccount(LedgerAccountCreateRequest.builder()
                  ...
                  .metadata(LedgerAccountCreateRequest.Metadata.builder()
                      ...
                      .build())
                  .build())
              .metadata(CounterpartyCreateParams.Account.Metadata.builder()
                  .putAdditionalProperty("key", JsonValue.from("value"))
                  .putAdditionalProperty("foo", JsonValue.from("bar"))
                  .putAdditionalProperty("modern", JsonValue.from("treasury"))
                  .build())
              ...
              .addRoutingDetail(CounterpartyCreateParams.Account.RoutingDetail.builder()
                  .routingNumber("routing_number")
                  .routingNumberType(CounterpartyCreateParams.Account.RoutingDetail.RoutingNumberType.ABA)
                  .paymentType(CounterpartyCreateParams.Account.RoutingDetail.PaymentType.ACH)
                  .build())
              .build())
          .email("dev@stainless.com")
          .externalId("external_id")
          .ledgerType(CounterpartyCreateParams.LedgerType.CUSTOMER)
          .legalEntity(CounterpartyCreateParams.LegalEntityCreateRequest.builder()
              .legalEntityType(CounterpartyCreateParams.LegalEntityCreateRequest.LegalEntityType.BUSINESS)
              ...
              .addDocument(CounterpartyCreateParams.LegalEntityCreateRequest.Document.builder()
                  .documentType(CounterpartyCreateParams.LegalEntityCreateRequest.Document.DocumentType.ARTICLES_OF_INCORPORATION)
                  .fileData("file_data")
                  .filename("filename")
                  .build())
              ...
              .addLegalEntityAssociation(LegalEntityAssociationInlineCreate.builder()
                  ...
                  .childLegalEntity(ChildLegalEntityCreate.builder()
                      .addAddress(LegalEntityAddressCreateRequest.builder()
                          .country("country")
                          .line1("line1")
                          .locality("locality")
                  ...
                  .title("title")
                  .build())
              .legalStructure(CounterpartyCreateParams.LegalEntityCreateRequest.LegalStructure.CORPORATION)
              .listedExchange("listed_exchange")
              .metadata(CounterpartyCreateParams.LegalEntityCreateRequest.Metadata.builder()
                  .putAdditionalProperty("key", JsonValue.from("value"))
                  .putAdditionalProperty("foo", JsonValue.from("bar"))
                  .putAdditionalProperty("modern", JsonValue.from("treasury"))
                  .build())
              .middleName("middle_name")
              .addOperatingJurisdiction("string")
              .addPhoneNumber(CounterpartyCreateParams.LegalEntityCreateRequest.PhoneNumber.builder()
                  .phoneNumber("phone_number")
                  .build())
              .politicallyExposedPerson(true)
              .preferredName("preferred_name")
              .prefix("prefix")
              .addPrimarySocialMediaSite("string")
              .addRegulator(CounterpartyCreateParams.LegalEntityCreateRequest.LegalEntityRegulator.builder()
                  .jurisdiction("jurisdiction")
                  .name("name")
                  .registrationNumber("registration_number")
                  .build())
              ...
              .serviceProviderLegalEntityId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
              .suffix("suffix")
              .termsOfUse(CounterpartyCreateParams.LegalEntityCreateRequest.TermsOfUse.builder()
                  .acceptedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                  .ipAddress("ip_address")
                  .build())
              .thirdPartyVerification(ThirdPartyVerification.builder()
          ...
          .metadata(CounterpartyCreateParams.Metadata.builder()
              .putAdditionalProperty("key", JsonValue.from("value"))
              .putAdditionalProperty("foo", JsonValue.from("bar"))
              .putAdditionalProperty("modern", JsonValue.from("treasury"))
              .build())
    ...
    suspend fun update() {
      ...
      val counterparty = counterpartyServiceAsync.update(CounterpartyUpdateParams.builder()
          .id("id")
          .email("dev@stainless.com")
          .externalId("external_id")
          .legalEntityId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ...
    suspend fun collectAccount() {
      ...
      val counterpartyCollectAccountResponse = counterpartyServiceAsync.collectAccount(CounterpartyCollectAccountParams.builder()
          .id("id")
