...
internal class CounterpartyServiceAsyncTest {
    ...
    suspend fun create() {
        val client =
            ModernTreasuryOkHttpClientAsync.builder()
                ...
                .build()
        val counterpartyServiceAsync = client.counterparties()
    ...
    suspend fun retrieve() {
        ...
        val counterparty = counterpartyServiceAsync.retrieve("id")
    ...
    suspend fun update() {
        ...
        val counterparty =
            counterpartyServiceAsync.update(
    ...
    suspend fun delete() {
        ...
        counterpartyServiceAsync.delete("id")
    }
    ...
    suspend fun collectAccount() {
        ...
        val counterpartyCollectAccountResponse =
            counterpartyServiceAsync.collectAccount(
