...
internal class LedgerAccountSettlementServiceTest {
    ...
    fun create() {
      ...
      val ledgerAccountSettlement = ledgerAccountSettlementService.create(LedgerAccountSettlementCreateParams.builder()
    ...
    fun retrieve() {
      ...
      val ledgerAccountSettlement = ledgerAccountSettlementService.retrieve("id")
    ...
    fun update() {
      ...
      val ledgerAccountSettlement = ledgerAccountSettlementService.update(LedgerAccountSettlementUpdateParams.builder()
          .id("id")
          .description("description")
