...
internal class AccountCollectionFlowServiceTest {
    ...
    fun create() {
      ...
      val accountCollectionFlow = accountCollectionFlowService.create(AccountCollectionFlowCreateParams.builder()
    ...
    fun update() {
      ...
      val accountCollectionFlow = accountCollectionFlowService.update(AccountCollectionFlowUpdateParams.builder()
          .id("id")
