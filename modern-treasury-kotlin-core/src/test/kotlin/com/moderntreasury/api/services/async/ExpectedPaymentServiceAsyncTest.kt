...
internal class ExpectedPaymentServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val expectedPayment = expectedPaymentServiceAsync.create(ExpectedPaymentCreateParams.builder()
          .amountLowerBound(0L)
          .amountReconciled(0L)
          .amountReconciledDirection(ExpectedPaymentCreateParams.AmountReconciledDirection.CREDIT)
          .amountUnreconciled(0L)
          .amountUnreconciledDirection(ExpectedPaymentCreateParams.AmountUnreconciledDirection.CREDIT)
          .amountUpperBound(0L)
          ...
          .addLineItem(ExpectedPaymentCreateParams.LineItemRequest.builder()
              .amount(0L)
              .accountingCategoryId("accounting_category_id")
              .description("description")
              .metadata(ExpectedPaymentCreateParams.LineItemRequest.Metadata.builder()
                  .putAdditionalProperty("key", JsonValue.from("value"))
                  .putAdditionalProperty("foo", JsonValue.from("bar"))
                  .putAdditionalProperty("modern", JsonValue.from("treasury"))
                  .build())
              .build())
          .metadata(ExpectedPaymentCreateParams.Metadata.builder()
              .putAdditionalProperty("key", JsonValue.from("value"))
              .putAdditionalProperty("foo", JsonValue.from("bar"))
              .putAdditionalProperty("modern", JsonValue.from("treasury"))
              .build())
          ...
          .addReconciliationRuleVariable(ReconciliationRule.builder()
              .amountLowerBound(0L)
              .amountUpperBound(0L)
              ...
              .counterpartyId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
              .currency(Currency.AED)
              .customIdentifiers(ReconciliationRule.CustomIdentifiers.builder()
    ...
    suspend fun retrieve() {
      ...
      val expectedPayment = expectedPaymentServiceAsync.retrieve("id")
    ...
    suspend fun update() {
      ...
      val expectedPayment = expectedPaymentServiceAsync.update(ExpectedPaymentUpdateParams.builder()
          .id("id")
          .amountLowerBound(0L)
          .amountReconciled(0L)
          .amountReconciledDirection(ExpectedPaymentUpdateParams.AmountReconciledDirection.CREDIT)
          .amountUnreconciled(0L)
          .amountUnreconciledDirection(ExpectedPaymentUpdateParams.AmountUnreconciledDirection.CREDIT)
          .amountUpperBound(0L)
          .counterpartyId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .currency(Currency.AED)
          .dateLowerBound(LocalDate.parse("2019-12-27"))
          ...
          .externalId("external_id")
          .internalAccountId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .metadata(ExpectedPaymentUpdateParams.Metadata.builder()
              .putAdditionalProperty("key", JsonValue.from("value"))
              .putAdditionalProperty("foo", JsonValue.from("bar"))
              .putAdditionalProperty("modern", JsonValue.from("treasury"))
              .build())
    ...
    suspend fun delete() {
      ...
      val expectedPayment = expectedPaymentServiceAsync.delete("id")
