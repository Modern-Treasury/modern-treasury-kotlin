...
internal class AccountEntryServiceAsyncTest {
    ...
    suspend fun update() {
      ...
      accountEntryServiceAsync.update(LedgerAccountSettlementAccountEntryUpdateParams.builder()
          .id("id")
    ...
    suspend fun delete() {
      ...
      accountEntryServiceAsync.delete(LedgerAccountSettlementAccountEntryDeleteParams.builder()
          .id("id")
          .addLedgerEntryId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .build())
    }
