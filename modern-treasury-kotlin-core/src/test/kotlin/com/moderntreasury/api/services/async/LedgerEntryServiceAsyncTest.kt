...
internal class LedgerEntryServiceAsyncTest {
    ...
    suspend fun retrieve() {
      ...
      val ledgerEntry = ledgerEntryServiceAsync.retrieve(LedgerEntryRetrieveParams.builder()
          .id("id")
          .showBalances(true)
          .build())
    ...
    suspend fun update() {
      ...
      val ledgerEntry = ledgerEntryServiceAsync.update(LedgerEntryUpdateParams.builder()
          .id("id")
