...
internal class LineItemServiceTest {
    ...
    fun create() {
      ...
      val invoiceLineItem = lineItemService.create(InvoiceLineItemCreateParams.builder()
    ...
    fun retrieve() {
      ...
      val invoiceLineItem = lineItemService.retrieve(InvoiceLineItemRetrieveParams.builder()
          .invoiceId("invoice_id")
          .id("id")
          .build())
    ...
    fun update() {
      ...
      val invoiceLineItem = lineItemService.update(InvoiceLineItemUpdateParams.builder()
          .invoiceId("invoice_id")
          .id("id")
          .description("description")
          .direction("direction")
    ...
    fun delete() {
      ...
      val invoiceLineItem = lineItemService.delete(InvoiceLineItemDeleteParams.builder()
          .invoiceId("invoice_id")
          .id("id")
          .build())
