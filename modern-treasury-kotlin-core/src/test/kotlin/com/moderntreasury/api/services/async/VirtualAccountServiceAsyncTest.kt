...
internal class VirtualAccountServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val virtualAccount = virtualAccountServiceAsync.create(VirtualAccountCreateParams.builder()
    ...
    suspend fun update() {
      ...
      val virtualAccount = virtualAccountServiceAsync.update(VirtualAccountUpdateParams.builder()
          .id("id")
          .counterpartyId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .ledgerAccountId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .metadata(VirtualAccountUpdateParams.Metadata.builder()
              .putAdditionalProperty("foo", JsonValue.from("string"))
              .build())
          .name("name")
          .build())
