...
internal class BulkRequestServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val bulkRequest = bulkRequestServiceAsync.create(BulkRequestCreateParams.builder()
          .actionType(BulkRequestCreateParams.ActionType.CREATE)
          .resourceType(BulkRequestCreateParams.ResourceType.PAYMENT_ORDER)
          .addResource(BulkRequestCreateParams.Resource.PaymentOrderAsyncCreateRequest.builder()
              .amount(0L)
              .direction(BulkRequestCreateParams.Resource.PaymentOrderAsyncCreateRequest.Direction.CREDIT)
              .originatingAccountId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
              .type(PaymentOrderType.ACH)
              .accounting(BulkRequestCreateParams.Resource.PaymentOrderAsyncCreateRequest.Accounting.builder()
              ...
              .chargeBearer(BulkRequestCreateParams.Resource.PaymentOrderAsyncCreateRequest.ChargeBearer.SHARED)
              .currency(Currency.AED)
              .description("description")
              .effectiveDate(LocalDate.parse("2019-12-27"))
              .expiresAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
              .externalId("external_id")
              .fallbackType(BulkRequestCreateParams.Resource.PaymentOrderAsyncCreateRequest.FallbackType.ACH)
              .foreignExchangeContract("foreign_exchange_contract")
              .foreignExchangeIndicator(BulkRequestCreateParams.Resource.PaymentOrderAsyncCreateRequest.ForeignExchangeIndicator.FIXED_TO_VARIABLE)
              .ledgerTransaction(LedgerTransactionCreateRequest.builder()
              ...
              .addLineItem(BulkRequestCreateParams.Resource.PaymentOrderAsyncCreateRequest.LineItemRequest.builder()
                  .amount(0L)
                  .accountingCategoryId("accounting_category_id")
                  .description("description")
                  .metadata(BulkRequestCreateParams.Resource.PaymentOrderAsyncCreateRequest.LineItemRequest.Metadata.builder()
                      .putAdditionalProperty("key", JsonValue.from("value"))
                      .putAdditionalProperty("foo", JsonValue.from("bar"))
                      .putAdditionalProperty("modern", JsonValue.from("treasury"))
                      .build())
                  .build())
              .metadata(BulkRequestCreateParams.Resource.PaymentOrderAsyncCreateRequest.Metadata.builder()
                  .putAdditionalProperty("key", JsonValue.from("value"))
                  .putAdditionalProperty("foo", JsonValue.from("bar"))
                  .putAdditionalProperty("modern", JsonValue.from("treasury"))
                  .build())
              ...
              .priority(BulkRequestCreateParams.Resource.PaymentOrderAsyncCreateRequest.Priority.HIGH)
              .processAfter(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
              .purpose("purpose")
              .receivingAccount(BulkRequestCreateParams.Resource.PaymentOrderAsyncCreateRequest.ReceivingAccount.builder()
                  .addAccountDetail(BulkRequestCreateParams.Resource.PaymentOrderAsyncCreateRequest.ReceivingAccount.AccountDetail.builder()
                      .accountNumber("account_number")
                      .accountNumberType(BulkRequestCreateParams.Resource.PaymentOrderAsyncCreateRequest.ReceivingAccount.AccountDetail.AccountNumberType.AU_NUMBER)
                      .build())
                  .accountType(ExternalAccountType.BASE_WALLET)
                  .addContactDetail(ContactDetailCreateRequest.builder()
                      .contactIdentifier("contact_identifier")
                      .contactIdentifierType(ContactDetailCreateRequest.ContactIdentifierType.EMAIL)
                      .build())
                  .externalId("external_id")
                  .ledgerAccount(LedgerAccountCreateRequest.builder()
                      .currency("currency")
                      ...
                      .metadata(LedgerAccountCreateRequest.Metadata.builder()
                          ...
                          .build())
                      .build())
                  .metadata(BulkRequestCreateParams.Resource.PaymentOrderAsyncCreateRequest.ReceivingAccount.Metadata.builder()
                      .putAdditionalProperty("key", JsonValue.from("value"))
                      .putAdditionalProperty("foo", JsonValue.from("bar"))
                      .putAdditionalProperty("modern", JsonValue.from("treasury"))
                      .build())
                  .name("name")
                  .partyAddress(AddressRequest.builder()
                      .country("country")
                      .line1("line1")
                      .line2("line2")
                      .locality("locality")
                  ...
                  .partyType(BulkRequestCreateParams.Resource.PaymentOrderAsyncCreateRequest.ReceivingAccount.PartyType.BUSINESS)
                  .plaidProcessorToken("plaid_processor_token")
                  .addRoutingDetail(BulkRequestCreateParams.Resource.PaymentOrderAsyncCreateRequest.ReceivingAccount.RoutingDetail.builder()
                      .routingNumber("routing_number")
                      .routingNumberType(BulkRequestCreateParams.Resource.PaymentOrderAsyncCreateRequest.ReceivingAccount.RoutingDetail.RoutingNumberType.ABA)
                      .paymentType(BulkRequestCreateParams.Resource.PaymentOrderAsyncCreateRequest.ReceivingAccount.RoutingDetail.PaymentType.ACH)
                      .build())
                  .build())
              .receivingAccountId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
              .reconciliationStatus(BulkRequestCreateParams.Resource.PaymentOrderAsyncCreateRequest.ReconciliationStatus.UNRECONCILED)
              ...
              .ultimateOriginatingPartyAddress(BulkRequestCreateParams.Resource.PaymentOrderAsyncCreateRequest.UltimateOriginatingPartyAddress.builder()
                  .country("country")
                  .line1("line1")
                  .line2("line2")
                  .locality("locality")
              ...
              .build())
          .metadata(BulkRequestCreateParams.Metadata.builder()
              .putAdditionalProperty("key", JsonValue.from("value"))
              .putAdditionalProperty("foo", JsonValue.from("bar"))
              .putAdditionalProperty("modern", JsonValue.from("treasury"))
              .build())
    ...
    suspend fun retrieve() {
      ...
      val bulkRequest = bulkRequestServiceAsync.retrieve("id")
    ...
    suspend fun list() {
      ...
      val page = bulkRequestServiceAsync.list()
