...
internal class PaymentActionServiceTest {
    ...
    fun create() {
      ...
      val paymentAction = paymentActionService.create(PaymentActionCreateParams.builder()
          .type("type")
    ...
    fun update() {
      ...
      val paymentAction = paymentActionService.update(PaymentActionUpdateParams.builder()
          .id("id")
