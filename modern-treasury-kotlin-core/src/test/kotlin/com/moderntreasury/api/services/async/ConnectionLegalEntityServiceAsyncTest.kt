...
internal class ConnectionLegalEntityServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val connectionLegalEntity = connectionLegalEntityServiceAsync.create(ConnectionLegalEntityCreateParams.builder()
          .connectionId("connection_id")
          .legalEntity(ConnectionLegalEntityCreateParams.LegalEntity.builder()
              ...
              .addDocument(ConnectionLegalEntityCreateParams.LegalEntity.Document.builder()
                  .documentType(ConnectionLegalEntityCreateParams.LegalEntity.Document.DocumentType.ARTICLES_OF_INCORPORATION)
                  .fileData("file_data")
                  .filename("filename")
                  .build())
              ...
              .addLegalEntityAssociation(LegalEntityAssociationInlineCreate.builder()
                  ...
                  .title("title")
                  .build())
              .legalEntityType(ConnectionLegalEntityCreateParams.LegalEntity.LegalEntityType.BUSINESS)
              .legalStructure(ConnectionLegalEntityCreateParams.LegalEntity.LegalStructure.CORPORATION)
              .listedExchange("listed_exchange")
              .metadata(ConnectionLegalEntityCreateParams.LegalEntity.Metadata.builder()
                  .putAdditionalProperty("key", JsonValue.from("value"))
                  .putAdditionalProperty("foo", JsonValue.from("bar"))
                  .putAdditionalProperty("modern", JsonValue.from("treasury"))
                  .build())
              .middleName("middle_name")
              .addOperatingJurisdiction("string")
              .addPhoneNumber(ConnectionLegalEntityCreateParams.LegalEntity.PhoneNumber.builder()
                  .phoneNumber("phone_number")
                  .build())
              .politicallyExposedPerson(true)
              .preferredName("preferred_name")
              .prefix("prefix")
              .addPrimarySocialMediaSite("string")
              .addRegulator(ConnectionLegalEntityCreateParams.LegalEntity.LegalEntityRegulator.builder()
                  .jurisdiction("jurisdiction")
                  .name("name")
                  .registrationNumber("registration_number")
                  .build())
              ...
              .serviceProviderLegalEntityId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
              .suffix("suffix")
              .termsOfUse(ConnectionLegalEntityCreateParams.LegalEntity.TermsOfUse.builder()
                  .acceptedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                  .ipAddress("ip_address")
                  .build())
              .thirdPartyVerification(ThirdPartyVerification.builder()
    ...
    suspend fun update() {
      ...
      val connectionLegalEntity = connectionLegalEntityServiceAsync.update(ConnectionLegalEntityUpdateParams.builder()
          .id("id")
