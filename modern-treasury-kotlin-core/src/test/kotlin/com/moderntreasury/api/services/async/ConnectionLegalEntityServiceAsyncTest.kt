...
internal class ConnectionLegalEntityServiceAsyncTest {
    ...
    suspend fun create() {
        ...
        val connectionLegalEntity =
            connectionLegalEntityServiceAsync.create(
                ConnectionLegalEntityCreateParams.builder()
                    ...
                    .legalEntity(
                        ConnectionLegalEntityCreateParams.LegalEntity.builder()
                            ...
                            .addDocument(
                                ConnectionLegalEntityCreateParams.LegalEntity.Document.builder()
                                    .documentType(
                                        ConnectionLegalEntityCreateParams.LegalEntity.Document
                                            .DocumentType
    ...
    suspend fun update() {
        ...
        val connectionLegalEntity =
            connectionLegalEntityServiceAsync.update(
