...
internal class LedgerTransactionServiceTest {
    ...
    fun create() {
      ...
      val ledgerTransaction = ledgerTransactionService.create(LedgerTransactionCreateRequest.builder()
    ...
    fun update() {
      ...
      val ledgerTransaction = ledgerTransactionService.update(LedgerTransactionUpdateParams.builder()
          .id("id")
          .description("description")
          .effectiveAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .externalId("external_id")
    ...
    fun createPartialPost() {
      ...
      val ledgerTransaction = ledgerTransactionService.createPartialPost(LedgerTransactionCreatePartialPostParams.builder()
          .id("id")
    ...
    fun createReversal() {
      ...
      val ledgerTransaction = ledgerTransactionService.createReversal(LedgerTransactionCreateReversalParams.builder()
          .id("id")
          .description("description")
          .effectiveAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .externalId("external_id")
