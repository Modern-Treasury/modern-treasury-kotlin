...
internal class LedgerAccountBalanceMonitorServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val ledgerAccountBalanceMonitor = ledgerAccountBalanceMonitorServiceAsync.create(LedgerAccountBalanceMonitorCreateParams.builder()
          .alertCondition(LedgerAccountBalanceMonitorCreateParams.AlertConditionCreateRequest.builder()
              .field("field")
              .operator("operator")
              .value(0L)
              .build())
          ...
          .metadata(LedgerAccountBalanceMonitorCreateParams.Metadata.builder()
    ...
    suspend fun update() {
      ...
      val ledgerAccountBalanceMonitor = ledgerAccountBalanceMonitorServiceAsync.update(LedgerAccountBalanceMonitorUpdateParams.builder()
          .id("id")
          .description("description")
          .metadata(LedgerAccountBalanceMonitorUpdateParams.Metadata.builder()
              .putAdditionalProperty("key", JsonValue.from("value"))
              .putAdditionalProperty("foo", JsonValue.from("bar"))
              .putAdditionalProperty("modern", JsonValue.from("treasury"))
              .build())
