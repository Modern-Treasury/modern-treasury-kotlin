...
internal class VirtualAccountServiceTest {
    ...
    fun create() {
      ...
      val virtualAccount = virtualAccountService.create(VirtualAccountCreateParams.builder()
    ...
    fun update() {
      ...
      val virtualAccount = virtualAccountService.update(VirtualAccountUpdateParams.builder()
          .id("id")
          .counterpartyId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
