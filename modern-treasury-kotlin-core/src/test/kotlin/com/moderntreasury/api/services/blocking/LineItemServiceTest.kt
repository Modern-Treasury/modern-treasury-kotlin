...
internal class LineItemServiceTest {
    ...
    fun retrieve() {
      ...
      val lineItem = lineItemService.retrieve(LineItemRetrieveParams.builder()
    ...
    fun update() {
      ...
      val lineItem = lineItemService.update(LineItemUpdateParams.builder()
    ...
    fun list() {
      ...
      val page = lineItemService.list(LineItemListParams.builder()
