...
internal class LegalEntityServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val legalEntity = legalEntityServiceAsync.create(LegalEntityCreateParams.builder()
    ...
    suspend fun update() {
      ...
      val legalEntity = legalEntityServiceAsync.update(LegalEntityUpdateParams.builder()
          .id("id")
          .addAddress(LegalEntityAddressCreateRequest.builder()
              .country("country")
              .line1("line1")
