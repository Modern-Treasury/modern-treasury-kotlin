...
internal class LegalEntityServiceAsyncTest {
        ...
        val legalEntity =
            legalEntityServiceAsync.create(
                LegalEntityCreateParams.builder()
                    ...
                    .addDocument(
                        LegalEntityCreateParams.Document.builder()
                            .documentType(
                                LegalEntityCreateParams.Document.DocumentType
    ...
    suspend fun retrieve() {
        ...
        val legalEntity = legalEntityServiceAsync.retrieve("id")
    ...
    suspend fun update() {
        ...
        val legalEntity =
            legalEntityServiceAsync.update(
