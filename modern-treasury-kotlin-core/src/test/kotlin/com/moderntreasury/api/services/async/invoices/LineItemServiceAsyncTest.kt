...
internal class LineItemServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val invoiceLineItem = lineItemServiceAsync.create(InvoiceLineItemCreateParams.builder()
          .invoiceId("invoice_id")
          .name("name")
          .unitAmount(0L)
          .description("description")
          .direction("direction")
          .metadata(InvoiceLineItemCreateParams.Metadata.builder()
    ...
    suspend fun retrieve() {
      ...
      val invoiceLineItem = lineItemServiceAsync.retrieve(InvoiceLineItemRetrieveParams.builder()
          .invoiceId("invoice_id")
          .id("id")
          .build())
    ...
    suspend fun update() {
      ...
      val invoiceLineItem = lineItemServiceAsync.update(InvoiceLineItemUpdateParams.builder()
          .invoiceId("invoice_id")
          .id("id")
          .description("description")
          .direction("direction")
          .metadata(InvoiceLineItemUpdateParams.Metadata.builder()
              .putAdditionalProperty("key", JsonValue.from("value"))
              .putAdditionalProperty("foo", JsonValue.from("bar"))
              .putAdditionalProperty("modern", JsonValue.from("treasury"))
              .build())
    ...
    suspend fun delete() {
      ...
      val invoiceLineItem = lineItemServiceAsync.delete(InvoiceLineItemDeleteParams.builder()
          .invoiceId("invoice_id")
          .id("id")
          .build())
