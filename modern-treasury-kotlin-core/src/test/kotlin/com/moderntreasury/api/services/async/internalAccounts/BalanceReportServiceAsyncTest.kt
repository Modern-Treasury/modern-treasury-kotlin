...
internal class BalanceReportServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val balanceReport = balanceReportServiceAsync.create(BalanceReportCreateParams.builder()
    ...
    suspend fun retrieve() {
      ...
      val balanceReport = balanceReportServiceAsync.retrieve(BalanceReportRetrieveParams.builder()
          .internalAccountId("internal_account_id")
    ...
    suspend fun list() {
      ...
      val page = balanceReportServiceAsync.list("internal_account_id")
    ...
    suspend fun delete() {
      ...
      balanceReportServiceAsync.delete(BalanceReportDeleteParams.builder()
          .internalAccountId("internal_account_id")
          .id("id")
          .build())
    }
