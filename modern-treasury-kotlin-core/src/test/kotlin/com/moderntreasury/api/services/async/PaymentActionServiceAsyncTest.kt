...
internal class PaymentActionServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val paymentAction = paymentActionServiceAsync.create(PaymentActionCreateParams.builder()
          .type("type")
    ...
    suspend fun update() {
      ...
      val paymentAction = paymentActionServiceAsync.update(PaymentActionUpdateParams.builder()
          .id("id")
