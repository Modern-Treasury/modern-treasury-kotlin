...
internal class AccountCollectionFlowServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val accountCollectionFlow = accountCollectionFlowServiceAsync.create(AccountCollectionFlowCreateParams.builder()
    ...
    suspend fun update() {
      ...
      val accountCollectionFlow = accountCollectionFlowServiceAsync.update(AccountCollectionFlowUpdateParams.builder()
          .id("id")
