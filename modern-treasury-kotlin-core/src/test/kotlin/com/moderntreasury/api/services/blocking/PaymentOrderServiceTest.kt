...
internal class PaymentOrderServiceTest {
    ...
    fun create() {
      ...
      val paymentOrder = paymentOrderService.create(PaymentOrderCreateParams.builder()
          .amount(0L)
    ...
    fun update() {
      ...
      val paymentOrder = paymentOrderService.update(PaymentOrderUpdateParams.builder()
          .id("id")
    ...
    fun createAsync() {
      ...
      val asyncResponse = paymentOrderService.createAsync(PaymentOrderCreateAsyncParams.builder()
          .amount(0L)
