...
internal class IncomingPaymentDetailServiceTest {
    ...
    fun retrieve() {
      ...
      val incomingPaymentDetail = incomingPaymentDetailService.retrieve("id")
    ...
    fun update() {
      ...
      val incomingPaymentDetail = incomingPaymentDetailService.update(IncomingPaymentDetailUpdateParams.builder()
          .id("id")
          .metadata(IncomingPaymentDetailUpdateParams.Metadata.builder()
    ...
    fun createAsync() {
      ...
      val incomingPaymentDetail = incomingPaymentDetailService.createAsync(IncomingPaymentDetailCreateAsyncParams.builder()
          .amount(0L)
