...
internal class CounterpartyServiceTest {
    ...
    fun create() {
      ...
      val counterparty = counterpartyService.create(CounterpartyCreateParams.builder()
          .name("name")
    ...
    fun update() {
      ...
      val counterparty = counterpartyService.update(CounterpartyUpdateParams.builder()
          .id("id")
          .email("dev@stainless.com")
          .externalId("external_id")
          .legalEntityId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ...
    fun collectAccount() {
      ...
      val counterpartyCollectAccountResponse = counterpartyService.collectAccount(CounterpartyCollectAccountParams.builder()
          .id("id")
