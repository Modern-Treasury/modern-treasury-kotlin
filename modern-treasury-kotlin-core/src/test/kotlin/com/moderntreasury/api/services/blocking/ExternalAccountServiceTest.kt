...
internal class ExternalAccountServiceTest {
    ...
    fun completeVerification() {
      ...
      val externalAccount = externalAccountService.completeVerification(ExternalAccountCompleteVerificationParams.builder()
          .id("id")
          .addAmount(2L)
          .addAmount(4L)
          .build())
    ...
    fun verify() {
      ...
      val response = externalAccountService.verify(ExternalAccountVerifyParams.builder()
          .id("id")
