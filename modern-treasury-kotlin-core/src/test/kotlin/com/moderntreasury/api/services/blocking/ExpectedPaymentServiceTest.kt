...
internal class ExpectedPaymentServiceTest {
    ...
    fun create() {
      ...
      val expectedPayment = expectedPaymentService.create(ExpectedPaymentCreateParams.builder()
          .amountLowerBound(0L)
          .amountReconciled(0L)
    ...
    fun update() {
      ...
      val expectedPayment = expectedPaymentService.update(ExpectedPaymentUpdateParams.builder()
          .id("id")
          .amountLowerBound(0L)
          .amountReconciled(0L)
