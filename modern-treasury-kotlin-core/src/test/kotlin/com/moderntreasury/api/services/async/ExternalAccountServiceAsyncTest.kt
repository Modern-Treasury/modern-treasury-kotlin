...
internal class ExternalAccountServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val externalAccount = externalAccountServiceAsync.create(ExternalAccountCreateParams.builder()
          .counterpartyId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .addAccountDetail(ExternalAccountCreateParams.AccountDetail.builder()
              .accountNumber("account_number")
              .accountNumberType(ExternalAccountCreateParams.AccountDetail.AccountNumberType.AU_NUMBER)
              .build())
          ...
          .ledgerAccount(LedgerAccountCreateRequest.builder()
              ...
              .metadata(LedgerAccountCreateRequest.Metadata.builder()
                  ...
                  .build())
              .build())
          .metadata(ExternalAccountCreateParams.Metadata.builder()
              .putAdditionalProperty("key", JsonValue.from("value"))
              .putAdditionalProperty("foo", JsonValue.from("bar"))
              .putAdditionalProperty("modern", JsonValue.from("treasury"))
              .build())
          ...
          .addRoutingDetail(ExternalAccountCreateParams.RoutingDetail.builder()
              .routingNumber("routing_number")
              .routingNumberType(ExternalAccountCreateParams.RoutingDetail.RoutingNumberType.ABA)
    ...
    suspend fun update() {
      ...
      val externalAccount = externalAccountServiceAsync.update(ExternalAccountUpdateParams.builder()
          .id("id")
          .accountType(ExternalAccountType.BASE_WALLET)
          .counterpartyId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .metadata(ExternalAccountUpdateParams.Metadata.builder()
    ...
    suspend fun completeVerification() {
      ...
      val externalAccount = externalAccountServiceAsync.completeVerification(ExternalAccountCompleteVerificationParams.builder()
          .id("id")
          .addAmount(2L)
          .addAmount(4L)
          .build())
    ...
    suspend fun verify() {
      ...
      val response = externalAccountServiceAsync.verify(ExternalAccountVerifyParams.builder()
          .id("id")
