...
internal class ConnectionLegalEntityServiceTest {
    ...
    fun create() {
      ...
      val connectionLegalEntity = connectionLegalEntityService.create(ConnectionLegalEntityCreateParams.builder()
    ...
    fun update() {
      ...
      val connectionLegalEntity = connectionLegalEntityService.update(ConnectionLegalEntityUpdateParams.builder()
          .id("id")
