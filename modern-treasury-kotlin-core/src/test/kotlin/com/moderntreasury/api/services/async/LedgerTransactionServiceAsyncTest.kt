...
internal class LedgerTransactionServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val ledgerTransaction = ledgerTransactionServiceAsync.create(LedgerTransactionCreateRequest.builder()
    ...
    suspend fun update() {
      ...
      val ledgerTransaction = ledgerTransactionServiceAsync.update(LedgerTransactionUpdateParams.builder()
          .id("id")
          .description("description")
          .effectiveAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .externalId("external_id")
    ...
    suspend fun createPartialPost() {
      ...
      val ledgerTransaction = ledgerTransactionServiceAsync.createPartialPost(LedgerTransactionCreatePartialPostParams.builder()
          .id("id")
    ...
    suspend fun createReversal() {
      ...
      val ledgerTransaction = ledgerTransactionServiceAsync.createReversal(LedgerTransactionCreateReversalParams.builder()
          .id("id")
          .description("description")
          .effectiveAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .externalId("external_id")
