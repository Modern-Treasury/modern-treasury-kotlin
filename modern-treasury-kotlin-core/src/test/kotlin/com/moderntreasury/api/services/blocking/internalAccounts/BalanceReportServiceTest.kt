...
internal class BalanceReportServiceTest {
    ...
    fun create() {
      ...
      val balanceReport = balanceReportService.create(BalanceReportCreateParams.builder()
    ...
    fun retrieve() {
      ...
      val balanceReport = balanceReportService.retrieve(BalanceReportRetrieveParams.builder()
          .internalAccountId("internal_account_id")
    ...
    fun delete() {
      ...
      balanceReportService.delete(BalanceReportDeleteParams.builder()
          .internalAccountId("internal_account_id")
          .id("id")
          .build())
    }
