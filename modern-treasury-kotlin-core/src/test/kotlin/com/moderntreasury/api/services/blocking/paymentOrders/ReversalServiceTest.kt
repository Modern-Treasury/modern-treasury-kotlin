...
internal class ReversalServiceTest {
    ...
    fun create() {
      ...
      val reversal = reversalService.create(PaymentOrderReversalCreateParams.builder()
    ...
    fun retrieve() {
      ...
      val reversal = reversalService.retrieve(PaymentOrderReversalRetrieveParams.builder()
          .paymentOrderId("payment_order_id")
