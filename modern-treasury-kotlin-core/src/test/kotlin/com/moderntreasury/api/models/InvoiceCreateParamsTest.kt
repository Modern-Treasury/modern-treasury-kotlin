...
internal class InvoiceCreateParamsTest {
    ...
    fun body() {
      ...
      assertThat(body.contactDetails()).containsExactly(ContactDetail.builder()
          ...
          .updatedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .build())
      assertThat(body.counterpartyBillingAddress()).isEqualTo(InvoiceCreateParams.CounterpartyBillingAddress.builder()
          .country("country")
          .line1("line1")
          .locality("locality")
          .postalCode("postal_code")
          ...
          .line2("line2")
          .build())
      assertThat(body.counterpartyShippingAddress()).isEqualTo(InvoiceCreateParams.CounterpartyShippingAddress.builder()
          .country("country")
          .line1("line1")
          .locality("locality")
          .postalCode("postal_code")
      ...
      assertThat(body.invoiceLineItems()).containsExactly(InvoiceCreateParams.InvoiceLineItemCreateRequest.builder()
          .name("name")
          .unitAmount(0L)
          .description("description")
          .direction("direction")
          ...
          .unitAmountDecimal("unit_amount_decimal")
          .build())
      assertThat(body.invoicerAddress()).isEqualTo(InvoiceCreateParams.InvoicerAddress.builder()
          .country("country")
          .line1("line1")
          .locality("locality")
          .postalCode("postal_code")
      ...
      assertThat(body.metadata()).isEqualTo(InvoiceCreateParams.Metadata.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
