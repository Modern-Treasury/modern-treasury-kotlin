...
internal class ForeignExchangeRateTest {
    ...
    @Test
    fun create() {
      val foreignExchangeRate = ForeignExchangeRate.builder()
          .baseAmount(0L)
    ...
    fun roundtrip() {
      ...
      val roundtrippedForeignExchangeRate = jsonMapper.readValue(jsonMapper.writeValueAsString(foreignExchangeRate), jacksonTypeRef<ForeignExchangeRate>())
