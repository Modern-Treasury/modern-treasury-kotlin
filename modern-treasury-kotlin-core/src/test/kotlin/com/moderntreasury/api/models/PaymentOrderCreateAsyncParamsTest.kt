...
internal class PaymentOrderCreateAsyncParamsTest {
    ...
    @Test
    fun body() {
      val params = PaymentOrderCreateAsyncParams.builder()
          .amount(0L)
          .direction(PaymentOrderCreateAsyncParams.Direction.CREDIT)
          .originatingAccountId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .type(PaymentOrderType.ACH)
      ...
      assertThat(body.accounting()).isEqualTo(PaymentOrderCreateAsyncParams.Accounting.builder()
          .accountId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .classId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .build())
      ...
      assertThat(body.foreignExchangeIndicator()).isEqualTo(PaymentOrderCreateAsyncParams.ForeignExchangeIndicator.FIXED_TO_VARIABLE)
      ...
      assertThat(body.lineItems()).containsExactly(PaymentOrderCreateAsyncParams.LineItemRequest.builder()
          .amount(0L)
          .accountingCategoryId("accounting_category_id")
          .description("description")
          .metadata(PaymentOrderCreateAsyncParams.LineItemRequest.Metadata.builder()
              ...
              .build())
          .build())
      assertThat(body.metadata()).isEqualTo(PaymentOrderCreateAsyncParams.Metadata.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
      ...
      assertThat(body.receivingAccount()).isEqualTo(PaymentOrderCreateAsyncParams.ReceivingAccount.builder()
          .addAccountDetail(PaymentOrderCreateAsyncParams.ReceivingAccount.AccountDetail.builder()
              .accountNumber("account_number")
              .accountNumberType(PaymentOrderCreateAsyncParams.ReceivingAccount.AccountDetail.AccountNumberType.AU_NUMBER)
              .build())
      ...
      assertThat(body.reconciliationStatus()).isEqualTo(PaymentOrderCreateAsyncParams.ReconciliationStatus.UNRECONCILED)
      ...
      assertThat(body.ultimateOriginatingAccountId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(body.ultimateOriginatingPartyAddress()).isEqualTo(PaymentOrderCreateAsyncParams.UltimateOriginatingPartyAddress.builder()
          .country("country")
          .line1("line1")
          .line2("line2")
          .locality("locality")
          ...
          .region("region")
          .build())
      assertThat(body.ultimateOriginatingPartyIdentifier()).isEqualTo("ultimate_originating_party_identifier")
      assertThat(body.ultimateOriginatingPartyName()).isEqualTo("ultimate_originating_party_name")
      assertThat(body.ultimateReceivingPartyIdentifier()).isEqualTo("ultimate_receiving_party_identifier")
