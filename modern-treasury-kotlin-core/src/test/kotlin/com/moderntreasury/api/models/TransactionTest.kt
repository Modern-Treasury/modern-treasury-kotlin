...
internal class TransactionTest {
    ...
    fun create() {
      val transaction = Transaction.builder()
          ...
          .customIdentifiers(Transaction.CustomIdentifiers.builder()
          ...
          .liveMode(true)
          .metadata(Transaction.Metadata.builder()
              .putAdditionalProperty("key", JsonValue.from("value"))
              .putAdditionalProperty("foo", JsonValue.from("bar"))
              .putAdditionalProperty("modern", JsonValue.from("treasury"))
              .build())
          ...
          .vendorId("vendor_id")
          .details(Transaction.Details.builder()
      ...
      assertThat(transaction.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(transaction.currency()).isEqualTo(Currency.AED)
      assertThat(transaction.customIdentifiers()).isEqualTo(Transaction.CustomIdentifiers.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
      assertThat(transaction.direction()).isEqualTo("direction")
      assertThat(transaction.discardedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(transaction.foreignExchangeRate()).isEqualTo(ForeignExchangeRate.builder()
          .baseAmount(0L)
          .baseCurrency(Currency.AED)
          .exponent(0L)
          .rateString("rate_string")
          ...
          .value(0L)
          .build())
      assertThat(transaction.internalAccountId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(transaction.liveMode()).isEqualTo(true)
      assertThat(transaction.metadata()).isEqualTo(Transaction.Metadata.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
      ...
      assertThat(transaction.updatedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(transaction.details()).isEqualTo(Transaction.Details.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
    ...
    fun roundtrip() {
      ...
      val roundtrippedTransaction = jsonMapper.readValue(jsonMapper.writeValueAsString(transaction), jacksonTypeRef<Transaction>())
