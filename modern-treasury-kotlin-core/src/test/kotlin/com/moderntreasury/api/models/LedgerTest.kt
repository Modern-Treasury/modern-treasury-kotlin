...
internal class LedgerTest {
    ...
    @Test
    fun create() {
      val ledger = Ledger.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .description("description")
          .discardedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .liveMode(true)
          .metadata(Ledger.Metadata.builder()
      ...
      assertThat(ledger.metadata()).isEqualTo(Ledger.Metadata.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
    ...
    fun roundtrip() {
      ...
      val roundtrippedLedger = jsonMapper.readValue(jsonMapper.writeValueAsString(ledger), jacksonTypeRef<Ledger>())
