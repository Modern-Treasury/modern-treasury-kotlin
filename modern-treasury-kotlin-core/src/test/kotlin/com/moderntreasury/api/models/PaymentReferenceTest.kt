...
internal class PaymentReferenceTest {
    ...
    @Test
    fun create() {
      val paymentReference = PaymentReference.builder()
      ...
      assertThat(paymentReference.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(paymentReference.referenceNumberType()).isEqualTo(PaymentReference.ReferenceNumberType.ACH_ORIGINAL_TRACE_NUMBER)
      assertThat(paymentReference.referenceableId()).isEqualTo("referenceable_id")
      assertThat(paymentReference.referenceableType()).isEqualTo(PaymentReference.ReferenceableType.PAYMENT_ORDER)
      assertThat(paymentReference.updatedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedPaymentReference = jsonMapper.readValue(jsonMapper.writeValueAsString(paymentReference), jacksonTypeRef<PaymentReference>())
