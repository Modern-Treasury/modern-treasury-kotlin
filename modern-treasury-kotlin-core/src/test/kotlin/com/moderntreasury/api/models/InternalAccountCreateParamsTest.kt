...
internal class InternalAccountCreateParamsTest {
    ...
    @Test
    fun body() {
      val params = InternalAccountCreateParams.builder()
          .currency(InternalAccountCreateParams.Currency.USD)
          .name("name")
          .addAccountCapability(InternalAccountCreateParams.AccountCapability.builder()
              .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      ...
      assertThat(body.accountCapabilities()).containsExactly(InternalAccountCreateParams.AccountCapability.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .direction(TransactionDirection.CREDIT)
          .discardedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(body.metadata()).isEqualTo(InternalAccountCreateParams.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
      assertThat(body.parentAccountId()).isEqualTo("parent_account_id")
      assertThat(body.partyAddress()).isEqualTo(InternalAccountCreateParams.PartyAddress.builder()
          .country("country")
          .line1("line1")
          .locality("locality")
          .postalCode("postal_code")
      ...
      assertThat(body.vendorAttributes()).isEqualTo(InternalAccountCreateParams.VendorAttributes.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
