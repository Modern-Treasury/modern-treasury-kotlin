...
internal class CounterpartyUpdateParamsTest {
    ...
    fun create() {
      CounterpartyUpdateParams.builder()
          ...
          .metadata(CounterpartyUpdateParams.Metadata.builder()
    ...
    @Test
    fun pathParams() {
      val params = CounterpartyUpdateParams.builder()
          .id("id")
          .build()
    ...
    fun body() {
      ...
      assertThat(body.metadata()).isEqualTo(CounterpartyUpdateParams.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
