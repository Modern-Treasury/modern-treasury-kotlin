...
internal class LedgerBalanceTest {
    ...
    @Test
    fun create() {
      val ledgerBalance = LedgerBalance.builder()
          .amount(0L)
    ...
    fun roundtrip() {
      ...
      val roundtrippedLedgerBalance = jsonMapper.readValue(jsonMapper.writeValueAsString(ledgerBalance), jacksonTypeRef<LedgerBalance>())
