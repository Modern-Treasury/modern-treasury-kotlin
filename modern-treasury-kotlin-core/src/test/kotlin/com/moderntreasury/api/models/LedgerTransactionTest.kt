...
internal class LedgerTransactionTest {
    ...
    @Test
    fun create() {
      val ledgerTransaction = LedgerTransaction.builder()
          ...
          .addLedgerEntry(LedgerEntry.builder()
              .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
              .amount(0L)
              ...
              .liveMode(true)
              .metadata(LedgerEntry.Metadata.builder()
          ...
          .liveMode(true)
          .metadata(LedgerTransaction.Metadata.builder()
              .putAdditionalProperty("key", JsonValue.from("value"))
              .putAdditionalProperty("foo", JsonValue.from("bar"))
              .putAdditionalProperty("modern", JsonValue.from("treasury"))
              .build())
      ...
      assertThat(ledgerTransaction.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(ledgerTransaction.description()).isEqualTo("description")
      assertThat(ledgerTransaction.effectiveAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(ledgerTransaction.ledgerEntries()).containsExactly(LedgerEntry.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .amount(0L)
          .amountString("amount_string")
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(ledgerTransaction.ledgerableId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(ledgerTransaction.ledgerableType()).isEqualTo(LedgerTransaction.LedgerableType.EXPECTED_PAYMENT)
      assertThat(ledgerTransaction.liveMode()).isEqualTo(true)
      assertThat(ledgerTransaction.metadata()).isEqualTo(LedgerTransaction.Metadata.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
      assertThat(ledgerTransaction.object_()).isEqualTo("object")
      assertThat(ledgerTransaction.partiallyPostsLedgerTransactionId()).isEqualTo("partially_posts_ledger_transaction_id")
      assertThat(ledgerTransaction.postedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(ledgerTransaction.reversedByLedgerTransactionId()).isEqualTo("reversed_by_ledger_transaction_id")
      assertThat(ledgerTransaction.reversesLedgerTransactionId()).isEqualTo("reverses_ledger_transaction_id")
      assertThat(ledgerTransaction.status()).isEqualTo(LedgerTransaction.Status.ARCHIVED)
      assertThat(ledgerTransaction.updatedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedLedgerTransaction = jsonMapper.readValue(jsonMapper.writeValueAsString(ledgerTransaction), jacksonTypeRef<LedgerTransaction>())
