...
internal class LedgerAccountSettlementListParamsTest {
    ...
    @Test
    fun queryParams() {
      val params = LedgerAccountSettlementListParams.builder()
          .addId("string")
          .afterCursor("after_cursor")
          .createdAt(LedgerAccountSettlementListParams.CreatedAt.builder()
              .putAdditionalProperty("foo", "2019-12-27T18:11:19.117Z")
