...
internal class BulkRequestTest {
    ...
    fun create() {
      val bulkRequest = BulkRequest.builder()
          ...
          .liveMode(true)
          .metadata(BulkRequest.Metadata.builder()
      ...
      assertThat(bulkRequest.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(bulkRequest.failedResultCount()).isEqualTo(0L)
      assertThat(bulkRequest.liveMode()).isEqualTo(true)
      assertThat(bulkRequest.metadata()).isEqualTo(BulkRequest.Metadata.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
      ...
      assertThat(bulkRequest.updatedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedBulkRequest = jsonMapper.readValue(jsonMapper.writeValueAsString(bulkRequest), jacksonTypeRef<BulkRequest>())
