...
internal class HoldRetrieveResponseTest {
    ...
    @Test
    fun create() {
      val holdRetrieveResponse = HoldRetrieveResponse.builder()
          ...
          .liveMode(true)
          .metadata(HoldRetrieveResponse.Metadata.builder()
      ...
      assertThat(holdRetrieveResponse.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(holdRetrieveResponse.targetId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(holdRetrieveResponse.targetType()).isEqualTo(HoldRetrieveResponse.TargetType.PAYMENT_ORDER)
      assertThat(holdRetrieveResponse.updatedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(holdRetrieveResponse.liveMode()).isEqualTo(true)
      assertThat(holdRetrieveResponse.metadata()).isEqualTo(HoldRetrieveResponse.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
      assertThat(holdRetrieveResponse.reason()).isEqualTo("reason")
      assertThat(holdRetrieveResponse.resolution()).isEqualTo("resolution")
      assertThat(holdRetrieveResponse.resolvedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedHoldRetrieveResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(holdRetrieveResponse), jacksonTypeRef<HoldRetrieveResponse>())
