...
internal class CounterpartyTest {
    ...
    fun create() {
      ...
      assertThat(counterparty.accounts()).containsExactly(Counterparty.Account.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .addAccountDetail(AccountDetail.builder()
              .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
              .accountNumberSafe("account_number_safe")
          ...
          .verificationStatus(Counterparty.Account.VerificationStatus.PENDING_VERIFICATION)
          .build())
      assertThat(counterparty.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(counterparty.discardedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(counterparty.metadata()).isEqualTo(Counterparty.Metadata.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
      ...
      assertThat(counterparty.updatedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
