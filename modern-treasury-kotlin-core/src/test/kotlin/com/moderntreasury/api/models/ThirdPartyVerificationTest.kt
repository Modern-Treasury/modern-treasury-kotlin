...
internal class ThirdPartyVerificationTest {
    ...
    @Test
    fun create() {
      val thirdPartyVerification = ThirdPartyVerification.builder()
      ...
      assertThat(thirdPartyVerification.outcome()).isEqualTo(ThirdPartyVerification.Outcome.PASSED)
      assertThat(thirdPartyVerification.vendor()).isEqualTo(ThirdPartyVerification.Vendor.PERSONA)
      assertThat(thirdPartyVerification.vendorVerificationId()).isEqualTo("vendor_verification_id")
      assertThat(thirdPartyVerification.verificationCategory()).isEqualTo(ThirdPartyVerification.VerificationCategory.LEGAL_NAME)
      assertThat(thirdPartyVerification.verificationMethod()).isEqualTo("verification_method")
      assertThat(thirdPartyVerification.verificationTime()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedThirdPartyVerification = jsonMapper.readValue(jsonMapper.writeValueAsString(thirdPartyVerification), jacksonTypeRef<ThirdPartyVerification>())
