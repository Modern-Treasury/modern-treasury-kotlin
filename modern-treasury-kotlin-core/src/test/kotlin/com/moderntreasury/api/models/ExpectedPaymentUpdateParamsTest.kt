...
internal class ExpectedPaymentUpdateParamsTest {
    ...
    @Test
    fun pathParams() {
      val params = ExpectedPaymentUpdateParams.builder()
          .id("id")
          .build()
    ...
    fun body() {
      ...
      assertThat(body.amountReconciledDirection()).isEqualTo(ExpectedPaymentUpdateParams.AmountReconciledDirection.CREDIT)
      assertThat(body.amountUnreconciled()).isEqualTo(0L)
      assertThat(body.amountUnreconciledDirection()).isEqualTo(ExpectedPaymentUpdateParams.AmountUnreconciledDirection.CREDIT)
      ...
      assertThat(body.metadata()).isEqualTo(ExpectedPaymentUpdateParams.Metadata.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
      ...
      assertThat(body.reconciliationRuleVariables()).containsExactly(ReconciliationRule.builder()
          .amountLowerBound(0L)
          .amountUpperBound(0L)
          .direction(ReconciliationRule.Direction.CREDIT)
          .internalAccountId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
