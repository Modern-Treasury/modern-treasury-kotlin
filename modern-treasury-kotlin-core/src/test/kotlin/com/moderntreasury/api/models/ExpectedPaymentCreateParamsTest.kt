...
internal class ExpectedPaymentCreateParamsTest {
    ...
    @Test
    fun body() {
      val params = ExpectedPaymentCreateParams.builder()
          .amountLowerBound(0L)
          .amountReconciled(0L)
          .amountReconciledDirection(ExpectedPaymentCreateParams.AmountReconciledDirection.CREDIT)
          .amountUnreconciled(0L)
      ...
      assertThat(body.amountReconciledDirection()).isEqualTo(ExpectedPaymentCreateParams.AmountReconciledDirection.CREDIT)
      assertThat(body.amountUnreconciled()).isEqualTo(0L)
      assertThat(body.amountUnreconciledDirection()).isEqualTo(ExpectedPaymentCreateParams.AmountUnreconciledDirection.CREDIT)
      ...
      assertThat(body.lineItems()).containsExactly(ExpectedPaymentCreateParams.LineItemRequest.builder()
          .amount(0L)
          .accountingCategoryId("accounting_category_id")
          .description("description")
          .metadata(ExpectedPaymentCreateParams.LineItemRequest.Metadata.builder()
              ...
              .build())
          .build())
      assertThat(body.metadata()).isEqualTo(ExpectedPaymentCreateParams.Metadata.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
