...
internal class LedgerTransactionCreateParamsTest {
    ...
    fun create() {
      LedgerTransactionCreateParams.builder()
          .ledgerTransactionCreateRequest(LedgerTransactionCreateRequest.builder()
    ...
    @Test
    fun body() {
      val params = LedgerTransactionCreateParams.builder()
          .ledgerTransactionCreateRequest(LedgerTransactionCreateRequest.builder()
              .addLedgerEntry(LedgerEntryCreateRequest.builder()
                  .direction(TransactionDirection.CREDIT)
                  .ledgerAccountId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      ...
      assertThat(body).isEqualTo(LedgerTransactionCreateRequest.builder()
          .addLedgerEntry(LedgerEntryCreateRequest.builder()
              .direction(TransactionDirection.CREDIT)
              .ledgerAccountId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
              .amount(0L)
