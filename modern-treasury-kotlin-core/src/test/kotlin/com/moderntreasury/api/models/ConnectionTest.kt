...
internal class ConnectionTest {
    ...
    fun create() {
      ...
      assertThat(connection.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(connection.discardedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(connection.liveMode()).isEqualTo(true)
      assertThat(connection.object_()).isEqualTo("object")
      assertThat(connection.updatedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedConnection = jsonMapper.readValue(jsonMapper.writeValueAsString(connection), jacksonTypeRef<Connection>())
