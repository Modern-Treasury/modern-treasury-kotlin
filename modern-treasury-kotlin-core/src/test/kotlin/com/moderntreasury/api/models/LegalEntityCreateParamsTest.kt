...
internal class LegalEntityCreateParamsTest {
        ...
        LegalEntityCreateParams.builder()
            ...
            .addDocument(
                LegalEntityCreateParams.Document.builder()
                    .documentType(
                        LegalEntityCreateParams.Document.DocumentType.ARTICLES_OF_INCORPORATION
                    )
                    .fileData("file_data")
                    .filename("filename")
                    .build()
    ...
    fun body() {
        ...
        assertThat(body.businessDesignation())
            .isEqualTo(LegalEntityCreateParams.BusinessDesignation.EXEMPT_FINANCIAL_INSTITUTION)
