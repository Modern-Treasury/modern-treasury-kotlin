...
internal class LegalEntityCreateParamsTest {
    ...
    fun create() {
      LegalEntityCreateParams.builder()
          ...
          .addDocument(LegalEntityCreateParams.Document.builder()
              .documentType(LegalEntityCreateParams.Document.DocumentType.ARTICLES_OF_INCORPORATION)
              .fileData("file_data")
              .filename("filename")
              .build())
          ...
          .listedExchange("listed_exchange")
          .metadata(LegalEntityCreateParams.Metadata.builder()
              .putAdditionalProperty("key", JsonValue.from("value"))
              .putAdditionalProperty("foo", JsonValue.from("bar"))
              .putAdditionalProperty("modern", JsonValue.from("treasury"))
              .build())
          .middleName("middle_name")
          .addOperatingJurisdiction("string")
          .addPhoneNumber(LegalEntityCreateParams.PhoneNumber.builder()
              .phoneNumber("phone_number")
              .build())
          .politicallyExposedPerson(true)
          .preferredName("preferred_name")
          .prefix("prefix")
          .addPrimarySocialMediaSite("string")
          .addRegulator(LegalEntityCreateParams.LegalEntityRegulator.builder()
              .jurisdiction("jurisdiction")
              .name("name")
              .registrationNumber("registration_number")
              .build())
          ...
          .serviceProviderLegalEntityId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .suffix("suffix")
          .termsOfUse(LegalEntityCreateParams.TermsOfUse.builder()
              .acceptedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
              .ipAddress("ip_address")
              .build())
          .thirdPartyVerification(ThirdPartyVerification.builder()
    ...
    @Test
    fun body() {
      val params = LegalEntityCreateParams.builder()
          .legalEntityType(LegalEntityCreateParams.LegalEntityType.BUSINESS)
          .addAddress(LegalEntityAddressCreateRequest.builder()
              .country("country")
              .line1("line1")
      ...
      assertThat(body.legalEntityType()).isEqualTo(LegalEntityCreateParams.LegalEntityType.BUSINESS)
      assertThat(body.addresses()).containsExactly(LegalEntityAddressCreateRequest.builder()
          .country("country")
          .line1("line1")
          .locality("locality")
          .postalCode("postal_code")
          ...
          .primary(true)
          .build())
      assertThat(body.bankSettings()).isEqualTo(BankSettings.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .backupWithholdingPercentage(0L)
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .discardedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(body.documents()).containsExactly(LegalEntityCreateParams.Document.builder()
          .documentType(LegalEntityCreateParams.Document.DocumentType.ARTICLES_OF_INCORPORATION)
          .fileData("file_data")
          .filename("filename")
          .build())
      ...
      assertThat(body.identifications()).containsExactly(IdentificationCreateRequest.builder()
          .idNumber("id_number")
          .idType(IdentificationCreateRequest.IdType.AR_CUIL)
          .addDocument(IdentificationCreateRequest.Document.builder()
              .documentType(IdentificationCreateRequest.Document.DocumentType.ARTICLES_OF_INCORPORATION)
          ...
          .issuingRegion("issuing_region")
          .build())
      assertThat(body.industryClassifications()).containsExactly(LegalEntityIndustryClassification.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .addClassificationCode("string")
          .classificationType(LegalEntityIndustryClassification.ClassificationType.ANZSIC)
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(body.legalEntityAssociations()).containsExactly(LegalEntityAssociationInlineCreate.builder()
          .addRelationshipType(LegalEntityAssociationInlineCreate.RelationshipType.AUTHORIZED_SIGNER)
          .childLegalEntity(ChildLegalEntityCreate.builder()
              .addAddress(LegalEntityAddressCreateRequest.builder()
                  .country("country")
          ...
          .title("title")
          .build())
      assertThat(body.legalStructure()).isEqualTo(LegalEntityCreateParams.LegalStructure.CORPORATION)
      assertThat(body.listedExchange()).isEqualTo("listed_exchange")
      assertThat(body.metadata()).isEqualTo(LegalEntityCreateParams.Metadata.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
      ...
      assertThat(body.phoneNumbers()).containsExactly(LegalEntityCreateParams.PhoneNumber.builder()
          .phoneNumber("phone_number")
          .build())
      ...
      assertThat(body.regulators()).containsExactly(LegalEntityCreateParams.LegalEntityRegulator.builder()
          .jurisdiction("jurisdiction")
          .name("name")
          .registrationNumber("registration_number")
          .build())
      assertThat(body.riskRating()).isEqualTo(LegalEntityCreateParams.RiskRating.LOW)
      assertThat(body.serviceProviderLegalEntityId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(body.suffix()).isEqualTo("suffix")
      assertThat(body.termsOfUse()).isEqualTo(LegalEntityCreateParams.TermsOfUse.builder()
          .acceptedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .ipAddress("ip_address")
          .build())
      assertThat(body.thirdPartyVerification()).isEqualTo(ThirdPartyVerification.builder()
          .outcome(ThirdPartyVerification.Outcome.PASSED)
          .vendor(ThirdPartyVerification.Vendor.PERSONA)
          .vendorVerificationId("vendor_verification_id")
          .verificationCategory(ThirdPartyVerification.VerificationCategory.LEGAL_NAME)
          ...
          .comment("comment")
          .build())
      assertThat(body.thirdPartyVerifications()).containsExactly(ThirdPartyVerification.builder()
          .outcome(ThirdPartyVerification.Outcome.PASSED)
          .vendor(ThirdPartyVerification.Vendor.PERSONA)
          .vendorVerificationId("vendor_verification_id")
          .verificationCategory(ThirdPartyVerification.VerificationCategory.LEGAL_NAME)
      ...
      assertThat(body.wealthAndEmploymentDetails()).isEqualTo(WealthAndEmploymentDetails.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .annualIncome(0L)
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .discardedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
