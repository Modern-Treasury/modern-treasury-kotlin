...
internal class LedgerAccountTest {
    ...
    @Test
    fun create() {
      val ledgerAccount = LedgerAccount.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .balances(LedgerAccount.LedgerBalancesWithEffectiveAt.builder()
          ...
          .liveMode(true)
          .lockVersion(0L)
          .metadata(LedgerAccount.Metadata.builder()
      ...
      assertThat(ledgerAccount.balances()).isEqualTo(LedgerAccount.LedgerBalancesWithEffectiveAt.builder()
          .availableBalance(LedgerBalance.builder()
              .amount(0L)
              .amountString("amount_string")
              .credits(0L)
          ...
          .postedBalance(LedgerBalance.builder()
              ...
              .build())
          .build())
      assertThat(ledgerAccount.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(ledgerAccount.description()).isEqualTo("description")
      assertThat(ledgerAccount.discardedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(ledgerAccount.ledgerableType()).isEqualTo(LedgerAccount.LedgerableType.COUNTERPARTY)
      assertThat(ledgerAccount.liveMode()).isEqualTo(true)
      assertThat(ledgerAccount.lockVersion()).isEqualTo(0L)
      assertThat(ledgerAccount.metadata()).isEqualTo(LedgerAccount.Metadata.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
      ...
      assertThat(ledgerAccount.updatedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedLedgerAccount = jsonMapper.readValue(jsonMapper.writeValueAsString(ledgerAccount), jacksonTypeRef<LedgerAccount>())
