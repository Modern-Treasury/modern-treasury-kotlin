...
internal class LegalEntityUpdateParamsTest {
    ...
    fun create() {
      LegalEntityUpdateParams.builder()
          ...
          .metadata(LegalEntityUpdateParams.Metadata.builder()
          ...
          .addPhoneNumber(LegalEntityUpdateParams.PhoneNumber.builder()
          ...
          .addRegulator(LegalEntityUpdateParams.LegalEntityRegulator.builder()
          ...
          .suffix("suffix")
          .termsOfUse(LegalEntityUpdateParams.TermsOfUse.builder()
    ...
    @Test
    fun pathParams() {
      val params = LegalEntityUpdateParams.builder()
          .id("id")
          .build()
    ...
    fun body() {
      ...
      assertThat(body.legalStructure()).isEqualTo(LegalEntityUpdateParams.LegalStructure.CORPORATION)
      assertThat(body.listedExchange()).isEqualTo("listed_exchange")
      assertThat(body.metadata()).isEqualTo(LegalEntityUpdateParams.Metadata.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
      ...
      assertThat(body.phoneNumbers()).containsExactly(LegalEntityUpdateParams.PhoneNumber.builder()
          .phoneNumber("phone_number")
          .build())
      ...
      assertThat(body.regulators()).containsExactly(LegalEntityUpdateParams.LegalEntityRegulator.builder()
          .jurisdiction("jurisdiction")
          .name("name")
          .registrationNumber("registration_number")
          .build())
      ...
      assertThat(body.termsOfUse()).isEqualTo(LegalEntityUpdateParams.TermsOfUse.builder()
          .acceptedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .ipAddress("ip_address")
          .build())
