...
internal class BankSettingsTest {
    ...
    @Test
    fun create() {
      val bankSettings = BankSettings.builder()
      ...
      assertThat(bankSettings.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(bankSettings.discardedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(bankSettings.updatedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedBankSettings = jsonMapper.readValue(jsonMapper.writeValueAsString(bankSettings), jacksonTypeRef<BankSettings>())
