...
internal class PaymentFlowTest {
    ...
    @Test
    fun create() {
      val paymentFlow = PaymentFlow.builder()
      ...
      assertThat(paymentFlow.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(paymentFlow.existingExternalAccountsFilter()).isEqualTo(PaymentFlow.ExistingExternalAccountsFilter.VERIFIED)
      assertThat(paymentFlow.externalAccountCollection()).isEqualTo(PaymentFlow.ExternalAccountCollection.DISABLED)
      assertThat(paymentFlow.liveMode()).isEqualTo(true)
      assertThat(paymentFlow.object_()).isEqualTo("object")
      assertThat(paymentFlow.originatingAccountId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(paymentFlow.paymentOrderId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(paymentFlow.receivingAccountId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      ...
      assertThat(paymentFlow.updatedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedPaymentFlow = jsonMapper.readValue(jsonMapper.writeValueAsString(paymentFlow), jacksonTypeRef<PaymentFlow>())
