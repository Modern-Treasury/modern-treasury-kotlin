...
internal class LedgerEntryCreateRequestTest {
    ...
    fun create() {
      ...
      assertThat(ledgerEntryCreateRequest.availableBalanceAmount()).isEqualTo(LedgerEntryCreateRequest.AvailableBalanceAmount.builder()
          .putAdditionalProperty("foo", JsonValue.from(0))
          .build())
      assertThat(ledgerEntryCreateRequest.effectiveAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(ledgerEntryCreateRequest.lockVersion()).isEqualTo(0L)
      assertThat(ledgerEntryCreateRequest.metadata()).isEqualTo(LedgerEntryCreateRequest.Metadata.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
      assertThat(ledgerEntryCreateRequest.pendingBalanceAmount()).isEqualTo(LedgerEntryCreateRequest.PendingBalanceAmount.builder()
          .putAdditionalProperty("foo", JsonValue.from(0))
          .build())
      assertThat(ledgerEntryCreateRequest.postedBalanceAmount()).isEqualTo(LedgerEntryCreateRequest.PostedBalanceAmount.builder()
          .putAdditionalProperty("foo", JsonValue.from(0))
          .build())
