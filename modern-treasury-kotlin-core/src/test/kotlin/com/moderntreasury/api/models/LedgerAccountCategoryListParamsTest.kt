...
internal class LedgerAccountCategoryListParamsTest {
    ...
    fun create() {
      LedgerAccountCategoryListParams.builder()
          ...
          .balances(LedgerAccountCategoryListParams.Balances.builder()
          ...
          .ledgerId("ledger_id")
          .metadata(LedgerAccountCategoryListParams.Metadata.builder()
    ...
    @Test
    fun queryParams() {
      val params = LedgerAccountCategoryListParams.builder()
          .addId("string")
          .afterCursor("after_cursor")
          .balances(LedgerAccountCategoryListParams.Balances.builder()
              .effectiveAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
