...
internal class LegalEntityAssociationInlineCreateTest {
    ...
    @Test
    fun create() {
        val legalEntityAssociationInlineCreate =
        ...
        assertThat(legalEntityAssociationInlineCreate.relationshipTypes())
            .containsExactly(LegalEntityAssociationInlineCreate.RelationshipType.AUTHORIZED_SIGNER)
        assertThat(legalEntityAssociationInlineCreate.childLegalEntity())
            .isEqualTo(
                ChildLegalEntityCreate.builder()
                    .addAddress(
                        LegalEntityAddressCreateRequest.builder()
        ...
        assertThat(legalEntityAssociationInlineCreate.childLegalEntityId())
            .isEqualTo("child_legal_entity_id")
    ...
    fun roundtrip() {
        ...
        val roundtrippedLegalEntityAssociationInlineCreate =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(legalEntityAssociationInlineCreate),
                jacksonTypeRef<LegalEntityAssociationInlineCreate>(),
            )

        assertThat(roundtrippedLegalEntityAssociationInlineCreate)
            .isEqualTo(legalEntityAssociationInlineCreate)
    }
}
