...
internal class LegalEntityAssociationInlineCreateTest {

    @Test
    fun create() {
      val legalEntityAssociationInlineCreate = LegalEntityAssociationInlineCreate.builder()
      ...
      assertThat(legalEntityAssociationInlineCreate.relationshipTypes()).containsExactly(LegalEntityAssociationInlineCreate.RelationshipType.AUTHORIZED_SIGNER)
      assertThat(legalEntityAssociationInlineCreate.childLegalEntity()).isEqualTo(ChildLegalEntityCreate.builder()
          .addAddress(LegalEntityAddressCreateRequest.builder()
              .country("country")
              .line1("line1")
              .locality("locality")
          ...
          .website("website")
          .build())
      assertThat(legalEntityAssociationInlineCreate.childLegalEntityId()).isEqualTo("child_legal_entity_id")
      assertThat(legalEntityAssociationInlineCreate.ownershipPercentage()).isEqualTo(0L)
      assertThat(legalEntityAssociationInlineCreate.title()).isEqualTo("title")
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedLegalEntityAssociationInlineCreate = jsonMapper.readValue(jsonMapper.writeValueAsString(legalEntityAssociationInlineCreate), jacksonTypeRef<LegalEntityAssociationInlineCreate>())

      assertThat(roundtrippedLegalEntityAssociationInlineCreate).isEqualTo(legalEntityAssociationInlineCreate)
    }
}
