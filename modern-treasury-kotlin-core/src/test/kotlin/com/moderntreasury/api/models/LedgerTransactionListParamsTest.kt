...
internal class LedgerTransactionListParamsTest {
    ...
    fun create() {
      LedgerTransactionListParams.builder()
          ...
          .amount(LedgerTransactionListParams.Amount.builder()
              .eq(0L)
              .gt(0L)
              .gte(0L)
              .lt(0L)
              .lte(0L)
              .build())
          .effectiveAt(LedgerTransactionListParams.EffectiveAt.builder()
              .putAdditionalProperty("foo", "2019-12-27T18:11:19.117Z")
              .build())
          .effectiveDate(LedgerTransactionListParams.EffectiveDate.builder()
              .putAdditionalProperty("foo", "2019-12-27T18:11:19.117Z")
              .build())
          ...
          .metadata(LedgerTransactionListParams.Metadata.builder()
              .putAdditionalProperty("foo", "string")
              .build())
          .orderBy(LedgerTransactionListParams.OrderBy.builder()
    ...
    @Test
    fun queryParams() {
      val params = LedgerTransactionListParams.builder()
          .addId("string")
          .afterCursor("after_cursor")
          .amount(LedgerTransactionListParams.Amount.builder()
              .eq(0L)
      ...
      assertThat(queryParams).isEqualTo(QueryParams.builder()
          ...
          .put("partially_posts_ledger_transaction_id", "partially_posts_ledger_transaction_id")
          .put("per_page", "0")
