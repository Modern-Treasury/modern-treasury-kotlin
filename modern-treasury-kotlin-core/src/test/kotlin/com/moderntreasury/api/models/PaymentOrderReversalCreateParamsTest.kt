...
internal class PaymentOrderReversalCreateParamsTest {
    ...
    @Test
    fun pathParams() {
      val params = PaymentOrderReversalCreateParams.builder()
          .paymentOrderId("payment_order_id")
          .reason(PaymentOrderReversalCreateParams.Reason.DUPLICATE)
          .build()
    ...
    fun body() {
      ...
      assertThat(body.ledgerTransaction()).isEqualTo(LedgerTransactionCreateRequest.builder()
          .addLedgerEntry(LedgerEntryCreateRequest.builder()
              .direction(TransactionDirection.CREDIT)
              .ledgerAccountId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
              .amount(0L)
          ...
          .status(LedgerTransactionCreateRequest.Status.ARCHIVED)
          .build())
      assertThat(body.metadata()).isEqualTo(PaymentOrderReversalCreateParams.Metadata.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
