...
internal class AccountDetailTest {
    ...
    fun create() {
        ...
        assertThat(accountDetail.accountNumberType())
            .isEqualTo(AccountDetail.AccountNumberType.ARBITRUM_ADDRESS)
    ...
    fun roundtrip() {
        ...
        val roundtrippedAccountDetail =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(accountDetail),
                jacksonTypeRef<AccountDetail>(),
            )
