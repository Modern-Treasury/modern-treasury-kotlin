...
internal class HoldListResponseTest {
    ...
    @Test
    fun create() {
      val holdListResponse = HoldListResponse.builder()
          ...
          .liveMode(true)
          .metadata(HoldListResponse.Metadata.builder()
      ...
      assertThat(holdListResponse.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(holdListResponse.targetType()).isEqualTo(HoldListResponse.TargetType.PAYMENT_ORDER)
      assertThat(holdListResponse.updatedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(holdListResponse.liveMode()).isEqualTo(true)
      assertThat(holdListResponse.metadata()).isEqualTo(HoldListResponse.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
      assertThat(holdListResponse.reason()).isEqualTo("reason")
      assertThat(holdListResponse.resolution()).isEqualTo("resolution")
      assertThat(holdListResponse.resolvedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedHoldListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(holdListResponse), jacksonTypeRef<HoldListResponse>())
