...
internal class IdentificationCreateRequestTest {
    ...
    fun create() {
      ...
      assertThat(identificationCreateRequest.documents()).containsExactly(IdentificationCreateRequest.Document.builder()
          .documentType(IdentificationCreateRequest.Document.DocumentType.ARTICLES_OF_INCORPORATION)
          .fileData("file_data")
          .filename("filename")
          .build())
      assertThat(identificationCreateRequest.expirationDate()).isEqualTo(LocalDate.parse("2019-12-27"))
