...
internal class LegalEntityAssociationTest {
    ...
    @Test
    fun create() {
      val legalEntityAssociation = LegalEntityAssociation.builder()
      ...
      assertThat(legalEntityAssociation.childLegalEntity()).isEqualTo(ChildLegalEntity.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .addAddress(ChildLegalEntity.LegalEntityAddress.builder()
              .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
              .addAddressType(ChildLegalEntity.LegalEntityAddress.AddressType.BUSINESS)
          ...
          .website("website")
          .build())
      assertThat(legalEntityAssociation.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(legalEntityAssociation.discardedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(legalEntityAssociation.relationshipTypes()).containsExactly(LegalEntityAssociation.RelationshipType.AUTHORIZED_SIGNER)
      assertThat(legalEntityAssociation.title()).isEqualTo("title")
      assertThat(legalEntityAssociation.updatedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedLegalEntityAssociation = jsonMapper.readValue(jsonMapper.writeValueAsString(legalEntityAssociation), jacksonTypeRef<LegalEntityAssociation>())
