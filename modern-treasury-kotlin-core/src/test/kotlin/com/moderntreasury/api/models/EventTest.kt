...
internal class EventTest {
    ...
    fun create() {
      ...
      assertThat(event.data()).isEqualTo(Event.Data.builder()
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .build())
    ...
    fun roundtrip() {
      ...
      val roundtrippedEvent = jsonMapper.readValue(jsonMapper.writeValueAsString(event), jacksonTypeRef<Event>())
