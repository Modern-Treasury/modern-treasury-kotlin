...
internal class PaymentOrderUpdateParamsTest {
    ...
    @Test
    fun pathParams() {
      val params = PaymentOrderUpdateParams.builder()
          .id("id")
          .build()
    ...
    fun body() {
      ...
      assertThat(body.accounting()).isEqualTo(PaymentOrderUpdateParams.Accounting.builder()
          .accountId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .classId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .build())
      ...
      assertThat(body.foreignExchangeIndicator()).isEqualTo(PaymentOrderUpdateParams.ForeignExchangeIndicator.FIXED_TO_VARIABLE)
      assertThat(body.lineItems()).containsExactly(PaymentOrderUpdateParams.LineItemRequest.builder()
          .amount(0L)
          .accountingCategoryId("accounting_category_id")
          .description("description")
          .metadata(PaymentOrderUpdateParams.LineItemRequest.Metadata.builder()
              ...
              .build())
          .build())
      assertThat(body.metadata()).isEqualTo(PaymentOrderUpdateParams.Metadata.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
      ...
      assertThat(body.receivingAccount()).isEqualTo(PaymentOrderUpdateParams.ReceivingAccount.builder()
          .addAccountDetail(PaymentOrderUpdateParams.ReceivingAccount.AccountDetail.builder()
              .accountNumber("account_number")
              .accountNumberType(PaymentOrderUpdateParams.ReceivingAccount.AccountDetail.AccountNumberType.AU_NUMBER)
              .build())
      ...
      assertThat(body.reconciliationStatus()).isEqualTo(PaymentOrderUpdateParams.ReconciliationStatus.UNRECONCILED)
