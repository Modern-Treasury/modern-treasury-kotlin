...
internal class ReturnObjectTest {
    ...
    @Test
    fun create() {
      val returnObject = ReturnObject.builder()
      ...
      assertThat(returnObject.corrections()).isEqualTo(ReturnObject.Corrections.builder()
          .accountNumber("account_number")
          .companyId("company_id")
          .companyName("company_name")
          .individualIdentificationNumber("individual_identification_number")
          ...
          .transactionCode("transaction_code")
          .build())
      assertThat(returnObject.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(returnObject.discardedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(returnObject.failureReason()).isEqualTo("failure_reason")
      assertThat(returnObject.internalAccountId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(returnObject.ledgerTransactionId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      ...
      assertThat(returnObject.reconciliationStatus()).isEqualTo(ReturnObject.ReconciliationStatus.UNRECONCILED)
      assertThat(returnObject.referenceNumbers()).containsExactly(ReturnObject.PaymentReference.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .liveMode(true)
          .object_("object")
      ...
      assertThat(returnObject.returnableType()).isEqualTo(ReturnObject.ReturnableType.INCOMING_PAYMENT_DETAIL)
      ...
      assertThat(returnObject.transactionLineItemId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(returnObject.type()).isEqualTo(ReturnObject.Type.ACH)
      assertThat(returnObject.updatedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedReturnObject = jsonMapper.readValue(jsonMapper.writeValueAsString(returnObject), jacksonTypeRef<ReturnObject>())
