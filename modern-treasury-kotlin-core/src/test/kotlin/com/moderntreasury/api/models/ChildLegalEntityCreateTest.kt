...
internal class ChildLegalEntityCreateTest {
    ...
    @Test
    fun create() {
      val childLegalEntityCreate = ChildLegalEntityCreate.builder()
          .addAddress(LegalEntityAddressCreateRequest.builder()
              .country("country")
              .line1("line1")
              .locality("locality")
          ...
          .addDocument(ChildLegalEntityCreate.Document.builder()
              .documentType(ChildLegalEntityCreate.Document.DocumentType.ARTICLES_OF_INCORPORATION)
              .fileData("file_data")
              .filename("filename")
              .build())
          ...
          .addIdentification(IdentificationCreateRequest.builder()
              .idNumber("id_number")
          ...
          .lastName("last_name")
          .addLegalEntityAssociation(LegalEntityAssociationInlineCreate.builder()
              .addRelationshipType(LegalEntityAssociationInlineCreate.RelationshipType.AUTHORIZED_SIGNER)
          ...
          .metadata(ChildLegalEntityCreate.Metadata.builder()
          ...
          .addPhoneNumber(ChildLegalEntityCreate.PhoneNumber.builder()
          ...
          .addRegulator(ChildLegalEntityCreate.LegalEntityRegulator.builder()
          ...
          .suffix("suffix")
          .termsOfUse(ChildLegalEntityCreate.TermsOfUse.builder()
      ...
      assertThat(childLegalEntityCreate.addresses()).containsExactly(LegalEntityAddressCreateRequest.builder()
          .country("country")
          .line1("line1")
          .locality("locality")
          .postalCode("postal_code")
          ...
          .primary(true)
          .build())
      assertThat(childLegalEntityCreate.bankSettings()).isEqualTo(BankSettings.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .backupWithholdingPercentage(0L)
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .discardedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(childLegalEntityCreate._complianceDetails()).isEqualTo(JsonValue.from(mapOf<String, Any>()))
      assertThat(childLegalEntityCreate.connectionId()).isEqualTo("connection_id")
      assertThat(childLegalEntityCreate.countryOfIncorporation()).isEqualTo("country_of_incorporation")
      ...
      assertThat(childLegalEntityCreate.documents()).containsExactly(ChildLegalEntityCreate.Document.builder()
          .documentType(ChildLegalEntityCreate.Document.DocumentType.ARTICLES_OF_INCORPORATION)
          .fileData("file_data")
          .filename("filename")
          .build())
      ...
      assertThat(childLegalEntityCreate.externalId()).isEqualTo("external_id")
      assertThat(childLegalEntityCreate.firstName()).isEqualTo("first_name")
      assertThat(childLegalEntityCreate.identifications()).containsExactly(IdentificationCreateRequest.builder()
          .idNumber("id_number")
          .idType(IdentificationCreateRequest.IdType.AR_CUIL)
          .addDocument(IdentificationCreateRequest.Document.builder()
              .documentType(IdentificationCreateRequest.Document.DocumentType.ARTICLES_OF_INCORPORATION)
          ...
          .issuingRegion("issuing_region")
          .build())
      assertThat(childLegalEntityCreate.industryClassifications()).containsExactly(LegalEntityIndustryClassification.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .addClassificationCode("string")
          .classificationType(LegalEntityIndustryClassification.ClassificationType.ANZSIC)
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(childLegalEntityCreate.legalEntityAssociations()).containsExactly(LegalEntityAssociationInlineCreate.builder()
          .addRelationshipType(LegalEntityAssociationInlineCreate.RelationshipType.AUTHORIZED_SIGNER)
          .childLegalEntityId("child_legal_entity_id")
          .ownershipPercentage(0L)
          .title("title")
          .build())
      assertThat(childLegalEntityCreate.legalEntityType()).isEqualTo(ChildLegalEntityCreate.LegalEntityType.BUSINESS)
      assertThat(childLegalEntityCreate.legalStructure()).isEqualTo(ChildLegalEntityCreate.LegalStructure.CORPORATION)
      assertThat(childLegalEntityCreate.listedExchange()).isEqualTo("listed_exchange")
      assertThat(childLegalEntityCreate.metadata()).isEqualTo(ChildLegalEntityCreate.Metadata.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
      ...
      assertThat(childLegalEntityCreate.phoneNumbers()).containsExactly(ChildLegalEntityCreate.PhoneNumber.builder()
          .phoneNumber("phone_number")
          .build())
      ...
      assertThat(childLegalEntityCreate.regulators()).containsExactly(ChildLegalEntityCreate.LegalEntityRegulator.builder()
          .jurisdiction("jurisdiction")
          .name("name")
          .registrationNumber("registration_number")
          .build())
      assertThat(childLegalEntityCreate.riskRating()).isEqualTo(ChildLegalEntityCreate.RiskRating.LOW)
      assertThat(childLegalEntityCreate.serviceProviderLegalEntityId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(childLegalEntityCreate.suffix()).isEqualTo("suffix")
      assertThat(childLegalEntityCreate.termsOfUse()).isEqualTo(ChildLegalEntityCreate.TermsOfUse.builder()
          .acceptedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .ipAddress("ip_address")
          .build())
      assertThat(childLegalEntityCreate.thirdPartyVerification()).isEqualTo(ThirdPartyVerification.builder()
          .outcome(ThirdPartyVerification.Outcome.PASSED)
          .vendor(ThirdPartyVerification.Vendor.PERSONA)
          .vendorVerificationId("vendor_verification_id")
          .verificationCategory(ThirdPartyVerification.VerificationCategory.LEGAL_NAME)
          ...
          .comment("comment")
          .build())
      assertThat(childLegalEntityCreate.thirdPartyVerifications()).containsExactly(ThirdPartyVerification.builder()
          .outcome(ThirdPartyVerification.Outcome.PASSED)
          .vendor(ThirdPartyVerification.Vendor.PERSONA)
          .vendorVerificationId("vendor_verification_id")
          .verificationCategory(ThirdPartyVerification.VerificationCategory.LEGAL_NAME)
          ...
          .comment("comment")
          .build())
      assertThat(childLegalEntityCreate.tickerSymbol()).isEqualTo("ticker_symbol")
      assertThat(childLegalEntityCreate.wealthAndEmploymentDetails()).isEqualTo(WealthAndEmploymentDetails.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .annualIncome(0L)
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .discardedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedChildLegalEntityCreate = jsonMapper.readValue(jsonMapper.writeValueAsString(childLegalEntityCreate), jacksonTypeRef<ChildLegalEntityCreate>())
