...
internal class InvoiceTest {
    ...
    fun create() {
      val invoice = Invoice.builder()
          ...
          .addContactDetail(ContactDetail.builder()
              ...
              .build())
          .counterpartyBillingAddress(Invoice.CounterpartyBillingAddress.builder()
              .country("country")
              .line1("line1")
              .locality("locality")
          ...
          .counterpartyShippingAddress(Invoice.CounterpartyShippingAddress.builder()
              .country("country")
              .line1("line1")
              .locality("locality")
              .postalCode("postal_code")
          ...
          .addExpectedPayment(ExpectedPayment.builder()
              .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
              .amountLowerBound(0L)
              .amountReconciled(0L)
              ...
              .liveMode(true)
              .metadata(ExpectedPayment.Metadata.builder()
          ...
          .invoicerAddress(Invoice.InvoicerAddress.builder()
              .country("country")
              .line1("line1")
              .locality("locality")
              .postalCode("postal_code")
          ...
          .liveMode(true)
          .metadata(Invoice.Metadata.builder()
              .putAdditionalProperty("key", JsonValue.from("value"))
              .putAdditionalProperty("foo", JsonValue.from("bar"))
              .putAdditionalProperty("modern", JsonValue.from("treasury"))
              .build())
          ...
          .addPaymentOrder(PaymentOrder.builder()
              .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      ...
      assertThat(invoice.contactDetails()).containsExactly(ContactDetail.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .contactIdentifier("contact_identifier")
          .contactIdentifierType(ContactDetail.ContactIdentifierType.EMAIL)
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          ...
          .updatedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .build())
      assertThat(invoice.counterpartyBillingAddress()).isEqualTo(Invoice.CounterpartyBillingAddress.builder()
          .country("country")
          .line1("line1")
          .locality("locality")
          .postalCode("postal_code")
      ...
      assertThat(invoice.counterpartyShippingAddress()).isEqualTo(Invoice.CounterpartyShippingAddress.builder()
          .country("country")
          .line1("line1")
          .locality("locality")
          .postalCode("postal_code")
      ...
      assertThat(invoice.expectedPayments()).containsExactly(ExpectedPayment.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .amountLowerBound(0L)
          .amountReconciled(0L)
          .amountReconciledDirection(ExpectedPayment.AmountReconciledDirection.CREDIT)
      ...
      assertThat(invoice.invoicerAddress()).isEqualTo(Invoice.InvoicerAddress.builder()
          .country("country")
          .line1("line1")
          .locality("locality")
          .postalCode("postal_code")
      ...
      assertThat(invoice.ledgerAccountSettlementId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(invoice.liveMode()).isEqualTo(true)
      assertThat(invoice.metadata()).isEqualTo(Invoice.Metadata.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
      ...
      assertThat(invoice.paymentOrders()).containsExactly(PaymentOrder.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .accounting(PaymentOrder.Accounting.builder()
              .accountId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
              .classId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      ...
      assertThat(invoice.transactionLineItemIds()).containsExactly("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ...
    fun roundtrip() {
      ...
      val roundtrippedInvoice = jsonMapper.readValue(jsonMapper.writeValueAsString(invoice), jacksonTypeRef<Invoice>())
