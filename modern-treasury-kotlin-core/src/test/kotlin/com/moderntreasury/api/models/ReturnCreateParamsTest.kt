...
internal class ReturnCreateParamsTest {
    ...
    @Test
    fun body() {
      val params = ReturnCreateParams.builder()
          .returnableId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .returnableType(ReturnCreateParams.ReturnableType.INCOMING_PAYMENT_DETAIL)
          .additionalInformation("additional_information")
          .code(ReturnCreateParams.Code._901)
      ...
      assertThat(body.returnableType()).isEqualTo(ReturnCreateParams.ReturnableType.INCOMING_PAYMENT_DETAIL)
      ...
      assertThat(body.corrections()).isEqualTo(ReturnCreateParams.Corrections.builder()
          .accountNumber("account_number")
          .companyId("company_id")
          .companyName("company_name")
          .individualIdentificationNumber("individual_identification_number")
      ...
      assertThat(body.reconciliationStatus()).isEqualTo(ReturnCreateParams.ReconciliationStatus.UNRECONCILED)
    }
