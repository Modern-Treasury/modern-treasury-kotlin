...
internal class ReversalTest {
    ...
    @Test
    fun create() {
      val reversal = Reversal.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .internalAccountId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .ledgerTransactionId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .liveMode(true)
          .metadata(Reversal.Metadata.builder()
          ...
          .status(Reversal.Status.CANCELLED)
      ...
      assertThat(reversal.internalAccountId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      ...
      assertThat(reversal.metadata()).isEqualTo(Reversal.Metadata.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
      ...
      assertThat(reversal.reconciliationStatus()).isEqualTo(Reversal.ReconciliationStatus.UNRECONCILED)
      assertThat(reversal.status()).isEqualTo(Reversal.Status.CANCELLED)
      assertThat(reversal.transactionIds()).containsExactly("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ...
    fun roundtrip() {
      ...
      val roundtrippedReversal = jsonMapper.readValue(jsonMapper.writeValueAsString(reversal), jacksonTypeRef<Reversal>())
