...
internal class LedgerAccountListParamsTest {
    ...
    fun create() {
      LedgerAccountListParams.builder()
          ...
          .availableBalanceAmount(LedgerAccountListParams.AvailableBalanceAmount.builder()
              .eq(0L)
              .gt(0L)
              .gte(0L)
              .lt(0L)
              ...
              .notEq(0L)
              .build())
          .balances(LedgerAccountListParams.Balances.builder()
              ...
              .build())
          .createdAt(LedgerAccountListParams.CreatedAt.builder()
          ...
          .ledgerId("ledger_id")
          .metadata(LedgerAccountListParams.Metadata.builder()
              .putAdditionalProperty("foo", "string")
              .build())
          .addName("string")
          .normalBalance(TransactionDirection.CREDIT)
          .pendingBalanceAmount(LedgerAccountListParams.PendingBalanceAmount.builder()
              .eq(0L)
              .gt(0L)
              .gte(0L)
              .lt(0L)
              ...
              .build())
          .perPage(0L)
          .postedBalanceAmount(LedgerAccountListParams.PostedBalanceAmount.builder()
              .eq(0L)
              .gt(0L)
              .gte(0L)
              .lt(0L)
              ...
              .notEq(0L)
              .build())
          .updatedAt(LedgerAccountListParams.UpdatedAt.builder()
              .putAdditionalProperty("foo", "2019-12-27T18:11:19.117Z")
              .build())
          .build()
    }
    ...
    @Test
    fun queryParams() {
      val params = LedgerAccountListParams.builder()
          .addId("string")
          .afterCursor("after_cursor")
          .availableBalanceAmount(LedgerAccountListParams.AvailableBalanceAmount.builder()
              .eq(0L)
