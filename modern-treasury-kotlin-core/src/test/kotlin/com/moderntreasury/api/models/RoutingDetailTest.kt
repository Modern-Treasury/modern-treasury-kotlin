...
internal class RoutingDetailTest {
    ...
    @Test
    fun create() {
      val routingDetail = RoutingDetail.builder()
      ...
      assertThat(routingDetail.bankAddress()).isEqualTo(Address.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .country("country")
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .line1("line1")
      ...
      assertThat(routingDetail.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(routingDetail.discardedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(routingDetail.updatedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedRoutingDetail = jsonMapper.readValue(jsonMapper.writeValueAsString(routingDetail), jacksonTypeRef<RoutingDetail>())
