...
internal class PaymentOrderTest {
    ...
    fun create() {
      val paymentOrder = PaymentOrder.builder()
          ...
          .accounting(PaymentOrder.Accounting.builder()
          ...
          .amount(0L)
          .batchId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .chargeBearer(PaymentOrder.ChargeBearer.SHARED)
          .counterpartyId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .currency(Currency.AED)
          .currentHold(PaymentOrder.Hold.builder()
              .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
              .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
              .object_(PaymentOrder.Hold.Object.HOLD)
              .status(PaymentOrder.Hold.Status.ACTIVE)
              .targetId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
              .targetType(PaymentOrder.Hold.TargetType.PAYMENT_ORDER)
              .updatedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
              .liveMode(true)
              .metadata(PaymentOrder.Hold.Metadata.builder()
              ...
              .build())
          .currentReturn(ReturnObject.builder()
              .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
              .amount(0L)
              .code(ReturnObject.Code._901)
              .corrections(ReturnObject.Corrections.builder()
              ...
              .addReferenceNumber(ReturnObject.PaymentReference.builder()
                  .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                  .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                  .liveMode(true)
                  .object_("object")
                  .referenceNumber("reference_number")
                  .referenceNumberType(ReturnObject.PaymentReference.ReferenceNumberType.ACH_ORIGINAL_TRACE_NUMBER)
                  .updatedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                  .build())
          ...
          .ledgerTransactionId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .liveMode(true)
          .metadata(PaymentOrder.Metadata.builder()
          ...
          .addReferenceNumber(PaymentOrder.PaymentReference.builder()
              .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
              .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
              .liveMode(true)
              .object_("object")
              .referenceNumber("reference_number")
              .referenceNumberType(PaymentOrder.PaymentReference.ReferenceNumberType.ACH_ORIGINAL_TRACE_NUMBER)
              .updatedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
              .build())
          ...
          .ultimateOriginatingAccount(VirtualAccount.builder()
              .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
              ...
              .liveMode(true)
              .metadata(VirtualAccount.Metadata.builder()
                  .putAdditionalProperty("key", JsonValue.from("value"))
                  .putAdditionalProperty("foo", JsonValue.from("bar"))
                  .putAdditionalProperty("modern", JsonValue.from("treasury"))
                  .build())
          ...
          .ultimateOriginatingAccountType(PaymentOrder.UltimateOriginatingAccountType.INTERNAL_ACCOUNT)
      ...
      assertThat(paymentOrder.accounting()).isEqualTo(PaymentOrder.Accounting.builder()
          .accountId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .classId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .build())
      assertThat(paymentOrder.accountingCategoryId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(paymentOrder.accountingLedgerClassId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(paymentOrder.amount()).isEqualTo(0L)
      assertThat(paymentOrder.batchId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      ...
      assertThat(paymentOrder.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(paymentOrder.currency()).isEqualTo(Currency.AED)
      assertThat(paymentOrder.currentHold()).isEqualTo(PaymentOrder.Hold.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .object_(PaymentOrder.Hold.Object.HOLD)
          .status(PaymentOrder.Hold.Status.ACTIVE)
          ...
          .resolvedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .build())
      assertThat(paymentOrder.currentReturn()).isEqualTo(ReturnObject.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .amount(0L)
          .code(ReturnObject.Code._901)
          .corrections(ReturnObject.Corrections.builder()
      ...
      assertThat(paymentOrder.expiresAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(paymentOrder.foreignExchangeIndicator()).isEqualTo(PaymentOrder.ForeignExchangeIndicator.FIXED_TO_VARIABLE)
      assertThat(paymentOrder.foreignExchangeRate()).isEqualTo(ForeignExchangeRate.builder()
          .baseAmount(0L)
          .baseCurrency(Currency.AED)
          .exponent(0L)
          .rateString("rate_string")
          ...
          .value(0L)
          .build())
      assertThat(paymentOrder.ledgerTransactionId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(paymentOrder.liveMode()).isEqualTo(true)
      assertThat(paymentOrder.metadata()).isEqualTo(PaymentOrder.Metadata.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
      ...
      assertThat(paymentOrder.originatingAccountId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      ...
      assertThat(paymentOrder.processAfter()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(paymentOrder.purpose()).isEqualTo("purpose")
      assertThat(paymentOrder.receivingAccountId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(paymentOrder.receivingAccountType()).isEqualTo(PaymentOrder.ReceivingAccountType.INTERNAL_ACCOUNT)
      assertThat(paymentOrder.reconciliationStatus()).isEqualTo(PaymentOrder.ReconciliationStatus.UNRECONCILED)
      assertThat(paymentOrder.referenceNumbers()).containsExactly(PaymentOrder.PaymentReference.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .liveMode(true)
          .object_("object")
      ...
      assertThat(paymentOrder.transactionIds()).containsExactly("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(paymentOrder.type()).isEqualTo(PaymentOrderType.ACH)
      assertThat(paymentOrder.ultimateOriginatingAccount()).isEqualTo(PaymentOrder.UltimateOriginatingAccount.ofVirtual(VirtualAccount.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .addAccountDetail(AccountDetail.builder()
              .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
              .accountNumberSafe("account_number_safe")
          ...
          .updatedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .build()))
      assertThat(paymentOrder.ultimateOriginatingAccountId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(paymentOrder.ultimateOriginatingAccountType()).isEqualTo(PaymentOrder.UltimateOriginatingAccountType.INTERNAL_ACCOUNT)
      assertThat(paymentOrder.ultimateOriginatingPartyIdentifier()).isEqualTo("ultimate_originating_party_identifier")
      assertThat(paymentOrder.ultimateOriginatingPartyName()).isEqualTo("ultimate_originating_party_name")
      assertThat(paymentOrder.ultimateReceivingPartyIdentifier()).isEqualTo("ultimate_receiving_party_identifier")
      assertThat(paymentOrder.ultimateReceivingPartyName()).isEqualTo("ultimate_receiving_party_name")
      assertThat(paymentOrder.updatedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedPaymentOrder = jsonMapper.readValue(jsonMapper.writeValueAsString(paymentOrder), jacksonTypeRef<PaymentOrder>())
