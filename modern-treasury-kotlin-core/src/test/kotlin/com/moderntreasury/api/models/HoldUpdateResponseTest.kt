...
internal class HoldUpdateResponseTest {
    ...
    @Test
    fun create() {
      val holdUpdateResponse = HoldUpdateResponse.builder()
          ...
          .liveMode(true)
          .metadata(HoldUpdateResponse.Metadata.builder()
      ...
      assertThat(holdUpdateResponse.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(holdUpdateResponse.targetType()).isEqualTo(HoldUpdateResponse.TargetType.PAYMENT_ORDER)
      assertThat(holdUpdateResponse.updatedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(holdUpdateResponse.liveMode()).isEqualTo(true)
      assertThat(holdUpdateResponse.metadata()).isEqualTo(HoldUpdateResponse.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
      assertThat(holdUpdateResponse.reason()).isEqualTo("reason")
      assertThat(holdUpdateResponse.resolution()).isEqualTo("resolution")
      assertThat(holdUpdateResponse.resolvedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedHoldUpdateResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(holdUpdateResponse), jacksonTypeRef<HoldUpdateResponse>())
