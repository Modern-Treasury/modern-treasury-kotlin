...
internal class TransactionLineItemTest {
    ...
    @Test
    fun create() {
      val transactionLineItem = TransactionLineItem.builder()
      ...
      assertThat(transactionLineItem.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(transactionLineItem.description()).isEqualTo("description")
      assertThat(transactionLineItem.discardedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(transactionLineItem.transactableType()).isEqualTo(TransactionLineItem.TransactableType.INCOMING_PAYMENT_DETAIL)
      ...
      assertThat(transactionLineItem.updatedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedTransactionLineItem = jsonMapper.readValue(jsonMapper.writeValueAsString(transactionLineItem), jacksonTypeRef<TransactionLineItem>())
