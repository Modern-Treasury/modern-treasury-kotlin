...
internal class LedgerTransactionVersionListParamsTest {
    ...
    fun create() {
      LedgerTransactionVersionListParams.builder()
          ...
          .createdAt(LedgerTransactionVersionListParams.CreatedAt.builder()
          ...
          .perPage(0L)
          .version(LedgerTransactionVersionListParams.Version.builder()
    ...
    @Test
    fun queryParams() {
      val params = LedgerTransactionVersionListParams.builder()
          .afterCursor("after_cursor")
          .createdAt(LedgerTransactionVersionListParams.CreatedAt.builder()
              .putAdditionalProperty("foo", "2019-12-27T18:11:19.117Z")
              .build())
