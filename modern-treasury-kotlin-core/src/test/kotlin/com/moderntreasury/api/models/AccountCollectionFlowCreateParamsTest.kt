...
internal class AccountCollectionFlowCreateParamsTest {
    ...
    @Test
    fun body() {
      val params = AccountCollectionFlowCreateParams.builder()
          .counterpartyId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .addPaymentType("string")
          .addReceivingCountry(AccountCollectionFlowCreateParams.ReceivingCountry.USA)
          .build()
      ...
      assertThat(body.receivingCountries()).containsExactly(AccountCollectionFlowCreateParams.ReceivingCountry.USA)
    }
