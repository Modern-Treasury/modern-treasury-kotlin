...
internal class ExpectedPaymentTest {
    ...
    @Test
    fun create() {
      val expectedPayment = ExpectedPayment.builder()
      ...
      assertThat(expectedPayment.amountReconciled()).isEqualTo(0L)
      assertThat(expectedPayment.amountReconciledDirection()).isEqualTo(ExpectedPayment.AmountReconciledDirection.CREDIT)
      assertThat(expectedPayment.amountUnreconciled()).isEqualTo(0L)
      assertThat(expectedPayment.amountUnreconciledDirection()).isEqualTo(ExpectedPayment.AmountUnreconciledDirection.CREDIT)
      assertThat(expectedPayment.amountUpperBound()).isEqualTo(0L)
      assertThat(expectedPayment.counterpartyId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(expectedPayment.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(expectedPayment.internalAccountId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(expectedPayment.ledgerTransactionId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(expectedPayment.liveMode()).isEqualTo(true)
      assertThat(expectedPayment.metadata()).isEqualTo(ExpectedPayment.Metadata.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
      assertThat(expectedPayment.object_()).isEqualTo("object")
      assertThat(expectedPayment._reconciliationFilters()).isEqualTo(JsonValue.from(mapOf<String, Any>()))
      assertThat(expectedPayment._reconciliationGroups()).isEqualTo(JsonValue.from(mapOf<String, Any>()))
      assertThat(expectedPayment.reconciliationMethod()).isEqualTo(ExpectedPayment.ReconciliationMethod.AUTOMATIC)
      assertThat(expectedPayment.reconciliationRuleVariables()).containsExactly(ReconciliationRule.builder()
          .amountLowerBound(0L)
          .amountUpperBound(0L)
          .direction(ReconciliationRule.Direction.CREDIT)
          .internalAccountId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      ...
      assertThat(expectedPayment.transactionId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(expectedPayment.transactionLineItemId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(expectedPayment.type()).isEqualTo(ExpectedPaymentType.ACH)
      assertThat(expectedPayment.updatedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedExpectedPayment = jsonMapper.readValue(jsonMapper.writeValueAsString(expectedPayment), jacksonTypeRef<ExpectedPayment>())
