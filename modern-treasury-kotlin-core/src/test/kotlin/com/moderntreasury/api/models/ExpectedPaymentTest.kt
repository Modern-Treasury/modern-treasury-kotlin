...
internal class ExpectedPaymentTest {
    ...
    fun create() {
        ...
        assertThat(expectedPayment.amountReconciledDirection())
            .isEqualTo(ExpectedPayment.AmountReconciledDirection.CREDIT)
        assertThat(expectedPayment.amountUnreconciled()).isEqualTo(0L)
        assertThat(expectedPayment.amountUnreconciledDirection())
            .isEqualTo(ExpectedPayment.AmountUnreconciledDirection.CREDIT)
