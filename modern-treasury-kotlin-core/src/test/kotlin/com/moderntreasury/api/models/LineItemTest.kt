...
internal class LineItemTest {
    ...
    @Test
    fun create() {
      val lineItem = LineItem.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .accounting(LineItem.Accounting.builder()
          ...
          .liveMode(true)
          .metadata(LineItem.Metadata.builder()
      ...
      assertThat(lineItem.accounting()).isEqualTo(LineItem.Accounting.builder()
          .accountId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .classId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .build())
      assertThat(lineItem.accountingCategoryId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(lineItem.accountingLedgerClassId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      ...
      assertThat(lineItem.metadata()).isEqualTo(LineItem.Metadata.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
    ...
    fun roundtrip() {
      ...
      val roundtrippedLineItem = jsonMapper.readValue(jsonMapper.writeValueAsString(lineItem), jacksonTypeRef<LineItem>())
