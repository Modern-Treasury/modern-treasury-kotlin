...
internal class LedgerAccountCategoryCreateParamsTest {
    ...
    @Test
    fun body() {
      val params = LedgerAccountCategoryCreateParams.builder()
          .currency("currency")
          .ledgerId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .name("name")
          .normalBalance(TransactionDirection.CREDIT)
      ...
      assertThat(body.ledgerAccountCategoryIds()).containsExactly("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(body.metadata()).isEqualTo(LedgerAccountCategoryCreateParams.Metadata.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
