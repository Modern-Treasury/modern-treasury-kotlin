...
internal class ConnectionLegalEntityTest {
    ...
    @Test
    fun create() {
      val connectionLegalEntity = ConnectionLegalEntity.builder()
      ...
      assertThat(connectionLegalEntity.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(connectionLegalEntity.discardedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(connectionLegalEntity.updatedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedConnectionLegalEntity = jsonMapper.readValue(jsonMapper.writeValueAsString(connectionLegalEntity), jacksonTypeRef<ConnectionLegalEntity>())
