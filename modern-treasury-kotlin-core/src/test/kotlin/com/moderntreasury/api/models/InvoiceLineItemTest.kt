...
internal class InvoiceLineItemTest {
    ...
    @Test
    fun create() {
      val invoiceLineItem = InvoiceLineItem.builder()
          ...
          .liveMode(true)
          .metadata(InvoiceLineItem.Metadata.builder()
      ...
      assertThat(invoiceLineItem.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(invoiceLineItem.metadata()).isEqualTo(InvoiceLineItem.Metadata.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
      ...
      assertThat(invoiceLineItem.updatedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedInvoiceLineItem = jsonMapper.readValue(jsonMapper.writeValueAsString(invoiceLineItem), jacksonTypeRef<InvoiceLineItem>())
