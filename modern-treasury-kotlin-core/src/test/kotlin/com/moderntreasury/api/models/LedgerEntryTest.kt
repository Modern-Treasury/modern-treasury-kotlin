...
internal class LedgerEntryTest {
    ...
    @Test
    fun create() {
      val ledgerEntry = LedgerEntry.builder()
      ...
      assertThat(ledgerEntry.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(ledgerEntry.direction()).isEqualTo(TransactionDirection.CREDIT)
      assertThat(ledgerEntry.discardedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(ledgerEntry.effectiveAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(ledgerEntry.metadata()).isEqualTo(LedgerEntry.Metadata.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
      assertThat(ledgerEntry.object_()).isEqualTo("object")
      assertThat(ledgerEntry.resultingLedgerAccountBalances()).isEqualTo(LedgerBalances.builder()
          .availableBalance(LedgerBalance.builder()
              .amount(0L)
              .amountString("amount_string")
              .credits(0L)
      ...
      assertThat(ledgerEntry.updatedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedLedgerEntry = jsonMapper.readValue(jsonMapper.writeValueAsString(ledgerEntry), jacksonTypeRef<LedgerEntry>())
