...
internal class AddressRequestTest {
    ...
    @Test
    fun create() {
      val addressRequest = AddressRequest.builder()
          .country("country")
          .line1("line1")
          .line2("line2")
          .locality("locality")
    ...
    fun roundtrip() {
      ...
      val roundtrippedAddressRequest = jsonMapper.readValue(jsonMapper.writeValueAsString(addressRequest), jacksonTypeRef<AddressRequest>())
