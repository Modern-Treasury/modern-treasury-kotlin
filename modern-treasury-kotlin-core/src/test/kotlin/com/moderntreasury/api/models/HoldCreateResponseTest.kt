...
internal class HoldCreateResponseTest {
    ...
    @Test
    fun create() {
      val holdCreateResponse = HoldCreateResponse.builder()
          ...
          .liveMode(true)
          .metadata(HoldCreateResponse.Metadata.builder()
      ...
      assertThat(holdCreateResponse.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(holdCreateResponse.targetType()).isEqualTo(HoldCreateResponse.TargetType.PAYMENT_ORDER)
      assertThat(holdCreateResponse.updatedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(holdCreateResponse.liveMode()).isEqualTo(true)
      assertThat(holdCreateResponse.metadata()).isEqualTo(HoldCreateResponse.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
      assertThat(holdCreateResponse.reason()).isEqualTo("reason")
      assertThat(holdCreateResponse.resolution()).isEqualTo("resolution")
      assertThat(holdCreateResponse.resolvedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedHoldCreateResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(holdCreateResponse), jacksonTypeRef<HoldCreateResponse>())
