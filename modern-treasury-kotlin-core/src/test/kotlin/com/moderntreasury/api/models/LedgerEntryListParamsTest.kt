...
internal class LedgerEntryListParamsTest {
    ...
    fun create() {
      LedgerEntryListParams.builder()
          ...
          .amount(LedgerEntryListParams.Amount.builder()
              .eq(0L)
              .gt(0L)
              .gte(0L)
              .lt(0L)
          ...
          .effectiveAt(LedgerEntryListParams.EffectiveAt.builder()
              .putAdditionalProperty("foo", "2019-12-27T18:11:19.117Z")
              .build())
          .effectiveDate(LedgerEntryListParams.EffectiveDate.builder()
              .putAdditionalProperty("foo", "2019-12-27")
              .build())
          .ledgerAccountCategoryId("ledger_account_category_id")
          .ledgerAccountId("ledger_account_id")
          .ledgerAccountLockVersion(LedgerEntryListParams.LedgerAccountLockVersion.builder()
          ...
          .metadata(LedgerEntryListParams.Metadata.builder()
              .putAdditionalProperty("foo", "string")
              .build())
          .orderBy(LedgerEntryListParams.OrderBy.builder()
          ...
          .updatedAt(LedgerEntryListParams.UpdatedAt.builder()
              .putAdditionalProperty("foo", "2019-12-27T18:11:19.117Z")
              .build())
          .build()
    }
    ...
    @Test
    fun queryParams() {
      val params = LedgerEntryListParams.builder()
          .addId("string")
          .afterCursor("after_cursor")
          .amount(LedgerEntryListParams.Amount.builder()
              .eq(0L)
