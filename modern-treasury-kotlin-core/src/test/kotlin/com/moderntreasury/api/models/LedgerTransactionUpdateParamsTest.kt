...
internal class LedgerTransactionUpdateParamsTest {
    ...
    @Test
    fun pathParams() {
      val params = LedgerTransactionUpdateParams.builder()
          .id("id")
          .build()
    ...
    fun body() {
      ...
      assertThat(body.ledgerEntries()).containsExactly(LedgerEntryCreateRequest.builder()
          .direction(TransactionDirection.CREDIT)
          .ledgerAccountId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .amount(0L)
          .amountString("amount_string")
      ...
      assertThat(body.ledgerableType()).isEqualTo(LedgerTransactionUpdateParams.LedgerableType.EXPECTED_PAYMENT)
      assertThat(body.metadata()).isEqualTo(LedgerTransactionUpdateParams.Metadata.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
