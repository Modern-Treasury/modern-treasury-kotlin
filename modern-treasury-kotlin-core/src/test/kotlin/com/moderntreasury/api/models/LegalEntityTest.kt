    ...
    fun create() {
        val legalEntity =
            LegalEntity.builder()
                ...
                .businessDesignation(LegalEntity.BusinessDesignation.EXEMPT_FINANCIAL_INSTITUTION)
                ...
                .suffix("suffix")
                .termsOfUse(
                    LegalEntity.TermsOfUse.builder()
        ...
        assertThat(legalEntity.businessDesignation())
            .isEqualTo(LegalEntity.BusinessDesignation.EXEMPT_FINANCIAL_INSTITUTION)
        ...
        assertThat(legalEntity.countryOfIncorporation()).isEqualTo("US")
        ...
        assertThat(legalEntity.operatingJurisdictions()).containsExactly("US", "CA")
        ...
        assertThat(legalEntity.termsOfUse())
            .isEqualTo(
                LegalEntity.TermsOfUse.builder()
                    .acceptedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                    .ipAddress("ip_address")
