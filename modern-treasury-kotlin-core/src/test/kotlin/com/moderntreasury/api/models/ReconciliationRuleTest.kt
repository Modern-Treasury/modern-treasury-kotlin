...
internal class ReconciliationRuleTest {
    ...
    @Test
    fun create() {
      val reconciliationRule = ReconciliationRule.builder()
          .amountLowerBound(0L)
          .amountUpperBound(0L)
      ...
      assertThat(reconciliationRule.internalAccountId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(reconciliationRule.counterpartyId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(reconciliationRule.currency()).isEqualTo(Currency.AED)
      assertThat(reconciliationRule.customIdentifiers()).isEqualTo(ReconciliationRule.CustomIdentifiers.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
    ...
    fun roundtrip() {
      ...
      val roundtrippedReconciliationRule = jsonMapper.readValue(jsonMapper.writeValueAsString(reconciliationRule), jacksonTypeRef<ReconciliationRule>())
