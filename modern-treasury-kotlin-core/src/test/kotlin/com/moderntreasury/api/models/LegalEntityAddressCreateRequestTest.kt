...
internal class LegalEntityAddressCreateRequestTest {
    ...
    @Test
    fun create() {
      val legalEntityAddressCreateRequest = LegalEntityAddressCreateRequest.builder()
          .country("country")
          .line1("line1")
          .locality("locality")
      ...
      assertThat(legalEntityAddressCreateRequest.addressTypes()).containsExactly(LegalEntityAddressCreateRequest.AddressType.BUSINESS)
    ...
    fun roundtrip() {
      ...
      val roundtrippedLegalEntityAddressCreateRequest = jsonMapper.readValue(jsonMapper.writeValueAsString(legalEntityAddressCreateRequest), jacksonTypeRef<LegalEntityAddressCreateRequest>())

      assertThat(roundtrippedLegalEntityAddressCreateRequest).isEqualTo(legalEntityAddressCreateRequest)
    }
}
